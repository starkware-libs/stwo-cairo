...
//! supported by the Stwo prover.
//! - `blake_outputs_packing`: Enables outputs packing using the blake hash function. Optional
//! feature. Not supported by the Poseidon verifier.
