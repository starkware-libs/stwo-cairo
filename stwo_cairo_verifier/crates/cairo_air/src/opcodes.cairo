...
pub struct OpcodeInteractionClaim {
    pub add: Array<components::add_opcode::InteractionClaim>,
    pub add_small: Array<components::add_opcode_small::InteractionClaim>,
    pub add_ap: Array<components::add_ap_opcode::InteractionClaim>,
    pub assert_eq: Array<components::assert_eq_opcode::InteractionClaim>,
    pub assert_eq_imm: Array<components::assert_eq_opcode_imm::InteractionClaim>,
    pub assert_eq_double_deref: Array<components::assert_eq_opcode_double_deref::InteractionClaim>,
    pub blake: Array<components::blake_compress_opcode::InteractionClaim>,
    pub call: Array<components::call_opcode_abs::InteractionClaim>,
    pub call_rel_imm: Array<components::call_opcode_rel_imm::InteractionClaim>,
    pub generic: Array<components::generic_opcode::InteractionClaim>,
    pub jnz: Array<components::jnz_opcode_non_taken::InteractionClaim>,
    pub jnz_taken: Array<components::jnz_opcode_taken::InteractionClaim>,
    pub jump: Array<components::jump_opcode_abs::InteractionClaim>,
    pub jump_double_deref: Array<components::jump_opcode_double_deref::InteractionClaim>,
    pub jump_rel: Array<components::jump_opcode_rel::InteractionClaim>,
    pub jump_rel_imm: Array<components::jump_opcode_rel_imm::InteractionClaim>,
    pub mul: Array<components::mul_opcode::InteractionClaim>,
    pub mul_small: Array<components::mul_opcode_small::InteractionClaim>,
    pub qm31: Array<components::qm_31_add_mul_opcode::InteractionClaim>,
    pub ret: Array<components::ret_opcode::InteractionClaim>,
}
