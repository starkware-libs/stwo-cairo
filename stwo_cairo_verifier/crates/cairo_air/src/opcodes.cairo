...
pub impl OpcodeComponentsImpl of OpcodeComponentsTrait {
    fn new(
        ...
        while let (Option::Some(claim), Option::Some(interaction_claim)) =
            ...
            add_components
                .append(
                    components::add_opcode::ComponentImpl::new(
        ...
        while let (Option::Some(claim), Option::Some(interaction_claim)) =
            ...
            add_small_components
                .append(
                    components::add_opcode_small::ComponentImpl::new(
                        claim, interaction_claim, interaction_elements,
                    ),
                );
        }
        ...
        while let (Option::Some(claim), Option::Some(interaction_claim)) =
            ...
            add_ap_components
                .append(
                    components::add_ap_opcode::ComponentImpl::new(
                        claim, interaction_claim, interaction_elements,
                    ),
                );
        }
        ...
        while let (Option::Some(claim), Option::Some(interaction_claim)) =
            ...
            assert_eq_components
                .append(
                    components::assert_eq_opcode::ComponentImpl::new(
                        claim, interaction_claim, interaction_elements,
                    ),
                );
        }
        ...
        while let (Option::Some(claim), Option::Some(interaction_claim)) =
            ...
            assert_eq_imm_components
                .append(
                    components::assert_eq_opcode_imm::ComponentImpl::new(
                        claim, interaction_claim, interaction_elements,
                    ),
                );
        }
        ...
        while let (Option::Some(claim), Option::Some(interaction_claim)) =
            ...
            assert_eq_double_deref_components
                .append(
                    components::assert_eq_opcode_double_deref::ComponentImpl::new(
                        claim, interaction_claim, interaction_elements,
                    ),
                );
        }
        ...
        while let (Option::Some(claim), Option::Some(interaction_claim)) =
            ...
            blake_components
                .append(
                    components::blake_compress_opcode::ComponentImpl::new(
                        claim, interaction_claim, interaction_elements,
                    ),
                );
        }
        ...
        while let (Option::Some(claim), Option::Some(interaction_claim)) =
            ...
            call_components
                .append(
                    components::call_opcode::ComponentImpl::new(
                        claim, interaction_claim, interaction_elements,
                    ),
                );
        }
        ...
        while let (Option::Some(claim), Option::Some(interaction_claim)) =
            ...
            call_rel_imm_components
                .append(
                    components::call_opcode_rel_imm::ComponentImpl::new(
                        claim, interaction_claim, interaction_elements,
                    ),
                );
        }
        ...
        while let (Option::Some(claim), Option::Some(interaction_claim)) =
            ...
            generic_components
                .append(
                    components::generic_opcode::ComponentImpl::new(
                        claim, interaction_claim, interaction_elements,
                    ),
                );
        }
        ...
        while let (Option::Some(claim), Option::Some(interaction_claim)) =
            ...
            jnz_components
                .append(
                    components::jnz_opcode::ComponentImpl::new(
                        claim, interaction_claim, interaction_elements,
                    ),
                );
        }
        ...
        while let (Option::Some(claim), Option::Some(interaction_claim)) =
            ...
            jnz_taken_components
                .append(
                    components::jnz_opcode_taken::ComponentImpl::new(
                        claim, interaction_claim, interaction_elements,
                    ),
                );
        }
        ...
        while let (Option::Some(claim), Option::Some(interaction_claim)) =
            ...
            jump_components
                .append(
                    components::jump_opcode::ComponentImpl::new(
                        claim, interaction_claim, interaction_elements,
                    ),
                );
        }
        ...
        while let (Option::Some(claim), Option::Some(interaction_claim)) =
            ...
            jump_double_deref_components
                .append(
                    components::jump_opcode_double_deref::ComponentImpl::new(
                        claim, interaction_claim, interaction_elements,
                    ),
                );
        }
        ...
        while let (Option::Some(claim), Option::Some(interaction_claim)) =
            ...
            jump_rel_components
                .append(
                    components::jump_opcode_rel::ComponentImpl::new(
                        claim, interaction_claim, interaction_elements,
                    ),
                );
        }
        ...
        while let (Option::Some(claim), Option::Some(interaction_claim)) =
            ...
            jump_rel_imm_components
                .append(
                    components::jump_opcode_rel_imm::ComponentImpl::new(
                        claim, interaction_claim, interaction_elements,
                    ),
                );
        }
        ...
        while let (Option::Some(claim), Option::Some(interaction_claim)) =
            ...
            mul_components
                .append(
                    components::mul_opcode::ComponentImpl::new(
                        claim, interaction_claim, interaction_elements,
                    ),
                );
        }
        ...
        while let (Option::Some(claim), Option::Some(interaction_claim)) =
            ...
            mul_small_components
                .append(
                    components::mul_opcode_small::ComponentImpl::new(
                        claim, interaction_claim, interaction_elements,
                    ),
                );
        }
        ...
        while let (Option::Some(claim), Option::Some(interaction_claim)) =
            ...
            qm31_components
                .append(
                    components::qm_31_add_mul_opcode::ComponentImpl::new(
                        claim, interaction_claim, interaction_elements,
                    ),
                );
        }
        ...
        while let (Option::Some(claim), Option::Some(interaction_claim)) =
            ...
            ret_components
                .append(
                    components::ret_opcode::ComponentImpl::new(
                        claim, interaction_claim, interaction_elements,
                    ),
                );
        }
