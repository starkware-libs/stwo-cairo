...
pub struct CairoAir {
    ...
    partial_ec_mul_generic: components::partial_ec_mul_generic::Component,
...
pub impl CairoAirNewImpl of CairoAirNewTrait {
    fn new(
        ...
        let partial_ec_mul_generic_component = components::partial_ec_mul_generic::NewComponentImpl::new(
            cairo_claim.partial_ec_mul_generic.as_snap().unwrap(),
            interaction_claim.partial_ec_mul_generic.as_snap().unwrap(),
...
pub impl CairoAirNewImpl of CairoAirNewTrait {
    fn new(
        ...
        assert!(cairo_claim.partial_ec_mul_generic.is_none(), "Partial EC Mul Generic is not supported.");
        assert!(interaction_claim.partial_ec_mul_generic.is_none(), "Partial EC Mul Generic is not supported.");
