...
pub impl CairoAirNewImpl of CairoAirNewTrait {
    fn new(
        ...
        let verifyinstruction_component = components::verify_instruction::ComponentImpl::new(
            cairo_claim.verify_instruction,
            interaction_claim.verify_instruction,
            interaction_elements,
        );

        let memory_address_to_id_component = components::memory_address_to_id::ComponentImpl::new(
        ...
        for i in 0..cairo_claim.memory_id_to_value.big_log_sizes.len() {
            ...
            memory_id_to_value_components
                .append(
                    components::memory_id_to_big::BigComponentImpl::new(
        ...
        let small_memory_id_to_value_component =
            components::memory_id_to_big::SmallComponentImpl::new(
        ...
        let verify_bitwise_xor_4_component = components::verify_bitwise_xor_4::ComponentImpl::new(
            cairo_claim.verify_bitwise_xor_4,
            interaction_claim.verify_bitwise_xor_4,
            interaction_elements,
        );

        let verify_bitwise_xor_7_component = components::verify_bitwise_xor_7::ComponentImpl::new(
            cairo_claim.verify_bitwise_xor_7,
            interaction_claim.verify_bitwise_xor_7,
            interaction_elements,
        );

        let verify_bitwise_xor_8_component = components::verify_bitwise_xor_8::ComponentImpl::new(
            cairo_claim.verify_bitwise_xor_8,
            interaction_claim.verify_bitwise_xor_8,
            interaction_elements,
        );

        let verify_bitwise_xor_9_component = components::verify_bitwise_xor_9::ComponentImpl::new(
