...
pub impl CairoClaimImpl of ClaimTrait<CairoClaim> {
    fn log_sizes(self: @CairoClaim) -> TreeArray<Span<u32>> {
        ...
        let mut blake_log_sizes = array![];
        if let Option::Some(claim) = self.blake_round {
            blake_log_sizes.append(claim.log_sizes());
        }
        if let Option::Some(claim) = self.blake_g {
            blake_log_sizes.append(claim.log_sizes());
        }
        if let Option::Some(claim) = self.blake_round_sigma {
            blake_log_sizes.append(claim.log_sizes());
        }
        if let Option::Some(claim) = self.triple_xor_32 {
            blake_log_sizes.append(claim.log_sizes());
        }
        if let Option::Some(claim) = self.verify_bitwise_xor_12 {
            blake_log_sizes.append(claim.log_sizes());
        }
        let blake_log_sizes_concat = utils::tree_array_concat_cols(blake_log_sizes);
        let mut aggregated_log_sizes = utils::tree_array_concat_cols(
            array![
                opcode_log_sizes_concat, self.verify_instruction.log_sizes(),
                blake_log_sizes_concat, self.builtins.log_sizes(),
    ...
    fn mix_into(self: @CairoClaim, ref channel: Channel) {
        ...
        if let Option::Some(claim) = blake_round {
            claim.mix_into(ref channel);
        }
        if let Option::Some(claim) = blake_g {
            claim.mix_into(ref channel);
        }
        if let Option::Some(claim) = blake_round_sigma {
            claim.mix_into(ref channel);
        }
        if let Option::Some(claim) = triple_xor_32 {
            claim.mix_into(ref channel);
        }
        if let Option::Some(claim) = verify_bitwise_xor_12 {
            claim.mix_into(ref channel);
        }
...
pub fn lookup_sum(
    ...
    if let Option::Some(interaction_claim) = blake_round {
        sum += *interaction_claim.claimed_sum;
    }
    if let Option::Some(interaction_claim) = blake_g {
        sum += *interaction_claim.claimed_sum;
    }
    if let Option::Some(interaction_claim) = blake_round_sigma {
        sum += *interaction_claim.claimed_sum;
    }
    if let Option::Some(interaction_claim) = triple_xor_32 {
        sum += *interaction_claim.claimed_sum;
    }
    if let Option::Some(interaction_claim) = verify_bitwise_xor_12 {
        sum += *interaction_claim.claimed_sum;
    }
    sum += builtins.sum();
...
pub impl CairoAirNewImpl of CairoAirNewTrait {
    fn new(
        ...
        let blake_round_component = if let (Option::Some(claim), Option::Some(interaction_claim)) =
            (cairo_claim.blake_round, interaction_claim.blake_round) {
            Option::Some(
                components::blake_round::NewComponentImpl::new(
                    claim, interaction_claim, interaction_elements,
                ),
            )
        } else {
        ...
        let blake_g_component = if let (Option::Some(claim), Option::Some(interaction_claim)) =
            (cairo_claim.blake_g, interaction_claim.blake_g) {
            Option::Some(
                components::blake_g::NewComponentImpl::new(
                    claim, interaction_claim, interaction_elements,
                ),
            )
        } else {
        ...
        let blake_round_sigma_component = if let (
            Option::Some(claim), Option::Some(interaction_claim),
        ) =
            (cairo_claim.blake_round_sigma, interaction_claim.blake_round_sigma) {
            Option::Some(
                components::blake_round_sigma::NewComponentImpl::new(
                    claim, interaction_claim, interaction_elements,
                ),
            )
        } else {
        ...
        let triple_xor_32_component = if let (
            Option::Some(claim), Option::Some(interaction_claim),
        ) =
            (cairo_claim.triple_xor_32, interaction_claim.triple_xor_32) {
            Option::Some(
                components::triple_xor_32::NewComponentImpl::new(
                    claim, interaction_claim, interaction_elements,
                ),
            )
        } else {
        ...
        let verify_bitwise_xor_12_component = if let (
            Option::Some(claim), Option::Some(interaction_claim),
        ) =
            (cairo_claim.verify_bitwise_xor_12, interaction_claim.verify_bitwise_xor_12) {
            Option::Some(
...
pub impl CairoAirImpl of Air<CairoAir> {
    ...
    fn eval_composition_polynomial_at_point(
        ...
        if let Option::Some(component) = blake_round {
            component
                .evaluate_constraints_at_point(
                    ref sum,
                    ref preprocessed_mask_values,
        ...
        if let Option::Some(component) = blake_g {
            component
                .evaluate_constraints_at_point(
                    ref sum,
                    ref preprocessed_mask_values,
        ...
        if let Option::Some(component) = blake_round_sigma {
            component
                .evaluate_constraints_at_point(
                    ref sum,
                    ref preprocessed_mask_values,
        ...
        if let Option::Some(component) = triple_xor_32 {
            component
                .evaluate_constraints_at_point(
                    ref sum,
                    ref preprocessed_mask_values,
        ...
        if let Option::Some(component) = verify_bitwise_xor_12 {
            component
                .evaluate_constraints_at_point(
                    ref sum,
                    ref preprocessed_mask_values,
