...
fn dummy_interaction_lookup_elements() -> CairoInteractionElements {
    CairoInteractionElements {
        ...
        pedersen_aggregator_window_bits_18: LookupElementsDummyImpl::dummy(),
        partial_ec_mul_window_bits_18: LookupElementsDummyImpl::dummy(),
        pedersen_points_table_window_bits_18: LookupElementsDummyImpl::dummy(),
        pedersen_aggregator_window_bits_9: LookupElementsDummyImpl::dummy(),
        partial_ec_mul_window_bits_9: LookupElementsDummyImpl::dummy(),
        pedersen_points_table_window_bits_9: LookupElementsDummyImpl::dummy(),
