...
pub impl BlakeComponentsImpl of BlakeComponentsTrait {
    fn new(
        ...
        let blake_round_component = components::blake_round::ComponentImpl::new(
            claim.blake_round, interaction_claim.blake_round, interaction_elements,
        );

        let blake_g_component = components::blake_g::ComponentImpl::new(
            claim.blake_g, interaction_claim.blake_g, interaction_elements,
        );

        let blake_round_sigma_component = components::blake_round_sigma::ComponentImpl::new(
            claim.blake_round_sigma, interaction_claim.blake_round_sigma, interaction_elements,
        );

        let triple_xor_32_component = components::triple_xor_32::ComponentImpl::new(
            claim.triple_xor_32, interaction_claim.triple_xor_32, interaction_elements,
        );

        let verify_bitwise_xor_12_component = components::verify_bitwise_xor_12::ComponentImpl::new(
