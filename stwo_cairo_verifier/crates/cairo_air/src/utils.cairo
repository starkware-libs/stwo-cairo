...
fn append_chunk(ref array: Array<QM31>, chunk: [u32; QM31_EXTENSION_DEGREE]) {
    ...
    assert!(v0 < P_U32, "Trying to pack value > P-1 into QM31");
    assert!(v1 < P_U32, "Trying to pack value > P-1 into QM31");
    assert!(v2 < P_U32, "Trying to pack value > P-1 into QM31");
    assert!(v3 < P_U32, "Trying to pack value > P-1 into QM31");
