...
pub const PEDERSEN_POINTS_0_IDX: u32 = 6; // PedersenPoints(0)
pub const PEDERSEN_POINTS_1_IDX: u32 = 7; // PedersenPoints(1)
pub const PEDERSEN_POINTS_2_IDX: u32 = 8; // PedersenPoints(2)
pub const PEDERSEN_POINTS_3_IDX: u32 = 9; // PedersenPoints(3)
pub const PEDERSEN_POINTS_4_IDX: u32 = 10; // PedersenPoints(4)
pub const PEDERSEN_POINTS_5_IDX: u32 = 11; // PedersenPoints(5)
pub const PEDERSEN_POINTS_6_IDX: u32 = 12; // PedersenPoints(6)
pub const PEDERSEN_POINTS_7_IDX: u32 = 13; // PedersenPoints(7)
pub const PEDERSEN_POINTS_8_IDX: u32 = 14; // PedersenPoints(8)
pub const PEDERSEN_POINTS_9_IDX: u32 = 15; // PedersenPoints(9)
pub const PEDERSEN_POINTS_10_IDX: u32 = 16; // PedersenPoints(10)
pub const PEDERSEN_POINTS_11_IDX: u32 = 17; // PedersenPoints(11)
pub const PEDERSEN_POINTS_12_IDX: u32 = 18; // PedersenPoints(12)
pub const PEDERSEN_POINTS_13_IDX: u32 = 19; // PedersenPoints(13)
pub const PEDERSEN_POINTS_14_IDX: u32 = 20; // PedersenPoints(14)
pub const PEDERSEN_POINTS_15_IDX: u32 = 21; // PedersenPoints(15)
pub const PEDERSEN_POINTS_16_IDX: u32 = 22; // PedersenPoints(16)
pub const PEDERSEN_POINTS_17_IDX: u32 = 23; // PedersenPoints(17)
pub const PEDERSEN_POINTS_18_IDX: u32 = 24; // PedersenPoints(18)
pub const PEDERSEN_POINTS_19_IDX: u32 = 25; // PedersenPoints(19)
pub const PEDERSEN_POINTS_20_IDX: u32 = 26; // PedersenPoints(20)
pub const PEDERSEN_POINTS_21_IDX: u32 = 27; // PedersenPoints(21)
pub const PEDERSEN_POINTS_22_IDX: u32 = 28; // PedersenPoints(22)
pub const PEDERSEN_POINTS_23_IDX: u32 = 29; // PedersenPoints(23)
pub const PEDERSEN_POINTS_24_IDX: u32 = 30; // PedersenPoints(24)
pub const PEDERSEN_POINTS_25_IDX: u32 = 31; // PedersenPoints(25)
pub const PEDERSEN_POINTS_26_IDX: u32 = 32; // PedersenPoints(26)
pub const PEDERSEN_POINTS_27_IDX: u32 = 33; // PedersenPoints(27)
pub const PEDERSEN_POINTS_28_IDX: u32 = 34; // PedersenPoints(28)
pub const PEDERSEN_POINTS_29_IDX: u32 = 35; // PedersenPoints(29)
pub const PEDERSEN_POINTS_30_IDX: u32 = 36; // PedersenPoints(30)
pub const PEDERSEN_POINTS_31_IDX: u32 = 37; // PedersenPoints(31)
pub const PEDERSEN_POINTS_32_IDX: u32 = 38; // PedersenPoints(32)
pub const PEDERSEN_POINTS_33_IDX: u32 = 39; // PedersenPoints(33)
pub const PEDERSEN_POINTS_34_IDX: u32 = 40; // PedersenPoints(34)
pub const PEDERSEN_POINTS_35_IDX: u32 = 41; // PedersenPoints(35)
pub const PEDERSEN_POINTS_36_IDX: u32 = 42; // PedersenPoints(36)
pub const PEDERSEN_POINTS_37_IDX: u32 = 43; // PedersenPoints(37)
pub const PEDERSEN_POINTS_38_IDX: u32 = 44; // PedersenPoints(38)
pub const PEDERSEN_POINTS_39_IDX: u32 = 45; // PedersenPoints(39)
pub const PEDERSEN_POINTS_40_IDX: u32 = 46; // PedersenPoints(40)
pub const PEDERSEN_POINTS_41_IDX: u32 = 47; // PedersenPoints(41)
pub const PEDERSEN_POINTS_42_IDX: u32 = 48; // PedersenPoints(42)
pub const PEDERSEN_POINTS_43_IDX: u32 = 49; // PedersenPoints(43)
pub const PEDERSEN_POINTS_44_IDX: u32 = 50; // PedersenPoints(44)
pub const PEDERSEN_POINTS_45_IDX: u32 = 51; // PedersenPoints(45)
pub const PEDERSEN_POINTS_46_IDX: u32 = 52; // PedersenPoints(46)
pub const PEDERSEN_POINTS_47_IDX: u32 = 53; // PedersenPoints(47)
pub const PEDERSEN_POINTS_48_IDX: u32 = 54; // PedersenPoints(48)
pub const PEDERSEN_POINTS_49_IDX: u32 = 55; // PedersenPoints(49)
pub const PEDERSEN_POINTS_50_IDX: u32 = 56; // PedersenPoints(50)
pub const PEDERSEN_POINTS_51_IDX: u32 = 57; // PedersenPoints(51)
pub const PEDERSEN_POINTS_52_IDX: u32 = 58; // PedersenPoints(52)
pub const PEDERSEN_POINTS_53_IDX: u32 = 59; // PedersenPoints(53)
pub const PEDERSEN_POINTS_54_IDX: u32 = 60; // PedersenPoints(54)
pub const PEDERSEN_POINTS_55_IDX: u32 = 61; // PedersenPoints(55)
pub const SEQ_22_IDX: u32 = 62; // Seq(22)
pub const SEQ_21_IDX: u32 = 63; // Seq(21)
pub const SEQ_20_IDX: u32 = 64; // Seq(20)
...
pub fn preprocessed_root(log_blowup_factor: u32) -> Hash {
    match log_blowup_factor - 1 {
        0 => Hash {
            hash: BoxImpl::new(
                [
                    0xfaed968f, 0x14a23359, 0x190c9280, 0x34b02e55, 0x28c25d87, 0x73b45e7c,
                    0x6d7aa8f6, 0x9db28a64,
                ],
            ),
        },
        1 => Hash {
            hash: BoxImpl::new(
                [
                    0x8fa99e16, 0xb40cadf5, 0x9d6e834c, 0x9bfe0e48, 0x2ea6a4e8, 0x7794500d,
                    0xae85946d, 0xfc5820da,
                ],
            ),
        },
        2 => Hash {
