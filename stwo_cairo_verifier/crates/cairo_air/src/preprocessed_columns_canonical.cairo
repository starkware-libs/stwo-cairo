...
pub fn preprocessed_root(log_blowup_factor: u32) -> Hash {
    match log_blowup_factor - 1 {
        0 => Hash {
            hash: BoxImpl::new(
                [
                    0xf754af5d, 0x597f3cf5, 0xbe85e026, 0x09003fc0, 0xabd768c0, 0x880f57ef,
                    0x20c57d49, 0x3bbe8348,
                ],
            ),
        },
        1 => Hash {
            hash: BoxImpl::new(
                [
                    0x244ac592, 0xd9cbf4a5, 0x55a5db2f, 0x4adf0077, 0x2a48c8b4, 0x93c4ebab,
                    0xab3dd20d, 0x6c1c323f,
                ],
            ),
        },
        2 => Hash {
