...
pub const N_INTERACTION_COLUMNS_PER_COMPONENT_IDX: [usize; N_COMPONENTS] = [
    ...
    memory_id_to_big::BIG_N_INTERACTION_COLUMNS, memory_id_to_big::BIG_N_INTERACTION_COLUMNS,
    memory_id_to_big::BIG_N_INTERACTION_COLUMNS, memory_id_to_big::BIG_N_INTERACTION_COLUMNS,
    memory_id_to_small::N_INTERACTION_COLUMNS, range_check_6::N_INTERACTION_COLUMNS,
    range_check_8::N_INTERACTION_COLUMNS, range_check_11::N_INTERACTION_COLUMNS,
    range_check_12::N_INTERACTION_COLUMNS, range_check_18::N_INTERACTION_COLUMNS,
    range_check_20::N_INTERACTION_COLUMNS, range_check_4_3::N_INTERACTION_COLUMNS,
    range_check_4_4::N_INTERACTION_COLUMNS, range_check_9_9::N_INTERACTION_COLUMNS,
    range_check_7_2_5::N_INTERACTION_COLUMNS, range_check_3_6_6_3::N_INTERACTION_COLUMNS,
    range_check_4_4_4_4::N_INTERACTION_COLUMNS, range_check_3_3_3_3_3::N_INTERACTION_COLUMNS,
    verify_bitwise_xor_4::N_INTERACTION_COLUMNS, verify_bitwise_xor_7::N_INTERACTION_COLUMNS,
    verify_bitwise_xor_8::N_INTERACTION_COLUMNS, verify_bitwise_xor_9::N_INTERACTION_COLUMNS,
];
