...
pub const N_TRACE_COLUMNS_PER_COMPONENT_IDX: [usize; N_COMPONENTS] = [
    add_opcode::N_TRACE_COLUMNS, add_opcode_small::N_TRACE_COLUMNS, add_ap_opcode::N_TRACE_COLUMNS,
    assert_eq_opcode::N_TRACE_COLUMNS, assert_eq_opcode_imm::N_TRACE_COLUMNS,
    assert_eq_opcode_double_deref::N_TRACE_COLUMNS, blake_compress_opcode::N_TRACE_COLUMNS,
    call_opcode_abs::N_TRACE_COLUMNS, call_opcode_rel_imm::N_TRACE_COLUMNS,
    generic_opcode::N_TRACE_COLUMNS, jnz_opcode_non_taken::N_TRACE_COLUMNS,
    jnz_opcode_taken::N_TRACE_COLUMNS, jump_opcode_abs::N_TRACE_COLUMNS,
    jump_opcode_double_deref::N_TRACE_COLUMNS, jump_opcode_rel::N_TRACE_COLUMNS,
    jump_opcode_rel_imm::N_TRACE_COLUMNS, mul_opcode::N_TRACE_COLUMNS,
    mul_opcode_small::N_TRACE_COLUMNS, qm_31_add_mul_opcode::N_TRACE_COLUMNS,
    ret_opcode::N_TRACE_COLUMNS, verify_instruction::N_TRACE_COLUMNS, blake_round::N_TRACE_COLUMNS,
    blake_g::N_TRACE_COLUMNS, blake_round_sigma::N_TRACE_COLUMNS, triple_xor_32::N_TRACE_COLUMNS,
    verify_bitwise_xor_12::N_TRACE_COLUMNS, add_mod_builtin::N_TRACE_COLUMNS,
    bitwise_builtin::N_TRACE_COLUMNS, mul_mod_builtin::N_TRACE_COLUMNS,
    pedersen_builtin::N_TRACE_COLUMNS, pedersen_builtin_narrow_windows::N_TRACE_COLUMNS,
    poseidon_builtin::N_TRACE_COLUMNS, range_check96_builtin::N_TRACE_COLUMNS,
    range_check_builtin::N_TRACE_COLUMNS, ec_op_builtin::N_TRACE_COLUMNS,
    partial_ec_mul_generic::N_TRACE_COLUMNS, pedersen_aggregator_window_bits_18::N_TRACE_COLUMNS,
    ...
    pedersen_points_table_window_bits_9::N_TRACE_COLUMNS, poseidon_aggregator::N_TRACE_COLUMNS,
    poseidon_3_partial_rounds_chain::N_TRACE_COLUMNS, poseidon_full_round_chain::N_TRACE_COLUMNS,
    cube_252::N_TRACE_COLUMNS, poseidon_round_keys::N_TRACE_COLUMNS,
    range_check_252_width_27::N_TRACE_COLUMNS, memory_address_to_id::N_TRACE_COLUMNS,
    // 16 slots for memory_id_to_big (BIG_N_COLUMNS each).
    memory_id_to_big::BIG_N_COLUMNS, memory_id_to_big::BIG_N_COLUMNS,
    memory_id_to_big::BIG_N_COLUMNS, memory_id_to_big::BIG_N_COLUMNS,
    memory_id_to_big::BIG_N_COLUMNS, memory_id_to_big::BIG_N_COLUMNS,
    memory_id_to_big::BIG_N_COLUMNS, memory_id_to_big::BIG_N_COLUMNS,
    memory_id_to_big::BIG_N_COLUMNS, memory_id_to_big::BIG_N_COLUMNS,
    ...
    memory_id_to_big::BIG_N_COLUMNS, memory_id_to_big::BIG_N_COLUMNS,
    memory_id_to_big::BIG_N_COLUMNS, memory_id_to_big::BIG_N_COLUMNS,
    memory_id_to_small::N_TRACE_COLUMNS, range_check_6::N_TRACE_COLUMNS,
    range_check_8::N_TRACE_COLUMNS, range_check_11::N_TRACE_COLUMNS,
    range_check_12::N_TRACE_COLUMNS, range_check_18::N_TRACE_COLUMNS,
    range_check_20::N_TRACE_COLUMNS, range_check_4_3::N_TRACE_COLUMNS,
    range_check_4_4::N_TRACE_COLUMNS, range_check_9_9::N_TRACE_COLUMNS,
    range_check_7_2_5::N_TRACE_COLUMNS, range_check_3_6_6_3::N_TRACE_COLUMNS,
    range_check_4_4_4_4::N_TRACE_COLUMNS, range_check_3_3_3_3_3::N_TRACE_COLUMNS,
    verify_bitwise_xor_4::N_TRACE_COLUMNS, verify_bitwise_xor_7::N_TRACE_COLUMNS,
    verify_bitwise_xor_8::N_TRACE_COLUMNS, verify_bitwise_xor_9::N_TRACE_COLUMNS,
];
...
pub const N_INTERACTION_COLUMNS_PER_COMPONENT_IDX: [usize; N_COMPONENTS] = [
    add_opcode::N_INTERACTION_COLUMNS, add_opcode_small::N_INTERACTION_COLUMNS,
    add_ap_opcode::N_INTERACTION_COLUMNS, assert_eq_opcode::N_INTERACTION_COLUMNS,
    assert_eq_opcode_imm::N_INTERACTION_COLUMNS,
    assert_eq_opcode_double_deref::N_INTERACTION_COLUMNS,
    blake_compress_opcode::N_INTERACTION_COLUMNS, call_opcode_abs::N_INTERACTION_COLUMNS,
    call_opcode_rel_imm::N_INTERACTION_COLUMNS, generic_opcode::N_INTERACTION_COLUMNS,
    jnz_opcode_non_taken::N_INTERACTION_COLUMNS, jnz_opcode_taken::N_INTERACTION_COLUMNS,
    jump_opcode_abs::N_INTERACTION_COLUMNS, jump_opcode_double_deref::N_INTERACTION_COLUMNS,
    jump_opcode_rel::N_INTERACTION_COLUMNS, jump_opcode_rel_imm::N_INTERACTION_COLUMNS,
    mul_opcode::N_INTERACTION_COLUMNS, mul_opcode_small::N_INTERACTION_COLUMNS,
    qm_31_add_mul_opcode::N_INTERACTION_COLUMNS, ret_opcode::N_INTERACTION_COLUMNS,
    verify_instruction::N_INTERACTION_COLUMNS, blake_round::N_INTERACTION_COLUMNS,
    blake_g::N_INTERACTION_COLUMNS, blake_round_sigma::N_INTERACTION_COLUMNS,
    triple_xor_32::N_INTERACTION_COLUMNS, verify_bitwise_xor_12::N_INTERACTION_COLUMNS,
    add_mod_builtin::N_INTERACTION_COLUMNS, bitwise_builtin::N_INTERACTION_COLUMNS,
    mul_mod_builtin::N_INTERACTION_COLUMNS, pedersen_builtin::N_INTERACTION_COLUMNS,
    pedersen_builtin_narrow_windows::N_INTERACTION_COLUMNS, poseidon_builtin::N_INTERACTION_COLUMNS,
    range_check96_builtin::N_INTERACTION_COLUMNS, range_check_builtin::N_INTERACTION_COLUMNS,
    ec_op_builtin::N_INTERACTION_COLUMNS, partial_ec_mul_generic::N_INTERACTION_COLUMNS,
    ...
    poseidon_full_round_chain::N_INTERACTION_COLUMNS, cube_252::N_INTERACTION_COLUMNS,
    poseidon_round_keys::N_INTERACTION_COLUMNS, range_check_252_width_27::N_INTERACTION_COLUMNS,
    memory_address_to_id::N_INTERACTION_COLUMNS, // 16 slots for memory_id_to_big (BIG_N_INTERACTION_COLUMNS each).
    memory_id_to_big::BIG_N_INTERACTION_COLUMNS,
    memory_id_to_big::BIG_N_INTERACTION_COLUMNS, memory_id_to_big::BIG_N_INTERACTION_COLUMNS,
    memory_id_to_big::BIG_N_INTERACTION_COLUMNS, memory_id_to_big::BIG_N_INTERACTION_COLUMNS,
    memory_id_to_big::BIG_N_INTERACTION_COLUMNS, memory_id_to_big::BIG_N_INTERACTION_COLUMNS,
    memory_id_to_big::BIG_N_INTERACTION_COLUMNS, memory_id_to_big::BIG_N_INTERACTION_COLUMNS,
    memory_id_to_big::BIG_N_INTERACTION_COLUMNS, memory_id_to_big::BIG_N_INTERACTION_COLUMNS,
    memory_id_to_big::BIG_N_INTERACTION_COLUMNS, memory_id_to_big::BIG_N_INTERACTION_COLUMNS,
    memory_id_to_big::BIG_N_INTERACTION_COLUMNS, memory_id_to_big::BIG_N_INTERACTION_COLUMNS,
    memory_id_to_big::BIG_N_INTERACTION_COLUMNS, memory_id_to_small::N_INTERACTION_COLUMNS,
    range_check_6::N_INTERACTION_COLUMNS, range_check_8::N_INTERACTION_COLUMNS,
    range_check_11::N_INTERACTION_COLUMNS, range_check_12::N_INTERACTION_COLUMNS,
    range_check_18::N_INTERACTION_COLUMNS, range_check_20::N_INTERACTION_COLUMNS,
    range_check_4_3::N_INTERACTION_COLUMNS, range_check_4_4::N_INTERACTION_COLUMNS,
    range_check_9_9::N_INTERACTION_COLUMNS, range_check_7_2_5::N_INTERACTION_COLUMNS,
    range_check_3_6_6_3::N_INTERACTION_COLUMNS, range_check_4_4_4_4::N_INTERACTION_COLUMNS,
    range_check_3_3_3_3_3::N_INTERACTION_COLUMNS, verify_bitwise_xor_4::N_INTERACTION_COLUMNS,
    verify_bitwise_xor_7::N_INTERACTION_COLUMNS, verify_bitwise_xor_8::N_INTERACTION_COLUMNS,
