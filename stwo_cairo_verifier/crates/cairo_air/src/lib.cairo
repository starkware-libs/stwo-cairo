...
pub fn verify_cairo(proof: CairoProof) {
    ...
    // TODO(audit): assert that len of commitments is 4.
    ...
    let tree_height = *commitment_scheme.trees[1].tree_height;
    assert!(tree_height == *commitment_scheme.trees[2].tree_height);
