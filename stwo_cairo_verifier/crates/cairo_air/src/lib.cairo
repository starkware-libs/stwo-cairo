...
impl PublicDataImpl of PublicDataTrait {
    fn logup_sum(self: @PublicData, common_lookup_elements: @crate::CommonElements) -> QM31 {
...
fn sum_public_memory_entries(
    pub_memory_entries: PublicMemoryEntries, common_lookup_elements: @crate::CommonElements,
) -> QM31 {
    let mut sum = Zero::zero();
