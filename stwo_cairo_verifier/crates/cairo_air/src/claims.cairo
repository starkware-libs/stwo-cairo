...
pub struct CairoClaim {
    ...
    pub verify_program_segment: Option<components::verify_program_segment::Claim>,
...
pub impl CairoClaimImpl of ClaimTrait<CairoClaim> {
    fn log_sizes(self: @CairoClaim) -> TreeArray<Span<u32>> {
        ...
        if let Some(claim) = self.verify_program_segment {
            log_sizes_list.append(claim.log_sizes());
        }
...
pub struct CairoInteractionClaim {
    ...
    pub verify_program_segment: Option<components::verify_program_segment::InteractionClaim>,
    pub pedersen_aggregator_window_bits_18: Option<
...
pub fn lookup_sum(
    ...
    if let Some(interaction_claim) = interaction_claim.verify_program_segment {
        sum += *interaction_claim.claimed_sum;
    }
