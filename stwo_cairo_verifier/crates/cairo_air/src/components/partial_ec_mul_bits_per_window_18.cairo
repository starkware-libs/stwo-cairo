...
pub const RELATION_USES_PER_ROW: [(felt252, u32); 18] = [
    ('PedersenPointsTableBitsPerWindow18', 1), ('RangeCheck_9_9', 6), ('RangeCheck_9_9_B', 6),
    ...
    ('RangeCheck_20_H', 9), ('PartialEcMulBitsPerWindow18', 1),
];
...
pub struct Component {
    ...
    pub pedersen_points_table_bits_per_window_18_lookup_elements: crate::PedersenPointsTableBitsPerWindow18Elements,
...
pub impl NewComponentImpl of NewComponent<Component> {
    ...
    fn new(
        ...
        Component {
            ...
            pedersen_points_table_bits_per_window_18_lookup_elements: interaction_elements
...
pub impl CairoComponentImpl of CairoComponent<Component> {
    fn evaluate_constraints_at_point(
        ...
        let mut pedersen_points_table_bits_per_window_18_sum_0: QM31 = Zero::zero();
        ...
        let mut partial_ec_mul_bits_per_window_18_sum_127: QM31 = Zero::zero();
        let mut partial_ec_mul_bits_per_window_18_sum_128: QM31 = Zero::zero();
        ...
        let [
            ...
            carry_25_col294,
            carry_26_col295,
            partial_ec_mul_bits_per_window_18_multiplicity,
        ]: [Span<QM31>; 297] =
            (*trace_mask_values
            .multi_pop_front()
            .unwrap())
        ...
        let [pedersen_points_table_bits_per_window_18_output_limb_0_col72]: [QM31; 1] =
            (*pedersen_points_table_bits_per_window_18_output_limb_0_col72
            .try_into()
            .unwrap())
            .unbox();
        let [pedersen_points_table_bits_per_window_18_output_limb_1_col73]: [QM31; 1] =
            (*pedersen_points_table_bits_per_window_18_output_limb_1_col73
            .try_into()
            .unwrap())
            .unbox();
        let [pedersen_points_table_bits_per_window_18_output_limb_2_col74]: [QM31; 1] =
            (*pedersen_points_table_bits_per_window_18_output_limb_2_col74
            .try_into()
            .unwrap())
            .unbox();
        let [pedersen_points_table_bits_per_window_18_output_limb_3_col75]: [QM31; 1] =
            (*pedersen_points_table_bits_per_window_18_output_limb_3_col75
            .try_into()
            .unwrap())
            .unbox();
        let [pedersen_points_table_bits_per_window_18_output_limb_4_col76]: [QM31; 1] =
            (*pedersen_points_table_bits_per_window_18_output_limb_4_col76
            .try_into()
            .unwrap())
            .unbox();
        let [pedersen_points_table_bits_per_window_18_output_limb_5_col77]: [QM31; 1] =
            (*pedersen_points_table_bits_per_window_18_output_limb_5_col77
            .try_into()
            .unwrap())
            .unbox();
        let [pedersen_points_table_bits_per_window_18_output_limb_6_col78]: [QM31; 1] =
            (*pedersen_points_table_bits_per_window_18_output_limb_6_col78
            .try_into()
            .unwrap())
            .unbox();
        let [pedersen_points_table_bits_per_window_18_output_limb_7_col79]: [QM31; 1] =
            (*pedersen_points_table_bits_per_window_18_output_limb_7_col79
            .try_into()
            .unwrap())
            .unbox();
        let [pedersen_points_table_bits_per_window_18_output_limb_8_col80]: [QM31; 1] =
            (*pedersen_points_table_bits_per_window_18_output_limb_8_col80
            .try_into()
            .unwrap())
            .unbox();
        let [pedersen_points_table_bits_per_window_18_output_limb_9_col81]: [QM31; 1] =
            (*pedersen_points_table_bits_per_window_18_output_limb_9_col81
            .try_into()
            .unwrap())
            .unbox();
        let [pedersen_points_table_bits_per_window_18_output_limb_10_col82]: [QM31; 1] =
            (*pedersen_points_table_bits_per_window_18_output_limb_10_col82
            .try_into()
            .unwrap())
            .unbox();
        let [pedersen_points_table_bits_per_window_18_output_limb_11_col83]: [QM31; 1] =
            (*pedersen_points_table_bits_per_window_18_output_limb_11_col83
            .try_into()
            .unwrap())
            .unbox();
        let [pedersen_points_table_bits_per_window_18_output_limb_12_col84]: [QM31; 1] =
            (*pedersen_points_table_bits_per_window_18_output_limb_12_col84
            .try_into()
            .unwrap())
            .unbox();
        let [pedersen_points_table_bits_per_window_18_output_limb_13_col85]: [QM31; 1] =
            (*pedersen_points_table_bits_per_window_18_output_limb_13_col85
            .try_into()
            .unwrap())
            .unbox();
        let [pedersen_points_table_bits_per_window_18_output_limb_14_col86]: [QM31; 1] =
            (*pedersen_points_table_bits_per_window_18_output_limb_14_col86
            .try_into()
            .unwrap())
            .unbox();
        let [pedersen_points_table_bits_per_window_18_output_limb_15_col87]: [QM31; 1] =
            (*pedersen_points_table_bits_per_window_18_output_limb_15_col87
            .try_into()
            .unwrap())
            .unbox();
        let [pedersen_points_table_bits_per_window_18_output_limb_16_col88]: [QM31; 1] =
            (*pedersen_points_table_bits_per_window_18_output_limb_16_col88
            .try_into()
            .unwrap())
            .unbox();
        let [pedersen_points_table_bits_per_window_18_output_limb_17_col89]: [QM31; 1] =
            (*pedersen_points_table_bits_per_window_18_output_limb_17_col89
            .try_into()
            .unwrap())
            .unbox();
        let [pedersen_points_table_bits_per_window_18_output_limb_18_col90]: [QM31; 1] =
            (*pedersen_points_table_bits_per_window_18_output_limb_18_col90
            .try_into()
            .unwrap())
            .unbox();
        let [pedersen_points_table_bits_per_window_18_output_limb_19_col91]: [QM31; 1] =
            (*pedersen_points_table_bits_per_window_18_output_limb_19_col91
            .try_into()
            .unwrap())
            .unbox();
        let [pedersen_points_table_bits_per_window_18_output_limb_20_col92]: [QM31; 1] =
            (*pedersen_points_table_bits_per_window_18_output_limb_20_col92
            .try_into()
            .unwrap())
            .unbox();
        let [pedersen_points_table_bits_per_window_18_output_limb_21_col93]: [QM31; 1] =
            (*pedersen_points_table_bits_per_window_18_output_limb_21_col93
            .try_into()
            .unwrap())
            .unbox();
        let [pedersen_points_table_bits_per_window_18_output_limb_22_col94]: [QM31; 1] =
            (*pedersen_points_table_bits_per_window_18_output_limb_22_col94
            .try_into()
            .unwrap())
            .unbox();
        let [pedersen_points_table_bits_per_window_18_output_limb_23_col95]: [QM31; 1] =
            (*pedersen_points_table_bits_per_window_18_output_limb_23_col95
            .try_into()
            .unwrap())
            .unbox();
        let [pedersen_points_table_bits_per_window_18_output_limb_24_col96]: [QM31; 1] =
            (*pedersen_points_table_bits_per_window_18_output_limb_24_col96
            .try_into()
            .unwrap())
            .unbox();
        let [pedersen_points_table_bits_per_window_18_output_limb_25_col97]: [QM31; 1] =
            (*pedersen_points_table_bits_per_window_18_output_limb_25_col97
            .try_into()
            .unwrap())
            .unbox();
        let [pedersen_points_table_bits_per_window_18_output_limb_26_col98]: [QM31; 1] =
            (*pedersen_points_table_bits_per_window_18_output_limb_26_col98
            .try_into()
            .unwrap())
            .unbox();
        let [pedersen_points_table_bits_per_window_18_output_limb_27_col99]: [QM31; 1] =
            (*pedersen_points_table_bits_per_window_18_output_limb_27_col99
            .try_into()
            .unwrap())
            .unbox();
        let [pedersen_points_table_bits_per_window_18_output_limb_28_col100]: [QM31; 1] =
            (*pedersen_points_table_bits_per_window_18_output_limb_28_col100
            .try_into()
            .unwrap())
            .unbox();
        let [pedersen_points_table_bits_per_window_18_output_limb_29_col101]: [QM31; 1] =
            (*pedersen_points_table_bits_per_window_18_output_limb_29_col101
            .try_into()
            .unwrap())
            .unbox();
        let [pedersen_points_table_bits_per_window_18_output_limb_30_col102]: [QM31; 1] =
            (*pedersen_points_table_bits_per_window_18_output_limb_30_col102
            .try_into()
            .unwrap())
            .unbox();
        let [pedersen_points_table_bits_per_window_18_output_limb_31_col103]: [QM31; 1] =
            (*pedersen_points_table_bits_per_window_18_output_limb_31_col103
            .try_into()
            .unwrap())
            .unbox();
        let [pedersen_points_table_bits_per_window_18_output_limb_32_col104]: [QM31; 1] =
            (*pedersen_points_table_bits_per_window_18_output_limb_32_col104
            .try_into()
            .unwrap())
            .unbox();
        let [pedersen_points_table_bits_per_window_18_output_limb_33_col105]: [QM31; 1] =
            (*pedersen_points_table_bits_per_window_18_output_limb_33_col105
            .try_into()
            .unwrap())
            .unbox();
        let [pedersen_points_table_bits_per_window_18_output_limb_34_col106]: [QM31; 1] =
            (*pedersen_points_table_bits_per_window_18_output_limb_34_col106
            .try_into()
            .unwrap())
            .unbox();
        let [pedersen_points_table_bits_per_window_18_output_limb_35_col107]: [QM31; 1] =
            (*pedersen_points_table_bits_per_window_18_output_limb_35_col107
            .try_into()
            .unwrap())
            .unbox();
        let [pedersen_points_table_bits_per_window_18_output_limb_36_col108]: [QM31; 1] =
            (*pedersen_points_table_bits_per_window_18_output_limb_36_col108
            .try_into()
            .unwrap())
            .unbox();
        let [pedersen_points_table_bits_per_window_18_output_limb_37_col109]: [QM31; 1] =
            (*pedersen_points_table_bits_per_window_18_output_limb_37_col109
            .try_into()
            .unwrap())
            .unbox();
        let [pedersen_points_table_bits_per_window_18_output_limb_38_col110]: [QM31; 1] =
            (*pedersen_points_table_bits_per_window_18_output_limb_38_col110
            .try_into()
            .unwrap())
            .unbox();
        let [pedersen_points_table_bits_per_window_18_output_limb_39_col111]: [QM31; 1] =
            (*pedersen_points_table_bits_per_window_18_output_limb_39_col111
            .try_into()
            .unwrap())
            .unbox();
        let [pedersen_points_table_bits_per_window_18_output_limb_40_col112]: [QM31; 1] =
            (*pedersen_points_table_bits_per_window_18_output_limb_40_col112
            .try_into()
            .unwrap())
            .unbox();
        let [pedersen_points_table_bits_per_window_18_output_limb_41_col113]: [QM31; 1] =
            (*pedersen_points_table_bits_per_window_18_output_limb_41_col113
            .try_into()
            .unwrap())
            .unbox();
        let [pedersen_points_table_bits_per_window_18_output_limb_42_col114]: [QM31; 1] =
            (*pedersen_points_table_bits_per_window_18_output_limb_42_col114
            .try_into()
            .unwrap())
            .unbox();
        let [pedersen_points_table_bits_per_window_18_output_limb_43_col115]: [QM31; 1] =
            (*pedersen_points_table_bits_per_window_18_output_limb_43_col115
            .try_into()
            .unwrap())
            .unbox();
        let [pedersen_points_table_bits_per_window_18_output_limb_44_col116]: [QM31; 1] =
            (*pedersen_points_table_bits_per_window_18_output_limb_44_col116
            .try_into()
            .unwrap())
            .unbox();
        let [pedersen_points_table_bits_per_window_18_output_limb_45_col117]: [QM31; 1] =
            (*pedersen_points_table_bits_per_window_18_output_limb_45_col117
            .try_into()
            .unwrap())
            .unbox();
        let [pedersen_points_table_bits_per_window_18_output_limb_46_col118]: [QM31; 1] =
            (*pedersen_points_table_bits_per_window_18_output_limb_46_col118
            .try_into()
            .unwrap())
            .unbox();
        let [pedersen_points_table_bits_per_window_18_output_limb_47_col119]: [QM31; 1] =
            (*pedersen_points_table_bits_per_window_18_output_limb_47_col119
            .try_into()
            .unwrap())
            .unbox();
        let [pedersen_points_table_bits_per_window_18_output_limb_48_col120]: [QM31; 1] =
            (*pedersen_points_table_bits_per_window_18_output_limb_48_col120
            .try_into()
            .unwrap())
            .unbox();
        let [pedersen_points_table_bits_per_window_18_output_limb_49_col121]: [QM31; 1] =
            (*pedersen_points_table_bits_per_window_18_output_limb_49_col121
            .try_into()
            .unwrap())
            .unbox();
        let [pedersen_points_table_bits_per_window_18_output_limb_50_col122]: [QM31; 1] =
            (*pedersen_points_table_bits_per_window_18_output_limb_50_col122
            .try_into()
            .unwrap())
            .unbox();
        let [pedersen_points_table_bits_per_window_18_output_limb_51_col123]: [QM31; 1] =
            (*pedersen_points_table_bits_per_window_18_output_limb_51_col123
            .try_into()
            .unwrap())
            .unbox();
        let [pedersen_points_table_bits_per_window_18_output_limb_52_col124]: [QM31; 1] =
            (*pedersen_points_table_bits_per_window_18_output_limb_52_col124
            .try_into()
            .unwrap())
            .unbox();
        let [pedersen_points_table_bits_per_window_18_output_limb_53_col125]: [QM31; 1] =
            (*pedersen_points_table_bits_per_window_18_output_limb_53_col125
            .try_into()
            .unwrap())
            .unbox();
        let [pedersen_points_table_bits_per_window_18_output_limb_54_col126]: [QM31; 1] =
            (*pedersen_points_table_bits_per_window_18_output_limb_54_col126
            .try_into()
            .unwrap())
            .unbox();
        let [pedersen_points_table_bits_per_window_18_output_limb_55_col127]: [QM31; 1] =
            (*pedersen_points_table_bits_per_window_18_output_limb_55_col127
            .try_into()
            .unwrap())
            .unbox();
        ...
        let [partial_ec_mul_bits_per_window_18_multiplicity]: [QM31; 1] =
            (*partial_ec_mul_bits_per_window_18_multiplicity
            .try_into()
            .unwrap())
            .unbox();
        ...
        let constraint_quotient = (partial_ec_mul_bits_per_window_18_multiplicity
            * partial_ec_mul_bits_per_window_18_multiplicity
            - partial_ec_mul_bits_per_window_18_multiplicity)
            * domain_vanishing_eval_inv;
        sum = sum * random_coeff + constraint_quotient;

        pedersen_points_table_bits_per_window_18_sum_0 = self
        ...
        partial_ec_mul_bits_per_window_18_sum_127 = self
        ...
        partial_ec_mul_bits_per_window_18_sum_128 = self
            .partial_ec_mul_bits_per_window_18_lookup_elements
            .combine_qm31(
                [
        ...
        lookup_constraints(
            ...
            pedersen_points_table_bits_per_window_18_sum_0,
            ...
            partial_ec_mul_bits_per_window_18_sum_127,
            partial_ec_mul_bits_per_window_18_sum_128,
        );
    }
}
...
fn lookup_constraints(
    ...
    random_coeff: QM31,
    claimed_sum: QM31,
    partial_ec_mul_bits_per_window_18_multiplicity: QM31,
    column_size: M31,
    ref interaction_trace_mask_values: ColumnSpan<Span<QM31>>,
    pedersen_points_table_bits_per_window_18_sum_0: QM31,
    ...
    partial_ec_mul_bits_per_window_18_sum_127: QM31,
    partial_ec_mul_bits_per_window_18_sum_128: QM31,
) {
    let [
        trace_2_col0,
        trace_2_col1,
    ...
    let constraint_quotient = (((QM31Impl::from_partial_evals(
        ...
        * range_check_20_d_sum_126
        * partial_ec_mul_bits_per_window_18_sum_127)
        - (range_check_20_d_sum_126 * partial_ec_mul_bits_per_window_18_multiplicity)
        - partial_ec_mul_bits_per_window_18_sum_127)
        * domain_vanishing_eval_inv;
    sum = sum * random_coeff + constraint_quotient;
...
mod tests {
    ...
    fn test_evaluation_result() {
        let component = Component {
            ...
            pedersen_points_table_bits_per_window_18_lookup_elements: make_lookup_elements(
