...
pub const N_TRACE_COLUMNS: usize = 21;pub const RELATION_USES_PER_ROW: [(felt252, u32); 4] = [
    ('VerifyBitwiseAnd_16', 6), ('Sha256BigSigma1O0', 1), ('Sha256BigSigma1O1', 1), ('VerifyBitwiseXor_16', 2)
];
...
pub impl CairoComponentImpl of CairoComponent<Component> {
    ...
    fn evaluate_constraints_at_point(
        ...
        let mut verify_bitwise_and_16_sum_0: QM31 = Zero::zero();let mut verify_bitwise_and_16_sum_1: QM31 = Zero::zero();let mut verify_bitwise_and_16_sum_2: QM31 = Zero::zero();let mut verify_bitwise_and_16_sum_3: QM31 = Zero::zero();let mut verify_bitwise_and_16_sum_4: QM31 = Zero::zero();let mut verify_bitwise_and_16_sum_5: QM31 = Zero::zero();let mut sha_256_big_sigma_1_o_0_sum_6: QM31 = Zero::zero();let mut sha_256_big_sigma_1_o_1_sum_7: QM31 = Zero::zero();let mut verify_bitwise_xor_16_sum_8: QM31 = Zero::zero();let mut verify_bitwise_xor_16_sum_9: QM31 = Zero::zero();let mut sha_256_big_sigma_1_sum_10: QM31 = Zero::zero();
        ...
        sum = sum * random_coeff + constraint_quotient;bitwise_and_num_bits_16_evaluate(
            [input_limb_0_col0, qm31_const::<29330, 0, 0, 0>()],
and_col2,
...
random_coeff
            ...
            [input_limb_0_col0, qm31_const::<109, 0, 0, 0>()],
and_col3,
self.verify_bitwise_and_16_lookup_elements,
...
random_coeff
            ...
            [input_limb_0_col0, qm31_const::<36096, 0, 0, 0>()],
and_col4,
self.verify_bitwise_and_16_lookup_elements,
...
random_coeff
            ...
            [input_limb_1_col1, qm31_const::<214, 0, 0, 0>()],
and_col5,
self.verify_bitwise_and_16_lookup_elements,
...
random_coeff
            ...
            [input_limb_1_col1, qm31_const::<39936, 0, 0, 0>()],
and_col6,
self.verify_bitwise_and_16_lookup_elements,
...
random_coeff
            ...
            [input_limb_1_col1, qm31_const::<25385, 0, 0, 0>()],
and_col7,
self.verify_bitwise_and_16_lookup_elements,
...
random_coeff
        ...
        sha_256_big_sigma_1_o_0_sum_6 = self.sha_256_big_sigma_1_o_0_lookup_elements.combine_qm31(
            [
                (and_col3 + and_col4),
and_col7,
sigma_O0_L_col8,
...
sigma_O2_H_col13
        ...
        sha_256_big_sigma_1_o_1_sum_7 = self.sha_256_big_sigma_1_o_1_lookup_elements.combine_qm31(
            [
                and_col2,
(and_col5 + and_col6),
sigma_O1_L_col10,
...
random_coeff
        ...
        sha_256_big_sigma_1_sum_10 = self.sha_256_big_sigma_1_lookup_elements.combine_qm31(
            [
                input_limb_0_col0,
input_limb_1_col1,
output_low_col18,
...
sha_256_big_sigma_1_o_0_sum_6,
sha_256_big_sigma_1_o_1_sum_7,
verify_bitwise_xor_16_sum_8,
verify_bitwise_xor_16_sum_9,
sha_256_big_sigma_1_sum_10
        );
    }
}
...
sha_256_big_sigma_1_o_0_sum_6: QM31,
sha_256_big_sigma_1_o_1_sum_7: QM31,
verify_bitwise_xor_16_sum_8: QM31,
verify_bitwise_xor_16_sum_9: QM31,
sha_256_big_sigma_1_sum_10: QM31
) {
...
let constraint_quotient = (
        (
            (
                ...
                - QM31Impl::from_partial_evals([trace_2_col8, trace_2_col9, trace_2_col10, trace_2_col11])
            ) * sha_256_big_sigma_1_o_0_sum_6 * sha_256_big_sigma_1_o_1_sum_7
        ) - sha_256_big_sigma_1_o_0_sum_6 - sha_256_big_sigma_1_o_1_sum_7
    ) * domain_vanishing_eval_inv;
sum = sum * random_coeff + constraint_quotient;
