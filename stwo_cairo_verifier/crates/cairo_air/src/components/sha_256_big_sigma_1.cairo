...
pub const RELATION_USES_PER_ROW: [(felt252, u32); 4] = [
    ('VerifyBitwiseAnd_8', 12), ('Sha256BigSigma1O0', 1), ('Sha256BigSigma1O1', 1),
...
pub impl CairoComponentImpl of CairoComponent<Component> {
    ...
    fn evaluate_constraints_at_point(
        ...
        let mut sha_256_big_sigma_1_o_0_sum_12: QM31 = Zero::zero();
        let mut sha_256_big_sigma_1_o_1_sum_13: QM31 = Zero::zero();
        ...
        let mut sha_256_big_sigma_1_sum_18: QM31 = Zero::zero();
        ...
        let split_16_low_part_size_8_output_tmp_438a7_1_limb_0: QM31 =
            split_16_low_part_size_8_evaluate(
            input_limb_0_col0, ms_8_bits_col2, ref sum, domain_vanishing_eval_inv, random_coeff,
        );
        let split_16_low_part_size_8_output_tmp_438a7_3_limb_0: QM31 =
            split_16_low_part_size_8_evaluate(
        ...
        sha_256_big_sigma_1_o_0_sum_12 = self
            .sha_256_big_sigma_1_o_0_lookup_elements
            .combine_qm31(
                [
                    (l1_col9 + l2_col12), h2_col21, sigma_O0_L_col22, sigma_O0_H_col23,
                    sigma_O2_L_col26, sigma_O2_H_col27,
                ],
            );

        sha_256_big_sigma_1_o_1_sum_13 = self
            .sha_256_big_sigma_1_o_1_lookup_elements
            .combine_qm31(
                [
                    l0_col6, (h0_col15 + h1_col18), sigma_O1_L_col24, sigma_O1_H_col25,
                    sigma_O2_prime_L_col28, sigma_O2_prime_H_col29,
                ],
            );
        let split_16_low_part_size_8_output_tmp_438a7_39_limb_0: QM31 =
            split_16_low_part_size_8_evaluate(
            sigma_O2_prime_L_col28,
            ms_8_bits_col30,
            ref sum,
        ...
        let split_16_low_part_size_8_output_tmp_438a7_41_limb_0: QM31 =
            split_16_low_part_size_8_evaluate(
            sigma_O2_L_col26, ms_8_bits_col31, ref sum, domain_vanishing_eval_inv, random_coeff,
        );
        bitwise_xor_num_bits_8_evaluate(
            [
                split_16_low_part_size_8_output_tmp_438a7_39_limb_0,
                split_16_low_part_size_8_output_tmp_438a7_41_limb_0,
            ],
            xor_col32,
        ...
        let constraint_quotient = ((output2l_col34
            ...
            * domain_vanishing_eval_inv;
        sum = sum * random_coeff + constraint_quotient;
        let split_16_low_part_size_8_output_tmp_438a7_47_limb_0: QM31 =
            split_16_low_part_size_8_evaluate(
            sigma_O2_prime_H_col29,
            ms_8_bits_col35,
            ref sum,
        ...
        let split_16_low_part_size_8_output_tmp_438a7_49_limb_0: QM31 =
            split_16_low_part_size_8_evaluate(
            sigma_O2_H_col27, ms_8_bits_col36, ref sum, domain_vanishing_eval_inv, random_coeff,
        );
        bitwise_xor_num_bits_8_evaluate(
            [
                split_16_low_part_size_8_output_tmp_438a7_47_limb_0,
                split_16_low_part_size_8_output_tmp_438a7_49_limb_0,
            ],
            xor_col37,
            self.verify_bitwise_xor_8_lookup_elements,
        ...
        sha_256_big_sigma_1_sum_18 = self
