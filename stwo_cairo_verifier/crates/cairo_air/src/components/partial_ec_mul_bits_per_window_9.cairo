...
pub const RELATION_USES_PER_ROW: [(felt252, u32); 18] = [
    ('PedersenPointsTableBitsPerWindow9', 1), ('RangeCheck_9_9', 6), ('RangeCheck_9_9_B', 6),
    ...
    ('RangeCheck_20_H', 9), ('PartialEcMulBitsPerWindow9', 1),
];
...
pub struct Component {
    ...
    pub pedersen_points_table_bits_per_window_9_lookup_elements: crate::PedersenPointsTableBitsPerWindow9Elements,
...
pub impl NewComponentImpl of NewComponent<Component> {
    ...
    fn new(
        ...
        Component {
            ...
            pedersen_points_table_bits_per_window_9_lookup_elements: interaction_elements
...
pub impl CairoComponentImpl of CairoComponent<Component> {
    fn evaluate_constraints_at_point(
        ...
        let mut pedersen_points_table_bits_per_window_9_sum_0: QM31 = Zero::zero();
        ...
        let mut partial_ec_mul_bits_per_window_9_sum_127: QM31 = Zero::zero();
        let mut partial_ec_mul_bits_per_window_9_sum_128: QM31 = Zero::zero();
        ...
        let [
            ...
            carry_25_col308,
            carry_26_col309,
            partial_ec_mul_bits_per_window_9_multiplicity,
        ]: [Span<QM31>; 311] =
            (*trace_mask_values
            .multi_pop_front()
            .unwrap())
        ...
        let [pedersen_points_table_bits_per_window_9_output_limb_0_col86]: [QM31; 1] =
            (*pedersen_points_table_bits_per_window_9_output_limb_0_col86
            .try_into()
            .unwrap())
            .unbox();
        let [pedersen_points_table_bits_per_window_9_output_limb_1_col87]: [QM31; 1] =
            (*pedersen_points_table_bits_per_window_9_output_limb_1_col87
            .try_into()
            .unwrap())
            .unbox();
        let [pedersen_points_table_bits_per_window_9_output_limb_2_col88]: [QM31; 1] =
            (*pedersen_points_table_bits_per_window_9_output_limb_2_col88
            .try_into()
            .unwrap())
            .unbox();
        let [pedersen_points_table_bits_per_window_9_output_limb_3_col89]: [QM31; 1] =
            (*pedersen_points_table_bits_per_window_9_output_limb_3_col89
            .try_into()
            .unwrap())
            .unbox();
        let [pedersen_points_table_bits_per_window_9_output_limb_4_col90]: [QM31; 1] =
            (*pedersen_points_table_bits_per_window_9_output_limb_4_col90
            .try_into()
            .unwrap())
            .unbox();
        let [pedersen_points_table_bits_per_window_9_output_limb_5_col91]: [QM31; 1] =
            (*pedersen_points_table_bits_per_window_9_output_limb_5_col91
            .try_into()
            .unwrap())
            .unbox();
        let [pedersen_points_table_bits_per_window_9_output_limb_6_col92]: [QM31; 1] =
            (*pedersen_points_table_bits_per_window_9_output_limb_6_col92
            .try_into()
            .unwrap())
            .unbox();
        let [pedersen_points_table_bits_per_window_9_output_limb_7_col93]: [QM31; 1] =
            (*pedersen_points_table_bits_per_window_9_output_limb_7_col93
            .try_into()
            .unwrap())
            .unbox();
        let [pedersen_points_table_bits_per_window_9_output_limb_8_col94]: [QM31; 1] =
            (*pedersen_points_table_bits_per_window_9_output_limb_8_col94
            .try_into()
            .unwrap())
            .unbox();
        let [pedersen_points_table_bits_per_window_9_output_limb_9_col95]: [QM31; 1] =
            (*pedersen_points_table_bits_per_window_9_output_limb_9_col95
            .try_into()
            .unwrap())
            .unbox();
        let [pedersen_points_table_bits_per_window_9_output_limb_10_col96]: [QM31; 1] =
            (*pedersen_points_table_bits_per_window_9_output_limb_10_col96
            .try_into()
            .unwrap())
            .unbox();
        let [pedersen_points_table_bits_per_window_9_output_limb_11_col97]: [QM31; 1] =
            (*pedersen_points_table_bits_per_window_9_output_limb_11_col97
            .try_into()
            .unwrap())
            .unbox();
        let [pedersen_points_table_bits_per_window_9_output_limb_12_col98]: [QM31; 1] =
            (*pedersen_points_table_bits_per_window_9_output_limb_12_col98
            .try_into()
            .unwrap())
            .unbox();
        let [pedersen_points_table_bits_per_window_9_output_limb_13_col99]: [QM31; 1] =
            (*pedersen_points_table_bits_per_window_9_output_limb_13_col99
            .try_into()
            .unwrap())
            .unbox();
        let [pedersen_points_table_bits_per_window_9_output_limb_14_col100]: [QM31; 1] =
            (*pedersen_points_table_bits_per_window_9_output_limb_14_col100
            .try_into()
            .unwrap())
            .unbox();
        let [pedersen_points_table_bits_per_window_9_output_limb_15_col101]: [QM31; 1] =
            (*pedersen_points_table_bits_per_window_9_output_limb_15_col101
            .try_into()
            .unwrap())
            .unbox();
        let [pedersen_points_table_bits_per_window_9_output_limb_16_col102]: [QM31; 1] =
            (*pedersen_points_table_bits_per_window_9_output_limb_16_col102
            .try_into()
            .unwrap())
            .unbox();
        let [pedersen_points_table_bits_per_window_9_output_limb_17_col103]: [QM31; 1] =
            (*pedersen_points_table_bits_per_window_9_output_limb_17_col103
            .try_into()
            .unwrap())
            .unbox();
        let [pedersen_points_table_bits_per_window_9_output_limb_18_col104]: [QM31; 1] =
            (*pedersen_points_table_bits_per_window_9_output_limb_18_col104
            .try_into()
            .unwrap())
            .unbox();
        let [pedersen_points_table_bits_per_window_9_output_limb_19_col105]: [QM31; 1] =
            (*pedersen_points_table_bits_per_window_9_output_limb_19_col105
            .try_into()
            .unwrap())
            .unbox();
        let [pedersen_points_table_bits_per_window_9_output_limb_20_col106]: [QM31; 1] =
            (*pedersen_points_table_bits_per_window_9_output_limb_20_col106
            .try_into()
            .unwrap())
            .unbox();
        let [pedersen_points_table_bits_per_window_9_output_limb_21_col107]: [QM31; 1] =
            (*pedersen_points_table_bits_per_window_9_output_limb_21_col107
            .try_into()
            .unwrap())
            .unbox();
        let [pedersen_points_table_bits_per_window_9_output_limb_22_col108]: [QM31; 1] =
            (*pedersen_points_table_bits_per_window_9_output_limb_22_col108
            .try_into()
            .unwrap())
            .unbox();
        let [pedersen_points_table_bits_per_window_9_output_limb_23_col109]: [QM31; 1] =
            (*pedersen_points_table_bits_per_window_9_output_limb_23_col109
            .try_into()
            .unwrap())
            .unbox();
        let [pedersen_points_table_bits_per_window_9_output_limb_24_col110]: [QM31; 1] =
            (*pedersen_points_table_bits_per_window_9_output_limb_24_col110
            .try_into()
            .unwrap())
            .unbox();
        let [pedersen_points_table_bits_per_window_9_output_limb_25_col111]: [QM31; 1] =
            (*pedersen_points_table_bits_per_window_9_output_limb_25_col111
            .try_into()
            .unwrap())
            .unbox();
        let [pedersen_points_table_bits_per_window_9_output_limb_26_col112]: [QM31; 1] =
            (*pedersen_points_table_bits_per_window_9_output_limb_26_col112
            .try_into()
            .unwrap())
            .unbox();
        let [pedersen_points_table_bits_per_window_9_output_limb_27_col113]: [QM31; 1] =
            (*pedersen_points_table_bits_per_window_9_output_limb_27_col113
            .try_into()
            .unwrap())
            .unbox();
        let [pedersen_points_table_bits_per_window_9_output_limb_28_col114]: [QM31; 1] =
            (*pedersen_points_table_bits_per_window_9_output_limb_28_col114
            .try_into()
            .unwrap())
            .unbox();
        let [pedersen_points_table_bits_per_window_9_output_limb_29_col115]: [QM31; 1] =
            (*pedersen_points_table_bits_per_window_9_output_limb_29_col115
            .try_into()
            .unwrap())
            .unbox();
        let [pedersen_points_table_bits_per_window_9_output_limb_30_col116]: [QM31; 1] =
            (*pedersen_points_table_bits_per_window_9_output_limb_30_col116
            .try_into()
            .unwrap())
            .unbox();
        let [pedersen_points_table_bits_per_window_9_output_limb_31_col117]: [QM31; 1] =
            (*pedersen_points_table_bits_per_window_9_output_limb_31_col117
            .try_into()
            .unwrap())
            .unbox();
        let [pedersen_points_table_bits_per_window_9_output_limb_32_col118]: [QM31; 1] =
            (*pedersen_points_table_bits_per_window_9_output_limb_32_col118
            .try_into()
            .unwrap())
            .unbox();
        let [pedersen_points_table_bits_per_window_9_output_limb_33_col119]: [QM31; 1] =
            (*pedersen_points_table_bits_per_window_9_output_limb_33_col119
            .try_into()
            .unwrap())
            .unbox();
        let [pedersen_points_table_bits_per_window_9_output_limb_34_col120]: [QM31; 1] =
            (*pedersen_points_table_bits_per_window_9_output_limb_34_col120
            .try_into()
            .unwrap())
            .unbox();
        let [pedersen_points_table_bits_per_window_9_output_limb_35_col121]: [QM31; 1] =
            (*pedersen_points_table_bits_per_window_9_output_limb_35_col121
            .try_into()
            .unwrap())
            .unbox();
        let [pedersen_points_table_bits_per_window_9_output_limb_36_col122]: [QM31; 1] =
            (*pedersen_points_table_bits_per_window_9_output_limb_36_col122
            .try_into()
            .unwrap())
            .unbox();
        let [pedersen_points_table_bits_per_window_9_output_limb_37_col123]: [QM31; 1] =
            (*pedersen_points_table_bits_per_window_9_output_limb_37_col123
            .try_into()
            .unwrap())
            .unbox();
        let [pedersen_points_table_bits_per_window_9_output_limb_38_col124]: [QM31; 1] =
            (*pedersen_points_table_bits_per_window_9_output_limb_38_col124
            .try_into()
            .unwrap())
            .unbox();
        let [pedersen_points_table_bits_per_window_9_output_limb_39_col125]: [QM31; 1] =
            (*pedersen_points_table_bits_per_window_9_output_limb_39_col125
            .try_into()
            .unwrap())
            .unbox();
        let [pedersen_points_table_bits_per_window_9_output_limb_40_col126]: [QM31; 1] =
            (*pedersen_points_table_bits_per_window_9_output_limb_40_col126
            .try_into()
            .unwrap())
            .unbox();
        let [pedersen_points_table_bits_per_window_9_output_limb_41_col127]: [QM31; 1] =
            (*pedersen_points_table_bits_per_window_9_output_limb_41_col127
            .try_into()
            .unwrap())
            .unbox();
        let [pedersen_points_table_bits_per_window_9_output_limb_42_col128]: [QM31; 1] =
            (*pedersen_points_table_bits_per_window_9_output_limb_42_col128
            .try_into()
            .unwrap())
            .unbox();
        let [pedersen_points_table_bits_per_window_9_output_limb_43_col129]: [QM31; 1] =
            (*pedersen_points_table_bits_per_window_9_output_limb_43_col129
            .try_into()
            .unwrap())
            .unbox();
        let [pedersen_points_table_bits_per_window_9_output_limb_44_col130]: [QM31; 1] =
            (*pedersen_points_table_bits_per_window_9_output_limb_44_col130
            .try_into()
            .unwrap())
            .unbox();
        let [pedersen_points_table_bits_per_window_9_output_limb_45_col131]: [QM31; 1] =
            (*pedersen_points_table_bits_per_window_9_output_limb_45_col131
            .try_into()
            .unwrap())
            .unbox();
        let [pedersen_points_table_bits_per_window_9_output_limb_46_col132]: [QM31; 1] =
            (*pedersen_points_table_bits_per_window_9_output_limb_46_col132
            .try_into()
            .unwrap())
            .unbox();
        let [pedersen_points_table_bits_per_window_9_output_limb_47_col133]: [QM31; 1] =
            (*pedersen_points_table_bits_per_window_9_output_limb_47_col133
            .try_into()
            .unwrap())
            .unbox();
        let [pedersen_points_table_bits_per_window_9_output_limb_48_col134]: [QM31; 1] =
            (*pedersen_points_table_bits_per_window_9_output_limb_48_col134
            .try_into()
            .unwrap())
            .unbox();
        let [pedersen_points_table_bits_per_window_9_output_limb_49_col135]: [QM31; 1] =
            (*pedersen_points_table_bits_per_window_9_output_limb_49_col135
            .try_into()
            .unwrap())
            .unbox();
        let [pedersen_points_table_bits_per_window_9_output_limb_50_col136]: [QM31; 1] =
            (*pedersen_points_table_bits_per_window_9_output_limb_50_col136
            .try_into()
            .unwrap())
            .unbox();
        let [pedersen_points_table_bits_per_window_9_output_limb_51_col137]: [QM31; 1] =
            (*pedersen_points_table_bits_per_window_9_output_limb_51_col137
            .try_into()
            .unwrap())
            .unbox();
        let [pedersen_points_table_bits_per_window_9_output_limb_52_col138]: [QM31; 1] =
            (*pedersen_points_table_bits_per_window_9_output_limb_52_col138
            .try_into()
            .unwrap())
            .unbox();
        let [pedersen_points_table_bits_per_window_9_output_limb_53_col139]: [QM31; 1] =
            (*pedersen_points_table_bits_per_window_9_output_limb_53_col139
            .try_into()
            .unwrap())
            .unbox();
        let [pedersen_points_table_bits_per_window_9_output_limb_54_col140]: [QM31; 1] =
            (*pedersen_points_table_bits_per_window_9_output_limb_54_col140
            .try_into()
            .unwrap())
            .unbox();
        let [pedersen_points_table_bits_per_window_9_output_limb_55_col141]: [QM31; 1] =
            (*pedersen_points_table_bits_per_window_9_output_limb_55_col141
            .try_into()
            .unwrap())
            .unbox();
        ...
        let [partial_ec_mul_bits_per_window_9_multiplicity]: [QM31; 1] =
            (*partial_ec_mul_bits_per_window_9_multiplicity
            .try_into()
            .unwrap())
            .unbox();
        ...
        let constraint_quotient = (partial_ec_mul_bits_per_window_9_multiplicity
            * partial_ec_mul_bits_per_window_9_multiplicity
            - partial_ec_mul_bits_per_window_9_multiplicity)
            * domain_vanishing_eval_inv;
        sum = sum * random_coeff + constraint_quotient;

        pedersen_points_table_bits_per_window_9_sum_0 = self
            .pedersen_points_table_bits_per_window_9_lookup_elements
            .combine_qm31(
                [
        ...
        partial_ec_mul_bits_per_window_9_sum_127 = self
            ...
            .combine_qm31(
                [
                    ...
                    input_limb_72_col72, input_limb_73_col73, input_limb_74_col74,
                    input_limb_75_col75, input_limb_76_col76, input_limb_77_col77,
                    input_limb_78_col78, input_limb_79_col79, input_limb_80_col80,
                    input_limb_81_col81, input_limb_82_col82, input_limb_83_col83,
                    input_limb_84_col84, input_limb_85_col85,
                ],
            );

        partial_ec_mul_bits_per_window_9_sum_128 = self
            .partial_ec_mul_bits_per_window_9_lookup_elements
            .combine_qm31(
                [
                    ...
                    input_limb_20_col20, input_limb_21_col21, input_limb_22_col22,
                    input_limb_23_col23, input_limb_24_col24, input_limb_25_col25,
                    input_limb_26_col26, input_limb_27_col27, input_limb_28_col28,
                    input_limb_29_col29, qm31_const::<0, 0, 0, 0>(), result_x_limb_0_col198,
                    result_x_limb_1_col199, result_x_limb_2_col200, result_x_limb_3_col201,
                    result_x_limb_4_col202, result_x_limb_5_col203, result_x_limb_6_col204,
                    result_x_limb_7_col205, result_x_limb_8_col206, result_x_limb_9_col207,
                    result_x_limb_10_col208, result_x_limb_11_col209, result_x_limb_12_col210,
                    result_x_limb_13_col211, result_x_limb_14_col212, result_x_limb_15_col213,
                    result_x_limb_16_col214, result_x_limb_17_col215, result_x_limb_18_col216,
                    result_x_limb_19_col217, result_x_limb_20_col218, result_x_limb_21_col219,
                    result_x_limb_22_col220, result_x_limb_23_col221, result_x_limb_24_col222,
                    result_x_limb_25_col223, result_x_limb_26_col224, result_x_limb_27_col225,
                    result_y_limb_0_col254, result_y_limb_1_col255, result_y_limb_2_col256,
                    result_y_limb_3_col257, result_y_limb_4_col258, result_y_limb_5_col259,
                    result_y_limb_6_col260, result_y_limb_7_col261, result_y_limb_8_col262,
                    result_y_limb_9_col263, result_y_limb_10_col264, result_y_limb_11_col265,
                    result_y_limb_12_col266, result_y_limb_13_col267, result_y_limb_14_col268,
                    result_y_limb_15_col269, result_y_limb_16_col270, result_y_limb_17_col271,
                    result_y_limb_18_col272, result_y_limb_19_col273, result_y_limb_20_col274,
                    result_y_limb_21_col275, result_y_limb_22_col276, result_y_limb_23_col277,
                    result_y_limb_24_col278, result_y_limb_25_col279, result_y_limb_26_col280,
                    result_y_limb_27_col281,
                ],
            );
        ...
        lookup_constraints(
            ...
            pedersen_points_table_bits_per_window_9_sum_0,
            ...
            partial_ec_mul_bits_per_window_9_sum_127,
            partial_ec_mul_bits_per_window_9_sum_128,
        );
    }
}
...
fn lookup_constraints(
    ...
    random_coeff: QM31,
    claimed_sum: QM31,
    partial_ec_mul_bits_per_window_9_multiplicity: QM31,
    column_size: M31,
    ref interaction_trace_mask_values: ColumnSpan<Span<QM31>>,
    pedersen_points_table_bits_per_window_9_sum_0: QM31,
    ...
    partial_ec_mul_bits_per_window_9_sum_127: QM31,
    partial_ec_mul_bits_per_window_9_sum_128: QM31,
) {
    let [
        trace_2_col0,
        trace_2_col1,
    ...
    let constraint_quotient = (((QM31Impl::from_partial_evals(
        ...
        * range_check_20_d_sum_126
        * partial_ec_mul_bits_per_window_9_sum_127)
        - (range_check_20_d_sum_126 * partial_ec_mul_bits_per_window_9_multiplicity)
        - partial_ec_mul_bits_per_window_9_sum_127)
        * domain_vanishing_eval_inv;
    sum = sum * random_coeff + constraint_quotient;
...
mod tests {
    ...
    fn test_evaluation_result() {
        let component = Component {
            ...
            pedersen_points_table_bits_per_window_9_lookup_elements: make_lookup_elements(
                qm31_const::<1009659930, 1979867785, 1095199609, 1092707797>(),
                qm31_const::<1377573126, 203335151, 557615259, 1133165061>(),
            ),
        ...
        assert_eq!(
            sum, QM31Trait::from_fixed_array(PARTIAL_EC_MUL_BITS_PER_WINDOW_9_SAMPLE_EVAL_RESULT),
        )
    }
}
