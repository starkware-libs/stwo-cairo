...
pub impl ComponentImpl of CairoComponent<Component> {
    ...
    fn evaluate_constraints_at_point(
        ...
        let mut range_check_19_b_sum_0: QM31 = Zero::zero();let seq = preprocessed_mask_values.get(PreprocessedColumn::Seq(SOME_COLUMN.log_size()));
        ...
        range_check_19_b_sum_0 = self.range_check_19_b_lookup_elements.combine_qm31(
            [
                seq
            ],
        );
