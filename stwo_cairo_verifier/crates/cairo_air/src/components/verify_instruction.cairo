...
use crate::components::range_check_4_3::RANGE_CHECK_4_3_RELATION_SIZE;
...
let [input_inst_felt5_high_col4]: [QM31; 1] = (*input_inst_felt5_high_col4.try_into().unwrap()).unbox();
let [input_inst_felt6_col5]: [QM31; 1] = (*input_inst_felt6_col5.try_into().unwrap()).unbox();
let [input_opcode_extension_col6]: [QM31; 1] = (*input_opcode_extension_col6.try_into().unwrap()).unbox();
...
random_coeff
        ...
        let [encode_offsets_output_tmp_16a4f_8_limb_1, encode_offsets_output_tmp_16a4f_8_limb_3] = output;
