...
pub impl CairoComponentImpl of CairoComponent<Component> {
    ...
    fn evaluate_constraints_at_point(
        ...
        let mut range_check_20_g_sum_0: QM31 = Zero::zero();
        ...
        range_check_20_g_sum_0 = self.range_check_20_g_lookup_elements.combine_qm31([seq_20]);
