...
pub fn mask_points(
    ...
    preprocessed_column_set.insert(PreprocessedColumn::Xor((4, 0)));
    preprocessed_column_set.insert(PreprocessedColumn::Xor((4, 1)));
    preprocessed_column_set.insert(PreprocessedColumn::Xor((4, 2)));
...
pub struct ConstraintParams {
    ...
    pub bitwise_xor_4_0: QM31,
    pub bitwise_xor_4_1: QM31,
    pub bitwise_xor_4_2: QM31,
...
fn intermediates(
    ...
    bitwise_xor_4_0: QM31,
    bitwise_xor_4_1: QM31,
    bitwise_xor_4_2: QM31,
) -> Array<QM31> {
...
pub fn intermediate0(
    ...
    (VerifyBitwiseXor_4_alpha0) * (bitwise_xor_4_0)
        + (VerifyBitwiseXor_4_alpha1) * (bitwise_xor_4_1)
        + (VerifyBitwiseXor_4_alpha2) * (bitwise_xor_4_2)
        - (VerifyBitwiseXor_4_z)
}
