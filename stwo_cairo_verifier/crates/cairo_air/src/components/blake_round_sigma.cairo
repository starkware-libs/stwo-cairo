...
use crate::components::{
    BLAKE_ROUND_SIGMA_LOG_SIZE, CairoComponent, OPCODES_RELATION_SIZE, opcodes_sum,
};
...
pub fn blake_round_sigma_sum(mut alphas: Span<QM31>, z: QM31, values: [QM31; 17]) -> QM31 {
    let [
        alpha0,
        alpha1,
        alpha2,
