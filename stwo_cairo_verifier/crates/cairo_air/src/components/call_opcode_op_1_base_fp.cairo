...
let mut opcodes_sum_8: QM31 = Zero::zero();
        ...
        let [input_pc_col0, input_ap_col1, input_fp_col2, offset2_col3, stored_fp_id_col4, stored_fp_limb_0_col5, stored_fp_limb_1_col6, stored_fp_limb_2_col7, stored_ret_pc_id_col8, stored_ret_pc_limb_0_col9, stored_ret_pc_limb_1_col10, stored_ret_pc_limb_2_col11, next_pc_id_col12, next_pc_limb_0_col13, next_pc_limb_1_col14, next_pc_limb_2_col15, enabler]: [Span<QM31>; 17]
...
let [stored_fp_limb_0_col5]: [QM31; 1] = (*stored_fp_limb_0_col5.try_into().unwrap()).unbox();
let [stored_fp_limb_1_col6]: [QM31; 1] = (*stored_fp_limb_1_col6.try_into().unwrap()).unbox();
let [stored_fp_limb_2_col7]: [QM31; 1] = (*stored_fp_limb_2_col7.try_into().unwrap()).unbox();
let [stored_ret_pc_id_col8]: [QM31; 1] = (*stored_ret_pc_id_col8.try_into().unwrap()).unbox();
let [stored_ret_pc_limb_0_col9]: [QM31; 1] = (*stored_ret_pc_limb_0_col9.try_into().unwrap()).unbox();
let [stored_ret_pc_limb_1_col10]: [QM31; 1] = (*stored_ret_pc_limb_1_col10.try_into().unwrap()).unbox();
let [stored_ret_pc_limb_2_col11]: [QM31; 1] = (*stored_ret_pc_limb_2_col11.try_into().unwrap()).unbox();
...
random_coeff
        ...
        // Constraint - [ap] = fp
        let constraint_quotient = ((((stored_fp_limb_0_col5 + (stored_fp_limb_1_col6 * qm31_const::<512, 0, 0, 0>())) + (stored_fp_limb_2_col7 * qm31_const::<262144, 0, 0, 0>())) - input_fp_col2)) * domain_vanishing_eval_inv;
        sum = sum * random_coeff + constraint_quotient;
...
random_coeff
        ...
        let constraint_quotient = ((((stored_ret_pc_limb_0_col9 + (stored_ret_pc_limb_1_col10 * qm31_const::<512, 0, 0, 0>())) + (stored_ret_pc_limb_2_col11 * qm31_const::<262144, 0, 0, 0>())) - (input_pc_col0 + qm31_const::<1, 0, 0, 0>()))) * domain_vanishing_eval_inv;
        sum = sum * random_coeff + constraint_quotient;
