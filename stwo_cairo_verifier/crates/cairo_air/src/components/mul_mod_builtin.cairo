...
interaction_trace_mask_points.append(array![point_offset_neg_1, point]);
    ...
    fn evaluate_constraints_at_point(
        ...
        let mul_mod_builtin_segment_start: QM31 = (TryInto::<u32, M31>::try_into((*(self.claim.mul_mod_builtin_segment_start))).unwrap()).into();
...
let [values_ptr_limb_0_col50]: [QM31; 1] = (*values_ptr_limb_0_col50.try_into().unwrap()).unbox();
let [values_ptr_limb_1_col51]: [QM31; 1] = (*values_ptr_limb_1_col51.try_into().unwrap()).unbox();
let [values_ptr_limb_2_col52]: [QM31; 1] = (*values_ptr_limb_2_col52.try_into().unwrap()).unbox();
let [offsets_ptr_id_col53]: [QM31; 1] = (*offsets_ptr_id_col53.try_into().unwrap()).unbox();
let [offsets_ptr_limb_0_col54]: [QM31; 1] = (*offsets_ptr_limb_0_col54.try_into().unwrap()).unbox();
let [offsets_ptr_limb_1_col55]: [QM31; 1] = (*offsets_ptr_limb_1_col55.try_into().unwrap()).unbox();
let [offsets_ptr_limb_2_col56]: [QM31; 1] = (*offsets_ptr_limb_2_col56.try_into().unwrap()).unbox();
let [offsets_ptr_prev_id_col57]: [QM31; 1] = (*offsets_ptr_prev_id_col57.try_into().unwrap()).unbox();
let [offsets_ptr_prev_limb_0_col58]: [QM31; 1] = (*offsets_ptr_prev_limb_0_col58.try_into().unwrap()).unbox();
let [offsets_ptr_prev_limb_1_col59]: [QM31; 1] = (*offsets_ptr_prev_limb_1_col59.try_into().unwrap()).unbox();
let [offsets_ptr_prev_limb_2_col60]: [QM31; 1] = (*offsets_ptr_prev_limb_2_col60.try_into().unwrap()).unbox();
...
let [values_ptr_prev_id_col69]: [QM31; 1] = (*values_ptr_prev_id_col69.try_into().unwrap()).unbox();
...
let [offsets_a_limb_0_col77]: [QM31; 1] = (*offsets_a_limb_0_col77.try_into().unwrap()).unbox();
let [offsets_a_limb_1_col78]: [QM31; 1] = (*offsets_a_limb_1_col78.try_into().unwrap()).unbox();
let [offsets_a_limb_2_col79]: [QM31; 1] = (*offsets_a_limb_2_col79.try_into().unwrap()).unbox();
...
let [offsets_b_limb_0_col83]: [QM31; 1] = (*offsets_b_limb_0_col83.try_into().unwrap()).unbox();
let [offsets_b_limb_1_col84]: [QM31; 1] = (*offsets_b_limb_1_col84.try_into().unwrap()).unbox();
let [offsets_b_limb_2_col85]: [QM31; 1] = (*offsets_b_limb_2_col85.try_into().unwrap()).unbox();
...
let [offsets_c_limb_0_col89]: [QM31; 1] = (*offsets_c_limb_0_col89.try_into().unwrap()).unbox();
let [offsets_c_limb_1_col90]: [QM31; 1] = (*offsets_c_limb_1_col90.try_into().unwrap()).unbox();
let [offsets_c_limb_2_col91]: [QM31; 1] = (*offsets_c_limb_2_col91.try_into().unwrap()).unbox();
...
let [ab_minus_c_div_p_limb_0_col236]: [QM31; 1] = (*ab_minus_c_div_p_limb_0_col236.try_into().unwrap()).unbox();
let [ab_minus_c_div_p_limb_1_col237]: [QM31; 1] = (*ab_minus_c_div_p_limb_1_col237.try_into().unwrap()).unbox();
let [ab_minus_c_div_p_limb_2_col238]: [QM31; 1] = (*ab_minus_c_div_p_limb_2_col238.try_into().unwrap()).unbox();
let [ab_minus_c_div_p_limb_3_col239]: [QM31; 1] = (*ab_minus_c_div_p_limb_3_col239.try_into().unwrap()).unbox();
let [ab_minus_c_div_p_limb_4_col240]: [QM31; 1] = (*ab_minus_c_div_p_limb_4_col240.try_into().unwrap()).unbox();
let [ab_minus_c_div_p_limb_5_col241]: [QM31; 1] = (*ab_minus_c_div_p_limb_5_col241.try_into().unwrap()).unbox();
let [ab_minus_c_div_p_limb_6_col242]: [QM31; 1] = (*ab_minus_c_div_p_limb_6_col242.try_into().unwrap()).unbox();
let [ab_minus_c_div_p_limb_7_col243]: [QM31; 1] = (*ab_minus_c_div_p_limb_7_col243.try_into().unwrap()).unbox();
let [ab_minus_c_div_p_limb_8_col244]: [QM31; 1] = (*ab_minus_c_div_p_limb_8_col244.try_into().unwrap()).unbox();
let [ab_minus_c_div_p_limb_9_col245]: [QM31; 1] = (*ab_minus_c_div_p_limb_9_col245.try_into().unwrap()).unbox();
let [ab_minus_c_div_p_limb_10_col246]: [QM31; 1] = (*ab_minus_c_div_p_limb_10_col246.try_into().unwrap()).unbox();
let [ab_minus_c_div_p_limb_11_col247]: [QM31; 1] = (*ab_minus_c_div_p_limb_11_col247.try_into().unwrap()).unbox();
let [ab_minus_c_div_p_limb_12_col248]: [QM31; 1] = (*ab_minus_c_div_p_limb_12_col248.try_into().unwrap()).unbox();
let [ab_minus_c_div_p_limb_13_col249]: [QM31; 1] = (*ab_minus_c_div_p_limb_13_col249.try_into().unwrap()).unbox();
let [ab_minus_c_div_p_limb_14_col250]: [QM31; 1] = (*ab_minus_c_div_p_limb_14_col250.try_into().unwrap()).unbox();
let [ab_minus_c_div_p_limb_15_col251]: [QM31; 1] = (*ab_minus_c_div_p_limb_15_col251.try_into().unwrap()).unbox();
let [ab_minus_c_div_p_limb_16_col252]: [QM31; 1] = (*ab_minus_c_div_p_limb_16_col252.try_into().unwrap()).unbox();
let [ab_minus_c_div_p_limb_17_col253]: [QM31; 1] = (*ab_minus_c_div_p_limb_17_col253.try_into().unwrap()).unbox();
let [ab_minus_c_div_p_limb_18_col254]: [QM31; 1] = (*ab_minus_c_div_p_limb_18_col254.try_into().unwrap()).unbox();
let [ab_minus_c_div_p_limb_19_col255]: [QM31; 1] = (*ab_minus_c_div_p_limb_19_col255.try_into().unwrap()).unbox();
let [ab_minus_c_div_p_limb_20_col256]: [QM31; 1] = (*ab_minus_c_div_p_limb_20_col256.try_into().unwrap()).unbox();
let [ab_minus_c_div_p_limb_21_col257]: [QM31; 1] = (*ab_minus_c_div_p_limb_21_col257.try_into().unwrap()).unbox();
let [ab_minus_c_div_p_limb_22_col258]: [QM31; 1] = (*ab_minus_c_div_p_limb_22_col258.try_into().unwrap()).unbox();
let [ab_minus_c_div_p_limb_23_col259]: [QM31; 1] = (*ab_minus_c_div_p_limb_23_col259.try_into().unwrap()).unbox();
let [ab_minus_c_div_p_limb_24_col260]: [QM31; 1] = (*ab_minus_c_div_p_limb_24_col260.try_into().unwrap()).unbox();
let [ab_minus_c_div_p_limb_25_col261]: [QM31; 1] = (*ab_minus_c_div_p_limb_25_col261.try_into().unwrap()).unbox();
let [ab_minus_c_div_p_limb_26_col262]: [QM31; 1] = (*ab_minus_c_div_p_limb_26_col262.try_into().unwrap()).unbox();
let [ab_minus_c_div_p_limb_27_col263]: [QM31; 1] = (*ab_minus_c_div_p_limb_27_col263.try_into().unwrap()).unbox();
let [ab_minus_c_div_p_limb_28_col264]: [QM31; 1] = (*ab_minus_c_div_p_limb_28_col264.try_into().unwrap()).unbox();
let [ab_minus_c_div_p_limb_29_col265]: [QM31; 1] = (*ab_minus_c_div_p_limb_29_col265.try_into().unwrap()).unbox();
let [ab_minus_c_div_p_limb_30_col266]: [QM31; 1] = (*ab_minus_c_div_p_limb_30_col266.try_into().unwrap()).unbox();
let [ab_minus_c_div_p_limb_31_col267]: [QM31; 1] = (*ab_minus_c_div_p_limb_31_col267.try_into().unwrap()).unbox();
