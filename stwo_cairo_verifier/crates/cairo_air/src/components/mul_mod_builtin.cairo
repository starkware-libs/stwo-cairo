...
pub impl ClaimImpl of ClaimTrait {
    fn log_sizes(self: @Claim) -> TreeArray<Span<u32>> {
        ...
        let trace_log_sizes = ArrayImpl::new_repeated(410, log_size).span();
...
pub impl CairoComponentImpl of CairoComponent<Component> {
    ...
    fn evaluate_constraints_at_point(
        ...
        let RangeCheck_3_6_6_3_z = *self.range_check_3_6_6_3_lookup_elements.z;
        let mut range_check_3_6_6_3_alpha_powers = self
            .range_check_3_6_6_3_lookup_elements
            .alpha_powers
            .span();
        let RangeCheck_3_6_6_3_alpha0 = *range_check_3_6_6_3_alpha_powers.pop_front().unwrap();
        let RangeCheck_3_6_6_3_alpha1 = *range_check_3_6_6_3_alpha_powers.pop_front().unwrap();
        let RangeCheck_3_6_6_3_alpha2 = *range_check_3_6_6_3_alpha_powers.pop_front().unwrap();
        let RangeCheck_3_6_6_3_alpha3 = *range_check_3_6_6_3_alpha_powers.pop_front().unwrap();

        let log_size = *self.claim.log_size;

        let claimed_sum = *self.interaction_claim.claimed_sum;

        let mul_mod_builtin_segment_start = (*self.claim.mul_mod_builtin_segment_start).into();

        let seq = preprocessed_mask_values.get(PreprocessedColumn::Seq(log_size));

        let params = constraints::ConstraintParams {
            column_size: m31(pow2(log_size)),
            builtin_segment_start: mul_mod_builtin_segment_start,
