...
pub const RELATION_USES_PER_ROW: [(felt252, u32); 2] = [
    ('MemoryAddressToId', 3), ('PedersenAggregatorBitsPerWindow9', 1),
];
...
pub impl CairoComponentImpl of CairoComponent<Component> {
    fn evaluate_constraints_at_point(
        ...
        let mut pedersen_aggregator_bits_per_window_9_sum_3: QM31 = Zero::zero();
        ...
        pedersen_aggregator_bits_per_window_9_sum_3 = self
        ...
        lookup_constraints(
            ...
            pedersen_aggregator_bits_per_window_9_sum_3,
        );
    }
}
...
fn lookup_constraints(
    ...
    pedersen_aggregator_bits_per_window_9_sum_3: QM31,
) {
    let [
        trace_2_col0,
        trace_2_col1,
