...
pub impl CairoComponentImpl of CairoComponent<Component> {
    fn mask_points(
        ...
        preprocessed_column_set.insert(BITWISE_XOR__9_0_IDX);
        preprocessed_column_set.insert(BITWISE_XOR__9_1_IDX);
        preprocessed_column_set.insert(BITWISE_XOR__9_2_IDX);
    ...
    fn evaluate_constraints_at_point(
        ...
        let bitwisexor_9_0 = preprocessed_mask_values.get(BITWISE_XOR__9_0_IDX);
        let bitwisexor_9_1 = preprocessed_mask_values.get(BITWISE_XOR__9_1_IDX);
        let bitwisexor_9_2 = preprocessed_mask_values.get(BITWISE_XOR__9_2_IDX);
