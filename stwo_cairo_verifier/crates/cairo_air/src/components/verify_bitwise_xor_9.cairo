...
use crate::components::{
    CairoComponent, OPCODES_RELATION_SIZE, VERIFY_BITWISE_XOR_9_LOG_SIZE, opcodes_sum,
};
...
pub const VERIFY_BITWISE_XOR_9_RELATION_SIZE: usize = 3;
...
pub impl ComponentImpl of CairoComponent<Component> {
    ...
    fn evaluate_constraints_at_point(
        ...
        verify_bitwise_xor_9_sum_0 =
            verify_bitwise_xor_9_sum(
                verify_bitwise_xor_9_alphas,
                verify_bitwise_xor_9_z,
                [bitwisexor_9_0, bitwisexor_9_1, bitwisexor_9_2],
            );
...
pub fn verify_bitwise_xor_9_sum(mut alphas: Span<QM31>, z: QM31, values: [QM31; 3]) -> QM31 {
