...
pub fn evaluate_constraints_at_point(
    ...
    // Constraint 1
    let constraint_quotient = ((trace_1_column_3_offset_0)
        * (m31(1).into() - (trace_1_column_3_offset_0)))
        * domain_vanish_at_point_inv;
    sum = sum * random_coeff + constraint_quotient;
    ...
    let constraint_quotient = ((QM31Trait::from_partial_evals(
        ...
        * ((intermediate2) * (intermediate4))
        - (intermediate4 + (intermediate2) * (trace_1_column_10_offset_0)))
        * domain_vanish_at_point_inv;
    sum = sum * random_coeff + constraint_quotient;
...
pub fn intermediate0(
    ...
    (VerifyInstruction_alpha0) * (trace_1_column_0_offset_0)
        ...
        + (VerifyInstruction_alpha4) * (qm31_const::<56, 0, 0, 0>())
        + (VerifyInstruction_alpha5)
            * (m31(4).into() + (trace_1_column_3_offset_0) * (m31(32).into()))
        - (VerifyInstruction_z)
}
...
pub fn intermediate5(
    ...
    (Opcodes_alpha0) * (trace_1_column_0_offset_0 + intermediate3)
