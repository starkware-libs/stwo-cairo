...
pub impl ClaimImpl of ClaimTrait {
    fn log_sizes(self: @Claim) -> TreeArray<Span<u32>> {
        ...
        let trace_log_sizes = ArrayImpl::new_repeated(21, log_size).span();
...
pub impl CairoComponentImpl of CairoComponent<Component> {
    ...
    fn evaluate_constraints_at_point(
        ...
        let TripleXor32_alpha3 = *triple_xor_32_alpha_powers.pop_front().unwrap();
        let TripleXor32_alpha4 = *triple_xor_32_alpha_powers.pop_front().unwrap();
        let TripleXor32_alpha5 = *triple_xor_32_alpha_powers.pop_front().unwrap();
        let TripleXor32_alpha6 = *triple_xor_32_alpha_powers.pop_front().unwrap();
        let TripleXor32_alpha7 = *triple_xor_32_alpha_powers.pop_front().unwrap();
