...
pub const N_TRACE_COLUMNS: usize = 1;const SOME_COLUMN: PreprocessedColumn = PreprocessedColumn::Seq((11));
...
pub impl ComponentImpl of CairoComponent<Component> {
    ...
    fn evaluate_constraints_at_point(
        ...
        let mut range_check_11_sum_0: QM31 = Zero::zero();let seq = preprocessed_mask_values.get(PreprocessedColumn::Seq(SOME_COLUMN.log_size()));
        ...
        range_check_11_sum_0 = self.range_check_11_lookup_elements.combine_qm31(
            [
                seq
            ],
        );
