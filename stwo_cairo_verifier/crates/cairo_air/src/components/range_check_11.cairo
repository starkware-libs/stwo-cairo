...
pub impl CairoComponentImpl of CairoComponent<Component> {
    fn mask_points(
        ...
        preprocessed_column_set.insert(SEQ_11_IDX);
    ...
    fn evaluate_constraints_at_point(
        ...
        let seq_11 = preprocessed_mask_values.get(SEQ_11_IDX);
        ...
        range_check_11_sum_0 = self.range_check_11_lookup_elements.combine_qm31([seq_11]);
