...
pub fn evaluate_constraints_at_point(
    ...
    // Constraint 20
    let constraint_quotient = (intermediate7 - (intermediate10 + intermediate13))
        * domain_vanish_at_point_inv;
    sum = sum * random_coeff + constraint_quotient;
    ...
    let constraint_quotient = ((QM31Trait::from_partial_evals(
        ...
        * ((intermediate9) * (intermediate11))
        - (intermediate11 + intermediate9))
        * domain_vanish_at_point_inv;
    sum = sum * random_coeff + constraint_quotient;
    ...
    let constraint_quotient = ((QM31Trait::from_partial_evals(
        ...
        * ((intermediate12) * (intermediate14))
        - (intermediate14 + (intermediate12) * (trace_1_column_32_offset_0)))
        * domain_vanish_at_point_inv;
    sum = sum * random_coeff + constraint_quotient;
    ...
    (VerifyInstruction_alpha0) * (trace_1_column_0_offset_0)
        ...
        + (VerifyInstruction_alpha4)
            * ((trace_1_column_6_offset_0) * (m31(8).into())
                ...
                + m31(256).into())
        + (VerifyInstruction_alpha5)
            * ((trace_1_column_10_offset_0) * (m31(32).into()) + m31(256).into())
        - (VerifyInstruction_z)
}
