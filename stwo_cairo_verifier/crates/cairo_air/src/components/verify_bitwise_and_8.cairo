...
const SOME_COLUMN: PreprocessedColumn = PreprocessedColumn::BitwiseAnd((8, 0));
...
pub impl CairoComponentImpl of CairoComponent<Component> {
    fn mask_points(
        ...
        preprocessed_column_set.insert(PreprocessedColumn::BitwiseAnd((8, 0)));
        preprocessed_column_set.insert(PreprocessedColumn::BitwiseAnd((8, 1)));
        preprocessed_column_set.insert(PreprocessedColumn::BitwiseAnd((8, 2)));
    ...
    fn evaluate_constraints_at_point(
        ...
        let bitwiseand_8_0 = preprocessed_mask_values.get(PreprocessedColumn::BitwiseAnd((8, 0)));
        let bitwiseand_8_1 = preprocessed_mask_values.get(PreprocessedColumn::BitwiseAnd((8, 1)));
        let bitwiseand_8_2 = preprocessed_mask_values.get(PreprocessedColumn::BitwiseAnd((8, 2)));
        ...
        verify_bitwise_and_8_sum_0 = self
            .verify_bitwise_and_8_lookup_elements
            .combine_qm31([bitwiseand_8_0, bitwiseand_8_1, bitwiseand_8_2]);
