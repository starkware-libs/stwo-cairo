...
fn lookup_constraints(
    ...
    let [trace_2_col72_neg1, trace_2_col72]: [QM31; N_SAMPLES_FOR_PREFIX_SUM] = (*trace_2_col72
        .try_into()
        .unwrap())
        .unbox();
    let [trace_2_col73_neg1, trace_2_col73]: [QM31; N_SAMPLES_FOR_PREFIX_SUM] = (*trace_2_col73
        .try_into()
        .unwrap())
        .unbox();
    let [trace_2_col74_neg1, trace_2_col74]: [QM31; N_SAMPLES_FOR_PREFIX_SUM] = (*trace_2_col74
        .try_into()
        .unwrap())
        .unbox();
    let [trace_2_col75_neg1, trace_2_col75]: [QM31; N_SAMPLES_FOR_PREFIX_SUM] = (*trace_2_col75
        .try_into()
        .unwrap())
        .unbox();
