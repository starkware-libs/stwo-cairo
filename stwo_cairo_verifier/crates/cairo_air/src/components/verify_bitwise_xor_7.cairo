...
pub impl CairoComponentImpl of CairoComponent<Component> {
    fn mask_points(
        ...
        preprocessed_column_set.insert(BITWISE_XOR__7_0_IDX);
        preprocessed_column_set.insert(BITWISE_XOR__7_1_IDX);
        preprocessed_column_set.insert(BITWISE_XOR__7_2_IDX);
    ...
    fn evaluate_constraints_at_point(
        ...
        let bitwisexor_7_0 = preprocessed_mask_values.get(BITWISE_XOR__7_0_IDX);
        let bitwisexor_7_1 = preprocessed_mask_values.get(BITWISE_XOR__7_1_IDX);
        let bitwisexor_7_2 = preprocessed_mask_values.get(BITWISE_XOR__7_2_IDX);
