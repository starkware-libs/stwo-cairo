...
pub impl CairoComponentImpl of CairoComponent<Component> {
    fn evaluate_constraints_at_point(
        ...
        let [verify_bitwise_xor_7_multiplicity]: [Span<QM31>; 1] = (*trace_mask_values
            .multi_pop_front()
            .unwrap())
            .unbox();
        let [verify_bitwise_xor_7_multiplicity]: [QM31; 1] = (*verify_bitwise_xor_7_multiplicity
            .try_into()
            .unwrap())
            .unbox();
        ...
        lookup_constraints(
            ...
            random_coeff,
            claimed_sum,
            verify_bitwise_xor_7_multiplicity,
            column_size,
...
fn lookup_constraints(
    ...
    random_coeff: QM31,
    claimed_sum: QM31,
    verify_bitwise_xor_7_multiplicity: QM31,
    column_size: M31,
    ref interaction_trace_mask_values: ColumnSpan<Span<QM31>>,
