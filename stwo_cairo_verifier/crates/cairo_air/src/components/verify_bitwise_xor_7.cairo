...
pub const N_TRACE_COLUMNS: usize = 1;const SOME_COLUMN: PreprocessedColumn = PreprocessedColumn::BitwiseXor((7, 0));
...
pub impl ComponentImpl of CairoComponent<Component> {
    fn mask_points(
        ...
        preprocessed_column_set.insert(PreprocessedColumn::BitwiseXor((7, 0)));preprocessed_column_set.insert(PreprocessedColumn::BitwiseXor((7, 1)));preprocessed_column_set.insert(PreprocessedColumn::BitwiseXor((7, 2)));trace_mask_points.append(array![point]);interaction_trace_mask_points.append(array![point_offset_neg_1, point]);
    ...
    fn evaluate_constraints_at_point(
        ...
        let mut verify_bitwise_xor_7_sum_0: QM31 = Zero::zero();let bitwisexor_7_0
            = preprocessed_mask_values.get(PreprocessedColumn::BitwiseXor((7, 0)));
        let bitwisexor_7_1
            = preprocessed_mask_values.get(PreprocessedColumn::BitwiseXor((7, 1)));
        let bitwisexor_7_2
            = preprocessed_mask_values.get(PreprocessedColumn::BitwiseXor((7, 2)));
        ...
        verify_bitwise_xor_7_sum_0 = self.verify_bitwise_xor_7_lookup_elements.combine_qm31(
            [
                bitwisexor_7_0,
bitwisexor_7_1,
bitwisexor_7_2
