...
pub impl CairoComponentImpl of CairoComponent<Component> {
    ...
    fn evaluate_constraints_at_point(
        ...
        let mut sha_256_big_sigma_0_o_0_sum_0: QM31 = Zero::zero();let sha256sigmatable_Sha256SigmaType_BigSigma0O0_0
            = preprocessed_mask_values.get(PreprocessedColumn::Sha256SigmaTable((Sha256SigmaType::BigSigma0O0, 0)));
        let sha256sigmatable_Sha256SigmaType_BigSigma0O0_1
            = preprocessed_mask_values.get(PreprocessedColumn::Sha256SigmaTable((Sha256SigmaType::BigSigma0O0, 1)));
        let sha256sigmatable_Sha256SigmaType_BigSigma0O0_2
            = preprocessed_mask_values.get(PreprocessedColumn::Sha256SigmaTable((Sha256SigmaType::BigSigma0O0, 2)));
        let sha256sigmatable_Sha256SigmaType_BigSigma0O0_3
            = preprocessed_mask_values.get(PreprocessedColumn::Sha256SigmaTable((Sha256SigmaType::BigSigma0O0, 3)));
        let sha256sigmatable_Sha256SigmaType_BigSigma0O0_4
            = preprocessed_mask_values.get(PreprocessedColumn::Sha256SigmaTable((Sha256SigmaType::BigSigma0O0, 4)));
        let sha256sigmatable_Sha256SigmaType_BigSigma0O0_5
            = preprocessed_mask_values.get(PreprocessedColumn::Sha256SigmaTable((Sha256SigmaType::BigSigma0O0, 5)));
        ...
        sha_256_big_sigma_0_o_0_sum_0 = self.sha_256_big_sigma_0_o_0_lookup_elements.combine_qm31(
            [
