...
pub fn decode_instruction_324b0_evaluate(
    input: QM31,
    offset0_col0: QM31,
    ...
    let decode_instruction_324b0_input_pc = input;

    // Constraint - Flag dst_base_fp is a bit
    let constraint_quotient = ((dst_base_fp_col1
        * (qm31_const::<1, 0, 0, 0>() - dst_base_fp_col1)));
    ...
    verify_instruction_sum_0 = common_lookup_elements
        .combine_qm31(
            [
                qm31_const::<1719106205, 0, 0, 0>(), decode_instruction_324b0_input_pc,
                offset0_col0, qm31_const::<32767, 0, 0, 0>(), qm31_const::<32769, 0, 0, 0>(),
                (((dst_base_fp_col1 * qm31_const::<8, 0, 0, 0>()) + qm31_const::<16, 0, 0, 0>())
                    + qm31_const::<32, 0, 0, 0>()),
                ((ap_update_add_1_col2 * qm31_const::<32, 0, 0, 0>())
