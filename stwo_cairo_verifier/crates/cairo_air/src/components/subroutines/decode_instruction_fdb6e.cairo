...
pub fn decode_instruction_fdb6e_evaluate(
    input: [QM31; 1],
    offset2_col0: QM31,
    ...
    let [decode_instruction_fdb6e_input_pc] = input;

    verify_instruction_sum_0 = verify_instruction_lookup_elements
        .combine_qm31(
            [
                decode_instruction_fdb6e_input_pc, qm31_const::<32768, 0, 0, 0>(),
                qm31_const::<32769, 0, 0, 0>(), offset2_col0, qm31_const::<128, 0, 0, 0>(),
