...
pub fn decode_instruction_cb32b_evaluate(
    ...
    let decode_instruction_cb32b_input = input;
    ...
    verify_instruction_sum_0 =
        verify_instruction_sum(
            ...
            [
                decode_instruction_cb32b_input, offset0_col0, offset1_col1, offset2_col2,
    ...
    [
        ...
        qm31_const::<0, 0, 0, 0>(), qm31_const::<0, 0, 0, 0>(), qm31_const::<0, 0, 0, 0>(),
        qm31_const::<0, 0, 0, 0>(), qm31_const::<0, 0, 0, 0>(), qm31_const::<0, 0, 0, 0>(),
        ap_update_add_1_col5, qm31_const::<0, 0, 0, 0>(), qm31_const::<0, 0, 0, 0>(),
