...
pub fn decode_instruction_cb32b_evaluate(
    input: QM31,
    offset0_col0: QM31,offset1_col1: QM31,offset2_col2: QM31,dst_base_fp_col3: QM31,op0_base_fp_col4: QM31,ap_update_add_1_col5: QM31,verify_instruction_lookup_elements: @crate::VerifyInstructionElements,ref verify_instruction_sum_0: QM31,
    ref sum: QM31,
    ...
    let constraint_quotient = ((ap_update_add_1_col5 * (qm31_const::<1, 0, 0, 0>() - ap_update_add_1_col5))) * domain_vanishing_eval_inv;
    sum = sum * random_coeff + constraint_quotient;
...
offset1_col1,
offset2_col2,
((dst_base_fp_col3 * qm31_const::<8, 0, 0, 0>()) + (op0_base_fp_col4 * qm31_const::<16, 0, 0, 0>())),
((ap_update_add_1_col5 * qm31_const::<32, 0, 0, 0>()) + qm31_const::<256, 0, 0, 0>()),
qm31_const::<0, 0, 0, 0>()
        ],
    );
