...
pub fn decode_instruction_ba944_evaluate(
    input: QM31,
    offset2_col0: QM31,
    ...
    let decode_instruction_ba944_input_pc = input;

    // Constraint - Flag op1_base_fp is a bit
    let constraint_quotient = ((op1_base_fp_col1
    ...
    verify_instruction_sum_0 = common_lookup_elements
        .combine_qm31(
            [
                qm31_const::<1719106205, 0, 0, 0>(), decode_instruction_ba944_input_pc,
                ...
                (qm31_const::<4, 0, 0, 0>() + (ap_update_add_1_col2 * qm31_const::<32, 0, 0, 0>())),
                qm31_const::<0, 0, 0, 0>(),
            ]
                .span(),
        );
