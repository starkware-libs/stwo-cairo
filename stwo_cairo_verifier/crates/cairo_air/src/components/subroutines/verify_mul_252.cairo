...
pub fn verify_mul_252_evaluate(
    ...
    range_check_19_sum_0 =
        range_check_19_sum(
            range_check_19_alphas, range_check_19_z, [(k_col0 + qm31_const::<262144, 0, 0, 0>())],
        );
