...
pub fn decode_instruction_b1597_evaluate(
    input: QM31,
    offset2_col0: QM31,
    ...
    let decode_instruction_b1597_input_pc = input;
    ...
    verify_instruction_sum_0 = common_lookup_elements
        .combine_qm31(
            [
                qm31_const::<1719106205, 0, 0, 0>(), decode_instruction_b1597_input_pc,
                ...
                (qm31_const::<2, 0, 0, 0>() + (ap_update_add_1_col2 * qm31_const::<32, 0, 0, 0>())),
                qm31_const::<0, 0, 0, 0>(),
            ]
                .span(),
        );
