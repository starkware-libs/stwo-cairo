...
pub fn handle_opcodes_evaluate(
    input: [QM31; 110], ref sum: QM31, domain_vanishing_eval_inv: QM31, random_coeff: QM31,
) -> () {
    let [
        handle_opcodes_input_limb_0,
        handle_opcodes_input_limb_1,
        handle_opcodes_input_limb_2,
        handle_opcodes_input_limb_3,
        handle_opcodes_input_limb_4,
        handle_opcodes_input_limb_5,
        handle_opcodes_input_limb_6,
        handle_opcodes_input_limb_7,
        handle_opcodes_input_limb_8,
        handle_opcodes_input_limb_9,
        handle_opcodes_input_limb_10,
        handle_opcodes_input_limb_11,
        handle_opcodes_input_limb_12,
        handle_opcodes_input_limb_13,
        handle_opcodes_input_limb_14,
        handle_opcodes_input_limb_15,
        handle_opcodes_input_limb_16,
        handle_opcodes_input_limb_17,
        handle_opcodes_input_limb_18,
        handle_opcodes_input_limb_19,
        handle_opcodes_input_limb_20,
        handle_opcodes_input_limb_21,
