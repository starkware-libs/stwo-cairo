...
pub fn bitwise_xor_num_bits_4_evaluate(
    input: [QM31; 2],
    xor_col0: QM31,verify_bitwise_xor_4_lookup_elements: @crate::VerifyBitwiseXor_4Elements,ref verify_bitwise_xor_4_sum_0: QM31,
    ref sum: QM31,
    ...
    verify_bitwise_xor_4_sum_0 = verify_bitwise_xor_4_lookup_elements.combine_qm31(
        [
