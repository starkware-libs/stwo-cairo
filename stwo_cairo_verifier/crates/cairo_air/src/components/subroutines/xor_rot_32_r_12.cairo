...
pub fn xor_rot_32_r_12_evaluate(
    ...
    let [
        ...
        input;
    let split_16_low_part_size_12_output_tmp_b89d6_1_limb_0: QM31 =
    ...
    bitwise_xor_num_bits_12_evaluate(
        [
            split_16_low_part_size_12_output_tmp_b89d6_3_limb_0,
            split_16_low_part_size_12_output_tmp_b89d6_7_limb_0,
        ],
        xor_col6,
        common_lookup_elements,
    ...
    let xor_rot_12_output_tmp_b89d6_16_limb_0: QM31 = (xor_col5
        + (xor_col6 * qm31_const::<16, 0, 0, 0>()));
    let xor_rot_12_output_tmp_b89d6_16_limb_1: QM31 = (xor_col7
        + (xor_col4 * qm31_const::<16, 0, 0, 0>()));

    [xor_rot_12_output_tmp_b89d6_16_limb_0, xor_rot_12_output_tmp_b89d6_16_limb_1]
}
