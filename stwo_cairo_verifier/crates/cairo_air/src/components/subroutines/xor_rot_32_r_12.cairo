...
let xor_rot_12_output_tmp_cf62f_16_limb_0: QM31 = (xor_col5 + (xor_col6 * qm31_const::<16, 0, 0, 0>()));
let xor_rot_12_output_tmp_cf62f_16_limb_1: QM31 = (xor_col7 + (xor_col4 * qm31_const::<16, 0, 0, 0>()));
