...
pub fn decode_instruction_7ebc4_evaluate(
    ...
    let decode_instruction_7ebc4_input = input;
    ...
    verify_instruction_sum_0 =
        verify_instruction_sum(
            ...
            [
                decode_instruction_7ebc4_input, qm31_const::<32767, 0, 0, 0>(),
    ...
    [
        ...
        qm31_const::<1, 0, 0, 0>(), qm31_const::<1, 0, 0, 0>(), qm31_const::<1, 0, 0, 0>(),
        qm31_const::<1, 0, 0, 0>(), qm31_const::<0, 0, 0, 0>(), qm31_const::<0, 0, 0, 0>(),
        qm31_const::<0, 0, 0, 0>(), qm31_const::<0, 0, 0, 0>(), qm31_const::<0, 0, 0, 0>(),
        qm31_const::<1, 0, 0, 0>(), qm31_const::<0, 0, 0, 0>(), qm31_const::<0, 0, 0, 0>(),
        ap_update_add_1_col0, qm31_const::<0, 0, 0, 0>(), qm31_const::<0, 0, 0, 0>(),
