...
pub fn read_positive_known_id_num_bits_27_evaluate(
    input: QM31,
    ...
    let read_positive_known_id_num_bits_27_input = input;

    memory_id_to_big_sum_0 = memory_id_to_big_lookup_elements
        .combine_qm31(
            [
                read_positive_known_id_num_bits_27_input, value_limb_0_col0, value_limb_1_col1,
                value_limb_2_col2, qm31_const::<0, 0, 0, 0>(), qm31_const::<0, 0, 0, 0>(),
