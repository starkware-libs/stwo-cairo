...
pub fn decode_instruction_7785f_evaluate(
    input: QM31,
    offset0_col0: QM31,
    offset1_col1: QM31,
    offset2_col2: QM31,
    ...
    let decode_instruction_7785f_input_pc = input;
    ...
    sum = sum * random_coeff + constraint_quotient;
    let op1_base_ap_tmp_7785f_9: QM31 = ((qm31_const::<1, 0, 0, 0>() - op1_imm_col5)
        - op1_base_fp_col6);

    // Constraint - Flag op1_base_ap is a bit
    let constraint_quotient = ((op1_base_ap_tmp_7785f_9
        * (qm31_const::<1, 0, 0, 0>() - op1_base_ap_tmp_7785f_9)));
    sum = sum * random_coeff + constraint_quotient;
    ...
    verify_instruction_sum_0 = common_lookup_elements
        .combine_qm31(
            [
                qm31_const::<1719106205, 0, 0, 0>(), decode_instruction_7785f_input_pc,
                ...
                ((((((dst_base_fp_col3 * qm31_const::<8, 0, 0, 0>())
                    ...
                    + (op1_base_ap_tmp_7785f_9 * qm31_const::<128, 0, 0, 0>()))
    ...
    [
        ...
        (offset2_col2 - qm31_const::<32768, 0, 0, 0>()), op1_base_ap_tmp_7785f_9,
    ]
}
