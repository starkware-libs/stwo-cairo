...
pub impl ComponentImpl of CairoComponent<Component> {
    ...
    fn evaluate_constraints_at_point(
        ...
        let [offset2_col0, op1_base_fp_col1]: [Span<QM31>; 2]
            = (*trace_mask_values.multi_pop_front().unwrap()).unbox();
        let [offset2_col0]: [QM31; 1] = (*offset2_col0.try_into().unwrap()).unbox();
        let [op1_base_fp_col1]: [QM31; 1] = (*op1_base_fp_col1.try_into().unwrap()).unbox();
