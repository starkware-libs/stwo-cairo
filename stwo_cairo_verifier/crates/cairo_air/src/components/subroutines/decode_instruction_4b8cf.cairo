...
pub fn decode_instruction_4b8cf_evaluate(
    ...
    sum = sum * random_coeff + constraint_quotient;
    let op1_base_ap_tmp_4b8cf_9: QM31 = ((qm31_const::<1, 0, 0, 0>() - op1_imm_col5)
        - op1_base_fp_col6);

    // Constraint - Flag op1_base_ap is a bit
    let constraint_quotient = ((op1_base_ap_tmp_4b8cf_9
        * (qm31_const::<1, 0, 0, 0>() - op1_base_ap_tmp_4b8cf_9)));
    sum = sum * random_coeff + constraint_quotient;
    ...
    verify_instruction_sum_0 = common_lookup_elements
        .combine_qm31(
            [
                qm31_const::<1719106205, 0, 0, 0>(), decode_instruction_4b8cf_input_pc,
                ...
                (((((dst_base_fp_col3 * qm31_const::<8, 0, 0, 0>())
                    ...
                    + (op1_base_ap_tmp_4b8cf_9 * qm31_const::<128, 0, 0, 0>())),
                ((qm31_const::<1, 0, 0, 0>() + (ap_update_add_1_col7 * qm31_const::<32, 0, 0, 0>()))
    ...
    [
        ...
        (offset2_col2 - qm31_const::<32768, 0, 0, 0>()), op1_base_ap_tmp_4b8cf_9,
    ]
}
