...
pub fn decode_instruction_3b105_evaluate(
    ...
    verify_instruction_sum_0 =
        verify_instruction_sum(
            ...
            [
                decode_instruction_3b105_input_pc, qm31_const::<32767, 0, 0, 0>(),
    ...
    [
        ...
        qm31_const::<1, 0, 0, 0>(), qm31_const::<0, 0, 0, 0>(), op1_base_fp_col1, op1_base_ap_col2,
        qm31_const::<0, 0, 0, 0>(), qm31_const::<0, 0, 0, 0>(), qm31_const::<0, 0, 0, 0>(),
        qm31_const::<1, 0, 0, 0>(), qm31_const::<0, 0, 0, 0>(), qm31_const::<0, 0, 0, 0>(),
        ap_update_add_1_col3, qm31_const::<0, 0, 0, 0>(), qm31_const::<0, 0, 0, 0>(),
