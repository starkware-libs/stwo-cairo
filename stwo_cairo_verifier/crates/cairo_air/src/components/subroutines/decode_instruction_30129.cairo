...
pub fn decode_instruction_30129_evaluate(
    input: QM31,
    offset0_col0: QM31,
    offset1_col1: QM31,
    offset2_col2: QM31,
    ...
    let decode_instruction_30129_input_pc = input;
    ...
    verify_instruction_sum_0 = common_lookup_elements
        .combine_qm31(
            [
                qm31_const::<1719106205, 0, 0, 0>(), decode_instruction_30129_input_pc,
                ...
                (ap_update_add_1_col6 * qm31_const::<32, 0, 0, 0>()), opcode_extension_col7,
            ]
                .span(),
        );
