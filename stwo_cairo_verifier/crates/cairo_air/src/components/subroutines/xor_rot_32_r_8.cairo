...
let xor_rot_8_output_tmp_aa6bd_16_limb_0: QM31 = (xor_col5 + (xor_col6 * qm31_const::<256, 0, 0, 0>()));
let xor_rot_8_output_tmp_aa6bd_16_limb_1: QM31 = (xor_col7 + (xor_col4 * qm31_const::<256, 0, 0, 0>()));
