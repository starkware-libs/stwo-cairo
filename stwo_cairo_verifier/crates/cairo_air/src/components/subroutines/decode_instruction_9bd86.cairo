...
pub fn decode_instruction_9bd86_evaluate(
    ...
    let decode_instruction_9bd86_input = input;
    ...
    verify_instruction_sum_0 =
        verify_instruction_sum(
            ...
            [
                decode_instruction_9bd86_input, qm31_const::<32767, 0, 0, 0>(), offset1_col0,
                offset2_col1,
    ...
    [
        qm31_const::<2147483646, 0, 0, 0>(), (offset1_col0 - qm31_const::<32768, 0, 0, 0>()),
        (offset2_col1 - qm31_const::<32768, 0, 0, 0>()), qm31_const::<1, 0, 0, 0>(),
        op0_base_fp_col2, qm31_const::<0, 0, 0, 0>(), qm31_const::<0, 0, 0, 0>(),
        qm31_const::<0, 0, 0, 0>(), qm31_const::<0, 0, 0, 0>(), qm31_const::<0, 0, 0, 0>(),
        qm31_const::<1, 0, 0, 0>(), qm31_const::<0, 0, 0, 0>(), qm31_const::<0, 0, 0, 0>(),
        qm31_const::<0, 0, 0, 0>(), ap_update_add_1_col3, qm31_const::<0, 0, 0, 0>(),
        qm31_const::<0, 0, 0, 0>(), qm31_const::<0, 0, 0, 0>(), qm31_const::<0, 0, 0, 0>(),
    ]
}
