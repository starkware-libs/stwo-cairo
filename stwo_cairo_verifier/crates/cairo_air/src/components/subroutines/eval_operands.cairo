...
pub fn eval_operands_evaluate(
    ...
    let cond_felt_252_as_addr_output_tmp_c9c94_12: QM31 = cond_felt_252_as_addr_evaluate(
        [
    ...
    let constraint_quotient = ((op1_src_col61
        - ((((eval_operands_input_op1_base_fp * eval_operands_input_fp)
            ...
            + (eval_operands_input_op1_base_op0 * cond_felt_252_as_addr_output_tmp_c9c94_12))));
    sum = sum * random_coeff + constraint_quotient;
    read_positive_num_bits_252_evaluate(
    ...
    let not_pc_update_jnz_tmp_c9c94_54: QM31 = (qm31_const::<1, 0, 0, 0>()
        - eval_operands_input_pc_update_jnz);
