...
pub fn decode_instruction_11364_evaluate(
    ...
    let decode_instruction_11364_input_pc = input;

    // Constraint - Flag op0_base_fp is a bit
    let constraint_quotient = ((op0_base_fp_col2
        * (qm31_const::<1, 0, 0, 0>() - op0_base_fp_col2)));
    ...
    verify_instruction_sum_0 = common_lookup_elements
        .combine_qm31(
            [
                qm31_const::<1719106205, 0, 0, 0>(), decode_instruction_11364_input_pc,
