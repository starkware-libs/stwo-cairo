...
pub fn cond_felt_252_as_rel_imm_evaluate(
    ...
    let [
        ...
        input;
    let [
        decode_small_sign_output_tmp_1e9bf_2_limb_0,
        decode_small_sign_output_tmp_1e9bf_2_limb_1,
        decode_small_sign_output_tmp_1e9bf_2_limb_2,
        decode_small_sign_output_tmp_1e9bf_2_limb_3,
    ] =
    ...
    let constraint_quotient = ((cond_felt_252_as_rel_imm_input_limb_28
        * (((((((((((((((((cond_felt_252_as_rel_imm_input_limb_4
            ...
            + cond_felt_252_as_rel_imm_input_limb_19)
            + cond_felt_252_as_rel_imm_input_limb_20)
            - (decode_small_sign_output_tmp_1e9bf_2_limb_1 * qm31_const::<17, 0, 0, 0>()))))
        * domain_vanishing_eval_inv;
    sum = sum * random_coeff + constraint_quotient;

    // Constraint - When the condition holds, limb 21 must be 0x0, 0x88 or 0x87
    let constraint_quotient = ((cond_felt_252_as_rel_imm_input_limb_28
        * (cond_felt_252_as_rel_imm_input_limb_21 - decode_small_sign_output_tmp_1e9bf_2_limb_2)))
        * domain_vanishing_eval_inv;
    sum = sum * random_coeff + constraint_quotient;
    ...
    let constraint_quotient = ((cond_felt_252_as_rel_imm_input_limb_28
        * (cond_felt_252_as_rel_imm_input_limb_27 - decode_small_sign_output_tmp_1e9bf_2_limb_3)))
        * domain_vanishing_eval_inv;
    sum = sum * random_coeff + constraint_quotient;
    ...
    (((((cond_felt_252_as_rel_imm_input_limb_0
        ...
        - (decode_small_sign_output_tmp_1e9bf_2_limb_3 * qm31_const::<8388608, 0, 0, 0>()))
        - (qm31_const::<536870912, 0, 0, 0>()
            * (decode_small_sign_output_tmp_1e9bf_2_limb_1 * qm31_const::<142885409, 0, 0, 0>())))
}
