...
pub fn linear_combination_n_4_coefs_3_1_1_1_evaluate(
    ...
    let [
        ...
        input;
    let carry_0_tmp_923fe_2: QM31 = (((((((qm31_const::<3, 0, 0, 0>()
        * linear_combination_n_4_coefs_3_1_1_1_input_limb_0)
        + linear_combination_n_4_coefs_3_1_1_1_input_limb_10)
        + linear_combination_n_4_coefs_3_1_1_1_input_limb_20)
        + linear_combination_n_4_coefs_3_1_1_1_input_limb_30)
        ...
        - p_coef_col10)
        * qm31_const::<16, 0, 0, 0>());
    let carry_1_tmp_923fe_3: QM31 = ((((((carry_0_tmp_923fe_2
        ...
        * qm31_const::<16, 0, 0, 0>());
    let carry_2_tmp_923fe_4: QM31 = ((((((carry_1_tmp_923fe_3
        ...
        * qm31_const::<16, 0, 0, 0>());
    let carry_3_tmp_923fe_5: QM31 = ((((((carry_2_tmp_923fe_4
        ...
        * qm31_const::<16, 0, 0, 0>());
    let carry_4_tmp_923fe_6: QM31 = ((((((carry_3_tmp_923fe_5
        ...
        * qm31_const::<16, 0, 0, 0>());
    let carry_5_tmp_923fe_7: QM31 = ((((((carry_4_tmp_923fe_6
        ...
        * qm31_const::<16, 0, 0, 0>());
    let carry_6_tmp_923fe_8: QM31 = ((((((carry_5_tmp_923fe_7
        ...
        * qm31_const::<16, 0, 0, 0>());
    let carry_7_tmp_923fe_9: QM31 = (((((((carry_6_tmp_923fe_8
        ...
        * qm31_const::<16, 0, 0, 0>());
    let carry_8_tmp_923fe_10: QM31 = ((((((carry_7_tmp_923fe_9
    ...
    let constraint_quotient = (((((((carry_8_tmp_923fe_10
    ...
    range_check_3_3_3_3_3_sum_0 = common_lookup_elements
        .combine_qm31(
            [
                qm31_const::<502259093, 0, 0, 0>(), (p_coef_col10 + qm31_const::<1, 0, 0, 0>()),
                (carry_0_tmp_923fe_2 + qm31_const::<1, 0, 0, 0>()),
                (carry_1_tmp_923fe_3 + qm31_const::<1, 0, 0, 0>()),
                (carry_2_tmp_923fe_4 + qm31_const::<1, 0, 0, 0>()),
                (carry_3_tmp_923fe_5 + qm31_const::<1, 0, 0, 0>()),
            ]
                .span(),
        );
    ...
    range_check_3_3_3_3_3_sum_1 = common_lookup_elements
        .combine_qm31(
            [
                ...
                (carry_4_tmp_923fe_6 + qm31_const::<1, 0, 0, 0>()),
                (carry_5_tmp_923fe_7 + qm31_const::<1, 0, 0, 0>()),
                (carry_6_tmp_923fe_8 + qm31_const::<1, 0, 0, 0>()),
                (carry_7_tmp_923fe_9 + qm31_const::<1, 0, 0, 0>()),
                (carry_8_tmp_923fe_10 + qm31_const::<1, 0, 0, 0>()),
            ]
                .span(),
        );
