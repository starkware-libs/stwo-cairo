...
pub fn decode_instruction_89ffb_evaluate(
    input: QM31,
    offset2_col0: QM31,
    op1_imm_col1: QM31,
    ...
    let decode_instruction_89ffb_input_pc = input;
    ...
    sum = sum * random_coeff + constraint_quotient;
    let op1_base_ap_tmp_89ffb_5: QM31 = ((qm31_const::<1, 0, 0, 0>() - op1_imm_col1)
        - op1_base_fp_col2);

    // Constraint - Flag op1_base_ap is a bit
    let constraint_quotient = ((op1_base_ap_tmp_89ffb_5
        * (qm31_const::<1, 0, 0, 0>() - op1_base_ap_tmp_89ffb_5)));
    sum = sum * random_coeff + constraint_quotient;

    verify_instruction_sum_0 = common_lookup_elements
        .combine_qm31(
            [
                qm31_const::<1719106205, 0, 0, 0>(), decode_instruction_89ffb_input_pc,
                ...
                (((qm31_const::<24, 0, 0, 0>() + (op1_imm_col1 * qm31_const::<32, 0, 0, 0>()))
                    ...
                    + (op1_base_ap_tmp_89ffb_5 * qm31_const::<128, 0, 0, 0>())),
    ...
    [(offset2_col0 - qm31_const::<32768, 0, 0, 0>()), op1_base_ap_tmp_89ffb_5]
}
