...
pub fn decode_instruction_64420_evaluate(
    ...
    let decode_instruction_64420_input = input;
    ...
    let constraint_quotient = ((op1_base_ap_col6 * (qm31_const::<1, 0, 0, 0>() - op1_base_ap_col6)))
        * domain_vanishing_eval_inv;
    sum = sum * random_coeff + constraint_quotient;
    ...
    verify_instruction_sum_0 =
        verify_instruction_sum(
            ...
            [
                decode_instruction_64420_input, offset0_col0, offset1_col1, offset2_col2,
                ((((dst_base_fp_col3 * qm31_const::<8, 0, 0, 0>())
                    + (op0_base_fp_col4 * qm31_const::<16, 0, 0, 0>()))
                    + (op1_base_fp_col5 * qm31_const::<64, 0, 0, 0>()))
                    + (op1_base_ap_col6 * qm31_const::<128, 0, 0, 0>())),
                (ap_update_add_1_col7 * qm31_const::<32, 0, 0, 0>()), opcode_extension_col8,
            ],
        );
    ...
    [
        ...
        qm31_const::<0, 0, 0, 0>(), op1_base_fp_col5, op1_base_ap_col6, qm31_const::<0, 0, 0, 0>(),
        qm31_const::<0, 0, 0, 0>(), qm31_const::<0, 0, 0, 0>(), qm31_const::<0, 0, 0, 0>(),
        qm31_const::<0, 0, 0, 0>(), qm31_const::<0, 0, 0, 0>(), ap_update_add_1_col7,
        qm31_const::<0, 0, 0, 0>(), qm31_const::<0, 0, 0, 0>(), qm31_const::<0, 0, 0, 0>(),
