...
pub fn decode_instruction_a1c8b_evaluate(
    input: QM31,
    offset0_col0: QM31,
    offset1_col1: QM31,
    offset2_col2: QM31,
    ...
    let decode_instruction_a1c8b_input_pc = input;
    ...
    let constraint_quotient = ((op1_base_ap_col7
        * (qm31_const::<1, 0, 0, 0>() - op1_base_ap_col7)));
    sum = sum * random_coeff + constraint_quotient;
    ...
    let constraint_quotient = ((opcode_ret_col16
        * (qm31_const::<1, 0, 0, 0>() - opcode_ret_col16)));
    sum = sum * random_coeff + constraint_quotient;
    ...
    verify_instruction_sum_0 = common_lookup_elements
        .combine_qm31(
            [
                qm31_const::<1719106205, 0, 0, 0>(), decode_instruction_a1c8b_input_pc,
