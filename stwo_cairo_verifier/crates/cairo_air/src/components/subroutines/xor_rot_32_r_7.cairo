...
let xor_rot_7_output_tmp_e97b9_16_limb_0: QM31 = (xor_col5 + (xor_col6 * qm31_const::<512, 0, 0, 0>()));
let xor_rot_7_output_tmp_e97b9_16_limb_1: QM31 = (xor_col7 + (xor_col4 * qm31_const::<512, 0, 0, 0>()));
