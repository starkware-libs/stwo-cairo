...
pub fn decode_instruction_fe864_evaluate(
    ...
    let decode_instruction_fe864_input = input;
    ...
    verify_instruction_sum_0 =
        verify_instruction_sum(
            ...
            [
                decode_instruction_fe864_input, offset0_col0, qm31_const::<32767, 0, 0, 0>(),
                offset2_col1,
    ...
    [
        ...
        (offset2_col1 - qm31_const::<32768, 0, 0, 0>()), dst_base_fp_col2,
        qm31_const::<1, 0, 0, 0>(), qm31_const::<0, 0, 0, 0>(), op1_base_fp_col3,
        (qm31_const::<1, 0, 0, 0>() - op1_base_fp_col3), qm31_const::<0, 0, 0, 0>(),
        qm31_const::<0, 0, 0, 0>(), qm31_const::<0, 0, 0, 0>(), qm31_const::<0, 0, 0, 0>(),
        qm31_const::<0, 0, 0, 0>(), qm31_const::<0, 0, 0, 0>(), ap_update_add_1_col4,
