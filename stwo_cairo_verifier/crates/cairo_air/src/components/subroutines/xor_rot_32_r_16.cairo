...
let xor_rot_16_output_tmp_813a9_16_limb_0: QM31 = (xor_col6 + (xor_col7 * qm31_const::<256, 0, 0, 0>()));
let xor_rot_16_output_tmp_813a9_16_limb_1: QM31 = (xor_col4 + (xor_col5 * qm31_const::<256, 0, 0, 0>()));
