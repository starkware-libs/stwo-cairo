...
pub fn decode_instruction_df7a6_evaluate(
    ...
    let decode_instruction_df7a6_input = input;
    ...
    verify_instruction_sum_0 =
        verify_instruction_sum(
            ...
            [
                decode_instruction_df7a6_input, offset0_col0, offset1_col1, offset2_col2,
    ...
    [
        ...
        op1_imm_col5, op1_base_fp_col6, op1_base_ap_col7, res_add_col8, res_mul_col9,
        pc_update_jump_col10, pc_update_jump_rel_col11, pc_update_jnz_col12, ap_update_add_col13,
        ap_update_add_1_col14, opcode_call_col15, opcode_ret_col16, opcode_assert_eq_col17,
        qm31_const::<0, 0, 0, 0>(),
    ]
}
