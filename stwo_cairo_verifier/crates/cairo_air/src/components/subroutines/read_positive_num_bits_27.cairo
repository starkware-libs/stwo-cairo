...
use crate::components::subroutines::read_positive_known_id_num_bits_27::read_positive_known_id_num_bits_27_evaluate;
use crate::prelude::*;
...
pub fn read_positive_num_bits_27_evaluate(
    ...
    read_positive_known_id_num_bits_27_evaluate(
        id_col0,
        value_limb_0_col1,
        value_limb_1_col2,
        value_limb_2_col3,
