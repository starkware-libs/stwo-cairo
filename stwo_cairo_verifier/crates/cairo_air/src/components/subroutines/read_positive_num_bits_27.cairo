...
pub fn read_positive_num_bits_27_evaluate(
    ...
    memory_address_to_id_sum_0 =
        memory_address_to_id_sum(
            ...
            [read_positive_num_bits_27_input, id_col0],
        );
    ...
    memory_id_to_big_sum_1 =
        memory_id_to_big_sum(
            ...
            memory_id_to_big_z,
            [
                id_col0, value_limb_0_col1, value_limb_1_col2, value_limb_2_col3,
    ...
    [
        value_limb_0_col1, value_limb_1_col2, value_limb_2_col3, qm31_const::<0, 0, 0, 0>(),
        qm31_const::<0, 0, 0, 0>(), qm31_const::<0, 0, 0, 0>(), qm31_const::<0, 0, 0, 0>(),
        qm31_const::<0, 0, 0, 0>(), qm31_const::<0, 0, 0, 0>(), qm31_const::<0, 0, 0, 0>(),
        qm31_const::<0, 0, 0, 0>(), qm31_const::<0, 0, 0, 0>(), qm31_const::<0, 0, 0, 0>(),
        qm31_const::<0, 0, 0, 0>(), qm31_const::<0, 0, 0, 0>(), qm31_const::<0, 0, 0, 0>(),
