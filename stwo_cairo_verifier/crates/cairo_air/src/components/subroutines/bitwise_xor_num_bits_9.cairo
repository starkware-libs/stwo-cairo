...
pub fn bitwise_xor_num_bits_9_evaluate(
    input: [QM31; 2],
    xor_col0: QM31,verify_bitwise_xor_9_lookup_elements: @crate::VerifyBitwiseXor_9Elements,ref verify_bitwise_xor_9_sum_0: QM31,
    ref sum: QM31,
    ...
    verify_bitwise_xor_9_sum_0 = verify_bitwise_xor_9_lookup_elements.combine_qm31(
        [
