...
let [mem1_base_limb_0_col12]: [QM31; 1] = (*mem1_base_limb_0_col12.try_into().unwrap()).unbox();
let [mem1_base_limb_1_col13]: [QM31; 1] = (*mem1_base_limb_1_col13.try_into().unwrap()).unbox();
let [mem1_base_limb_2_col14]: [QM31; 1] = (*mem1_base_limb_2_col14.try_into().unwrap()).unbox();
...
random_coeff
        ...
        let [decode_instruction_cb32b_output_tmp_b1151_8_offset0, decode_instruction_cb32b_output_tmp_b1151_8_offset1, decode_instruction_cb32b_output_tmp_b1151_8_offset2] = output;
