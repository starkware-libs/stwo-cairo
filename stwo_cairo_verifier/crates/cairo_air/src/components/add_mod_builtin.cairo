...
pub impl ClaimImpl of ClaimTrait {
    fn log_sizes(self: @Claim) -> TreeArray<Span<u32>> {
        ...
        let trace_log_sizes = ArrayImpl::new_repeated(251, log_size).span();
...
pub impl CairoComponentImpl of CairoComponent<Component> {
    ...
    fn evaluate_constraints_at_point(
        ...
        let add_mod_builtin_segment_start = (*self.claim.add_mod_builtin_segment_start).into();
        ...
        let params = constraints::ConstraintParams {
            ...
            MemoryIdToBig_z,
            claimed_sum,
            builtin_segment_start: add_mod_builtin_segment_start,
            seq,
        };
