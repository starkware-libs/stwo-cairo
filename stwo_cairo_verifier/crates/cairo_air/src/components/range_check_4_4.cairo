...
pub impl CairoComponentImpl of CairoComponent<Component> {
    fn evaluate_constraints_at_point(
        ...
        let range_check_4_4_column_0 = preprocessed_mask_values
            .get_and_mark_used(RANGE_CHECK_4_4_COLUMN_0_IDX);
        let range_check_4_4_column_1 = preprocessed_mask_values
            .get_and_mark_used(RANGE_CHECK_4_4_COLUMN_1_IDX);

        let [range_check_4_4_multiplicity]: [Span<QM31>; 1] = (*trace_mask_values
            .multi_pop_front()
            .unwrap())
            .unbox();
        let [range_check_4_4_multiplicity]: [QM31; 1] = (*range_check_4_4_multiplicity
            .try_into()
            .unwrap())
            .unbox();
        ...
        range_check_4_4_sum_0 = self
            ...
            .combine_qm31(
                [
                    qm31_const::<1651211826, 0, 0, 0>(), range_check_4_4_column_0,
...
fn lookup_constraints(
    ...
    random_coeff: QM31,
    claimed_sum: QM31,
    range_check_4_4_multiplicity: QM31,
    column_size: M31,
    ref interaction_trace_mask_values: ColumnSpan<Span<QM31>>,
...
mod tests {
    ...
    fn test_evaluation_result() {
        ...
        let mut preprocessed_trace = preprocessed_mask_add(
            preprocessed_trace,
            RANGE_CHECK_4_4_COLUMN_0_IDX,
            qm31_const::<1928260429, 15680291, 139619331, 637239059>(),
        );
        let mut preprocessed_trace = preprocessed_mask_add(
            preprocessed_trace,
            RANGE_CHECK_4_4_COLUMN_1_IDX,
            qm31_const::<1861151250, 2028946210, 72510466, 637239059>(),
        );
        ...
        assert_eq!(sum, QM31Trait::from_fixed_array(RANGE_CHECK_4_4_SAMPLE_EVAL_RESULT))
    }
}
