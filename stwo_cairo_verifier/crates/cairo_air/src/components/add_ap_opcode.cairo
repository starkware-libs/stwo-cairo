...
let mut opcodes_sum_4: QM31 = Zero::zero();
        ...
        let [input_pc_col0, input_ap_col1, input_fp_col2, offset2_col3, op1_imm_col4, op1_base_fp_col5, mem1_base_col6, op1_id_col7, msb_col8, mid_limbs_set_col9, op1_limb_0_col10, op1_limb_1_col11, op1_limb_2_col12, enabler]: [Span<QM31>; 14]
...
(input_ap_col1 + read_small_output_tmp_c921e_11_limb_0),
input_fp_col2
            ],
        );
