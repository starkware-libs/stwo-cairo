...
use crate::components::subroutines::range_check_27::range_check_27_evaluate;
...
pub impl ComponentImpl of CairoComponent<Component> {
    ...
    fn evaluate_constraints_at_point(
        ...
        let [rangecheck27_bot8bits_col13]: [QM31; 1] = (*rangecheck27_bot8bits_col13
            .try_into()
            .unwrap())
            .unbox();
