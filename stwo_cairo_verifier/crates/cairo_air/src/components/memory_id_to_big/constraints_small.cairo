...
pub fn evaluate_constraints_at_point(
    ...
    // let [trace_2_column_17_offset_0]: [QM31; 1] =
    // (*trace_2_column_17.try_into().unwrap()).unbox();

    // let [trace_2_column_18_offset_0]: [QM31; 1] =
    // (*trace_2_column_18.try_into().unwrap()).unbox();

    // let [trace_2_column_19_offset_0]: [QM31; 1] =
    // (*trace_2_column_19.try_into().unwrap()).unbox();

    // let [trace_2_column_20_offset_0]: [QM31; 1] =
    // (*trace_2_column_20.try_into().unwrap()).unbox();

    // let [trace_2_column_21_offset_0]: [QM31; 1] =
    // (*trace_2_column_21.try_into().unwrap()).unbox();

    // let [trace_2_column_22_offset_0]: [QM31; 1] =
    // (*trace_2_column_22.try_into().unwrap()).unbox();

    // let [trace_2_column_23_offset_0]: [QM31; 1] =
    // (*trace_2_column_23.try_into().unwrap()).unbox();

    // let [trace_2_column_24_offset_0]: [QM31; 1] =
    // (*trace_2_column_24.try_into().unwrap()).unbox();
