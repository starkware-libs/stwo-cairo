...
const SOME_COLUMN: PreprocessedColumn = PreprocessedColumn::RangeCheck1(([2], 0));
...
pub impl CairoComponentImpl of CairoComponent<Component> {
    fn mask_points(
        ...
        preprocessed_column_set.insert(PreprocessedColumn::RangeCheck1(([2], 0)));
    ...
    fn evaluate_constraints_at_point(
        ...
        let mut range_check_2_sum_0: QM31 = Zero::zero();
        let seq = preprocessed_mask_values.get(PreprocessedColumn::RangeCheck1(([2], 0)));
        ...
        range_check_2_sum_0 = self.range_check_2_lookup_elements.combine_qm31([seq]);
