...
fn lookup_constraints(
    ...
    let [trace_2_col128_neg1, trace_2_col128]: [QM31; N_SAMPLES_FOR_PREFIX_SUM] = (*trace_2_col128
        .try_into()
        .unwrap())
        .unbox();
    let [trace_2_col129_neg1, trace_2_col129]: [QM31; N_SAMPLES_FOR_PREFIX_SUM] = (*trace_2_col129
        .try_into()
        .unwrap())
        .unbox();
    let [trace_2_col130_neg1, trace_2_col130]: [QM31; N_SAMPLES_FOR_PREFIX_SUM] = (*trace_2_col130
        .try_into()
        .unwrap())
        .unbox();
    let [trace_2_col131_neg1, trace_2_col131]: [QM31; N_SAMPLES_FOR_PREFIX_SUM] = (*trace_2_col131
        .try_into()
        .unwrap())
        .unbox();
