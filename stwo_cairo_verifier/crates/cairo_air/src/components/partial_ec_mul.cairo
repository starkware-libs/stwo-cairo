...
fn lookup_constraints(
    ...
    let [trace_2_col424_neg1, trace_2_col424]: [QM31; N_SAMPLES_FOR_PREFIX_SUM] = (*trace_2_col424
        .try_into()
        .unwrap())
        .unbox();
    let [trace_2_col425_neg1, trace_2_col425]: [QM31; N_SAMPLES_FOR_PREFIX_SUM] = (*trace_2_col425
        .try_into()
        .unwrap())
        .unbox();
    let [trace_2_col426_neg1, trace_2_col426]: [QM31; N_SAMPLES_FOR_PREFIX_SUM] = (*trace_2_col426
        .try_into()
        .unwrap())
        .unbox();
    let [trace_2_col427_neg1, trace_2_col427]: [QM31; N_SAMPLES_FOR_PREFIX_SUM] = (*trace_2_col427
        .try_into()
        .unwrap())
        .unbox();
