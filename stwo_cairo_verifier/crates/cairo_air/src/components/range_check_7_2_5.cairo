...
pub const N_TRACE_COLUMNS: usize = 1;const SOME_COLUMN: PreprocessedColumn = PreprocessedColumn::RangeCheck3(([7,2,5], 0));
...
pub impl ComponentImpl of CairoComponent<Component> {
    fn mask_points(
        ...
        preprocessed_column_set.insert(PreprocessedColumn::RangeCheck3(([7,2,5], 0)));preprocessed_column_set.insert(PreprocessedColumn::RangeCheck3(([7,2,5], 1)));preprocessed_column_set.insert(PreprocessedColumn::RangeCheck3(([7,2,5], 2)));trace_mask_points.append(array![point]);interaction_trace_mask_points.append(array![point_offset_neg_1, point]);
    ...
    fn evaluate_constraints_at_point(
        ...
        let mut range_check_7_2_5_sum_0: QM31 = Zero::zero();let rangecheck_7_2_5_0
            = preprocessed_mask_values.get(PreprocessedColumn::RangeCheck3(([7,2,5], 0)));
        let rangecheck_7_2_5_1
            = preprocessed_mask_values.get(PreprocessedColumn::RangeCheck3(([7,2,5], 1)));
        let rangecheck_7_2_5_2
            = preprocessed_mask_values.get(PreprocessedColumn::RangeCheck3(([7,2,5], 2)));
        ...
        range_check_7_2_5_sum_0 = self.range_check_7_2_5_lookup_elements.combine_qm31(
            [
                rangecheck_7_2_5_0,
rangecheck_7_2_5_1,
rangecheck_7_2_5_2
