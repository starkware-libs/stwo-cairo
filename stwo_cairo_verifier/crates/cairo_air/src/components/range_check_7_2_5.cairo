...
pub impl CairoComponentImpl of CairoComponent<Component> {
    fn mask_points(
        ...
        preprocessed_column_set.insert(RANGE_CHECK_3_7_2_5_0_IDX);
        preprocessed_column_set.insert(RANGE_CHECK_3_7_2_5_1_IDX);
        preprocessed_column_set.insert(RANGE_CHECK_3_7_2_5_2_IDX);
    ...
    fn evaluate_constraints_at_point(
        ...
        let rangecheck_7_2_5_0 = preprocessed_mask_values.get(RANGE_CHECK_3_7_2_5_0_IDX);
        let rangecheck_7_2_5_1 = preprocessed_mask_values.get(RANGE_CHECK_3_7_2_5_1_IDX);
        let rangecheck_7_2_5_2 = preprocessed_mask_values.get(RANGE_CHECK_3_7_2_5_2_IDX);
