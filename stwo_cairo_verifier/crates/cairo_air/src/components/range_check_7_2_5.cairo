...
use crate::components::{
    CairoComponent, OPCODES_RELATION_SIZE, RANGE_CHECK_7_2_5_LOG_SIZE, opcodes_sum,
};
...
//         let range_check_7_2_5_alphas =
//         self.range_check_7_2_5_lookup_elements.alpha_powers.span();
...
//         range_check_7_2_5_sum_0 = range_check_7_2_5_sum(
