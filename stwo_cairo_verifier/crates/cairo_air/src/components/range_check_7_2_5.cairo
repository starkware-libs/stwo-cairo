...
pub impl CairoComponentImpl of CairoComponent<Component> {
    fn evaluate_constraints_at_point(
        ...
        let range_check_7_2_5_column_0 = preprocessed_mask_values
            .get_and_mark_used(RANGE_CHECK_7_2_5_COLUMN_0_IDX);
        let range_check_7_2_5_column_1 = preprocessed_mask_values
            .get_and_mark_used(RANGE_CHECK_7_2_5_COLUMN_1_IDX);
        let range_check_7_2_5_column_2 = preprocessed_mask_values
            .get_and_mark_used(RANGE_CHECK_7_2_5_COLUMN_2_IDX);

        let [range_check_7_2_5_multiplicity]: [Span<QM31>; 1] = (*trace_mask_values
            .multi_pop_front()
            .unwrap())
            .unbox();
        let [range_check_7_2_5_multiplicity]: [QM31; 1] = (*range_check_7_2_5_multiplicity
            .try_into()
            .unwrap())
            .unbox();
        ...
        range_check_7_2_5_sum_0 = self
            ...
            .combine_qm31(
                [
                    qm31_const::<371240602, 0, 0, 0>(), range_check_7_2_5_column_0,
                    range_check_7_2_5_column_1, range_check_7_2_5_column_2,
                ]
                    .span(),
            );
...
mod tests {
    ...
    fn test_evaluation_result() {
        ...
        let mut preprocessed_trace = preprocessed_mask_add(
            preprocessed_trace,
            RANGE_CHECK_7_2_5_COLUMN_0_IDX,
            qm31_const::<511731811, 1003307901, 686287373, 2115861185>(),
        );
        let mut preprocessed_trace = preprocessed_mask_add(
            preprocessed_trace,
            RANGE_CHECK_7_2_5_COLUMN_1_IDX,
            qm31_const::<578840990, 1137525629, 753396237, 2115861185>(),
        );
        let mut preprocessed_trace = preprocessed_mask_add(
            preprocessed_trace,
            RANGE_CHECK_7_2_5_COLUMN_2_IDX,
            qm31_const::<377513453, 734872445, 552069645, 2115861185>(),
        );
        ...
        assert_eq!(sum, QM31Trait::from_fixed_array(RANGE_CHECK_7_2_5_SAMPLE_EVAL_RESULT))
    }
}
