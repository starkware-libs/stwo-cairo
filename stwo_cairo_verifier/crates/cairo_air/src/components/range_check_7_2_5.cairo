...
pub impl CairoComponentImpl of CairoComponent<Component> {
    fn mask_points(
        ...
        preprocessed_column_set.insert(RANGE_CHECK_7_2_5_COLUMN_0_IDX);
        preprocessed_column_set.insert(RANGE_CHECK_7_2_5_COLUMN_1_IDX);
        preprocessed_column_set.insert(RANGE_CHECK_7_2_5_COLUMN_2_IDX);
    ...
    fn evaluate_constraints_at_point(
        ...
        range_check_7_2_5_sum_0 = self
            ...
            .combine_qm31(
                [
                    range_check_7_2_5_column_0, range_check_7_2_5_column_1,
