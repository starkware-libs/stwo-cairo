...
use crate::components::{
    CairoComponent, OPCODES_RELATION_SIZE, VERIFY_BITWISE_XOR_8_LOG_SIZE, opcodes_sum,
};
...
pub impl ComponentImpl of CairoComponent<Component> {
    ...
    fn evaluate_constraints_at_point(
        ...
        verify_bitwise_xor_8_sum_0 =
            verify_bitwise_xor_8_sum(
                verify_bitwise_xor_8_alphas,
                verify_bitwise_xor_8_z,
                [bitwisexor_8_0, bitwisexor_8_1, bitwisexor_8_2],
            );
...
pub fn verify_bitwise_xor_8_sum(mut alphas: Span<QM31>, z: QM31, values: [QM31; 3]) -> QM31 {
