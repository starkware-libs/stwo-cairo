...
use crate::PreprocessedColumnTrait;use crate::components::subroutines::decode_instruction_9bd86::decode_instruction_9bd86_evaluate;use crate::components::subroutines::read_positive_num_bits_27::read_positive_num_bits_27_evaluate;
...
random_coeff
            ...
            (((mem1_base_limb_0_col9 + (mem1_base_limb_1_col10 * qm31_const::<512, 0, 0, 0>())) + (mem1_base_limb_2_col11 * qm31_const::<262144, 0, 0, 0>())) + decode_instruction_9bd86_output_tmp_22134_6_offset2),
next_pc_id_col12,
...
input_fp_col2
        ...
        opcodes_sum_6 = self.opcodes_lookup_elements.combine_qm31(
            [
                ((next_pc_limb_0_col13 + (next_pc_limb_1_col14 * qm31_const::<512, 0, 0, 0>())) + (next_pc_limb_2_col15 * qm31_const::<262144, 0, 0, 0>())),
