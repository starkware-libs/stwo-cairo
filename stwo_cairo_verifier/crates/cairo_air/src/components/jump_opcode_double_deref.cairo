...
let [mem1_base_limb_0_col9]: [QM31; 1] = (*mem1_base_limb_0_col9.try_into().unwrap()).unbox();
let [mem1_base_limb_1_col10]: [QM31; 1] = (*mem1_base_limb_1_col10.try_into().unwrap()).unbox();
let [mem1_base_limb_2_col11]: [QM31; 1] = (*mem1_base_limb_2_col11.try_into().unwrap()).unbox();
...
random_coeff
        ...
        let [decode_instruction_9bd86_output_tmp_22134_6_offset1, decode_instruction_9bd86_output_tmp_22134_6_offset2] = output;
