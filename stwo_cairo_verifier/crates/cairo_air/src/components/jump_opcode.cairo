...
let mut opcodes_sum_4: QM31 = Zero::zero();
        ...
        let [input_pc_col0, input_ap_col1, input_fp_col2, offset2_col3, op1_base_fp_col4, op1_base_ap_col5, ap_update_add_1_col6, mem1_base_col7, next_pc_id_col8, next_pc_limb_0_col9, next_pc_limb_1_col10, next_pc_limb_2_col11, enabler]: [Span<QM31>; 13]
...
input_fp_col2
        ...
        opcodes_sum_4 = self.opcodes_lookup_elements.combine_qm31(
            [
                ((next_pc_limb_0_col9 + (next_pc_limb_1_col10 * qm31_const::<512, 0, 0, 0>())) + (next_pc_limb_2_col11 * qm31_const::<262144, 0, 0, 0>())),
