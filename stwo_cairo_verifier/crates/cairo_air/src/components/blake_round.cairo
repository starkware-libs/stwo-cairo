...
use crate::components::blake_g::{BLAKE_G_RELATION_SIZE, blake_g_sum};
use crate::components::blake_round_sigma::{BLAKE_ROUND_SIGMA_RELATION_SIZE, blake_round_sigma_sum};
...
pub impl ComponentImpl of CairoComponent<Component> {
    ...
    fn evaluate_constraints_at_point(
        ...
        let blake_round_sigma_alphas = self.blake_round_sigma_lookup_elements.alpha_powers.span();
        let blake_round_sigma_z = *self.blake_round_sigma_lookup_elements.z;
        ...
        let blake_g_alphas = self.blake_g_lookup_elements.alpha_powers.span();
        let blake_g_z = *self.blake_g_lookup_elements.z;
        ...
        blake_round_sigma_sum_0 =
            blake_round_sigma_sum(
                blake_round_sigma_alphas,
                blake_round_sigma_z,
                [
        ...
        let [
            read_blake_word_output_tmp_92ff8_18_limb_0, read_blake_word_output_tmp_92ff8_18_limb_1,
        ] =
            output;
        ...
        let [
            read_blake_word_output_tmp_92ff8_27_limb_0, read_blake_word_output_tmp_92ff8_27_limb_1,
        ] =
            output;
        ...
        let [
            read_blake_word_output_tmp_92ff8_36_limb_0, read_blake_word_output_tmp_92ff8_36_limb_1,
        ] =
            output;
        ...
        let [
            read_blake_word_output_tmp_92ff8_45_limb_0, read_blake_word_output_tmp_92ff8_45_limb_1,
        ] =
            output;
        ...
        let [
            read_blake_word_output_tmp_92ff8_54_limb_0, read_blake_word_output_tmp_92ff8_54_limb_1,
        ] =
            output;
        ...
        let [
            read_blake_word_output_tmp_92ff8_63_limb_0, read_blake_word_output_tmp_92ff8_63_limb_1,
        ] =
            output;
        ...
        let [
            read_blake_word_output_tmp_92ff8_72_limb_0, read_blake_word_output_tmp_92ff8_72_limb_1,
        ] =
            output;
        ...
        let [
            read_blake_word_output_tmp_92ff8_81_limb_0, read_blake_word_output_tmp_92ff8_81_limb_1,
        ] =
            output;
        ...
        let [
            read_blake_word_output_tmp_92ff8_90_limb_0, read_blake_word_output_tmp_92ff8_90_limb_1,
        ] =
            output;
        ...
        let [
            read_blake_word_output_tmp_92ff8_99_limb_0, read_blake_word_output_tmp_92ff8_99_limb_1,
        ] =
            output;
...
pub fn blake_round_sum(mut alphas: Span<QM31>, z: QM31, values: [QM31; 35]) -> QM31 {
    let [
        alpha0,
        alpha1,
        alpha2,
