...
fn intermediates(
    ...
    let intermediate8 = intermediate8(trace_1_column_13_offset_0, trace_1_column_15_offset_0);

    let intermediate9 = intermediate9(trace_1_column_17_offset_0, trace_1_column_19_offset_0);
...
pub fn intermediate8(trace_1_column_13_offset_0: QM31, trace_1_column_15_offset_0: QM31) -> QM31 {
    trace_1_column_13_offset_0 + (trace_1_column_15_offset_0) * (m31(256).into())
}

pub fn intermediate9(trace_1_column_17_offset_0: QM31, trace_1_column_19_offset_0: QM31) -> QM31 {
...
pub fn intermediate10(
    ...
    (TripleXor32_alpha0) * (trace_1_column_0_offset_0)
        ...
        + (TripleXor32_alpha3) * (trace_1_column_3_offset_0)
        + (TripleXor32_alpha4) * (trace_1_column_4_offset_0)
        + (TripleXor32_alpha5) * (trace_1_column_5_offset_0)
        + (TripleXor32_alpha6) * (intermediate8)
        + (TripleXor32_alpha7) * (intermediate9)
        - (TripleXor32_z)
}
