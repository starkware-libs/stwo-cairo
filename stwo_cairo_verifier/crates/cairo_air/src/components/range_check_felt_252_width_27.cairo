...
fn lookup_constraints(
    ...
    let [trace_2_col28_neg1, trace_2_col28]: [QM31; N_SAMPLES_FOR_PREFIX_SUM] = (*trace_2_col28
        .try_into()
        .unwrap())
        .unbox();
    let [trace_2_col29_neg1, trace_2_col29]: [QM31; N_SAMPLES_FOR_PREFIX_SUM] = (*trace_2_col29
        .try_into()
        .unwrap())
        .unbox();
    let [trace_2_col30_neg1, trace_2_col30]: [QM31; N_SAMPLES_FOR_PREFIX_SUM] = (*trace_2_col30
        .try_into()
        .unwrap())
        .unbox();
    let [trace_2_col31_neg1, trace_2_col31]: [QM31; N_SAMPLES_FOR_PREFIX_SUM] = (*trace_2_col31
        .try_into()
        .unwrap())
        .unbox();
