...
pub const RANGE_CHECK_FELT_252_WIDTH_27_RELATION_SIZE: usize = 10;
...
let [limb_0_high_part_col10]: [QM31; 1] = (*limb_0_high_part_col10.try_into().unwrap()).unbox();
let [limb_1_low_part_col11]: [QM31; 1] = (*limb_1_low_part_col11.try_into().unwrap()).unbox();
let [limb_2_high_part_col12]: [QM31; 1] = (*limb_2_high_part_col12.try_into().unwrap()).unbox();
let [limb_3_low_part_col13]: [QM31; 1] = (*limb_3_low_part_col13.try_into().unwrap()).unbox();
let [limb_4_high_part_col14]: [QM31; 1] = (*limb_4_high_part_col14.try_into().unwrap()).unbox();
let [limb_5_low_part_col15]: [QM31; 1] = (*limb_5_low_part_col15.try_into().unwrap()).unbox();
let [limb_6_high_part_col16]: [QM31; 1] = (*limb_6_high_part_col16.try_into().unwrap()).unbox();
let [limb_7_low_part_col17]: [QM31; 1] = (*limb_7_low_part_col17.try_into().unwrap()).unbox();
let [limb_8_high_part_col18]: [QM31; 1] = (*limb_8_high_part_col18.try_into().unwrap()).unbox();
...
limb_1_low_part_col11
        ...
        range_check_9_9_sum_3 = self.range_check_9_9_lookup_elements.combine_qm31(
            [
...
limb_3_low_part_col13
        ...
        range_check_18_sum_4 = self.range_check_18_lookup_elements.combine_qm31(
            [
        ...
        range_check_9_9_sum_6 = self.range_check_9_9_lookup_elements.combine_qm31(
            [
...
limb_5_low_part_col15
        ...
        range_check_9_9_sum_9 = self.range_check_9_9_lookup_elements.combine_qm31(
            [
...
limb_7_low_part_col17
        ...
        range_check_18_sum_10 = self.range_check_18_lookup_elements.combine_qm31(
            [
        ...
        range_check_9_9_sum_12 = self.range_check_9_9_lookup_elements.combine_qm31(
            [
        ...
        (
            (
                QM31Impl::from_partial_evals([trace_2_col4, trace_2_col5, trace_2_col6, trace_2_col7]) 
                    - QM31Impl::from_partial_evals([trace_2_col0, trace_2_col1, trace_2_col2, trace_2_col3])
            ) * range_check_18_sum_2 * range_check_9_9_sum_3
        ) - range_check_18_sum_2 - range_check_9_9_sum_3
    ) * domain_vanishing_eval_inv;
sum = sum * random_coeff + constraint_quotient;
        ...
        (
            (
                QM31Impl::from_partial_evals([trace_2_col8, trace_2_col9, trace_2_col10, trace_2_col11]) 
                    - QM31Impl::from_partial_evals([trace_2_col4, trace_2_col5, trace_2_col6, trace_2_col7])
            ) * range_check_18_sum_4 * range_check_18_sum_5
        ) - range_check_18_sum_4 - range_check_18_sum_5
    ) * domain_vanishing_eval_inv;
sum = sum * random_coeff + constraint_quotient;
        ...
        (
            (
                QM31Impl::from_partial_evals([trace_2_col12, trace_2_col13, trace_2_col14, trace_2_col15]) 
                    - QM31Impl::from_partial_evals([trace_2_col8, trace_2_col9, trace_2_col10, trace_2_col11])
            ) * range_check_9_9_sum_6 * range_check_18_sum_7
        ) - range_check_9_9_sum_6 - range_check_18_sum_7
    ) * domain_vanishing_eval_inv;
sum = sum * random_coeff + constraint_quotient;
        ...
        (
            (
                QM31Impl::from_partial_evals([trace_2_col16, trace_2_col17, trace_2_col18, trace_2_col19]) 
                    - QM31Impl::from_partial_evals([trace_2_col12, trace_2_col13, trace_2_col14, trace_2_col15])
            ) * range_check_18_sum_8 * range_check_9_9_sum_9
        ) - range_check_18_sum_8 - range_check_9_9_sum_9
    ) * domain_vanishing_eval_inv;
sum = sum * random_coeff + constraint_quotient;
        ...
        (
            (
                QM31Impl::from_partial_evals([trace_2_col20, trace_2_col21, trace_2_col22, trace_2_col23]) 
                    - QM31Impl::from_partial_evals([trace_2_col16, trace_2_col17, trace_2_col18, trace_2_col19])
            ) * range_check_18_sum_10 * range_check_18_sum_11
        ) - range_check_18_sum_10 - range_check_18_sum_11
    ) * domain_vanishing_eval_inv;
sum = sum * random_coeff + constraint_quotient;
        ...
        (
            (
                QM31Impl::from_partial_evals([trace_2_col24, trace_2_col25, trace_2_col26, trace_2_col27]) 
                    - QM31Impl::from_partial_evals([trace_2_col20, trace_2_col21, trace_2_col22, trace_2_col23])
            ) * range_check_9_9_sum_12 * range_check_18_sum_13
        ) - range_check_9_9_sum_12 - range_check_18_sum_13
    ) * domain_vanishing_eval_inv;
sum = sum * random_coeff + constraint_quotient;
