...
pub impl CairoComponentImpl of CairoComponent<Component> {
    fn mask_points(
        ...
        preprocessed_column_set.insert(preprocessed_columns::RANGE_CHECK_4_3_6_6_3_0_IDX);
        preprocessed_column_set.insert(preprocessed_columns::RANGE_CHECK_4_3_6_6_3_1_IDX);
        preprocessed_column_set.insert(preprocessed_columns::RANGE_CHECK_4_3_6_6_3_2_IDX);
        preprocessed_column_set.insert(preprocessed_columns::RANGE_CHECK_4_3_6_6_3_3_IDX);
    ...
    fn evaluate_constraints_at_point(
        ...
        let rangecheck_3_6_6_3_0 = preprocessed_mask_values
            .get(preprocessed_columns::RANGE_CHECK_4_3_6_6_3_0_IDX);
        let rangecheck_3_6_6_3_1 = preprocessed_mask_values
            .get(preprocessed_columns::RANGE_CHECK_4_3_6_6_3_1_IDX);
        let rangecheck_3_6_6_3_2 = preprocessed_mask_values
            .get(preprocessed_columns::RANGE_CHECK_4_3_6_6_3_2_IDX);
        let rangecheck_3_6_6_3_3 = preprocessed_mask_values
            .get(preprocessed_columns::RANGE_CHECK_4_3_6_6_3_3_IDX);
