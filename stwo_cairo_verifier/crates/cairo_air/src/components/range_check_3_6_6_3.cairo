...
pub impl CairoComponentImpl of CairoComponent<Component> {
    fn evaluate_constraints_at_point(
        ...
        let range_check_3_6_6_3_column_0 = preprocessed_mask_values
            .get_and_mark_used(RANGE_CHECK_3_6_6_3_COLUMN_0_IDX);
        let range_check_3_6_6_3_column_1 = preprocessed_mask_values
            .get_and_mark_used(RANGE_CHECK_3_6_6_3_COLUMN_1_IDX);
        let range_check_3_6_6_3_column_2 = preprocessed_mask_values
            .get_and_mark_used(RANGE_CHECK_3_6_6_3_COLUMN_2_IDX);
        let range_check_3_6_6_3_column_3 = preprocessed_mask_values
            .get_and_mark_used(RANGE_CHECK_3_6_6_3_COLUMN_3_IDX);

        let [range_check_3_6_6_3_multiplicity]: [Span<QM31>; 1] = (*trace_mask_values
            .multi_pop_front()
            .unwrap())
            .unbox();
        let [range_check_3_6_6_3_multiplicity]: [QM31; 1] = (*range_check_3_6_6_3_multiplicity
            .try_into()
            .unwrap())
            .unbox();
        ...
        range_check_3_6_6_3_sum_0 = self
            ...
            .combine_qm31(
                [
                    qm31_const::<1005786011, 0, 0, 0>(), range_check_3_6_6_3_column_0,
                    range_check_3_6_6_3_column_1, range_check_3_6_6_3_column_2,
        ...
        lookup_constraints(
            ...
            random_coeff,
            claimed_sum,
            range_check_3_6_6_3_multiplicity,
            column_size,
...
fn lookup_constraints(
    ...
    random_coeff: QM31,
    claimed_sum: QM31,
    range_check_3_6_6_3_multiplicity: QM31,
    column_size: M31,
    ref interaction_trace_mask_values: ColumnSpan<Span<QM31>>,
...
mod tests {
    ...
    fn test_evaluation_result() {
        ...
        let mut preprocessed_trace = preprocessed_mask_add(
            preprocessed_trace,
            RANGE_CHECK_3_6_6_3_COLUMN_0_IDX,
            qm31_const::<802513802, 1922585512, 1089386476, 1846978329>(),
        );
        let mut preprocessed_trace = preprocessed_mask_add(
            preprocessed_trace,
            RANGE_CHECK_3_6_6_3_COLUMN_1_IDX,
            qm31_const::<735404623, 1788367784, 1022277612, 1846978329>(),
        );
        let mut preprocessed_trace = preprocessed_mask_add(
            preprocessed_trace,
            RANGE_CHECK_3_6_6_3_COLUMN_2_IDX,
            qm31_const::<936732160, 43537321, 1223604205, 1846978329>(),
        );
        let mut preprocessed_trace = preprocessed_mask_add(
            preprocessed_trace,
            RANGE_CHECK_3_6_6_3_COLUMN_3_IDX,
            qm31_const::<869622981, 2056803240, 1156495340, 1846978329>(),
        );
        ...
        assert_eq!(sum, QM31Trait::from_fixed_array(RANGE_CHECK_3_6_6_3_SAMPLE_EVAL_RESULT))
    }
}
