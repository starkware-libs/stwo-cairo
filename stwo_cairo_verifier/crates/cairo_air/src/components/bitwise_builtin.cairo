...
use crate::components::verify_bitwise_xor_9::VERIFY_BITWISE_XOR_9_RELATION_SIZE;
...
interaction_trace_mask_points.append(array![point_offset_neg_1, point]);
    ...
    fn evaluate_constraints_at_point(
        ...
        let bitwise_builtin_segment_start: QM31 = (TryInto::<u32, M31>::try_into((*(self.claim.bitwise_builtin_segment_start))).unwrap()).into();
...
let and_tmp_efb2a_8: QM31 = (qm31_const::<1073741824, 0, 0, 0>() * ((op0_limb_0_col1 + op1_limb_0_col30) - xor_col58));
...
let and_tmp_efb2a_11: QM31 = (qm31_const::<1073741824, 0, 0, 0>() * ((op0_limb_1_col2 + op1_limb_1_col31) - xor_col59));
...
let and_tmp_efb2a_14: QM31 = (qm31_const::<1073741824, 0, 0, 0>() * ((op0_limb_2_col3 + op1_limb_2_col32) - xor_col60));
...
let and_tmp_efb2a_17: QM31 = (qm31_const::<1073741824, 0, 0, 0>() * ((op0_limb_3_col4 + op1_limb_3_col33) - xor_col61));
...
let and_tmp_efb2a_20: QM31 = (qm31_const::<1073741824, 0, 0, 0>() * ((op0_limb_4_col5 + op1_limb_4_col34) - xor_col62));
...
let and_tmp_efb2a_23: QM31 = (qm31_const::<1073741824, 0, 0, 0>() * ((op0_limb_5_col6 + op1_limb_5_col35) - xor_col63));
...
let and_tmp_efb2a_26: QM31 = (qm31_const::<1073741824, 0, 0, 0>() * ((op0_limb_6_col7 + op1_limb_6_col36) - xor_col64));
...
let and_tmp_efb2a_29: QM31 = (qm31_const::<1073741824, 0, 0, 0>() * ((op0_limb_7_col8 + op1_limb_7_col37) - xor_col65));
...
let and_tmp_efb2a_32: QM31 = (qm31_const::<1073741824, 0, 0, 0>() * ((op0_limb_8_col9 + op1_limb_8_col38) - xor_col66));
...
let and_tmp_efb2a_35: QM31 = (qm31_const::<1073741824, 0, 0, 0>() * ((op0_limb_9_col10 + op1_limb_9_col39) - xor_col67));
...
let and_tmp_efb2a_38: QM31 = (qm31_const::<1073741824, 0, 0, 0>() * ((op0_limb_10_col11 + op1_limb_10_col40) - xor_col68));
...
let and_tmp_efb2a_41: QM31 = (qm31_const::<1073741824, 0, 0, 0>() * ((op0_limb_11_col12 + op1_limb_11_col41) - xor_col69));
...
let and_tmp_efb2a_44: QM31 = (qm31_const::<1073741824, 0, 0, 0>() * ((op0_limb_12_col13 + op1_limb_12_col42) - xor_col70));
...
let and_tmp_efb2a_47: QM31 = (qm31_const::<1073741824, 0, 0, 0>() * ((op0_limb_13_col14 + op1_limb_13_col43) - xor_col71));
...
let and_tmp_efb2a_50: QM31 = (qm31_const::<1073741824, 0, 0, 0>() * ((op0_limb_14_col15 + op1_limb_14_col44) - xor_col72));
...
let and_tmp_efb2a_53: QM31 = (qm31_const::<1073741824, 0, 0, 0>() * ((op0_limb_15_col16 + op1_limb_15_col45) - xor_col73));
...
let and_tmp_efb2a_56: QM31 = (qm31_const::<1073741824, 0, 0, 0>() * ((op0_limb_16_col17 + op1_limb_16_col46) - xor_col74));
...
let and_tmp_efb2a_59: QM31 = (qm31_const::<1073741824, 0, 0, 0>() * ((op0_limb_17_col18 + op1_limb_17_col47) - xor_col75));
...
let and_tmp_efb2a_62: QM31 = (qm31_const::<1073741824, 0, 0, 0>() * ((op0_limb_18_col19 + op1_limb_18_col48) - xor_col76));
...
let and_tmp_efb2a_65: QM31 = (qm31_const::<1073741824, 0, 0, 0>() * ((op0_limb_19_col20 + op1_limb_19_col49) - xor_col77));
...
let and_tmp_efb2a_68: QM31 = (qm31_const::<1073741824, 0, 0, 0>() * ((op0_limb_20_col21 + op1_limb_20_col50) - xor_col78));
...
let and_tmp_efb2a_71: QM31 = (qm31_const::<1073741824, 0, 0, 0>() * ((op0_limb_21_col22 + op1_limb_21_col51) - xor_col79));
...
let and_tmp_efb2a_74: QM31 = (qm31_const::<1073741824, 0, 0, 0>() * ((op0_limb_22_col23 + op1_limb_22_col52) - xor_col80));
...
let and_tmp_efb2a_77: QM31 = (qm31_const::<1073741824, 0, 0, 0>() * ((op0_limb_23_col24 + op1_limb_23_col53) - xor_col81));
...
let and_tmp_efb2a_80: QM31 = (qm31_const::<1073741824, 0, 0, 0>() * ((op0_limb_24_col25 + op1_limb_24_col54) - xor_col82));
...
let and_tmp_efb2a_83: QM31 = (qm31_const::<1073741824, 0, 0, 0>() * ((op0_limb_25_col26 + op1_limb_25_col55) - xor_col83));
...
let and_tmp_efb2a_86: QM31 = (qm31_const::<1073741824, 0, 0, 0>() * ((op0_limb_26_col27 + op1_limb_26_col56) - xor_col84));
...
let and_tmp_efb2a_89: QM31 = (qm31_const::<1073741824, 0, 0, 0>() * ((op0_limb_27_col28 + op1_limb_27_col57) - xor_col85));
        ...
        (
            (
                QM31Impl::from_partial_evals([trace_2_col60, trace_2_col61, trace_2_col62, trace_2_col63]) 
                    - QM31Impl::from_partial_evals([trace_2_col56, trace_2_col57, trace_2_col58, trace_2_col59])
            ) * verify_bitwise_xor_9_sum_30 * verify_bitwise_xor_9_sum_31
        ) - verify_bitwise_xor_9_sum_30 - verify_bitwise_xor_9_sum_31
    ) * domain_vanishing_eval_inv;
sum = sum * random_coeff + constraint_quotient;
