...
use crate::components::{
    CairoComponent, OPCODES_RELATION_SIZE, RANGE_CHECK_18_LOG_SIZE, opcodes_sum,
};
...
pub const RANGE_CHECK_18_RELATION_SIZE: usize = 1;
...
pub impl ComponentImpl of CairoComponent<Component> {
    ...
    fn evaluate_constraints_at_point(
        ...
        range_check_18_sum_0 = range_check_18_sum(range_check_18_alphas, range_check_18_z, [seq]);
...
pub fn range_check_18_sum(mut alphas: Span<QM31>, z: QM31, values: [QM31; 1]) -> QM31 {
