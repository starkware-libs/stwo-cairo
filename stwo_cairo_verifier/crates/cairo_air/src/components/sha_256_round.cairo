...
pub const RELATION_USES_PER_ROW: [(felt252, u32); 7] = [
    ('Sha256BigSigma1', 1), ('Sha256BigSigma0', 1), ('VerifyBitwiseAnd_8', 20),
    ('VerifyBitwiseXor_8', 12), ('Sha256KTable', 1), ('Sha256Schedule', 1), ('Sha256Round', 1),
];
...
pub impl CairoComponentImpl of CairoComponent<Component> {
    ...
    fn evaluate_constraints_at_point(
        ...
        let mut sha_256_big_sigma_1_sum_0: QM31 = Zero::zero();
        let mut sha_256_big_sigma_0_sum_1: QM31 = Zero::zero();
        ...
        let mut verify_bitwise_xor_8_sum_12: QM31 = Zero::zero();
        let mut verify_bitwise_xor_8_sum_13: QM31 = Zero::zero();
        let mut sha_256_k_table_sum_14: QM31 = Zero::zero();
        let mut verify_bitwise_and_8_sum_15: QM31 = Zero::zero();
        let mut verify_bitwise_and_8_sum_16: QM31 = Zero::zero();
        let mut verify_bitwise_and_8_sum_17: QM31 = Zero::zero();
        let mut verify_bitwise_and_8_sum_18: QM31 = Zero::zero();
        let mut verify_bitwise_and_8_sum_19: QM31 = Zero::zero();
        let mut verify_bitwise_and_8_sum_20: QM31 = Zero::zero();
        let mut verify_bitwise_and_8_sum_21: QM31 = Zero::zero();
        let mut verify_bitwise_and_8_sum_22: QM31 = Zero::zero();
        let mut verify_bitwise_and_8_sum_23: QM31 = Zero::zero();
        let mut verify_bitwise_and_8_sum_24: QM31 = Zero::zero();
        let mut verify_bitwise_and_8_sum_25: QM31 = Zero::zero();
        let mut verify_bitwise_and_8_sum_26: QM31 = Zero::zero();
        let mut verify_bitwise_xor_8_sum_27: QM31 = Zero::zero();
        let mut verify_bitwise_xor_8_sum_28: QM31 = Zero::zero();
        let mut verify_bitwise_xor_8_sum_29: QM31 = Zero::zero();
        let mut verify_bitwise_xor_8_sum_30: QM31 = Zero::zero();
        let mut verify_bitwise_xor_8_sum_31: QM31 = Zero::zero();
        let mut verify_bitwise_xor_8_sum_32: QM31 = Zero::zero();
        let mut verify_bitwise_xor_8_sum_33: QM31 = Zero::zero();
        let mut verify_bitwise_xor_8_sum_34: QM31 = Zero::zero();
        let mut sha_256_schedule_sum_35: QM31 = Zero::zero();
        let mut sha_256_round_sum_36: QM31 = Zero::zero();
        let mut sha_256_round_sum_37: QM31 = Zero::zero();
        ...
        let [sha_256_big_sigma_1_output_limb_0_col50]: [QM31; 1] =
            (*sha_256_big_sigma_1_output_limb_0_col50
            .try_into()
            .unwrap())
            .unbox();
        let [sha_256_big_sigma_1_output_limb_1_col51]: [QM31; 1] =
            (*sha_256_big_sigma_1_output_limb_1_col51
            .try_into()
            .unwrap())
            .unbox();
        let [sha_256_big_sigma_0_output_limb_0_col52]: [QM31; 1] =
            (*sha_256_big_sigma_0_output_limb_0_col52
            .try_into()
            .unwrap())
            .unbox();
        let [sha_256_big_sigma_0_output_limb_1_col53]: [QM31; 1] =
            (*sha_256_big_sigma_0_output_limb_1_col53
            .try_into()
            .unwrap())
            .unbox();
        let [ms_8_bits_col54]: [QM31; 1] = (*ms_8_bits_col54.try_into().unwrap()).unbox();
        let [ms_8_bits_col55]: [QM31; 1] = (*ms_8_bits_col55.try_into().unwrap()).unbox();
        let [ms_8_bits_col56]: [QM31; 1] = (*ms_8_bits_col56.try_into().unwrap()).unbox();
        let [ms_8_bits_col57]: [QM31; 1] = (*ms_8_bits_col57.try_into().unwrap()).unbox();
        let [and_col58]: [QM31; 1] = (*and_col58.try_into().unwrap()).unbox();
        let [and_col59]: [QM31; 1] = (*and_col59.try_into().unwrap()).unbox();
        let [and_col60]: [QM31; 1] = (*and_col60.try_into().unwrap()).unbox();
        let [and_col61]: [QM31; 1] = (*and_col61.try_into().unwrap()).unbox();
        let [not_e_l_col62]: [QM31; 1] = (*not_e_l_col62.try_into().unwrap()).unbox();
        let [not_e_h_col63]: [QM31; 1] = (*not_e_h_col63.try_into().unwrap()).unbox();
        let [ms_8_bits_col64]: [QM31; 1] = (*ms_8_bits_col64.try_into().unwrap()).unbox();
        let [ms_8_bits_col65]: [QM31; 1] = (*ms_8_bits_col65.try_into().unwrap()).unbox();
        let [ms_8_bits_col66]: [QM31; 1] = (*ms_8_bits_col66.try_into().unwrap()).unbox();
        let [ms_8_bits_col67]: [QM31; 1] = (*ms_8_bits_col67.try_into().unwrap()).unbox();
        let [and_col68]: [QM31; 1] = (*and_col68.try_into().unwrap()).unbox();
        let [and_col69]: [QM31; 1] = (*and_col69.try_into().unwrap()).unbox();
        let [and_col70]: [QM31; 1] = (*and_col70.try_into().unwrap()).unbox();
        let [and_col71]: [QM31; 1] = (*and_col71.try_into().unwrap()).unbox();
        ...
        let [chl_col76]: [QM31; 1] = (*chl_col76.try_into().unwrap()).unbox();
        let [chh_col77]: [QM31; 1] = (*chh_col77.try_into().unwrap()).unbox();
        let [ch_limb_0_col78]: [QM31; 1] = (*ch_limb_0_col78.try_into().unwrap()).unbox();
        let [ch_limb_1_col79]: [QM31; 1] = (*ch_limb_1_col79.try_into().unwrap()).unbox();
        let [sha_256_k_table_output_limb_0_col80]: [QM31; 1] = (*sha_256_k_table_output_limb_0_col80
            .try_into()
            .unwrap())
            .unbox();
        let [sha_256_k_table_output_limb_1_col81]: [QM31; 1] = (*sha_256_k_table_output_limb_1_col81
            .try_into()
            .unwrap())
            .unbox();
        let [triple_sum32_res_limb_0_col82]: [QM31; 1] = (*triple_sum32_res_limb_0_col82
            .try_into()
            .unwrap())
            .unbox();
        let [triple_sum32_res_limb_1_col83]: [QM31; 1] = (*triple_sum32_res_limb_1_col83
            .try_into()
            .unwrap())
            .unbox();
        let [triple_sum32_res_limb_0_col84]: [QM31; 1] = (*triple_sum32_res_limb_0_col84
            .try_into()
            .unwrap())
            .unbox();
        let [triple_sum32_res_limb_1_col85]: [QM31; 1] = (*triple_sum32_res_limb_1_col85
            .try_into()
            .unwrap())
            .unbox();
        ...
        let [ms_8_bits_col88]: [QM31; 1] = (*ms_8_bits_col88.try_into().unwrap()).unbox();
        let [ms_8_bits_col89]: [QM31; 1] = (*ms_8_bits_col89.try_into().unwrap()).unbox();
        let [ms_8_bits_col90]: [QM31; 1] = (*ms_8_bits_col90.try_into().unwrap()).unbox();
        let [ms_8_bits_col91]: [QM31; 1] = (*ms_8_bits_col91.try_into().unwrap()).unbox();
        let [and_col92]: [QM31; 1] = (*and_col92.try_into().unwrap()).unbox();
        let [and_col93]: [QM31; 1] = (*and_col93.try_into().unwrap()).unbox();
        let [and_col94]: [QM31; 1] = (*and_col94.try_into().unwrap()).unbox();
        let [and_col95]: [QM31; 1] = (*and_col95.try_into().unwrap()).unbox();
        let [and_col96]: [QM31; 1] = (*and_col96.try_into().unwrap()).unbox();
        let [and_col97]: [QM31; 1] = (*and_col97.try_into().unwrap()).unbox();
        let [and_col98]: [QM31; 1] = (*and_col98.try_into().unwrap()).unbox();
        let [and_col99]: [QM31; 1] = (*and_col99.try_into().unwrap()).unbox();
        let [and_col100]: [QM31; 1] = (*and_col100.try_into().unwrap()).unbox();
        let [and_col101]: [QM31; 1] = (*and_col101.try_into().unwrap()).unbox();
        let [and_col102]: [QM31; 1] = (*and_col102.try_into().unwrap()).unbox();
        let [and_col103]: [QM31; 1] = (*and_col103.try_into().unwrap()).unbox();
        let [xor_col104]: [QM31; 1] = (*xor_col104.try_into().unwrap()).unbox();
        let [xor_col105]: [QM31; 1] = (*xor_col105.try_into().unwrap()).unbox();
        let [xor_col106]: [QM31; 1] = (*xor_col106.try_into().unwrap()).unbox();
        let [xor_col107]: [QM31; 1] = (*xor_col107.try_into().unwrap()).unbox();
        let [xor_col108]: [QM31; 1] = (*xor_col108.try_into().unwrap()).unbox();
        let [xor_col109]: [QM31; 1] = (*xor_col109.try_into().unwrap()).unbox();
        let [xor_col110]: [QM31; 1] = (*xor_col110.try_into().unwrap()).unbox();
        let [xor_col111]: [QM31; 1] = (*xor_col111.try_into().unwrap()).unbox();
        let [majl_col112]: [QM31; 1] = (*majl_col112.try_into().unwrap()).unbox();
        let [majh_col113]: [QM31; 1] = (*majh_col113.try_into().unwrap()).unbox();
        let [maj_limb_0_col114]: [QM31; 1] = (*maj_limb_0_col114.try_into().unwrap()).unbox();
        let [maj_limb_1_col115]: [QM31; 1] = (*maj_limb_1_col115.try_into().unwrap()).unbox();
        let [triple_sum32_res_limb_0_col116]: [QM31; 1] = (*triple_sum32_res_limb_0_col116
            .try_into()
            .unwrap())
            .unbox();
        let [triple_sum32_res_limb_1_col117]: [QM31; 1] = (*triple_sum32_res_limb_1_col117
            .try_into()
            .unwrap())
            .unbox();
        let [sha_256_schedule_output_limb_0_col118]: [QM31; 1] =
            (*sha_256_schedule_output_limb_0_col118
            .try_into()
            .unwrap())
            .unbox();
        let [sha_256_schedule_output_limb_1_col119]: [QM31; 1] =
            (*sha_256_schedule_output_limb_1_col119
            .try_into()
            .unwrap())
            .unbox();
        let [triple_sum32_res_limb_0_col120]: [QM31; 1] = (*triple_sum32_res_limb_0_col120
            .try_into()
            .unwrap())
            .unbox();
        let [triple_sum32_res_limb_1_col121]: [QM31; 1] = (*triple_sum32_res_limb_1_col121
            .try_into()
            .unwrap())
            .unbox();
        let [triple_sum32_res_limb_0_col122]: [QM31; 1] = (*triple_sum32_res_limb_0_col122
            .try_into()
            .unwrap())
            .unbox();
        let [triple_sum32_res_limb_1_col123]: [QM31; 1] = (*triple_sum32_res_limb_1_col123
            .try_into()
            .unwrap())
            .unbox();
        ...
        sha_256_big_sigma_1_sum_0 = self
            .sha_256_big_sigma_1_lookup_elements
            .combine_qm31(
                [
        ...
        sha_256_big_sigma_0_sum_1 = self
            .sha_256_big_sigma_0_lookup_elements
            .combine_qm31(
                [
                    input_limb_2_col2, input_limb_3_col3, sha_256_big_sigma_0_output_limb_0_col52,
                    sha_256_big_sigma_0_output_limb_1_col53,
                ],
            );
        let split_16_low_part_size_8_output_tmp_ce7d8_3_limb_0: QM31 =
            split_16_low_part_size_8_evaluate(
            input_limb_10_col10, ms_8_bits_col54, ref sum, domain_vanishing_eval_inv, random_coeff,
        );
        let split_16_low_part_size_8_output_tmp_ce7d8_5_limb_0: QM31 =
            split_16_low_part_size_8_evaluate(
            input_limb_11_col11, ms_8_bits_col55, ref sum, domain_vanishing_eval_inv, random_coeff,
        );
        let split_16_low_part_size_8_output_tmp_ce7d8_7_limb_0: QM31 =
            split_16_low_part_size_8_evaluate(
            input_limb_12_col12, ms_8_bits_col56, ref sum, domain_vanishing_eval_inv, random_coeff,
        );
        let split_16_low_part_size_8_output_tmp_ce7d8_9_limb_0: QM31 =
            split_16_low_part_size_8_evaluate(
            input_limb_13_col13, ms_8_bits_col57, ref sum, domain_vanishing_eval_inv, random_coeff,
        );
        bitwise_and_num_bits_8_evaluate(
            [
                split_16_low_part_size_8_output_tmp_ce7d8_3_limb_0,
                split_16_low_part_size_8_output_tmp_ce7d8_7_limb_0,
            ],
            and_col58,
        ...
        bitwise_and_num_bits_8_evaluate(
            [
                split_16_low_part_size_8_output_tmp_ce7d8_5_limb_0,
                split_16_low_part_size_8_output_tmp_ce7d8_9_limb_0,
            ],
            and_col60,
            self.verify_bitwise_and_8_lookup_elements,
        ...
        // Constraint - not_e_l
        let constraint_quotient = ((not_e_l_col62
            - (qm31_const::<65535, 0, 0, 0>() - input_limb_10_col10)))
            * domain_vanishing_eval_inv;
        sum = sum * random_coeff + constraint_quotient;

        // Constraint - not_e_h
        let constraint_quotient = ((not_e_h_col63
            - (qm31_const::<65535, 0, 0, 0>() - input_limb_11_col11)))
            * domain_vanishing_eval_inv;
        sum = sum * random_coeff + constraint_quotient;
        let split_16_low_part_size_8_output_tmp_ce7d8_19_limb_0: QM31 =
            split_16_low_part_size_8_evaluate(
            not_e_l_col62, ms_8_bits_col64, ref sum, domain_vanishing_eval_inv, random_coeff,
        );
        let split_16_low_part_size_8_output_tmp_ce7d8_21_limb_0: QM31 =
            split_16_low_part_size_8_evaluate(
            not_e_h_col63, ms_8_bits_col65, ref sum, domain_vanishing_eval_inv, random_coeff,
        );
        let split_16_low_part_size_8_output_tmp_ce7d8_23_limb_0: QM31 =
            split_16_low_part_size_8_evaluate(
            input_limb_14_col14, ms_8_bits_col66, ref sum, domain_vanishing_eval_inv, random_coeff,
        );
        let split_16_low_part_size_8_output_tmp_ce7d8_25_limb_0: QM31 =
            split_16_low_part_size_8_evaluate(
            input_limb_15_col15, ms_8_bits_col67, ref sum, domain_vanishing_eval_inv, random_coeff,
        );
        bitwise_and_num_bits_8_evaluate(
            [
                split_16_low_part_size_8_output_tmp_ce7d8_19_limb_0,
                split_16_low_part_size_8_output_tmp_ce7d8_23_limb_0,
            ],
            and_col68,
            self.verify_bitwise_and_8_lookup_elements,
        ...
        bitwise_and_num_bits_8_evaluate(
            [
                split_16_low_part_size_8_output_tmp_ce7d8_21_limb_0,
                split_16_low_part_size_8_output_tmp_ce7d8_25_limb_0,
            ],
            and_col70,
            self.verify_bitwise_and_8_lookup_elements,
        ...
        // Constraint - chl
        let constraint_quotient = ((chl_col76
            - (xor_col72 + (xor_col73 * qm31_const::<256, 0, 0, 0>()))))
            * domain_vanishing_eval_inv;
        sum = sum * random_coeff + constraint_quotient;

        // Constraint - chh
        let constraint_quotient = ((chh_col77
            - (xor_col74 + (xor_col75 * qm31_const::<256, 0, 0, 0>()))))
            * domain_vanishing_eval_inv;
        sum = sum * random_coeff + constraint_quotient;

        sha_256_k_table_sum_14 = self
            .sha_256_k_table_lookup_elements
            .combine_qm31(
                [
                    input_limb_1_col1, sha_256_k_table_output_limb_0_col80,
                    sha_256_k_table_output_limb_1_col81,
                ],
            );
        triple_sum_32_evaluate(
            [
                input_limb_16_col16, input_limb_17_col17, sha_256_big_sigma_1_output_limb_0_col50,
                sha_256_big_sigma_1_output_limb_1_col51, ch_limb_0_col78, ch_limb_1_col79,
            ],
            triple_sum32_res_limb_0_col82,
            triple_sum32_res_limb_1_col83,
            ref sum,
        ...
        triple_sum_32_evaluate(
            [
                triple_sum32_res_limb_0_col82, triple_sum32_res_limb_1_col83,
                sha_256_k_table_output_limb_0_col80, sha_256_k_table_output_limb_1_col81,
                input_limb_18_col18, input_limb_19_col19,
            ],
            triple_sum32_res_limb_0_col84,
            triple_sum32_res_limb_1_col85,
            ref sum,
        ...
        let split_16_low_part_size_8_output_tmp_ce7d8_53_limb_0: QM31 =
            split_16_low_part_size_8_evaluate(
            input_limb_2_col2, ms_8_bits_col86, ref sum, domain_vanishing_eval_inv, random_coeff,
        );
        let split_16_low_part_size_8_output_tmp_ce7d8_55_limb_0: QM31 =
            split_16_low_part_size_8_evaluate(
            input_limb_3_col3, ms_8_bits_col87, ref sum, domain_vanishing_eval_inv, random_coeff,
        );
        let split_16_low_part_size_8_output_tmp_ce7d8_57_limb_0: QM31 =
            split_16_low_part_size_8_evaluate(
            input_limb_4_col4, ms_8_bits_col88, ref sum, domain_vanishing_eval_inv, random_coeff,
        );
        let split_16_low_part_size_8_output_tmp_ce7d8_59_limb_0: QM31 =
            split_16_low_part_size_8_evaluate(
            input_limb_5_col5, ms_8_bits_col89, ref sum, domain_vanishing_eval_inv, random_coeff,
        );
        let split_16_low_part_size_8_output_tmp_ce7d8_61_limb_0: QM31 =
            split_16_low_part_size_8_evaluate(
            input_limb_6_col6, ms_8_bits_col90, ref sum, domain_vanishing_eval_inv, random_coeff,
        );
        let split_16_low_part_size_8_output_tmp_ce7d8_63_limb_0: QM31 =
            split_16_low_part_size_8_evaluate(
            input_limb_7_col7, ms_8_bits_col91, ref sum, domain_vanishing_eval_inv, random_coeff,
        );
        bitwise_and_num_bits_8_evaluate(
            [
                split_16_low_part_size_8_output_tmp_ce7d8_53_limb_0,
                split_16_low_part_size_8_output_tmp_ce7d8_57_limb_0,
            ],
            and_col92,
            self.verify_bitwise_and_8_lookup_elements,
        ...
        bitwise_and_num_bits_8_evaluate(
            [
                split_16_low_part_size_8_output_tmp_ce7d8_55_limb_0,
        ...
        bitwise_and_num_bits_8_evaluate(
            [
                split_16_low_part_size_8_output_tmp_ce7d8_53_limb_0,
                split_16_low_part_size_8_output_tmp_ce7d8_61_limb_0,
            ],
            and_col96,
            self.verify_bitwise_and_8_lookup_elements,
        ...
        bitwise_and_num_bits_8_evaluate(
            [
                split_16_low_part_size_8_output_tmp_ce7d8_55_limb_0,
                split_16_low_part_size_8_output_tmp_ce7d8_63_limb_0,
            ],
            and_col98,
            self.verify_bitwise_and_8_lookup_elements,
        ...
        // Constraint - majl
        let constraint_quotient = ((majl_col112
            - (xor_col108 + (xor_col109 * qm31_const::<256, 0, 0, 0>()))))
            * domain_vanishing_eval_inv;
        sum = sum * random_coeff + constraint_quotient;

        // Constraint - majh
        let constraint_quotient = ((majh_col113
            - (xor_col110 + (xor_col111 * qm31_const::<256, 0, 0, 0>()))))
            * domain_vanishing_eval_inv;
        sum = sum * random_coeff + constraint_quotient;
        triple_sum_32_evaluate(
            [
                sha_256_big_sigma_0_output_limb_0_col52, sha_256_big_sigma_0_output_limb_1_col53,
                maj_limb_0_col114, maj_limb_1_col115, qm31_const::<0, 0, 0, 0>(),
                qm31_const::<0, 0, 0, 0>(),
            ],
            triple_sum32_res_limb_0_col116,
            triple_sum32_res_limb_1_col117,
        ...
        sha_256_schedule_sum_35 = self
            .sha_256_schedule_lookup_elements
            .combine_qm31(
                [
                    ...
                    input_limb_48_col48, input_limb_49_col49, sha_256_schedule_output_limb_0_col118,
                    sha_256_schedule_output_limb_1_col119,
                ],
            );
        triple_sum_32_evaluate(
            [
                triple_sum32_res_limb_0_col84, triple_sum32_res_limb_1_col85, input_limb_8_col8,
                input_limb_9_col9, qm31_const::<0, 0, 0, 0>(), qm31_const::<0, 0, 0, 0>(),
            ],
            triple_sum32_res_limb_0_col120,
            triple_sum32_res_limb_1_col121,
            ref sum,
        ...
        triple_sum_32_evaluate(
            [
                triple_sum32_res_limb_0_col84, triple_sum32_res_limb_1_col85,
                triple_sum32_res_limb_0_col116, triple_sum32_res_limb_1_col117,
        ...
        sha_256_round_sum_36 = self
            ...
            .combine_qm31(
                [
                    ...
                    input_limb_42_col42, input_limb_43_col43, input_limb_44_col44,
                    input_limb_45_col45, input_limb_46_col46, input_limb_47_col47,
                    input_limb_48_col48, input_limb_49_col49,
                ],
            );

        sha_256_round_sum_37 = self
            .sha_256_round_lookup_elements
            .combine_qm31(
                [
                    input_limb_0_col0, (input_limb_1_col1 + qm31_const::<1, 0, 0, 0>()),
                    triple_sum32_res_limb_0_col122, triple_sum32_res_limb_1_col123,
                    input_limb_2_col2, input_limb_3_col3, input_limb_4_col4, input_limb_5_col5,
                    input_limb_6_col6, input_limb_7_col7, triple_sum32_res_limb_0_col120,
                    triple_sum32_res_limb_1_col121, input_limb_10_col10, input_limb_11_col11,
                    input_limb_12_col12, input_limb_13_col13, input_limb_14_col14,
                    input_limb_15_col15, input_limb_20_col20, input_limb_21_col21,
                    ...
                    input_limb_49_col49, sha_256_schedule_output_limb_0_col118,
                    sha_256_schedule_output_limb_1_col119,
                ],
            );
...
fn lookup_constraints(
    ...
    let constraint_quotient = (((QM31Impl::from_partial_evals(
        ...
        * sha_256_round_sum_36
        * sha_256_round_sum_37)
        + (sha_256_round_sum_36 * enabler)
        - (sha_256_round_sum_37 * enabler))
        * domain_vanishing_eval_inv;
    sum = sum * random_coeff + constraint_quotient;
}
