...
pub impl CairoComponentImpl of CairoComponent<Component> {
    fn evaluate_constraints_at_point(
        ...
        program_component_sum_0 = self
            ...
            .combine_qm31(
                [
                    qm31_const::<1942035206, 0, 0, 0>(), seq_12, curr_program_0, curr_program_1,
                    curr_program_2, curr_program_3, curr_program_4, curr_program_5, curr_program_6,
                    curr_program_7, curr_program_8, curr_program_9, curr_program_10,
                    curr_program_11, curr_program_12, curr_program_13, curr_program_14,
