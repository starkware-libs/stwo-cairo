...
pub const N_TRACE_COLUMNS: usize = 43;pub const RELATION_USES_PER_ROW: [(felt252, u32); 4] = [
    ('VerifyBitwiseAnd_8', 12), ('Sha256SmallSigma0O0', 1), ('Sha256SmallSigma0O1', 1), ('VerifyBitwiseXor_8', 4)
];
...
pub sha_256_small_sigma_0_o_0_lookup_elements: crate::Sha256SmallSigma0O0Elements,
pub sha_256_small_sigma_0_o_1_lookup_elements: crate::Sha256SmallSigma0O1Elements,
...
sha_256_small_sigma_0_o_0_lookup_elements: interaction_elements.sha_256_small_sigma_0_o_0.clone(),
sha_256_small_sigma_0_o_1_lookup_elements: interaction_elements.sha_256_small_sigma_0_o_1.clone(),
...
pub impl CairoComponentImpl of CairoComponent<Component> {
    ...
    fn evaluate_constraints_at_point(
        ...
        sum = sum * random_coeff + constraint_quotient;let split_16_low_part_size_8_output_tmp_4b93d_1_limb_0: QM31 = split_16_low_part_size_8_evaluate(
            input_limb_0_col0,
ms_8_bits_col2,
ref sum,
domain_vanishing_eval_inv,
random_coeff
        );let split_16_low_part_size_8_output_tmp_4b93d_3_limb_0: QM31 = split_16_low_part_size_8_evaluate(
            input_limb_1_col1,
ms_8_bits_col3,
ref sum,
domain_vanishing_eval_inv,
random_coeff
            ...
            [split_16_low_part_size_8_output_tmp_4b93d_1_limb_0, qm31_const::<170, 0, 0, 0>()],
and_col4,
...
random_coeff
            ...
            [ms_8_bits_col2, qm31_const::<74, 0, 0, 0>()],
and_col5,
self.verify_bitwise_and_8_lookup_elements,
...
random_coeff
        ...
        sum = sum * random_coeff + constraint_quotient;bitwise_and_num_bits_8_evaluate(
            [split_16_low_part_size_8_output_tmp_4b93d_1_limb_0, qm31_const::<85, 0, 0, 0>()],
and_col7,
self.verify_bitwise_and_8_lookup_elements,
...
random_coeff
        ...
        sum = sum * random_coeff + constraint_quotient;bitwise_and_num_bits_8_evaluate(
            [split_16_low_part_size_8_output_tmp_4b93d_1_limb_0, qm31_const::<0, 0, 0, 0>()],
and_col10,
self.verify_bitwise_and_8_lookup_elements,
...
random_coeff
            ...
            [ms_8_bits_col2, qm31_const::<181, 0, 0, 0>()],
and_col11,
self.verify_bitwise_and_8_lookup_elements,
...
random_coeff
        ...
        sum = sum * random_coeff + constraint_quotient;bitwise_and_num_bits_8_evaluate(
            [split_16_low_part_size_8_output_tmp_4b93d_3_limb_0, qm31_const::<85, 0, 0, 0>()],
and_col13,
self.verify_bitwise_and_8_lookup_elements,
...
random_coeff
        ...
        sum = sum * random_coeff + constraint_quotient;bitwise_and_num_bits_8_evaluate(
            [split_16_low_part_size_8_output_tmp_4b93d_3_limb_0, qm31_const::<0, 0, 0, 0>()],
and_col16,
self.verify_bitwise_and_8_lookup_elements,
...
random_coeff
            ...
            [ms_8_bits_col3, qm31_const::<181, 0, 0, 0>()],
and_col17,
self.verify_bitwise_and_8_lookup_elements,
...
random_coeff
        ...
        sum = sum * random_coeff + constraint_quotient;bitwise_and_num_bits_8_evaluate(
            [split_16_low_part_size_8_output_tmp_4b93d_3_limb_0, qm31_const::<170, 0, 0, 0>()],
and_col19,
self.verify_bitwise_and_8_lookup_elements,
...
random_coeff
        ...
        sha_256_small_sigma_0_o_0_sum_12 = self.sha_256_small_sigma_0_o_0_lookup_elements.combine_qm31(
            [
                (l1_col9 + l2_col12),
h2_col21,
sigma_O0_L_col22,
...
sigma_O2_H_col27
        ...
        sha_256_small_sigma_0_o_1_sum_13 = self.sha_256_small_sigma_0_o_1_lookup_elements.combine_qm31(
            [
                l0_col6,
(h0_col15 + h1_col18),
sigma_O1_L_col24,
...
sigma_O2_prime_H_col29
        ...
        );let split_16_low_part_size_8_output_tmp_4b93d_39_limb_0: QM31 = split_16_low_part_size_8_evaluate(
            sigma_O2_prime_L_col28,
ms_8_bits_col30,
ref sum,
domain_vanishing_eval_inv,
random_coeff
        );let split_16_low_part_size_8_output_tmp_4b93d_41_limb_0: QM31 = split_16_low_part_size_8_evaluate(
            sigma_O2_L_col26,
ms_8_bits_col31,
ref sum,
domain_vanishing_eval_inv,
random_coeff
            ...
            [split_16_low_part_size_8_output_tmp_4b93d_39_limb_0, split_16_low_part_size_8_output_tmp_4b93d_41_limb_0],
xor_col32,
...
random_coeff
        ...
        sum = sum * random_coeff + constraint_quotient;let split_16_low_part_size_8_output_tmp_4b93d_47_limb_0: QM31 = split_16_low_part_size_8_evaluate(
            sigma_O2_prime_H_col29,
ms_8_bits_col35,
ref sum,
domain_vanishing_eval_inv,
random_coeff
        );let split_16_low_part_size_8_output_tmp_4b93d_49_limb_0: QM31 = split_16_low_part_size_8_evaluate(
            sigma_O2_H_col27,
ms_8_bits_col36,
ref sum,
domain_vanishing_eval_inv,
random_coeff
            ...
            [split_16_low_part_size_8_output_tmp_4b93d_47_limb_0, split_16_low_part_size_8_output_tmp_4b93d_49_limb_0],
xor_col37,
self.verify_bitwise_xor_8_lookup_elements,
...
random_coeff
        ...
        sha_256_small_sigma_0_sum_18 = self.sha_256_small_sigma_0_lookup_elements.combine_qm31(
            [
                input_limb_0_col0,
input_limb_1_col1,
output_low_col40,
...
sha_256_small_sigma_0_o_0_sum_12: QM31,
sha_256_small_sigma_0_o_1_sum_13: QM31,
...
sha_256_small_sigma_0_sum_18: QM31
) {
