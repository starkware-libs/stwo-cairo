...
pub fn evaluate_constraints_at_point(
    ...
    let mut trace_1_column_3 = *trace_mask_values.pop_front().unwrap();
    ...
    let mut trace_2_column_6 = *interaction_mask_values.pop_front().unwrap();
    ...
    let mut trace_2_column_7 = *interaction_mask_values.pop_front().unwrap();
