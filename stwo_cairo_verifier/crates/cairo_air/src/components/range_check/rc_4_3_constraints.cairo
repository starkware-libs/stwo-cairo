...
let trace_2_column_6_offset_0 = *trace_2_column_6.pop_front().unwrap();
            let intermediate0 = (RangeCheck_4_3_alpha0) * (trace_1_column_0_offset_0) + (RangeCheck_4_3_alpha1) * (trace_1_column_1_offset_0) - (RangeCheck_4_3_z);

let constraint_0 = (QM31Impl::from_partial_evals([trace_2_column_3_offset_0, trace_2_column_4_offset_0, trace_2_column_5_offset_0, trace_2_column_6_offset_0]) - (QM31Impl::from_partial_evals([trace_2_column_3_offset_neg_1, trace_2_column_4_offset_neg_1, trace_2_column_5_offset_neg_1, trace_2_column_6_offset_neg_1]) - ((total_sum) * (preprocessed_is_first)))) * (intermediate0) - (-(trace_1_column_2_offset_0));
