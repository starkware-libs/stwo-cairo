...
pub fn evaluate_constraints_at_point(
    ...
    let [trace_2_column_85_offset_0]: [QM31; 1] = (*trace_2_column_85.try_into().unwrap()).unbox();

    let [trace_2_column_86_offset_0]: [QM31; 1] = (*trace_2_column_86.try_into().unwrap()).unbox();

    let [trace_2_column_87_offset_0]: [QM31; 1] = (*trace_2_column_87.try_into().unwrap()).unbox();

    let [trace_2_column_88_offset_0]: [QM31; 1] = (*trace_2_column_88.try_into().unwrap()).unbox();
    ...
    let [trace_2_column_93_offset_neg_1, trace_2_column_93_offset_0]: [QM31; 2] =
        (*trace_2_column_93
        .try_into()
        .unwrap())
        .unbox();

    let [trace_2_column_94_offset_neg_1, trace_2_column_94_offset_0]: [QM31; 2] =
        (*trace_2_column_94
        .try_into()
        .unwrap())
        .unbox();

    let [trace_2_column_95_offset_neg_1, trace_2_column_95_offset_0]: [QM31; 2] =
        (*trace_2_column_95
        .try_into()
        .unwrap())
        .unbox();

    let [trace_2_column_96_offset_neg_1, trace_2_column_96_offset_0]: [QM31; 2] =
        (*trace_2_column_96
        .try_into()
        .unwrap())
        .unbox();
    ...
    // Constraint 0
    let constraint_quotient = ((trace_1_column_72_offset_0) * (trace_1_column_72_offset_0)
    ...
    // Constraint 8
    let constraint_quotient = ((trace_1_column_8_offset_0) * (intermediate3 - (m31(1).into())))
        * domain_vanish_at_point_inv;
    sum = sum * random_coeff + constraint_quotient;
    ...
    // Constraint 14
    let constraint_quotient = (((trace_1_column_35_offset_0
        + trace_1_column_36_offset_0
        + trace_1_column_37_offset_0
        + trace_1_column_38_offset_0
        - (m31(1548).into()))
    ...
    // Constraint 15
    let constraint_quotient = (((trace_1_column_43_offset_0
        + trace_1_column_44_offset_0
        + trace_1_column_45_offset_0
        + trace_1_column_46_offset_0
        - (m31(1548).into()))
    ...
    // Constraint 16
    let constraint_quotient = (((trace_1_column_54_offset_0
        + trace_1_column_55_offset_0
        + trace_1_column_56_offset_0
        + trace_1_column_57_offset_0
        - (m31(1548).into()))
    ...
    let constraint_quotient = (intermediate9
        - (((intermediate16) * (intermediate23)
            - ((intermediate17) * (intermediate24))
            + (m31(2).into())
                * ((intermediate18) * (intermediate25) - ((intermediate19) * (intermediate26)))
            - ((intermediate18) * (intermediate26))
            - ((intermediate19) * (intermediate25)))
            * (intermediate5))
        - ((intermediate16 + intermediate23) * (trace_1_column_10_offset_0)))
        * domain_vanish_at_point_inv;
    sum = sum * random_coeff + constraint_quotient;

    // Constraint 19
    let constraint_quotient = (intermediate10
        - (((intermediate16) * (intermediate24)
            + (intermediate17) * (intermediate23)
            + (m31(2).into())
                * ((intermediate18) * (intermediate26) + (intermediate19) * (intermediate25))
            + (intermediate18) * (intermediate25)
            - ((intermediate19) * (intermediate26)))
            * (intermediate5))
        - ((intermediate17 + intermediate24) * (trace_1_column_10_offset_0)))
        * domain_vanish_at_point_inv;
    sum = sum * random_coeff + constraint_quotient;

    // Constraint 20
    let constraint_quotient = (intermediate11
        - (((intermediate16) * (intermediate25)
            - ((intermediate17) * (intermediate26))
            + (intermediate18) * (intermediate23)
            - ((intermediate19) * (intermediate24)))
            * (intermediate5))
        - ((intermediate18 + intermediate25) * (trace_1_column_10_offset_0)))
        * domain_vanish_at_point_inv;
    sum = sum * random_coeff + constraint_quotient;

    // Constraint 21
    let constraint_quotient = (intermediate12
        - (((intermediate16) * (intermediate26)
            + (intermediate17) * (intermediate25)
            + (intermediate18) * (intermediate24)
            + (intermediate19) * (intermediate23))
            * (intermediate5))
        - ((intermediate19 + intermediate26) * (trace_1_column_10_offset_0)))
        * domain_vanish_at_point_inv;
    sum = sum * random_coeff + constraint_quotient;
    ...
    let constraint_quotient = ((QM31Trait::from_partial_evals(
        ...
        * ((intermediate15) * (intermediate20))
        - (intermediate20 + intermediate15))
        * domain_vanish_at_point_inv;
    sum = sum * random_coeff + constraint_quotient;
    ...
    let constraint_quotient = ((QM31Trait::from_partial_evals(
        ...
        - (QM31Trait::from_partial_evals(
            [
                trace_2_column_93_offset_neg_1, trace_2_column_94_offset_neg_1,
                trace_2_column_95_offset_neg_1, trace_2_column_96_offset_neg_1,
            ],
        ))
        - (QM31Trait::from_partial_evals(
            [
        ...
        * ((intermediate27) * (intermediate28))
        - ((intermediate28) * (trace_1_column_72_offset_0)
            - ((intermediate27) * (trace_1_column_72_offset_0))))
        * domain_vanish_at_point_inv;
    sum = sum * random_coeff + constraint_quotient;
}
...
fn intermediates(
    ...
    let intermediate5 = intermediate5(trace_1_column_10_offset_0);
...
pub fn intermediate26(
    ...
    trace_1_column_66_offset_0
        ...
        + (trace_1_column_69_offset_0) * (m31(134217728).into())
}
...
pub fn intermediate9(
    ...
    trace_1_column_16_offset_0
        ...
        + (trace_1_column_19_offset_0) * (m31(134217728).into())
}
...
pub fn intermediate11(
    ...
    trace_1_column_24_offset_0
        ...
        + (trace_1_column_26_offset_0) * (m31(262144).into())
        + (trace_1_column_27_offset_0) * (m31(134217728).into())
}
...
pub fn intermediate12(
    ...
    trace_1_column_28_offset_0
        + (trace_1_column_29_offset_0) * (m31(512).into())
        + (trace_1_column_30_offset_0) * (m31(262144).into())
        + (trace_1_column_31_offset_0) * (m31(134217728).into())
}
...
pub fn intermediate18(
    ...
    trace_1_column_43_offset_0
        + (trace_1_column_44_offset_0) * (m31(512).into())
        + (trace_1_column_45_offset_0) * (m31(262144).into())
        + (trace_1_column_46_offset_0) * (m31(134217728).into())
}

pub fn intermediate5(trace_1_column_10_offset_0: QM31) -> QM31 {
    m31(1).into() - (trace_1_column_10_offset_0)
}
...
pub fn intermediate16(
    ...
    trace_1_column_35_offset_0
        + (trace_1_column_36_offset_0) * (m31(512).into())
        + (trace_1_column_37_offset_0) * (m31(262144).into())
        + (trace_1_column_38_offset_0) * (m31(134217728).into())
}
...
pub fn intermediate24(
    ...
    trace_1_column_58_offset_0
        ...
        + (trace_1_column_61_offset_0) * (m31(134217728).into())
}
...
pub fn intermediate23(
    ...
    trace_1_column_54_offset_0
        ...
        + (trace_1_column_57_offset_0) * (m31(134217728).into())
}
...
pub fn intermediate19(
    ...
    trace_1_column_47_offset_0
        + (trace_1_column_48_offset_0) * (m31(512).into())
        + (trace_1_column_49_offset_0) * (m31(262144).into())
        + (trace_1_column_50_offset_0) * (m31(134217728).into())
}
...
pub fn intermediate25(
    ...
    trace_1_column_62_offset_0
        ...
        + (trace_1_column_65_offset_0) * (m31(134217728).into())
}
...
pub fn intermediate10(
    ...
    trace_1_column_20_offset_0
        ...
        + (trace_1_column_22_offset_0) * (m31(262144).into())
        + (trace_1_column_23_offset_0) * (m31(134217728).into())
}
...
pub fn intermediate17(
    ...
    trace_1_column_39_offset_0
        ...
        + (trace_1_column_42_offset_0) * (m31(134217728).into())
}
    ...
    (VerifyInstruction_alpha0) * (trace_1_column_0_offset_0)
        ...
        + (VerifyInstruction_alpha4)
            * ((trace_1_column_6_offset_0) * (m31(8).into())
                ...
                + (m31(1).into() - (trace_1_column_8_offset_0) - (trace_1_column_9_offset_0))
                    * (m31(128).into())
                + (trace_1_column_10_offset_0) * (m31(256).into()))
        + (VerifyInstruction_alpha5)
            * (m31(1).into()
                - (trace_1_column_10_offset_0)
                + (trace_1_column_11_offset_0) * (m31(32).into())
                + m31(256).into())
        + (VerifyInstruction_alpha6) * (qm31_const::<3, 0, 0, 0>())
        - (VerifyInstruction_z)
}
...
pub fn intermediate14(
    ...
    (MemoryIdToBig_alpha0) * (trace_1_column_34_offset_0)
        + (MemoryIdToBig_alpha1) * (trace_1_column_35_offset_0)
        + (MemoryIdToBig_alpha2) * (trace_1_column_36_offset_0)
        + (MemoryIdToBig_alpha3) * (trace_1_column_37_offset_0)
        + (MemoryIdToBig_alpha4) * (trace_1_column_38_offset_0)
        + (MemoryIdToBig_alpha5) * (trace_1_column_39_offset_0)
        + (MemoryIdToBig_alpha6) * (trace_1_column_40_offset_0)
        + (MemoryIdToBig_alpha7) * (trace_1_column_41_offset_0)
        + (MemoryIdToBig_alpha8) * (trace_1_column_42_offset_0)
        + (MemoryIdToBig_alpha9) * (trace_1_column_43_offset_0)
        + (MemoryIdToBig_alpha10) * (trace_1_column_44_offset_0)
        + (MemoryIdToBig_alpha11) * (trace_1_column_45_offset_0)
        + (MemoryIdToBig_alpha12) * (trace_1_column_46_offset_0)
        + (MemoryIdToBig_alpha13) * (trace_1_column_47_offset_0)
        + (MemoryIdToBig_alpha14) * (trace_1_column_48_offset_0)
        + (MemoryIdToBig_alpha15) * (trace_1_column_49_offset_0)
        + (MemoryIdToBig_alpha16) * (trace_1_column_50_offset_0)
        - (MemoryIdToBig_z)
}
...
pub fn intermediate7(
    ...
    (MemoryIdToBig_alpha0) * (trace_1_column_15_offset_0)
        + (MemoryIdToBig_alpha1) * (trace_1_column_16_offset_0)
        + (MemoryIdToBig_alpha2) * (trace_1_column_17_offset_0)
        + (MemoryIdToBig_alpha3) * (trace_1_column_18_offset_0)
        + (MemoryIdToBig_alpha4) * (trace_1_column_19_offset_0)
        + (MemoryIdToBig_alpha5) * (trace_1_column_20_offset_0)
        + (MemoryIdToBig_alpha6) * (trace_1_column_21_offset_0)
        + (MemoryIdToBig_alpha7) * (trace_1_column_22_offset_0)
        + (MemoryIdToBig_alpha8) * (trace_1_column_23_offset_0)
        + (MemoryIdToBig_alpha9) * (trace_1_column_24_offset_0)
        + (MemoryIdToBig_alpha10) * (trace_1_column_25_offset_0)
        + (MemoryIdToBig_alpha11) * (trace_1_column_26_offset_0)
        + (MemoryIdToBig_alpha12) * (trace_1_column_27_offset_0)
        + (MemoryIdToBig_alpha13) * (trace_1_column_28_offset_0)
        + (MemoryIdToBig_alpha14) * (trace_1_column_29_offset_0)
        + (MemoryIdToBig_alpha15) * (trace_1_column_30_offset_0)
        + (MemoryIdToBig_alpha16) * (trace_1_column_31_offset_0)
        - (MemoryIdToBig_z)
}
...
pub fn intermediate22(
    ...
    (RangeCheck_4_4_4_4_alpha0) * (trace_1_column_57_offset_0)
        + (RangeCheck_4_4_4_4_alpha1) * (trace_1_column_61_offset_0)
        + (RangeCheck_4_4_4_4_alpha2) * (trace_1_column_65_offset_0)
        + (RangeCheck_4_4_4_4_alpha3) * (trace_1_column_69_offset_0)
        - (RangeCheck_4_4_4_4_z)
}
...
pub fn intermediate28(
    ...
    (Opcodes_alpha0) * (trace_1_column_0_offset_0 + m31(1).into() + trace_1_column_8_offset_0)
        + (Opcodes_alpha1) * (trace_1_column_1_offset_0 + trace_1_column_11_offset_0)
...
pub fn intermediate13(
    ...
    (MemoryAddressToId_alpha0) * (trace_1_column_13_offset_0 + intermediate2)
        + (MemoryAddressToId_alpha1) * (trace_1_column_34_offset_0)
        - (MemoryAddressToId_z)
}
...
pub fn intermediate15(
    ...
    (RangeCheck_4_4_4_4_alpha0) * (trace_1_column_38_offset_0)
        + (RangeCheck_4_4_4_4_alpha1) * (trace_1_column_42_offset_0)
        + (RangeCheck_4_4_4_4_alpha2) * (trace_1_column_46_offset_0)
        + (RangeCheck_4_4_4_4_alpha3) * (trace_1_column_50_offset_0)
        - (RangeCheck_4_4_4_4_z)
}
...
pub fn intermediate21(
    ...
    (MemoryIdToBig_alpha0) * (trace_1_column_53_offset_0)
        ...
        + (MemoryIdToBig_alpha4) * (trace_1_column_57_offset_0)
        + (MemoryIdToBig_alpha5) * (trace_1_column_58_offset_0)
        + (MemoryIdToBig_alpha6) * (trace_1_column_59_offset_0)
        + (MemoryIdToBig_alpha7) * (trace_1_column_60_offset_0)
        + (MemoryIdToBig_alpha8) * (trace_1_column_61_offset_0)
        + (MemoryIdToBig_alpha9) * (trace_1_column_62_offset_0)
        + (MemoryIdToBig_alpha10) * (trace_1_column_63_offset_0)
        + (MemoryIdToBig_alpha11) * (trace_1_column_64_offset_0)
        + (MemoryIdToBig_alpha12) * (trace_1_column_65_offset_0)
        + (MemoryIdToBig_alpha13) * (trace_1_column_66_offset_0)
        + (MemoryIdToBig_alpha14) * (trace_1_column_67_offset_0)
        + (MemoryIdToBig_alpha15) * (trace_1_column_68_offset_0)
        + (MemoryIdToBig_alpha16) * (trace_1_column_69_offset_0)
        - (MemoryIdToBig_z)
}
...
pub fn intermediate20(
    ...
    (MemoryAddressToId_alpha0) * (trace_1_column_14_offset_0 + intermediate3)
...
pub fn intermediate8(
    ...
    (RangeCheck_4_4_4_4_alpha0) * (trace_1_column_19_offset_0)
        + (RangeCheck_4_4_4_4_alpha1) * (trace_1_column_23_offset_0)
        + (RangeCheck_4_4_4_4_alpha2) * (trace_1_column_27_offset_0)
        + (RangeCheck_4_4_4_4_alpha3) * (trace_1_column_31_offset_0)
        - (RangeCheck_4_4_4_4_z)
}
...
pub fn intermediate6(
    ...
    (MemoryAddressToId_alpha0) * (trace_1_column_12_offset_0 + intermediate1)
