...
use crate::components::{CairoComponent, RANGE_CHECK_19_G_LOG_SIZE};

pub const N_TRACE_COLUMNS: usize = 1;
pub const LOG_SIZE: u32 = RANGE_CHECK_19_G_LOG_SIZE;
...
pub impl ComponentImpl of CairoComponent<Component> {
    ...
    fn evaluate_constraints_at_point(
        ...
        let mut range_check_19_g_sum_0: QM31 = Zero::zero();
        ...
        range_check_19_g_sum_0 = self.range_check_19_g_lookup_elements.combine_qm31([seq]);
