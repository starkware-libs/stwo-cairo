...
pub fn mask_points(
    ...
    preprocessed_column_set.insert(PreprocessedColumn::Xor((7, 0)));
    preprocessed_column_set.insert(PreprocessedColumn::Xor((7, 1)));
    preprocessed_column_set.insert(PreprocessedColumn::Xor((7, 2)));
...
pub struct ConstraintParams {
    ...
    pub bitwise_xor_7_0: QM31,
    pub bitwise_xor_7_1: QM31,
    pub bitwise_xor_7_2: QM31,
...
fn intermediates(
    ...
    bitwise_xor_7_0: QM31,
    bitwise_xor_7_1: QM31,
    bitwise_xor_7_2: QM31,
) -> Array<QM31> {
...
pub fn intermediate0(
    ...
    (VerifyBitwiseXor_7_alpha0) * (bitwise_xor_7_0)
        + (VerifyBitwiseXor_7_alpha1) * (bitwise_xor_7_1)
        + (VerifyBitwiseXor_7_alpha2) * (bitwise_xor_7_2)
        - (VerifyBitwiseXor_7_z)
}
