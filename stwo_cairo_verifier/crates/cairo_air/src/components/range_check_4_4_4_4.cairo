...
pub const N_TRACE_COLUMNS: usize = 1;const SOME_COLUMN: PreprocessedColumn = PreprocessedColumn::RangeCheck4(([4,4,4,4], 0));
...
pub impl CairoComponentImpl of CairoComponent<Component> {
    fn mask_points(
        ...
        preprocessed_column_set.insert(PreprocessedColumn::RangeCheck4(([4,4,4,4], 0)));preprocessed_column_set.insert(PreprocessedColumn::RangeCheck4(([4,4,4,4], 1)));preprocessed_column_set.insert(PreprocessedColumn::RangeCheck4(([4,4,4,4], 2)));preprocessed_column_set.insert(PreprocessedColumn::RangeCheck4(([4,4,4,4], 3)));trace_mask_points.append(array![point]);interaction_trace_mask_points.append(array![point_offset_neg_1, point]);
    ...
    fn evaluate_constraints_at_point(
        ...
        let mut range_check_4_4_4_4_sum_0: QM31 = Zero::zero();let rangecheck_4_4_4_4_0
        ...
        range_check_4_4_4_4_sum_0 = self.range_check_4_4_4_4_lookup_elements.combine_qm31(
            [
