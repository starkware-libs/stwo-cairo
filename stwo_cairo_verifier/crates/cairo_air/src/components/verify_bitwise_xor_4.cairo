...
pub impl CairoComponentImpl of CairoComponent<Component> {
    fn mask_points(
        ...
        preprocessed_column_set.insert(preprocessed_columns::BITWISE_XOR__4_0_IDX);
        preprocessed_column_set.insert(preprocessed_columns::BITWISE_XOR__4_1_IDX);
        preprocessed_column_set.insert(preprocessed_columns::BITWISE_XOR__4_2_IDX);
    ...
    fn evaluate_constraints_at_point(
        ...
        let bitwisexor_4_0 = preprocessed_mask_values
            .get(preprocessed_columns::BITWISE_XOR__4_0_IDX);
        let bitwisexor_4_1 = preprocessed_mask_values
            .get(preprocessed_columns::BITWISE_XOR__4_1_IDX);
        let bitwisexor_4_2 = preprocessed_mask_values
            .get(preprocessed_columns::BITWISE_XOR__4_2_IDX);
