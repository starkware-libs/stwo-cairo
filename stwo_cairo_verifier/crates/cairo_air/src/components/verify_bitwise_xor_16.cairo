...
pub const N_TRACE_COLUMNS: usize = 1;const SOME_COLUMN: PreprocessedColumn = PreprocessedColumn::BitwiseXor((16, 0));
...
pub impl CairoComponentImpl of CairoComponent<Component> {
    fn mask_points(
        ...
        preprocessed_column_set.insert(PreprocessedColumn::BitwiseXor((16, 0)));preprocessed_column_set.insert(PreprocessedColumn::BitwiseXor((16, 1)));preprocessed_column_set.insert(PreprocessedColumn::BitwiseXor((16, 2)));trace_mask_points.append(array![point]);interaction_trace_mask_points.append(array![point_offset_neg_1, point]);
    ...
    fn evaluate_constraints_at_point(
        ...
        let mut verify_bitwise_xor_16_sum_0: QM31 = Zero::zero();let bitwisexor_16_0
            = preprocessed_mask_values.get(PreprocessedColumn::BitwiseXor((16, 0)));
        let bitwisexor_16_1
            = preprocessed_mask_values.get(PreprocessedColumn::BitwiseXor((16, 1)));
        let bitwisexor_16_2
            = preprocessed_mask_values.get(PreprocessedColumn::BitwiseXor((16, 2)));
        ...
        verify_bitwise_xor_16_sum_0 = self.verify_bitwise_xor_16_lookup_elements.combine_qm31(
            [
                bitwisexor_16_0,
bitwisexor_16_1,
bitwisexor_16_2
...
fn lookup_constraints(
    ...
    column_size: M31,
    ref interaction_trace_mask_values: ColumnSpan<Span<QM31>>,
    verify_bitwise_xor_16_sum_0: QM31
) {
