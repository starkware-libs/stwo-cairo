...
pub impl CairoComponentImpl of CairoComponent<Component> {
    fn evaluate_constraints_at_point(
        ...
        let [pedersen_points_table_bits_per_window_9_multiplicity]: [Span<QM31>; 1] =
            (*trace_mask_values
            .multi_pop_front()
            .unwrap())
            .unbox();
        let [pedersen_points_table_bits_per_window_9_multiplicity]: [QM31; 1] =
            (*pedersen_points_table_bits_per_window_9_multiplicity
            .try_into()
            .unwrap())
            .unbox();
...
fn lookup_constraints(
    ...
    random_coeff: QM31,
    claimed_sum: QM31,
    pedersen_points_table_bits_per_window_9_multiplicity: QM31,
    column_size: M31,
    ref interaction_trace_mask_values: ColumnSpan<Span<QM31>>,
