...
pub impl CairoComponentImpl of CairoComponent<Component> {
    ...
    fn evaluate_constraints_at_point(
        ...
        let mut sha_256_small_sigma_0_sum_0: QM31 = Zero::zero();
        let mut sha_256_small_sigma_1_sum_1: QM31 = Zero::zero();
        let mut range_check_2_sum_2: QM31 = Zero::zero();
        let mut range_check_2_sum_3: QM31 = Zero::zero();
        let mut sha_256_schedule_sum_4: QM31 = Zero::zero();
        ...
        let [sha_256_small_sigma_0_output_limb_0_col32]: [QM31; 1] =
            (*sha_256_small_sigma_0_output_limb_0_col32
            .try_into()
            .unwrap())
            .unbox();
        let [sha_256_small_sigma_0_output_limb_1_col33]: [QM31; 1] =
            (*sha_256_small_sigma_0_output_limb_1_col33
            .try_into()
            .unwrap())
            .unbox();
        let [sha_256_small_sigma_1_output_limb_0_col34]: [QM31; 1] =
            (*sha_256_small_sigma_1_output_limb_0_col34
            .try_into()
            .unwrap())
            .unbox();
        let [sha_256_small_sigma_1_output_limb_1_col35]: [QM31; 1] =
            (*sha_256_small_sigma_1_output_limb_1_col35
            .try_into()
            .unwrap())
            .unbox();
        let [w_i_limb_0_col36]: [QM31; 1] = (*w_i_limb_0_col36.try_into().unwrap()).unbox();
        let [w_i_limb_1_col37]: [QM31; 1] = (*w_i_limb_1_col37.try_into().unwrap()).unbox();
        ...
        sha_256_small_sigma_0_sum_0 = self
            ...
            .combine_qm31(
                [
                    input_limb_2_col2, input_limb_3_col3, sha_256_small_sigma_0_output_limb_0_col32,
                    sha_256_small_sigma_0_output_limb_1_col33,
                ],
            );

        sha_256_small_sigma_1_sum_1 = self
            .sha_256_small_sigma_1_lookup_elements
            .combine_qm31(
                [
                    input_limb_28_col28, input_limb_29_col29,
                    sha_256_small_sigma_1_output_limb_0_col34,
                    sha_256_small_sigma_1_output_limb_1_col35,
                ],
            );
        let carry_low_tmp_3b5f1_3: QM31 = (((((input_limb_0_col0
            + sha_256_small_sigma_0_output_limb_0_col32)
            + input_limb_18_col18)
            + sha_256_small_sigma_1_output_limb_0_col34)
            - w_i_limb_0_col36)
        ...
        range_check_2_sum_2 = self
            .range_check_2_lookup_elements
            .combine_qm31([carry_low_tmp_3b5f1_3]);
        let carry_high_tmp_3b5f1_4: QM31 = ((((((input_limb_1_col1
            + sha_256_small_sigma_0_output_limb_1_col33)
            + input_limb_19_col19)
            + sha_256_small_sigma_1_output_limb_1_col35)
        ...
        range_check_2_sum_3 = self
            .range_check_2_lookup_elements
            .combine_qm31([carry_high_tmp_3b5f1_4]);

        sha_256_schedule_sum_4 = self
            ...
            .combine_qm31(
                [
                    ...
                    input_limb_30_col30, input_limb_31_col31, w_i_limb_0_col36, w_i_limb_1_col37,
                ],
            );
