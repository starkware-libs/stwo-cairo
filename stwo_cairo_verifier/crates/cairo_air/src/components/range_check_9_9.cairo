...
use crate::components::{
    CairoComponent, OPCODES_RELATION_SIZE, RANGE_CHECK_9_9_LOG_SIZE, opcodes_sum,
};
...
pub const RANGE_CHECK_9_9_RELATION_SIZE: usize = 2;
...
pub impl ComponentImpl of CairoComponent<Component> {
    ...
    fn evaluate_constraints_at_point(
        ...
        range_check_9_9_sum_0 =
            range_check_9_9_sum(
                range_check_9_9_alphas, range_check_9_9_z, [rangecheck_9_9_0, rangecheck_9_9_1],
            );
...
pub fn range_check_9_9_sum(mut alphas: Span<QM31>, z: QM31, values: [QM31; 2]) -> QM31 {
