...
pub fn evaluate_constraints_at_point(
    ...
    let [
        trace_2_column_17, trace_2_column_18, trace_2_column_19, trace_2_column_20,
    ]: [Span<QM31>; 4] =
...
fn intermediates(
    ...
    let intermediate1 = intermediate1(trace_1_column_15_offset_0, trace_1_column_16_offset_0);
...
pub fn intermediate1(trace_1_column_15_offset_0: QM31, trace_1_column_16_offset_0: QM31) -> QM31 {
    trace_1_column_15_offset_0 - ((trace_1_column_16_offset_0) * (m31(2).into()))
}
pub fn intermediate0(
    ...
    (MemoryAddressToId_alpha0) * (builtin_segment_start.into() + seq)
