...
use crate::PreprocessedColumnTrait;use crate::components::subroutines::decode_instruction_15a61::decode_instruction_15a61_evaluate;use crate::components::subroutines::read_positive_num_bits_27::read_positive_num_bits_27_evaluate;

pub const N_TRACE_COLUMNS: usize = 12;pub const RELATION_USES_PER_ROW: [(felt252, u32); 4] = [
...
pub impl ComponentImpl of CairoComponent<Component> {
    fn mask_points(
        ...
        trace_mask_points.append(array![point]);trace_mask_points.append(array![point]);trace_mask_points.append(array![point]);trace_mask_points.append(array![point]);trace_mask_points.append(array![point]);trace_mask_points.append(array![point]);trace_mask_points.append(array![point]);trace_mask_points.append(array![point]);trace_mask_points.append(array![point]);trace_mask_points.append(array![point]);trace_mask_points.append(array![point]);trace_mask_points.append(array![point]);interaction_trace_mask_points.append(array![point]);interaction_trace_mask_points.append(array![point]);interaction_trace_mask_points.append(array![point]);interaction_trace_mask_points.append(array![point]);interaction_trace_mask_points.append(array![point]);interaction_trace_mask_points.append(array![point]);interaction_trace_mask_points.append(array![point]);interaction_trace_mask_points.append(array![point]);interaction_trace_mask_points.append(array![point]);interaction_trace_mask_points.append(array![point]);interaction_trace_mask_points.append(array![point]);interaction_trace_mask_points.append(array![point]);interaction_trace_mask_points.append(array![point_offset_neg_1, point]);
    ...
    fn evaluate_constraints_at_point(
        ...
        let [input_pc_col0, input_ap_col1, input_fp_col2, next_pc_id_col3, next_pc_limb_0_col4, next_pc_limb_1_col5, next_pc_limb_2_col6, next_fp_id_col7, next_fp_limb_0_col8, next_fp_limb_1_col9, next_fp_limb_2_col10, enabler]: [Span<QM31>; 12]
            = (*trace_mask_values.multi_pop_front().unwrap()).unbox();
        let [input_pc_col0]: [QM31; 1] = (*input_pc_col0.try_into().unwrap()).unbox();let [input_ap_col1]: [QM31; 1] = (*input_ap_col1.try_into().unwrap()).unbox();let [input_fp_col2]: [QM31; 1] = (*input_fp_col2.try_into().unwrap()).unbox();let [next_pc_id_col3]: [QM31; 1] = (*next_pc_id_col3.try_into().unwrap()).unbox();let [next_pc_limb_0_col4]: [QM31; 1] = (*next_pc_limb_0_col4.try_into().unwrap()).unbox();let [next_pc_limb_1_col5]: [QM31; 1] = (*next_pc_limb_1_col5.try_into().unwrap()).unbox();let [next_pc_limb_2_col6]: [QM31; 1] = (*next_pc_limb_2_col6.try_into().unwrap()).unbox();let [next_fp_id_col7]: [QM31; 1] = (*next_fp_id_col7.try_into().unwrap()).unbox();let [next_fp_limb_0_col8]: [QM31; 1] = (*next_fp_limb_0_col8.try_into().unwrap()).unbox();let [next_fp_limb_1_col9]: [QM31; 1] = (*next_fp_limb_1_col9.try_into().unwrap()).unbox();let [next_fp_limb_2_col10]: [QM31; 1] = (*next_fp_limb_2_col10.try_into().unwrap()).unbox();let [enabler]: [QM31; 1] = (*enabler.try_into().unwrap()).unbox();
...
input_fp_col2
        ...
        opcodes_sum_6 = self.opcodes_lookup_elements.combine_qm31(
            [
                ((next_pc_limb_0_col4 + (next_pc_limb_1_col5 * qm31_const::<512, 0, 0, 0>())) + (next_pc_limb_2_col6 * qm31_const::<262144, 0, 0, 0>())),
input_ap_col1,
((next_fp_limb_0_col8 + (next_fp_limb_1_col9 * qm31_const::<512, 0, 0, 0>())) + (next_fp_limb_2_col10 * qm31_const::<262144, 0, 0, 0>()))
            ],
        );
