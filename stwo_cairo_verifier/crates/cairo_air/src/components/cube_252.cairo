...
fn lookup_constraints(
    ...
    let [trace_2_col196_neg1, trace_2_col196]: [QM31; N_SAMPLES_FOR_PREFIX_SUM] = (*trace_2_col196
        .try_into()
        .unwrap())
        .unbox();
    let [trace_2_col197_neg1, trace_2_col197]: [QM31; N_SAMPLES_FOR_PREFIX_SUM] = (*trace_2_col197
        .try_into()
        .unwrap())
        .unbox();
    let [trace_2_col198_neg1, trace_2_col198]: [QM31; N_SAMPLES_FOR_PREFIX_SUM] = (*trace_2_col198
        .try_into()
        .unwrap())
        .unbox();
    let [trace_2_col199_neg1, trace_2_col199]: [QM31; N_SAMPLES_FOR_PREFIX_SUM] = (*trace_2_col199
        .try_into()
        .unwrap())
        .unbox();
