...
pub impl CairoComponentImpl of CairoComponent<Component> {
    fn mask_points(
        ...
        preprocessed_column_set.insert(RANGE_CHECK_2_5_4_0_IDX);
        preprocessed_column_set.insert(RANGE_CHECK_2_5_4_1_IDX);
    ...
    fn evaluate_constraints_at_point(
        ...
        let rangecheck_5_4_0 = preprocessed_mask_values.get(RANGE_CHECK_2_5_4_0_IDX);
        let rangecheck_5_4_1 = preprocessed_mask_values.get(RANGE_CHECK_2_5_4_1_IDX);
