...
use crate::components::{
    CairoComponent, OPCODES_RELATION_SIZE, RANGE_CHECK_5_4_LOG_SIZE, opcodes_sum,
};
...
pub const RANGE_CHECK_5_4_RELATION_SIZE: usize = 2;
...
//         range_check_5_4_sum_0 = range_check_5_4_sum(
...
pub fn range_check_5_4_sum(mut alphas: Span<QM31>, z: QM31, values: [QM31; 2]) -> QM31 {
