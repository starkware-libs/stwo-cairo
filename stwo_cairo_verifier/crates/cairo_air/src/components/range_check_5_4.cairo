...
pub impl CairoComponentImpl of CairoComponent<Component> {
    fn evaluate_constraints_at_point(
        ...
        let range_check_5_4_column_0 = preprocessed_mask_values
            .get_and_mark_used(RANGE_CHECK_5_4_COLUMN_0_IDX);
        let range_check_5_4_column_1 = preprocessed_mask_values
            .get_and_mark_used(RANGE_CHECK_5_4_COLUMN_1_IDX);

        let [range_check_5_4_multiplicity]: [Span<QM31>; 1] = (*trace_mask_values
            .multi_pop_front()
            .unwrap())
            .unbox();
        let [range_check_5_4_multiplicity]: [QM31; 1] = (*range_check_5_4_multiplicity
            .try_into()
            .unwrap())
            .unbox();
        ...
        range_check_5_4_sum_0 = self
            ...
            .combine_qm31([range_check_5_4_column_0, range_check_5_4_column_1]);
...
fn lookup_constraints(
    ...
    random_coeff: QM31,
    claimed_sum: QM31,
    range_check_5_4_multiplicity: QM31,
    column_size: M31,
    ref interaction_trace_mask_values: ColumnSpan<Span<QM31>>,
