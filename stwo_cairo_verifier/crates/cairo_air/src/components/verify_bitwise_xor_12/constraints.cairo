...
pub fn mask_points(
    ...
    preprocessed_column_set.insert(PreprocessedColumn::Xor((12, 0)));
    preprocessed_column_set.insert(PreprocessedColumn::Xor((12, 1)));
    preprocessed_column_set.insert(PreprocessedColumn::Xor((12, 2)));
...
pub struct ConstraintParams {
    ...
    pub bitwise_xor_12_0: QM31,
    pub bitwise_xor_12_1: QM31,
    pub bitwise_xor_12_2: QM31,
...
fn intermediates(
    ...
    bitwise_xor_12_0: QM31,
    bitwise_xor_12_1: QM31,
    bitwise_xor_12_2: QM31,
) -> Array<QM31> {
...
pub fn intermediate0(
    ...
    (VerifyBitwiseXor_12_alpha0) * (bitwise_xor_12_0)
        + (VerifyBitwiseXor_12_alpha1) * (bitwise_xor_12_1)
        + (VerifyBitwiseXor_12_alpha2) * (bitwise_xor_12_2)
        - (VerifyBitwiseXor_12_z)
}
