...
pub fn mask_points(
    ...
    preprocessed_column_set.insert(PreprocessedColumn::Xor((10, 0)));
    preprocessed_column_set.insert(PreprocessedColumn::Xor((10, 1)));
    preprocessed_column_set.insert(PreprocessedColumn::Xor((10, 2)));
