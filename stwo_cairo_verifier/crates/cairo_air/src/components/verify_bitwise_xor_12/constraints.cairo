...
pub fn mask_points(
    ...
    preprocessed_column_set.insert(preprocessed_columns::BITWISE_XOR_10_0_IDX);
    preprocessed_column_set.insert(preprocessed_columns::BITWISE_XOR_10_1_IDX);
    preprocessed_column_set.insert(preprocessed_columns::BITWISE_XOR_10_2_IDX);
