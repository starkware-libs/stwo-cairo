...
pub fn evaluate_constraints_at_point(
    ...
    let constraint_quotient = ((QM31Trait::from_partial_evals(
        ...
        * ((intermediate85) * (intermediate86))
        - ((intermediate86) * (trace_1_column_170_offset_0)
            - ((intermediate85) * (trace_1_column_170_offset_0))))
        * domain_vanish_at_point_inv;
    sum = sum * random_coeff + constraint_quotient;
}
...
fn intermediates(
    ...
    let intermediate13 = intermediate13(
        trace_1_column_14_offset_0, trace_1_column_15_offset_0, trace_1_column_16_offset_0,
    );
    ...
    let intermediate16 = intermediate16(trace_1_column_11_offset_0);

    let intermediate41 = intermediate41(trace_1_column_27_offset_0, trace_1_column_81_offset_0);

    let intermediate42 = intermediate42(trace_1_column_28_offset_0, trace_1_column_82_offset_0);

    let intermediate47 = intermediate47(trace_1_column_83_offset_0, trace_1_column_84_offset_0);

    let intermediate48 = intermediate48(trace_1_column_85_offset_0, trace_1_column_86_offset_0);

    let intermediate49 = intermediate49(intermediate16);

    let intermediate50 = intermediate50(intermediate16);
...
pub fn intermediate42(trace_1_column_28_offset_0: QM31, trace_1_column_82_offset_0: QM31) -> QM31 {
...
pub fn intermediate47(trace_1_column_83_offset_0: QM31, trace_1_column_84_offset_0: QM31) -> QM31 {
    trace_1_column_83_offset_0 + (trace_1_column_84_offset_0) * (m31(256).into())
}

pub fn intermediate48(trace_1_column_85_offset_0: QM31, trace_1_column_86_offset_0: QM31) -> QM31 {
    trace_1_column_85_offset_0 + (trace_1_column_86_offset_0) * (m31(256).into())
}

pub fn intermediate49(intermediate16: QM31) -> QM31 {
    (intermediate16) * (m31(9812).into()) + (m31(1).into() - (intermediate16)) * (m31(55723).into())
}

pub fn intermediate50(intermediate16: QM31) -> QM31 {
    (intermediate16) * (m31(57468).into()) + (m31(1).into() - (intermediate16)) * (m31(8067).into())
}
...
pub fn intermediate16(trace_1_column_11_offset_0: QM31) -> QM31 {
    trace_1_column_11_offset_0 - (m31(1).into())
}

pub fn intermediate41(trace_1_column_27_offset_0: QM31, trace_1_column_81_offset_0: QM31) -> QM31 {
...
pub fn intermediate36(
    ...
    (MemoryAddressToId_alpha0) * (intermediate13 + m31(6).into())
...
pub fn intermediate11(
    ...
    (MemoryAddressToId_alpha0) * (trace_1_column_26_offset_0 + intermediate1)
...
pub fn intermediate21(
    ...
    (MemoryAddressToId_alpha0) * (intermediate13 + m31(1).into())
...
pub fn intermediate24(
    ...
    (MemoryAddressToId_alpha0) * (intermediate13 + m31(2).into())
...
pub fn intermediate6(
    ...
    (MemoryAddressToId_alpha0) * (trace_1_column_17_offset_0 + intermediate3)
...
pub fn intermediate43(
    ...
    (VerifyBitwiseXor_8_alpha0) * (intermediate41)
...
pub fn intermediate27(
    ...
    (MemoryAddressToId_alpha0) * (intermediate13 + m31(3).into())
...
pub fn intermediate33(
    ...
    (MemoryAddressToId_alpha0) * (intermediate13 + m31(5).into())
...
pub fn intermediate51(
    ...
    (BlakeRound_alpha0) * (seq)
        ...
        + (BlakeRound_alpha26) * (intermediate47)
        + (BlakeRound_alpha27) * (intermediate48)
        + (BlakeRound_alpha28) * (qm31_const::<26764, 0, 0, 0>())
        + (BlakeRound_alpha29) * (qm31_const::<39685, 0, 0, 0>())
        + (BlakeRound_alpha30) * (intermediate49)
        + (BlakeRound_alpha31) * (intermediate50)
        + (BlakeRound_alpha32) * (qm31_const::<52505, 0, 0, 0>())
        + (BlakeRound_alpha33) * (qm31_const::<23520, 0, 0, 0>())
        + (BlakeRound_alpha34) * (intermediate14)
        - (BlakeRound_z)
}
...
pub fn intermediate77(
    ...
    (MemoryAddressToId_alpha0) * (intermediate15 + m31(5).into())
...
pub fn intermediate39(
    ...
    (MemoryAddressToId_alpha0) * (intermediate13 + m31(7).into())
...
pub fn intermediate71(
    ...
    (MemoryAddressToId_alpha0) * (intermediate15 + m31(3).into())
...
pub fn intermediate45(
    ...
    (VerifyBitwiseXor_8_alpha0) * (intermediate42)
...
pub fn intermediate65(
    ...
    (MemoryAddressToId_alpha0) * (intermediate15 + m31(1).into())
...
pub fn intermediate80(
    ...
    (MemoryAddressToId_alpha0) * (intermediate15 + m31(6).into())
...
pub fn intermediate83(
    ...
    (MemoryAddressToId_alpha0) * (intermediate15 + m31(7).into())
...
pub fn intermediate18(
    ...
    (MemoryAddressToId_alpha0) * (intermediate13)
...
pub fn intermediate62(
    ...
    (MemoryAddressToId_alpha0) * (intermediate15)
...
pub fn intermediate30(
    ...
    (MemoryAddressToId_alpha0) * (intermediate13 + m31(4).into())
...
pub fn intermediate74(
    ...
    (MemoryAddressToId_alpha0) * (intermediate15 + m31(4).into())
...
pub fn intermediate68(
    ...
    (MemoryAddressToId_alpha0) * (intermediate15 + m31(2).into())
