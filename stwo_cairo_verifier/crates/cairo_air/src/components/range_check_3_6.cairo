...
use crate::components::RANGE_CHECK_3_6_LOG_SIZE;
...
let rangecheck_3_6_0
            = preprocessed_mask_values.get(PreprocessedColumn::RangeCheck2(([3,6], 0)));

        let rangecheck_3_6_1
            = preprocessed_mask_values.get(PreprocessedColumn::RangeCheck2(([3,6], 1)));
...
let [enabler]: [QM31; 1] = (*enabler.try_into().unwrap()).unbox();
        ...
        range_check_3_6_sum_0 = self.range_check_3_6_lookup_elements.combine_qm31(
            [
                rangecheck_3_6_0,
rangecheck_3_6_1
            ],
