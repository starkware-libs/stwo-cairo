...
use crate::components::{CairoComponent, OPCODES_RELATION_SIZE, RANGE_CHECK_3_6_LOG_SIZE};
use crate::utils::U32Impl;


pub const N_TRACE_COLUMNS: usize = 1;
pub const LOG_SIZE: u32 = RANGE_CHECK_3_6_LOG_SIZE;
pub const RANGE_CHECK_3_6_RELATION_SIZE: usize = 2;
...
pub struct Component {
    ...
    pub range_check_3_6_lookup_elements: crate::RangeCheck_3_6Elements,
}
...
pub impl ComponentImpl of CairoComponent<Component> {
    fn mask_points(
        ...
        preprocessed_column_set.insert(PreprocessedColumn::RangeCheck2(([3, 6], 0)));
        preprocessed_column_set.insert(PreprocessedColumn::RangeCheck2(([3, 6], 1)));
    ...
    fn evaluate_constraints_at_point(
        ...
        let mut range_check_3_6_sum_0: QM31 = Zero::zero();
        let rangecheck_3_6_0 = preprocessed_mask_values
            .get(PreprocessedColumn::RangeCheck2(([3, 6], 0)));

        let rangecheck_3_6_1 = preprocessed_mask_values
        ...
        range_check_3_6_sum_0 = self
            .range_check_3_6_lookup_elements
            .combine_qm31([rangecheck_3_6_0, rangecheck_3_6_1]);
