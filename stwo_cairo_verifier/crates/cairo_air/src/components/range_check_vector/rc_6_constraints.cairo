...
pub fn mask_points(
    ...
    preprocessed_column_set.insert(PreprocessedColumn::RangeCheck5(([6, 0, 0, 0, 0], 0)));
...
pub struct ConstraintParams {
    ...
    pub range_check_6_column_0: QM31,
    pub column_size: M31,
}
...
pub fn evaluate_constraints_at_point(
    ...
    let ConstraintParams {
        RangeCheck_6_alpha0, RangeCheck_6_z, claimed_sum, range_check_6_column_0, column_size,
    } = params;
    ...
    let mut intermediates = intermediates(
        RangeCheck_6_alpha0, RangeCheck_6_z, range_check_6_column_0,
    )
        .span();
...
fn intermediates(
    RangeCheck_6_alpha0: QM31, RangeCheck_6_z: QM31, range_check_6_column_0: QM31,
) -> Array<QM31> {
    let intermediate0 = intermediate0(RangeCheck_6_alpha0, RangeCheck_6_z, range_check_6_column_0);
    array![intermediate0]
}
...
pub fn intermediate0(
    ...
    (RangeCheck_6_alpha0) * (range_check_6_column_0) - (RangeCheck_6_z)
}
