...
pub fn evaluate_constraints_at_point(
    ...
    let ConstraintParams { RangeCheck_12_alpha0, RangeCheck_12_z, claimed_sum, log_size } = params;
    ...
    let mut intermediates = intermediates(
        RangeCheck_12_alpha0, RangeCheck_12_z, trace_1_column_0_offset_0,
    )
        .span();
...
fn intermediates(
    RangeCheck_12_alpha0: QM31, RangeCheck_12_z: QM31, trace_1_column_0_offset_0: QM31,
) -> Array<QM31> {
...
pub fn intermediate0(
    ...
    (RangeCheck_12_alpha0) * (trace_1_column_0_offset_0) - (RangeCheck_12_z)
}
