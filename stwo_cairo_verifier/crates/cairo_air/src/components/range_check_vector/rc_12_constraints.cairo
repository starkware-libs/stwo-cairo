...
pub fn mask_points(
    ...
    preprocessed_column_set.insert(PreprocessedColumn::RangeCheck(([12, 0, 0, 0, 0], 0)));
...
pub fn evaluate_constraints_at_point(
    ...
    let ConstraintParams {
        RangeCheck_12_alpha0, RangeCheck_12_z, claimed_sum, range_check_12_column_0, column_size,
    } = params;
