...
pub fn mask_points(
    ...
    preprocessed_column_set.insert(PreprocessedColumn::RangeCheck(([3, 6, 0, 0, 0], 0)));
    preprocessed_column_set.insert(PreprocessedColumn::RangeCheck(([3, 6, 0, 0, 0], 1)));
...
pub struct ConstraintParams {
    pub RangeCheck_3_6_alpha0: QM31,
    pub RangeCheck_3_6_alpha1: QM31,
    pub RangeCheck_3_6_z: QM31,
    pub claimed_sum: QM31,
    pub range_check_3_6_column_0: QM31,
    pub range_check_3_6_column_1: QM31,
    pub column_size: M31,
}
...
pub fn evaluate_constraints_at_point(
    ...
    let ConstraintParams {
        RangeCheck_3_6_alpha0,
        RangeCheck_3_6_alpha1,
        RangeCheck_3_6_z,
        claimed_sum,
        range_check_3_6_column_0,
        range_check_3_6_column_1,
        column_size,
    } = params;
...
fn intermediates(
    RangeCheck_3_6_alpha0: QM31,
    RangeCheck_3_6_alpha1: QM31,
    RangeCheck_3_6_z: QM31,
    range_check_3_6_column_0: QM31,
    range_check_3_6_column_1: QM31,
) -> Array<QM31> {
...
pub fn intermediate0(
    ...
    (RangeCheck_3_6_alpha0) * (range_check_3_6_column_0)
        + (RangeCheck_3_6_alpha1) * (range_check_3_6_column_1)
        - (RangeCheck_3_6_z)
}
