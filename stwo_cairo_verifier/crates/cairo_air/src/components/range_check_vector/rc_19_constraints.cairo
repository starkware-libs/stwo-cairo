...
pub fn mask_points(
    ...
    preprocessed_column_set.insert(PreprocessedColumn::RangeCheck5(([19, 0, 0, 0, 0], 0)));
...
pub struct ConstraintParams {
    ...
    pub range_check_19_column_0: QM31,
    pub column_size: M31,
}
...
pub fn evaluate_constraints_at_point(
    ...
    let ConstraintParams {
        RangeCheck_19_alpha0, RangeCheck_19_z, claimed_sum, column_size, range_check_19_column_0,
    } = params;
    ...
    let mut intermediates = intermediates(
        RangeCheck_19_alpha0, RangeCheck_19_z, range_check_19_column_0,
    )
        .span();
...
fn intermediates(
    RangeCheck_19_alpha0: QM31, RangeCheck_19_z: QM31, range_check_19_column_0: QM31,
) -> Array<QM31> {
...
pub fn intermediate0(
    ...
    (RangeCheck_19_alpha0) * (range_check_19_column_0) - (RangeCheck_19_z)
}
