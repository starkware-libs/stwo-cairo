...
pub fn mask_points(
    ...
    preprocessed_column_set.insert(PreprocessedColumn::RangeCheck(([4, 4, 0, 0, 0], 0)));
    preprocessed_column_set.insert(PreprocessedColumn::RangeCheck(([4, 4, 0, 0, 0], 1)));
...
pub struct ConstraintParams {
    ...
    pub range_check_4_4_column_0: QM31,
    pub range_check_4_4_column_1: QM31,
    pub column_size: M31,
}
...
fn intermediates(
    ...
    range_check_4_4_column_0: QM31,
    range_check_4_4_column_1: QM31,
) -> Array<QM31> {
...
pub fn intermediate0(
    ...
    (RangeCheck_4_4_alpha0) * (range_check_4_4_column_0)
        + (RangeCheck_4_4_alpha1) * (range_check_4_4_column_1)
        - (RangeCheck_4_4_z)
}
