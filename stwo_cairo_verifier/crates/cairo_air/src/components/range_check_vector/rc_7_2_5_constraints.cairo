...
pub fn mask_points(
    ...
    preprocessed_column_set.insert(PreprocessedColumn::RangeCheck(([7, 2, 5, 0, 0], 0)));
    preprocessed_column_set.insert(PreprocessedColumn::RangeCheck(([7, 2, 5, 0, 0], 1)));
    preprocessed_column_set.insert(PreprocessedColumn::RangeCheck(([7, 2, 5, 0, 0], 2)));
...
pub struct ConstraintParams {
    ...
    pub range_check_7_2_5_column_0: QM31,
    pub range_check_7_2_5_column_1: QM31,
    pub range_check_7_2_5_column_2: QM31,
    pub column_size: M31,
}
...
fn intermediates(
    ...
    range_check_7_2_5_column_0: QM31,
    range_check_7_2_5_column_1: QM31,
    range_check_7_2_5_column_2: QM31,
) -> Array<QM31> {
...
pub fn intermediate0(
    ...
    (RangeCheck_7_2_5_alpha0) * (range_check_7_2_5_column_0)
        + (RangeCheck_7_2_5_alpha1) * (range_check_7_2_5_column_1)
        + (RangeCheck_7_2_5_alpha2) * (range_check_7_2_5_column_2)
        - (RangeCheck_7_2_5_z)
}
