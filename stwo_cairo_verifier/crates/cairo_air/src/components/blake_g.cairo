...
use crate::components::verify_bitwise_xor_12::VERIFY_BITWISE_XOR_12_RELATION_SIZE;
use crate::components::verify_bitwise_xor_4::VERIFY_BITWISE_XOR_4_RELATION_SIZE;
...
pub const BLAKE_G_RELATION_SIZE: usize = 20;
...
let [triple_sum32_res_limb_0_col12]: [QM31; 1] = (*triple_sum32_res_limb_0_col12.try_into().unwrap()).unbox();
let [triple_sum32_res_limb_1_col13]: [QM31; 1] = (*triple_sum32_res_limb_1_col13.try_into().unwrap()).unbox();
...
let [triple_sum32_res_limb_0_col22]: [QM31; 1] = (*triple_sum32_res_limb_0_col22.try_into().unwrap()).unbox();
let [triple_sum32_res_limb_1_col23]: [QM31; 1] = (*triple_sum32_res_limb_1_col23.try_into().unwrap()).unbox();
...
let [triple_sum32_res_limb_0_col32]: [QM31; 1] = (*triple_sum32_res_limb_0_col32.try_into().unwrap()).unbox();
let [triple_sum32_res_limb_1_col33]: [QM31; 1] = (*triple_sum32_res_limb_1_col33.try_into().unwrap()).unbox();
...
let [triple_sum32_res_limb_0_col42]: [QM31; 1] = (*triple_sum32_res_limb_0_col42.try_into().unwrap()).unbox();
let [triple_sum32_res_limb_1_col43]: [QM31; 1] = (*triple_sum32_res_limb_1_col43.try_into().unwrap()).unbox();
...
random_coeff
        ...
        let [xor_rot_32_r_16_output_tmp_f72c8_21_limb_0, xor_rot_32_r_16_output_tmp_f72c8_21_limb_1] = output;
...
random_coeff
        ...
        let [xor_rot_32_r_12_output_tmp_f72c8_43_limb_0, xor_rot_32_r_12_output_tmp_f72c8_43_limb_1] = output;
...
random_coeff
        ...
        let [xor_rot_32_r_8_output_tmp_f72c8_65_limb_0, xor_rot_32_r_8_output_tmp_f72c8_65_limb_1] = output;
...
random_coeff
        ...
        let [xor_rot_32_r_7_output_tmp_f72c8_87_limb_0, xor_rot_32_r_7_output_tmp_f72c8_87_limb_1] = output;
