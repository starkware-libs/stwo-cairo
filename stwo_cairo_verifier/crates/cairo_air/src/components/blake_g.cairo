...
use crate::components::verify_bitwise_xor_4::{
    VERIFY_BITWISE_XOR_4_RELATION_SIZE, verify_bitwise_xor_4_sum,
};
...
pub impl ComponentImpl of CairoComponent<Component> {
    ...
    fn evaluate_constraints_at_point(
        ...
        let verify_bitwise_xor_12_alphas = self
            .verify_bitwise_xor_12_lookup_elements
            .alpha_powers
            .span();
        let verify_bitwise_xor_12_z = *self.verify_bitwise_xor_12_lookup_elements.z;
        let verify_bitwise_xor_4_alphas = self
            .verify_bitwise_xor_4_lookup_elements
            .alpha_powers
            .span();
        let verify_bitwise_xor_4_z = *self.verify_bitwise_xor_4_lookup_elements.z;
        ...
        let output: [QM31; 2] = triple_sum_32_evaluate(
            [
        ...
        let output: [QM31; 2] = xor_rot_32_r_12_evaluate(
            ...
            verify_bitwise_xor_4_alphas,
            verify_bitwise_xor_4_z,
...
pub fn blake_g_sum(mut alphas: Span<QM31>, z: QM31, values: [QM31; 20]) -> QM31 {
    let [
        alpha0,
        alpha1,
        alpha2,
