...
pub impl ComponentImpl of CairoComponent<Component> {
    ...
    fn evaluate_constraints_at_point(
        ...
        let TripleXor32_alpha3 = *triple_xor32_alpha_powers.pop_front().unwrap();
        let TripleXor32_alpha4 = *triple_xor32_alpha_powers.pop_front().unwrap();
        let TripleXor32_alpha5 = *triple_xor32_alpha_powers.pop_front().unwrap();
        let TripleXor32_alpha6 = *triple_xor32_alpha_powers.pop_front().unwrap();
        let TripleXor32_alpha7 = *triple_xor32_alpha_powers.pop_front().unwrap();
