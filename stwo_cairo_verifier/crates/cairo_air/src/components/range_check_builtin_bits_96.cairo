...
use crate::components::range_check_6::RANGE_CHECK_6_RELATION_SIZE;
...
interaction_trace_mask_points.append(array![point_offset_neg_1, point]);
    ...
    fn evaluate_constraints_at_point(
        ...
        let range_check96_builtin_segment_start: QM31 = (TryInto::<u32, M31>::try_into((*(self.claim.range_check96_builtin_segment_start))).unwrap()).into();
