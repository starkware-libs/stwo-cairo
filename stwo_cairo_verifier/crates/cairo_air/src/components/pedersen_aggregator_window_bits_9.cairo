...
pub impl AirComponentImpl of AirComponent<Component> {
    fn evaluate_constraints_at_point(
        ...
        let [partial_ec_mul_window_bits_9_output_limb_83_col232]: [QM31; 1] =
            ...
            .unwrap())
            .unbox();
        let [multiplicity_0_col233]: [QM31; 1] = (*multiplicity_0_col233.try_into().unwrap())
            .unbox();
        ...
        pedersen_aggregator_window_bits_9_sum_11 = self
            ...
            .combine_qm31(
                [
                    qm31_const::<194336987, 0, 0, 0>(), input_limb_0_col0, input_limb_1_col1,
                    input_limb_2_col2,
                ]
                    .span(),
            );
        numerator_11 = multiplicity_0_col233;
