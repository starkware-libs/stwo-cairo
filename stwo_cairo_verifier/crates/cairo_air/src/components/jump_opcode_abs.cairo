...
use crate::components::subroutines::decode_instruction_1f0a3::decode_instruction_1f0a3_evaluate;
...
pub impl AirComponentImpl of AirComponent<Component> {
    fn evaluate_constraints_at_point(
        ...
        let [
            ...
            decode_instruction_1f0a3_evaluate(
            input_pc_col1,
            enabler_col0,
            offset2_col4,
            op1_base_fp_col5,
...
mod tests {
    ...
    fn test_evaluation_result() {
        ...
        assert_eq!(sum, QM31Trait::from_fixed_array(JUMP_OPCODE_ABS_SAMPLE_EVAL_RESULT))
    }
}
