...
use crate::components::{CairoComponent, OPCODES_RELATION_SIZE, RANGE_CHECK_8_LOG_SIZE, opcodes_sum};
use crate::utils::U32Impl;


pub const N_TRACE_COLUMNS: usize = 1;
pub const LOG_SIZE: u32 = RANGE_CHECK_8_LOG_SIZE;
pub const RANGE_CHECK_8_RELATION_SIZE: usize = 1;
...
pub impl ComponentImpl of CairoComponent<Component> {
    ...
    fn evaluate_constraints_at_point(
        ...
        range_check_8_sum_0 = range_check_8_sum(range_check_8_alphas, range_check_8_z, [seq]);
...
pub fn range_check_8_sum(mut alphas: Span<QM31>, z: QM31, values: [QM31; 1]) -> QM31 {
