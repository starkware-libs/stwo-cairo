...
pub impl CairoComponentImpl of CairoComponent<Component> {
    fn evaluate_constraints_at_point(
        ...
        let seq_8 = preprocessed_mask_values.get_and_mark_used(SEQ_8_IDX);

        let [range_check_8_multiplicity]: [Span<QM31>; 1] = (*trace_mask_values
            .multi_pop_front()
            .unwrap())
            .unbox();
        let [range_check_8_multiplicity]: [QM31; 1] = (*range_check_8_multiplicity
            .try_into()
            .unwrap())
            .unbox();
        ...
        range_check_8_sum_0 = self
            .common_lookup_elements
            .combine_qm31([qm31_const::<1420243005, 0, 0, 0>(), seq_8].span());

        lookup_constraints(
            ref sum,
            random_coeff,
            claimed_sum,
            range_check_8_multiplicity,
            column_size,
...
fn lookup_constraints(
    ...
    random_coeff: QM31,
    claimed_sum: QM31,
    range_check_8_multiplicity: QM31,
    column_size: M31,
    ref interaction_trace_mask_values: ColumnSpan<Span<QM31>>,
...
mod tests {
    ...
    fn test_evaluation_result() {
        ...
        let mut preprocessed_trace = preprocessed_mask_add(
            preprocessed_trace,
            SEQ_8_IDX,
            qm31_const::<1031919509, 939093766, 2028410799, 865942395>(),
        );
        ...
        assert_eq!(sum, QM31Trait::from_fixed_array(RANGE_CHECK_8_SAMPLE_EVAL_RESULT))
    }
}
