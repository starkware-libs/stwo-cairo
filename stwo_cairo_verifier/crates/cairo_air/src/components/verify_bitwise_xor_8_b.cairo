...
pub impl CairoComponentImpl of CairoComponent<Component> {
    fn mask_points(
        ...
        preprocessed_column_set.insert(preprocessed_columns::BITWISE_XOR__8_0_IDX);
        preprocessed_column_set.insert(preprocessed_columns::BITWISE_XOR__8_1_IDX);
        preprocessed_column_set.insert(preprocessed_columns::BITWISE_XOR__8_2_IDX);
    ...
    fn evaluate_constraints_at_point(
        ...
        let mut verify_bitwise_xor_8_b_sum_0: QM31 = Zero::zero();
        let bitwisexor_8_0 = preprocessed_mask_values
            .get(preprocessed_columns::BITWISE_XOR__8_0_IDX);
        let bitwisexor_8_1 = preprocessed_mask_values
            .get(preprocessed_columns::BITWISE_XOR__8_1_IDX);
        let bitwisexor_8_2 = preprocessed_mask_values
            .get(preprocessed_columns::BITWISE_XOR__8_2_IDX);
        ...
        verify_bitwise_xor_8_b_sum_0 = self
...
fn lookup_constraints(
    ...
    column_size: M31,
    ref interaction_trace_mask_values: ColumnSpan<Span<QM31>>,
    verify_bitwise_xor_8_b_sum_0: QM31,
) {
