...
pub impl CairoComponentImpl of CairoComponent<Component> {
    fn evaluate_constraints_at_point(
        ...
        let range_check_4_3_column_0 = preprocessed_mask_values
            .get_and_mark_used(RANGE_CHECK_4_3_COLUMN_0_IDX);
        let range_check_4_3_column_1 = preprocessed_mask_values
            .get_and_mark_used(RANGE_CHECK_4_3_COLUMN_1_IDX);

        let [range_check_4_3_multiplicity]: [Span<QM31>; 1] = (*trace_mask_values
            .multi_pop_front()
            .unwrap())
            .unbox();
        let [range_check_4_3_multiplicity]: [QM31; 1] = (*range_check_4_3_multiplicity
            .try_into()
            .unwrap())
            .unbox();
        ...
        range_check_4_3_sum_0 = self
            ...
            .combine_qm31(
                [
                    qm31_const::<1567323731, 0, 0, 0>(), range_check_4_3_column_0,
...
fn lookup_constraints(
    ...
    random_coeff: QM31,
    claimed_sum: QM31,
    range_check_4_3_multiplicity: QM31,
    column_size: M31,
    ref interaction_trace_mask_values: ColumnSpan<Span<QM31>>,
...
mod tests {
    ...
    fn test_evaluation_result() {
        ...
        let mut preprocessed_trace = preprocessed_mask_add(
            preprocessed_trace,
            RANGE_CHECK_4_3_COLUMN_0_IDX,
            qm31_const::<998303435, 170695910, 1979882780, 534397045>(),
        );
        let mut preprocessed_trace = preprocessed_mask_add(
            preprocessed_trace,
            RANGE_CHECK_4_3_COLUMN_1_IDX,
            qm31_const::<1065412614, 304913638, 2046991644, 534397045>(),
        );
        ...
        assert_eq!(sum, QM31Trait::from_fixed_array(RANGE_CHECK_4_3_SAMPLE_EVAL_RESULT))
    }
}
