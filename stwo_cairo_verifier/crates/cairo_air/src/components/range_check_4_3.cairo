...
use crate::components::{
    CairoComponent, OPCODES_RELATION_SIZE, RANGE_CHECK_4_3_LOG_SIZE, opcodes_sum,
};
...
pub const RANGE_CHECK_4_3_RELATION_SIZE: usize = 2;
...
//         range_check_4_3_sum_0 = range_check_4_3_sum(
...
pub fn range_check_4_3_sum(mut alphas: Span<QM31>, z: QM31, values: [QM31; 2]) -> QM31 {
