...
pub impl CairoComponentImpl of CairoComponent<Component> {
    fn mask_points(
        ...
        preprocessed_column_set.insert(RANGE_CHECK_4_3_COLUMN_0_IDX);
        preprocessed_column_set.insert(RANGE_CHECK_4_3_COLUMN_1_IDX);
    ...
    fn evaluate_constraints_at_point(
        ...
        let range_check_4_3_column_0 = preprocessed_mask_values.get(RANGE_CHECK_4_3_COLUMN_0_IDX);
        let range_check_4_3_column_1 = preprocessed_mask_values.get(RANGE_CHECK_4_3_COLUMN_1_IDX);
