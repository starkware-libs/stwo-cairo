...
pub impl CairoComponentImpl of CairoComponent<Component> {
    fn mask_points(
        ...
        preprocessed_column_set.insert(RANGE_CHECK_2_4_3_0_IDX);
        preprocessed_column_set.insert(RANGE_CHECK_2_4_3_1_IDX);
    ...
    fn evaluate_constraints_at_point(
        ...
        let rangecheck_4_3_0 = preprocessed_mask_values.get(RANGE_CHECK_2_4_3_0_IDX);
        let rangecheck_4_3_1 = preprocessed_mask_values.get(RANGE_CHECK_2_4_3_1_IDX);
