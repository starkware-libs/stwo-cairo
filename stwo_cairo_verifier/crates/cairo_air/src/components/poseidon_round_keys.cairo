...
use crate::components::{
    CairoComponent, OPCODES_RELATION_SIZE, POSEIDON_ROUND_KEYS_LOG_SIZE, opcodes_sum,
};
...
pub fn poseidon_round_keys_sum(mut alphas: Span<QM31>, z: QM31, values: [QM31; 31]) -> QM31 {
    let [
        alpha0,
        alpha1,
        alpha2,
