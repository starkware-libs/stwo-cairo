...
interaction_trace_mask_points.append(array![point]);
interaction_trace_mask_points.append(array![point]);
interaction_trace_mask_points.append(array![point_offset_neg_1,point,point_offset_claimed_sum]);
interaction_trace_mask_points.append(array![point_offset_neg_1,point,point_offset_claimed_sum]);
interaction_trace_mask_points.append(array![point_offset_neg_1,point,point_offset_claimed_sum]);
interaction_trace_mask_points.append(array![point_offset_neg_1,point,point_offset_claimed_sum]);
        }
...
let intermediate1 = (MemoryAddressToId_alpha0) * (trace_1_column_2_offset_0 - (m31(1).into())) + (MemoryAddressToId_alpha1) * (trace_1_column_3_offset_0) - (MemoryAddressToId_z);

let intermediate2 = (MemoryIdToBig_alpha0) * (trace_1_column_3_offset_0) + (MemoryIdToBig_alpha1) * (trace_1_column_4_offset_0) + (MemoryIdToBig_alpha2) * (trace_1_column_5_offset_0) + (MemoryIdToBig_alpha3) * (trace_1_column_6_offset_0) - (MemoryIdToBig_z);

let intermediate3 = (MemoryAddressToId_alpha0) * (trace_1_column_2_offset_0 - (m31(2).into())) + (MemoryAddressToId_alpha1) * (trace_1_column_7_offset_0) - (MemoryAddressToId_z);

let intermediate4 = (MemoryIdToBig_alpha0) * (trace_1_column_7_offset_0) + (MemoryIdToBig_alpha1) * (trace_1_column_8_offset_0) + (MemoryIdToBig_alpha2) * (trace_1_column_9_offset_0) + (MemoryIdToBig_alpha3) * (trace_1_column_10_offset_0) - (MemoryIdToBig_z);

let intermediate5 = (Opcodes_alpha0) * (trace_1_column_0_offset_0) + (Opcodes_alpha1) * (trace_1_column_1_offset_0) + (Opcodes_alpha2) * (trace_1_column_2_offset_0) - (Opcodes_z);

let intermediate6 = (Opcodes_alpha0) * (trace_1_column_4_offset_0 + (trace_1_column_5_offset_0) * (m31(512).into()) + (trace_1_column_6_offset_0) * (m31(262144).into())) + (Opcodes_alpha1) * (trace_1_column_1_offset_0) + (Opcodes_alpha2) * (trace_1_column_8_offset_0 + (trace_1_column_9_offset_0) * (m31(512).into()) + (trace_1_column_10_offset_0) * (m31(262144).into())) - (Opcodes_z);

let constraint_0 = (QM31Impl::from_partial_evals([trace_2_column_11_offset_0, trace_2_column_12_offset_0, trace_2_column_13_offset_0, trace_2_column_14_offset_0])) * ((intermediate0) * (intermediate1)) - (intermediate1 + intermediate0);

let constraint_1 = (QM31Impl::from_partial_evals([trace_2_column_15_offset_0, trace_2_column_16_offset_0, trace_2_column_17_offset_0, trace_2_column_18_offset_0]) - (QM31Impl::from_partial_evals([trace_2_column_11_offset_0, trace_2_column_12_offset_0, trace_2_column_13_offset_0, trace_2_column_14_offset_0]))) * ((intermediate2) * (intermediate3)) - (intermediate3 + intermediate2);

let constraint_2 = (QM31Impl::from_partial_evals([trace_2_column_19_offset_0, trace_2_column_20_offset_0, trace_2_column_21_offset_0, trace_2_column_22_offset_0]) - (QM31Impl::from_partial_evals([trace_2_column_15_offset_0, trace_2_column_16_offset_0, trace_2_column_17_offset_0, trace_2_column_18_offset_0]))) * ((intermediate4) * (intermediate5)) - (intermediate5 + intermediate4);

let constraint_3 = (QM31Impl::from_partial_evals([trace_2_column_23_offset_claimed_sum, trace_2_column_24_offset_claimed_sum, trace_2_column_25_offset_claimed_sum, trace_2_column_26_offset_claimed_sum]) - (claimed_sum)) * (preprocessed_is_first);

let constraint_4 = (QM31Impl::from_partial_evals([trace_2_column_23_offset_0, trace_2_column_24_offset_0, trace_2_column_25_offset_0, trace_2_column_26_offset_0]) - (QM31Impl::from_partial_evals([trace_2_column_23_offset_neg_1, trace_2_column_24_offset_neg_1, trace_2_column_25_offset_neg_1, trace_2_column_26_offset_neg_1]) - ((total_sum) * (preprocessed_is_first))) - (QM31Impl::from_partial_evals([trace_2_column_19_offset_0, trace_2_column_20_offset_0, trace_2_column_21_offset_0, trace_2_column_22_offset_0]))) * (intermediate6) - (qm31(2147483646, 0, 0, 0));
