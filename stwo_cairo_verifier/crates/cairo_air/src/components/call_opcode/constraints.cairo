...
pub fn intermediate6(
    ...
    (MemoryAddressToId_alpha0) * (trace_1_column_1_offset_0 + intermediate1)
...
pub fn intermediate0(
    ...
    (VerifyInstruction_alpha0) * (trace_1_column_0_offset_0)
        ...
        + (VerifyInstruction_alpha4) * (qm31_const::<128, 0, 0, 0>())
        + (VerifyInstruction_alpha5) * (qm31_const::<66, 0, 0, 0>())
        - (VerifyInstruction_z)
}
