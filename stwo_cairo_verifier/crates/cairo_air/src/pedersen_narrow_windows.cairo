use components::partial_ec_mul_window_bits_9::InteractionClaimImpl as PartialEcMulInteractionClaimImpl;
use components::pedersen_aggregator_window_bits_9::InteractionClaimImpl as PedersenAggregatorInteractionClaimImpl;
use components::pedersen_builtin::InteractionClaimImpl as PedersenBuiltinInteractionClaimImpl;
use components::pedersen_points_table_window_bits_9::InteractionClaimImpl as PedersenPointsTableInteractionClaimImpl;
...
pub struct PedersenClaim {
    pub pedersen_aggregator: components::pedersen_aggregator_window_bits_9::Claim,
    pub partial_ec_mul: components::partial_ec_mul_window_bits_9::Claim,
    pub pedersen_points_table: components::pedersen_points_table_window_bits_9::Claim,
}
...
pub struct PedersenInteractionClaim {
    pub pedersen_aggregator: components::pedersen_aggregator_window_bits_9::InteractionClaim,
    pub partial_ec_mul: components::partial_ec_mul_window_bits_9::InteractionClaim,
    pub pedersen_points_table: components::pedersen_points_table_window_bits_9::InteractionClaim,
}
...
pub struct PedersenComponents {
    pub pedersen_aggregator: components::pedersen_aggregator_window_bits_9::Component,
    pub partial_ec_mul: components::partial_ec_mul_window_bits_9::Component,
    pub pedersen_points_table: components::pedersen_points_table_window_bits_9::Component,
}
...
pub impl PedersenComponentsImpl of PedersenComponentsTrait {
    fn new(
        ...
        let pedersen_aggregator_component =
            components::pedersen_aggregator_window_bits_9::NewComponentImpl::new(
        ...
        let partial_ec_mul_component =
            components::partial_ec_mul_window_bits_9::NewComponentImpl::new(
            claim.partial_ec_mul, interaction_claim.partial_ec_mul, common_lookup_elements,
        );

        let pedersen_points_table_component =
            components::pedersen_points_table_window_bits_9::NewComponentImpl::new(
