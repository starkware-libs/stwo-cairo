...
pub fn xor_rot_32_r_7_evaluate(
    ...
    let xor_rot_7_output_tmp_12336_16_limb_0: QM31 = (xor_col5
        + (xor_col6 * qm31_const::<512, 0, 0, 0>()));
    let xor_rot_7_output_tmp_12336_16_limb_1: QM31 = (xor_col7
        + (xor_col4 * qm31_const::<512, 0, 0, 0>()));

    [xor_rot_7_output_tmp_12336_16_limb_0, xor_rot_7_output_tmp_12336_16_limb_1]
}
