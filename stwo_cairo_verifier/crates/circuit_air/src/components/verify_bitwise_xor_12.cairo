...
pub impl CircuitComponentImpl of CircuitComponent<Component> {
    fn evaluate_constraints_at_point(
        ...
        let a_offs = [
            bitwise_xor_10_0,
            bitwise_xor_10_0 + limb_off,
            bitwise_xor_10_0 + limb_off_2,
            bitwise_xor_10_0 + limb_off_3,
        ];
        let b_offs = [
            bitwise_xor_10_1,
            bitwise_xor_10_1 + limb_off,
            bitwise_xor_10_1 + limb_off_2,
            bitwise_xor_10_1 + limb_off_3,
        ];
        // c offsets — XOR of i and j folded in.
        let c_offs = [
            bitwise_xor_10_2,
            bitwise_xor_10_2 + limb_off,
            bitwise_xor_10_2 + limb_off_2,
        ...
        lookup_constraints(
            ...
            multiplicity_col0, multiplicity_col1, multiplicity_col2, multiplicity_col3,
            multiplicity_col4, multiplicity_col5, multiplicity_col6, multiplicity_col7,
            multiplicity_col8, multiplicity_col9, multiplicity_col10, multiplicity_col11,
            multiplicity_col12, multiplicity_col13, multiplicity_col14, multiplicity_col15,
        );
    }
}
...
fn lookup_constraints(
    ...
    let q = ((cur_7 - cur_6 - cur_7_neg1 + (claimed_sum * (column_size.inverse().into())))
        * sum_14 * sum_15) + (sum_14 * num_15) + (sum_15 * num_14);
    sum = sum * random_coeff + q;
}
