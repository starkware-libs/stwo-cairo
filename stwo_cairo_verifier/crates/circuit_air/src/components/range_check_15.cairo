...
pub impl AirComponentImpl of AirComponent<Component> {
    fn evaluate_constraints_at_point(
        ...
        let mut range_check_15_sum_0: QM31 = Zero::zero();
        ...
        range_check_15_sum_0 = self
            .common_lookup_elements
            .combine_qm31([qm31_const::<1058718565, 0, 0, 0>(), seq_15].span());
