...
/// Number of public output values of the recursive verification circuit: the bootloader
/// output hash packed as 2 QM31s. (The logup anchor `u` is appended internally by the
/// verifier and is not part of the public outputs.)
...
/// index constants in `stwo_circuit_air`'s `preprocessed_columns.cairo`.
