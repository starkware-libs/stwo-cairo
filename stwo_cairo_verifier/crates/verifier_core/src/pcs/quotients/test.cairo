...
use crate::pcs::quotients::{
    ColumnSampleBatch, QuotientConstantsImpl,
...
fn test_fri_answers_for_log_size() {
    ...
    let sample_batches_by_point: Array<ColumnSampleBatch> = array![
        ...
        ColumnSampleBatch {
            point: p1, columns_and_values: array![(0, sample1)],
        },
        ColumnSampleBatch {
            point: p2, columns_and_values: array![(0, sample2), (2, sample2)],
        },
    ];
    ...
    let res = fri_answers_for_log_size(
        log_size, sample_batches_by_point, random_coeff, query_positions, ref query_evals, n_columns,
    );
...
fn test_fri_answers_with_1000_columns() {
    ...
    let sample_batches_by_point: Array<ColumnSampleBatch> = array![
        ColumnSampleBatch {
            point: p0, columns_and_values: p0_column_and_values,
        },
        ColumnSampleBatch {
            point: p1, columns_and_values: array![(0, sample1)],
        },
