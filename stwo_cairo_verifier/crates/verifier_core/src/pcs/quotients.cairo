...
/// Computes the denominators in the FRI quotients.
/// Given a `domain_point` corresponding to a query index, it computes, for each `sample_point`
/// (a QM31 circle point corresponding to some translate of the OOD point), the value
/// at `domain_point` of the line passing through `(sample_point, conj(sample_point))`.
/// Here the conjugation is coordinate-wise conjugation with respect to CM31.
