...
mod tests {
    ...
    pub fn test_draw_random_bytes_1() {
        ...
        let expected_result = array![
            202, 249, 218, 52, 208, 208, 120, 28, 251, 5, 215, 191, 0, 129, 91, 82, 5, 139, 123, 1,
            233, 109, 186, 139, 66, 126, 67, 139, 136, 81, 93,
        ];
    ...
    pub fn test_draw_random_bytes_2() {
        ...
        let result = channel.draw_random_bytes();
        let expected_result = array![
            122, 237, 190, 125, 191, 88, 175, 93, 133, 241, 197, 158, 15, 129, 95, 205, 251, 171,
            97, 162, 35, 79, 107, 70, 39, 233, 52, 55, 28, 86, 174,
        ];
        assert_eq!(expected_result, result);
    }
