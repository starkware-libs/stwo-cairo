...
///  for each tree the columns are grouped by thier log size, where the log_size is in the range [0,
...
/// size.
pub fn columns_by_log_size(column_log_sizes: Span<u32>) -> Span<Span<usize>> {
