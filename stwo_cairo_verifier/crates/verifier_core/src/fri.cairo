...
pub impl FriVerifierImpl of FriVerifierTrait {
    ...
    fn sample_query_positions(
        ...
        for column_commitment_domain in self
            .first_layer
...
impl FriFirstLayerVerifierImpl of FriFirstLayerVerifierTrait {
    ...
    fn verify(
        ...
        loop {
            ...
            for subset_eval in sparse_evaluation
                .subset_evals
                .span() {
                    for eval in subset_eval
                        .span() {
...
impl SparseEvaluationImpl of SparseEvaluationTrait {
    ...
    fn fold_line(
        ...
        for subset_domain_initial_index in *self
