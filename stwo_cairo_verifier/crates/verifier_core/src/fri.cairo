...
impl FriVerificationErrorDisplay of core::fmt::Display<FriVerificationError> {
    fn fmt(
        ...
        match self {
            ...
            FriVerificationError::FirstLayerCommitmentInvalid => write!(
                f, "Invalid first layer commitment",
            ),
            FriVerificationError::InnerLayerEvaluationsInvalid => write!(
                f, "Invalid inner layer evaluations",
            ),
            FriVerificationError::InnerLayerCommitmentInvalid => write!(
                f, "Invalid inner layer commitment",
            ),
