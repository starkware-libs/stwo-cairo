...
pub impl QM31Impl of QM31Trait {
    ...
    fn fms(a: QM31, b: QM31, c: QM31) -> QM31 {
        let res: UnreducedQM31 = a.into() * b.into() - c.into();
        QM31 {
            a: CM31 {
                a: M31Impl::reduce_u128(res.a.try_into().unwrap()),
                b: M31Impl::reduce_u128(res.b.try_into().unwrap())
            },
            b: CM31 {
                a: M31Impl::reduce_u128(res.c.try_into().unwrap()),
                b: M31Impl::reduce_u128(res.d.try_into().unwrap())
            }
        }
    }
    ...
    fn fma(a: QM31, b: QM31, c: QM31) -> QM31 {
        let a: UnreducedQM31 = a.into();
        let b: UnreducedQM31 = b.into();
        let res = a * b + c.into();
        QM31 {
            a: CM31 {
                a: M31Impl::reduce_u128(res.a.try_into().unwrap()),
...
impl UnreducedQM31Mul of Mul<UnreducedQM31> {
    ...
    #[inline]
    fn mul(lhs: UnreducedQM31, rhs: UnreducedQM31) -> UnreducedQM31 {
        /// Equals `P * P * 16`.
...
mod tests {
    ...
    #[test]
    fn test_unreduced_qm31() {
        let a = qm31(P - 4, P - 90, 958, P - 1);
        let b = qm31(P - 183, 75, P - 921, P - 6124);

        let res_unreduced: UnreducedQM31 = a.into() * b.into();
