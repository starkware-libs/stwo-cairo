...
const NZ_M31_P: NonZero<ConstValue<0x7fffffff>> = 0x7fffffff;
const M31_P: ConstValue<0x7fffffff> = 0x7fffffff;
...
impl DivRemU128ByP of DivRemHelper<u128, ConstValue<0x7fffffff>> {
...
impl M31AddReduceHelper of SubHelper<BoundedInt<P, { 2 * (P - 1) }>, ConstValue<0x7fffffff>> {
    type Result = BoundedInt<0, { P - 2 }>;
}


impl M31SubReduceHelper of AddHelper<BoundedInt<{ -(P - 1) }, { -1 }>, ConstValue<0x7fffffff>> {
