...
pub fn fri_answers_for_log_size(
    ...
    while i < query_domain.domains.len() {
        ...
        while row < domain.size() {
            ...
            // Chequear que accumulate_row_quotients esta funcionando bien porque EVALS tiene bien
            // el dominio pero mal los valores.
...
//         CircleEvaluation { domain: CircleDomain { half_coset: Coset { initial_index: 41943040,
//         step_size: 2147483648, log_size: 0 } },
//                           values: array![qm31(908763622, 1585299850, 463460326, 1048007085),
//                           qm31(1123843977, 425287367, 713867037, 231900223)]},
//         CircleEvaluation { domain: CircleDomain { half_coset: Coset { initial_index: 2122317824,
//         step_size: 2147483648, log_size: 0 } },
//                           values: array![qm31(1489324268, 1315746611, 1235430137, 1650466882),
//                           qm31(158201991, 1003575152, 1730507932, 1741921065)]}
//       ]
// })
}
        ...
        let expected_result = SparseCircleEvaluation {
            subcircle_evals: array![
                CircleEvaluation {
                    ...
                    values: array![
                        qm31(908763622, 1585299850, 463460326, 1048007085),
                        qm31(1123843977, 425287367, 713867037, 231900223)
                    ]
                },
                CircleEvaluation {
                    ...
                    values: array![
                        qm31(1489324268, 1315746611, 1235430137, 1650466882),
                        qm31(158201991, 1003575152, 1730507932, 1741921065)
                    ]
                }
            ]
