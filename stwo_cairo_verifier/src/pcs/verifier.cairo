...
use stwo_cairo_verifier::queries::{SparseSubCircleDomainTrait, get_sparse_sub_circle_domain_dict};
use stwo_cairo_verifier::utils::{flat_3d_array, substract_map_2d_array, ArrayExTrait};
...
impl CommitmentSchemeVerifierImpl of CommitmentSchemeVerifierTrait {
    ...
    fn verify_values(
        ...
        let bounds = vec_to_sort.sort_descending().dedup();
...
mod tests {
    ...
    use super::{PcsConfig, CommitmentSchemeVerifierImpl, CommitmentSchemeProof};
