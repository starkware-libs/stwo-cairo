use components::addr_to_id::{
    ClaimImpl as AddrToIdClaimImpl, ComponentImpl as AddrToIdComponentImpl,
    InteractionClaimImpl as AddrToIdInteractionClaimImpl,
};
use components::genericopcode::{
    ClaimImpl as GenericOpcodeClaimImpl, ComponentImpl as GenericOpcodeComponentImpl,
    ComponentImpl as GenericOpcodeComponentImpl,
    InteractionClaimImpl as GenericOpcodeInteractionClaimImpl,
};
use components::id_to_f252::{
    ClaimImpl as IdToF252ClaimImpl, ComponentImpl as IdToF252ComponentImpl,
...
use components::range_check::{
    ...
    Rc19BitComponentImpl, Rc4Bit3BitComponentImpl, Rc7Bit2Bit5BitComponentImpl,
    Rc9Bit9BitComponentImpl,
};
use components::ret_opcode::{
    ClaimImpl as RetOpcodeClaimImpl, ComponentImpl as RetComponentImpl,
    ComponentImpl as RetOpcodeComponentImpl, InteractionClaimImpl as RetOpcodeInteractionClaimImpl,
};
use components::verify_instruction::{
    ClaimImpl as VerifyInstructionClaimImpl, ComponentImpl as VerifyComponentImpl,
...
use stwo_cairo_verifier::verifier::{StarkProof, VerificationError, verify};
use stwo_cairo_verifier::{ColumnArray, TreeArray};
use super::super::constraint_framework::{
    LookupElements, LookupElementsImpl, PreprocessedColumn, TraceLocationAllocatorImpl,
};
...
pub struct CairoClaim {
    ...
    pub range_check9_9: components::range_check::Claim,
    pub range_check7_2_5: components::range_check::Claim,
    pub range_check4_3: components::range_check::Claim,
}
...
pub struct CairoAir {
    ...
    verify_instruction: components::verifyinstruction::Component,
    ...
    range_check9_9: components::range_check::Rc9Bit9BitComponent,
    range_check7_2_5: components::range_check::Rc7Bit2Bit5BitComponent,
    range_check4_3: components::range_check::Rc4Bit3BitComponent,
    // ...
}
...
impl CairoAirNewImpl of CairoAirNewTrait {
    fn new(
        ...
        let opcode_components = OpcodeComponentsImpl::new(
            cairo_claim.opcodes, interaction_elements, interaction_claim,
        );
        ...
        let memory_addr_to_id_component = components::addr_to_id::Component {
            ...
            lookup_elements: *interaction_claim.memory_addr_to_id,
        };

        let memory_id_to_value_component = components::id_to_f252::BigComponent {
            claim: *cairo_claim.memory_id_to_value,
            interaction_claim: *interaction_claim.memory_id_to_value,
            lookup_elements: interaction_elements.memory_id_to_value.clone(),
            range9_9_lookup_elements: interaction_elements.range_check_9_9.clone(),
        };

        // let mut _tree_span_provider = TraceLocationAllocatorImpl::new_with_preproccessed_columns(
        //     preprocessed_columns.span(),
        // );
        ...
        CairoAir { opcodes: opcode_components, 
            verify_instruction: verifyinstruction_component
            memory_addr_to_id: memory_addr_to_id_component
            memory_id_to_value: (memory_id_to_value_component, memory_id_to_value_component_small), }
    }
}
...
impl CairoAirImpl of Air<CairoAir> {
    ...
    fn mask_points(
        ...
        let mut preprocessed_trace_mask_points = ArrayImpl::new_repeated(
            IS_FIRST_LOG_SIZES.span().len(), array![point],
        );
