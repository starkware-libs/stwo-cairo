...
pub impl ComponentImpl of CairoComponent<Component> {
    ...
    fn evaluate_constraints_at_point(
        ...
        let vm_z = *vm_alpha_powers.pop_front().unwrap();

        let (claimed_sum, _) = (*self.interaction_claim.claimed_sum).unwrap();

        let params = constraints::ConstraintParams {
            AddrToId_alpha0: addr_to_id_alpha_pow_0,
            AddrToId_alpha1: addr_to_id_alpha_pow_1,
            AddrToId_z: *self.memoryaddresstoid_lookup_elements.z,
            IdToValue_alpha0: id_to_value_alpha_pow_0,
            IdToValue_alpha1: id_to_value_alpha_pow_1,
            IdToValue_alpha2: id_to_value_alpha_pow_2,
            IdToValue_alpha3: id_to_value_alpha_pow_3,
            ...
            Vm_alpha0: vm_alpha_pow_0,
            Vm_alpha1: vm_alpha_pow_1,
            Vm_alpha2: vm_alpha_pow_2,
            Vm_z: vm_z,
