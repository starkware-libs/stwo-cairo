...
fn test_horizontal_fib_128_column_with_blowup_16_and_fri_layer_0() {
    let proof = proofs::horizontal_fib_128_column_with_blowup_16_and_fri_layer_0::proof();
    ...
    commitment_scheme
        .commit(
            *proof.commitment_scheme_proof.commitments[0],
...
#[test]
#[available_gas(100000000000)]
fn test_horizontal_fib_512_column_with_blowup_16_and_fri_layer_0() {
    let proof = proofs::horizontal_fib_512_column_with_blowup_16_and_fri_layer_0::proof();
    let config = PcsConfig {
        pow_bits: 0,
        fri_config: FriConfig {
            log_last_layer_degree_bound: 4, log_blowup_factor: 4, n_queries: 15,
    ...
    commitment_scheme
        .commit(
            *proof.commitment_scheme_proof.commitments[0],
            @ArrayImpl::new_repeated(512, log_size),
            ref channel,
        );
...
// #[test]
// #[available_gas(100000000000)]
// fn test_horizontal_fib_32_column_with_blowup_2_and_fri_layer_0() {
//     let proof = proofs::horizontal_fib_32_column_with_blowup_2_and_fri_layer_0::proof();
//     let config = PcsConfig {
//         pow_bits: 0,
//         fri_config: FriConfig {
...
//         .commit(
//             *proof.commitment_scheme_proof.commitments[0],
//             @ArrayImpl::new_repeated(32, log_size),
//             ref channel,
//         );
...
// #[test]
// #[available_gas(100000000000)]
// fn test_horizontal_fib_128_column_with_blowup_2_and_fri_layer_0() {
//     let proof = proofs::horizontal_fib_128_column_with_blowup_2_and_fri_layer_0::proof();
//     let config = PcsConfig {
//         pow_bits: 0,
//         fri_config: FriConfig {
//             log_last_layer_degree_bound: 6, log_blowup_factor: 1, n_queries: 60,
