...
fn write_trace_simd(
    ...
    let range_check_3_6_6_3_column_0 = preprocessed_trace
        .get_column(&PreProcessedColumnId { id: "range_check_3_6_6_3_column_0".to_owned() });
    let range_check_3_6_6_3_column_1 = preprocessed_trace
        .get_column(&PreProcessedColumnId { id: "range_check_3_6_6_3_column_1".to_owned() });
    let range_check_3_6_6_3_column_2 = preprocessed_trace
        .get_column(&PreProcessedColumnId { id: "range_check_3_6_6_3_column_2".to_owned() });
    let range_check_3_6_6_3_column_3 = preprocessed_trace
        .get_column(&PreProcessedColumnId { id: "range_check_3_6_6_3_column_3".to_owned() });
...
impl InteractionClaimGenerator {
    pub fn write_interaction_trace(
        ...
        (col_gen.par_iter_mut(), &self.lookup_data.range_check_3_6_6_3_0, self.lookup_data.mults_0)
            .into_par_iter()
