...
fn write_trace_simd(
    ...
    let range_check_4_4_column_0 = preprocessed_trace
        .get_column(&PreProcessedColumnId { id: "range_check_4_4_column_0".to_owned() });
    let range_check_4_4_column_1 = preprocessed_trace
        .get_column(&PreProcessedColumnId { id: "range_check_4_4_column_1".to_owned() });
    ...
    (trace.par_iter_mut(), lookup_data.par_iter_mut()).into_par_iter().enumerate().for_each(
        |(row_index, (row, lookup_data))| {
            ...
            *lookup_data.range_check_4_4_0 =
                [M31_1651211826, range_check_4_4_column_0, range_check_4_4_column_1];
...
impl InteractionClaimGenerator {
    pub fn write_interaction_trace(
        ...
        (col_gen.par_iter_mut(), &self.lookup_data.range_check_4_4_0, self.lookup_data.mults_0)
            .into_par_iter()
