...
/// Enables serialization of types into a format that can be deserialized by corresponding types in
/// a Cairo program that implement the [`Serde`](https://docs.swmansion.com/scarb/corelib/core-serde-Serde.html) trait.
