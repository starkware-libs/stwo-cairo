...
let trace_2_column_489_offset_neg_1 = *trace_2_column_489.pop_front().unwrap();
let mut trace_2_column_490 = interaction_mask_values.pop_front().unwrap().span();
let trace_2_column_490_offset_0 = *trace_2_column_490.pop_front().unwrap();
let mut trace_2_column_491 = interaction_mask_values.pop_front().unwrap().span();
let trace_2_column_491_offset_neg_1 = *trace_2_column_491.pop_front().unwrap();
