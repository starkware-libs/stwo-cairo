...
impl ClaimGenerator {
    // pub fn new(packed_inputs: Vec<PackedInputType>) -> Self {
    //     Self { packed_inputs }
    // }
        ...
        SimdBackend: BackendForChannel<MC>,
    {
        ...
        // let (inputs1, inputs2, inputs3): (Vec<M31>, Vec<M31>, Vec<(M31, [M31; 14], [Felt252;
        // 2])>) =     inputs.into_iter().unzip();

        // let (inputs1, inputs2, nested_inputs): (
        //     Vec<M31>,
        //     Vec<M31>,
        //     Vec<(M31, [M31; 14], [Felt252; 2])>,
        // ) = inputs.into_iter().multiunzip();

        // let (nested_inputs1, nested_inputs2, nested_inputs3): (
        //     Vec<M31>,
        //     Vec<[M31; 14]>,
        //     Vec<[Felt252; 2]>,
        // ) = nested_inputs.into_iter().multiunzip();

        // let packed_inputs1 = pack_values(&inputs1);
        // let packed_inputs2 = pack_values(&inputs2);
        // let packed_nested_inputs1 = pack_values(&nested_inputs1);
        // let packed_nested_inputs2 = pack_values(&nested_inputs2);

        // let nested_inputs3a: Vec<Felt252> = nested_inputs3.iter().map(|&[a, _]| a).collect();
        // let nested_inputs3b: Vec<Felt252> = nested_inputs3.iter().map(|&[_, b]| b).collect();

        // let packed_nested_inputs3a = pack_values(&nested_inputs3a);

        // let packed_nested_inputs3 = pack_values(&nested_inputs3);
        ...
        .for_each(
            |(((row_index, mut row), partial_ec_mul_input), lookup_data)| {
                ...
                *row[72] = input_limb_72_col72;
                ...
                //         + (input_limb_3_col3)),
                // ];
                // deduce_output_packed
                let pedersen_points_table_output_tmp_71feb_0 = pedersen_points_table_state
                    .deduce_output([(((input_limb_2_col2)
                        + ((M31_262144) * (input_limb_1_col1)))
                        + (input_limb_3_col3))]);
                // let pedersen_points_table_output_tmp_71feb_0 =
                //     PedersenPointsTable::deduce_output_packed([(((input_limb_2_col2)
                //         + ((M31_262144) * (input_limb_1_col1)))
                //         + (input_limb_3_col3))]); //
...
impl InteractionClaimGenerator {
        ...
        SimdBackend: BackendForChannel<MC>,
    {
        ...
        .enumerate()
        {
            ...
            col_gen.write_frac(
                i,
                denom0 * enabler.packed_at(i) + denom1, //
                denom0 * denom1,
            ); //
        }
        col_gen.finalize_col();
