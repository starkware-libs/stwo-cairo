...
impl Claim {
    pub fn log_sizes(&self) -> TreeVec<Vec<u32>> {
        let trace_log_sizes = vec![self.log_size; 169];
...
impl FrameworkEval for Eval {
    ...
    fn evaluate<E: EvalAtRow>(&self, mut eval: E) -> E {
        ...
        // eval.add_constraint(
        // ((((((((carry_8_tmp_44f04_12.clone() - combination_limb_9_col91.clone()) + (M31_4.clone()
        // * input_limb_11_col11.clone())) + (M31_2.clone() * input_limb_21_col21.clone())) +
        // (M31_3.clone() * input_limb_31_col31.clone())) + (M31_1.clone() *
        // input_limb_41_col41.clone())) - (M31_1.clone() * cube_252_output_limb_9_col81.clone())) +
        ...
        // final limb constraint.
        // eval.add_constraint(
        // (((carry_8_tmp_44f04_23.clone() - combination_limb_9_col102.clone()) + (M31_2.clone() *
        // combination_limb_9_col91.clone())) - (p_coef_col103.clone() * M31_256.clone()))
        // );
        ...
        // (M31_4.clone() * input_limb_31_col31.clone())) + (M31_2.clone() *
        // input_limb_41_col41.clone())) + (M31_3.clone() * cube_252_output_limb_9_col81.clone())) +
        // (M31_1.clone() * combination_limb_9_col102.clone())) - (M31_1.clone() *
        // cube_252_output_limb_9_col113.clone())) + (M31_1.clone() *
        // poseidon_round_keys_output_limb_19_col61.clone())) - (p_coef_col124.clone() *
        // M31_256.clone())) );
        eval.add_to_relation(RelationEntry::new(
            &self.range_check_4_4_4_4_lookup_elements,
            E::EF::one(),
        ...
        // final limb constraint.
        // eval.add_constraint(
        // (((carry_8_tmp_44f04_56.clone() - combination_limb_9_col134.clone()) + (M31_2.clone() *
        // combination_limb_9_col123.clone())) - (p_coef_col135.clone() * M31_256.clone()))
        // );
        ...
        // (M31_4.clone() * cube_252_output_limb_9_col81.clone())) + (M31_2.clone() *
        // combination_limb_9_col102.clone())) + (M31_3.clone() *
        // cube_252_output_limb_9_col113.clone())) + (M31_1.clone() *
        // combination_limb_9_col134.clone())) - (M31_1.clone() *
        // cube_252_output_limb_9_col145.clone())) + (M31_1.clone() *
        // poseidon_round_keys_output_limb_29_col71.clone())) - (p_coef_col156.clone() *
        // M31_256.clone())) );
        eval.add_to_relation(RelationEntry::new(
            &self.range_check_4_4_4_4_lookup_elements,
            E::EF::one(),
        ...
        // final limb constraint.
        // eval.add_constraint(
        // (((carry_8_tmp_44f04_89.clone() - combination_limb_9_col166.clone()) + (M31_2.clone() *
        // combination_limb_9_col155.clone())) - (p_coef_col167.clone() * M31_256.clone()))
        // );
