...
pub fn write_trace_simd(
    ...
    iter.for_each(|(row_index, jnz_opcode_is_taken_f_dst_base_fp_f_input)| {
        unsafe {
            ...
            let memoryaddresstoid_value_tmp_c1ec_1 =
                memory_address_to_id_state.deduce_output(input_pc_col0);
            let memoryidtobig_value_tmp_c1ec_2 =
                memory_id_to_big_state.deduce_output(memoryaddresstoid_value_tmp_c1ec_1);
            let offset0_tmp_c1ec_3 =
                ((PackedUInt16::from_m31(memoryidtobig_value_tmp_c1ec_2.get_m31(0)))
                    + (((PackedUInt16::from_m31(memoryidtobig_value_tmp_c1ec_2.get_m31(1)))
                        & (UInt16_127))
                        << (UInt16_9)));
            let offset0_col3 = offset0_tmp_c1ec_3.as_m31();
            (*trace.data[3].get()).data[row_index] = offset0_col3;
            let ap_update_add_1_tmp_c1ec_4 =
                (((((PackedUInt16::from_m31(memoryidtobig_value_tmp_c1ec_2.get_m31(5)))
                    >> (UInt16_3))
                    + ((PackedUInt16::from_m31(memoryidtobig_value_tmp_c1ec_2.get_m31(6)))
                        << (UInt16_6)))
                    >> (UInt16_11))
                    & (UInt16_1));
            ...
            let memoryaddresstoid_value_tmp_c1ec_5 = memory_address_to_id_state
                .deduce_output(((input_ap_col1) + ((offset0_col3) - (M31_32768))));
            let memoryidtobig_value_tmp_c1ec_6 =
                memory_id_to_big_state.deduce_output(memoryaddresstoid_value_tmp_c1ec_5);
            let dst_id_col5 = memoryaddresstoid_value_tmp_c1ec_5;
            (*trace.data[5].get()).data[row_index] = dst_id_col5;
            (*sub_components_inputs.memory_address_to_id_inputs[0].get())
                [row_index * N_LANES..(row_index + 1) * N_LANES]
                .copy_from_slice(&((input_ap_col1) + ((offset0_col3) - (M31_32768))).unpack());

            (*lookup_data.memoryaddresstoid[0].get())[row_index] = [
                ((input_ap_col1) + ((offset0_col3) - (M31_32768))),
                dst_id_col5,
            ];
            let dst_limb_0_col6 = memoryidtobig_value_tmp_c1ec_6.get_m31(0);
            (*trace.data[6].get()).data[row_index] = dst_limb_0_col6;
            let dst_limb_1_col7 = memoryidtobig_value_tmp_c1ec_6.get_m31(1);
            (*trace.data[7].get()).data[row_index] = dst_limb_1_col7;
            let dst_limb_2_col8 = memoryidtobig_value_tmp_c1ec_6.get_m31(2);
            (*trace.data[8].get()).data[row_index] = dst_limb_2_col8;
            let dst_limb_3_col9 = memoryidtobig_value_tmp_c1ec_6.get_m31(3);
            (*trace.data[9].get()).data[row_index] = dst_limb_3_col9;
            let dst_limb_4_col10 = memoryidtobig_value_tmp_c1ec_6.get_m31(4);
            (*trace.data[10].get()).data[row_index] = dst_limb_4_col10;
            let dst_limb_5_col11 = memoryidtobig_value_tmp_c1ec_6.get_m31(5);
            (*trace.data[11].get()).data[row_index] = dst_limb_5_col11;
            let dst_limb_6_col12 = memoryidtobig_value_tmp_c1ec_6.get_m31(6);
            (*trace.data[12].get()).data[row_index] = dst_limb_6_col12;
            let dst_limb_7_col13 = memoryidtobig_value_tmp_c1ec_6.get_m31(7);
            (*trace.data[13].get()).data[row_index] = dst_limb_7_col13;
            let dst_limb_8_col14 = memoryidtobig_value_tmp_c1ec_6.get_m31(8);
            (*trace.data[14].get()).data[row_index] = dst_limb_8_col14;
            let dst_limb_9_col15 = memoryidtobig_value_tmp_c1ec_6.get_m31(9);
            (*trace.data[15].get()).data[row_index] = dst_limb_9_col15;
            let dst_limb_10_col16 = memoryidtobig_value_tmp_c1ec_6.get_m31(10);
            (*trace.data[16].get()).data[row_index] = dst_limb_10_col16;
            let dst_limb_11_col17 = memoryidtobig_value_tmp_c1ec_6.get_m31(11);
            (*trace.data[17].get()).data[row_index] = dst_limb_11_col17;
            let dst_limb_12_col18 = memoryidtobig_value_tmp_c1ec_6.get_m31(12);
            (*trace.data[18].get()).data[row_index] = dst_limb_12_col18;
            let dst_limb_13_col19 = memoryidtobig_value_tmp_c1ec_6.get_m31(13);
            (*trace.data[19].get()).data[row_index] = dst_limb_13_col19;
            let dst_limb_14_col20 = memoryidtobig_value_tmp_c1ec_6.get_m31(14);
            (*trace.data[20].get()).data[row_index] = dst_limb_14_col20;
            let dst_limb_15_col21 = memoryidtobig_value_tmp_c1ec_6.get_m31(15);
            (*trace.data[21].get()).data[row_index] = dst_limb_15_col21;
            let dst_limb_16_col22 = memoryidtobig_value_tmp_c1ec_6.get_m31(16);
            (*trace.data[22].get()).data[row_index] = dst_limb_16_col22;
            let dst_limb_17_col23 = memoryidtobig_value_tmp_c1ec_6.get_m31(17);
            (*trace.data[23].get()).data[row_index] = dst_limb_17_col23;
            let dst_limb_18_col24 = memoryidtobig_value_tmp_c1ec_6.get_m31(18);
            (*trace.data[24].get()).data[row_index] = dst_limb_18_col24;
            let dst_limb_19_col25 = memoryidtobig_value_tmp_c1ec_6.get_m31(19);
            (*trace.data[25].get()).data[row_index] = dst_limb_19_col25;
            let dst_limb_20_col26 = memoryidtobig_value_tmp_c1ec_6.get_m31(20);
            (*trace.data[26].get()).data[row_index] = dst_limb_20_col26;
            let dst_limb_21_col27 = memoryidtobig_value_tmp_c1ec_6.get_m31(21);
            (*trace.data[27].get()).data[row_index] = dst_limb_21_col27;
            let dst_limb_22_col28 = memoryidtobig_value_tmp_c1ec_6.get_m31(22);
            (*trace.data[28].get()).data[row_index] = dst_limb_22_col28;
            let dst_limb_23_col29 = memoryidtobig_value_tmp_c1ec_6.get_m31(23);
            (*trace.data[29].get()).data[row_index] = dst_limb_23_col29;
            let dst_limb_24_col30 = memoryidtobig_value_tmp_c1ec_6.get_m31(24);
            (*trace.data[30].get()).data[row_index] = dst_limb_24_col30;
            let dst_limb_25_col31 = memoryidtobig_value_tmp_c1ec_6.get_m31(25);
            (*trace.data[31].get()).data[row_index] = dst_limb_25_col31;
            let dst_limb_26_col32 = memoryidtobig_value_tmp_c1ec_6.get_m31(26);
            (*trace.data[32].get()).data[row_index] = dst_limb_26_col32;
            let dst_limb_27_col33 = memoryidtobig_value_tmp_c1ec_6.get_m31(27);
