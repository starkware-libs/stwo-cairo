...
pub(super) const N_TRACE_COLUMNS: usize = 102;
...
impl FrameworkEval for Eval {
    ...
    fn evaluate<E: EvalAtRow>(&self, mut eval: E) -> E {
        ...
        let sub_p_bit_col100 = eval.next_trace_mask();
        ...
        // sub_p_bit is a bit.
        eval.add_constraint(
            (sub_p_bit_col100.clone() * (sub_p_bit_col100.clone() - M31_1.clone())),
        );
        let carry_tmp_3fa46_16 = eval.add_intermediate(
            ((((op0_limb_0_col43.clone() + op1_limb_0_col72.clone()) - dst_limb_0_col14.clone())
                - sub_p_bit_col100.clone())
                * M31_4194304.clone()),
        );
        eval.add_constraint(
            (carry_tmp_3fa46_16.clone()
                * ((carry_tmp_3fa46_16.clone() * carry_tmp_3fa46_16.clone()) - M31_1.clone())),
        );
        let carry_tmp_3fa46_17 = eval.add_intermediate(
        ...
        eval.add_constraint(
            (carry_tmp_3fa46_17.clone()
                * ((carry_tmp_3fa46_17.clone() * carry_tmp_3fa46_17.clone()) - M31_1.clone())),
        );
        ...
        let carry_tmp_3fa46_37 = eval.add_intermediate(
            (((((op0_limb_21_col64.clone() + op1_limb_21_col93.clone())
                + carry_tmp_3fa46_36.clone())
                - dst_limb_21_col35.clone())
                - (M31_136.clone() * sub_p_bit_col100.clone()))
                * M31_4194304.clone()),
        );
        eval.add_constraint(
        ...
        eval.add_constraint(
            ((((op0_limb_27_col70.clone() + op1_limb_27_col99.clone())
                + carry_tmp_3fa46_42.clone())
                - dst_limb_27_col41.clone())
                - (M31_256.clone() * sub_p_bit_col100.clone())),
        );
