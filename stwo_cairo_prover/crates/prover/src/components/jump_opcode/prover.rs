...
fn write_trace_simd(
    ...
    trace
        ...
        .for_each(|(((row_index, mut row), jump_opcode_input), lookup_data)| {
            ...
            let verify_instruction_inputs_0 = (
                ...
                [
                    ((((M31_24) + ((op1_base_fp_col4) * (M31_64)))
                        ...
                        + (M31_0)),
                    (((((M31_2) + ((ap_update_add_1_col6) * (M31_32))) + (M31_0)) + (M31_0))
                        + (M31_0)),
                ],
                M31_0,
            )
            ...
            *lookup_data.verify_instruction_0 = [
                ...
                M31_32767,
                offset2_col3,
                ((((M31_24) + ((op1_base_fp_col4) * (M31_64))) + ((op1_base_ap_col5) * (M31_128)))
                    + (M31_0)),
                (((((M31_2) + ((ap_update_add_1_col6) * (M31_32))) + (M31_0)) + (M31_0)) + (M31_0)),
                M31_0,
            ];
            ...
            *row[12] = padding.packed_at(row_index);
