...
impl FrameworkEval for Eval {
    ...
    fn evaluate<E: EvalAtRow>(&self, mut eval: E) -> E {
        let bitwisexor = eval.get_preprocessed_column((BitwiseXor::new(8, 0)).id());
        let bitwisexor = eval.get_preprocessed_column((BitwiseXor::new(8, 1)).id());
        let bitwisexor = eval.get_preprocessed_column((BitwiseXor::new(8, 2)).id());
