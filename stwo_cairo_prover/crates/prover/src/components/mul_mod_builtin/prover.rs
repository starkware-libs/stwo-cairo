    ...
    trace
        ...
        .for_each(|((row_index, row), lookup_data)| {
            ...
            *lookup_data.memory_id_to_big_23 = [
            ...
            let ab_minus_c_div_p_tmp_cf8b4_61 = PackedBigUInt::<384, 6>::from_biguint::<768, 12>(
                (((PackedBigUInt::<384, 6>::from_felt252_array([
                ...
                .widening_mul(PackedBigUInt::<384, 6>::from_felt252_array([
                    PackedFelt252::from_limbs([
                        b0_limb_0_col141,
                        b0_limb_1_col142,
                        b0_limb_2_col143,
                ...
                ]))) - (PackedBigUInt::<768, 12>::from_biguint::<384, 6>(PackedBigUInt::<
                    384,
                    6,
                >::from_felt252_array(
                    [
                ...
                )))) / (PackedBigUInt::<768, 12>::from_biguint::<384, 6>(
                    PackedBigUInt::<384, 6>::from_felt252_array([
                        PackedFelt252::from_limbs([
                            p0_limb_0_col2,
                            p0_limb_1_col3,
