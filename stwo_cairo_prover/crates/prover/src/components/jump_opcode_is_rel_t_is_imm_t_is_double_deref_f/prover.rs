    ...
    iter.for_each(
        |(row_index, jump_opcode_is_rel_t_is_imm_t_is_double_deref_f_input)| {
            unsafe {
                ...
                (*trace.data[3].get()).data[row_index] = ap_update_add_1_col3;
                ...
                (*trace.data[4].get()).data[row_index] = next_pc_id_col4;
                ...
                let mid_limbs_set_tmp_ad2c_7 =
                    memoryidtobig_value_tmp_ad2c_5.get_m31(20).eq(M31_511);
                ...
                (*trace.data[7].get()).data[row_index] = next_pc_limb_0_col7;
                let next_pc_limb_1_col8 = memoryidtobig_value_tmp_ad2c_5.get_m31(1);
                (*trace.data[8].get()).data[row_index] = next_pc_limb_1_col8;
                let next_pc_limb_2_col9 = memoryidtobig_value_tmp_ad2c_5.get_m31(2);
                (*trace.data[9].get()).data[row_index] = next_pc_limb_2_col9;
                (*sub_components_inputs.memory_id_to_big_inputs[0].get())
                    [row_index * N_LANES..(row_index + 1) * N_LANES]
                    .copy_from_slice(&next_pc_id_col4.unpack());
