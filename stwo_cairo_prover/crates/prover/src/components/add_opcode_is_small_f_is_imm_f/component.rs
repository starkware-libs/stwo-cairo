...
impl Claim {
    pub fn log_sizes(&self) -> TreeVec<Vec<u32>> {
        ...
        let trace_log_sizes = vec![log_size; 101];
...
impl FrameworkEval for Eval {
    ...
    fn evaluate<E: EvalAtRow>(&self, mut eval: E) -> E {
        ...
        let carry_tmp_f459_18 = eval.add_intermediate(
            (((((op0_limb_0_col43.clone() + op1_limb_0_col72.clone()) + M31_0.clone())
                - dst_limb_0_col14.clone())
                - (M31_1.clone() * sub_p_bit_col100.clone()))
                * M31_4194304.clone()),
        );
        eval.add_constraint(
        ...
        let carry_tmp_f459_19 = eval.add_intermediate(
            (((((op0_limb_1_col44.clone() + op1_limb_1_col73.clone())
                + carry_tmp_f459_18.clone())
                - dst_limb_1_col15.clone())
                - (M31_0.clone() * sub_p_bit_col100.clone()))
                * M31_4194304.clone()),
        );
        eval.add_constraint(
