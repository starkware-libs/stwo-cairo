...
fn write_trace_simd(
    ...
    trace
        ...
        .for_each(
            |(((row_index, mut row), assert_eq_opcode_imm_input), lookup_data)| {
                ...
                *row[5] = ap_update_add_1_col5;
                let verify_instruction_inputs_0 = (
                    ...
                    [
                        (((((((M31_0) + ((dst_base_fp_col4) * (M31_8))) + (M31_16)) + (M31_32))
                            + (M31_0))
                            + (M31_0))
                            + (M31_0)),
                        (((((M31_0) + ((ap_update_add_1_col5) * (M31_32))) + (M31_0)) + (M31_0))
                            + (M31_256)),
                    ],
                    M31_0,
                )
                ...
                *row[8] = padding.packed_at(row_index);
