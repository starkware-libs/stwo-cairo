...
use crate::components::sub_routines::cond_decode_small_sign::component::CondDecodeSmallSign;
...
impl ReadSmall {
    ...
    pub fn evaluate<E: EvalAtRow>(
        ...
        let tmp_ceaaf_4_limb_0 = eval.add_intermediate(
        ...
        [tmp_ceaaf_4_limb_0.clone(), id_col0.clone()]
    }
}
