...
impl ModWordsTo12BitArray {
    ...
    pub fn evaluate<E: EvalAtRow>(
        ...
        let tmp_f4497_20_limb_0 = eval.add_intermediate(
            (mod_words_to_12_bit_array_input_limb_0.clone()
                + (M31_512.clone() * limb1a_0_tmp_f4497_1.clone())),
        );
        let tmp_f4497_20_limb_1 = eval.add_intermediate(
            (limb1b_0_col0.clone() + (M31_64.clone() * limb2a_0_tmp_f4497_3.clone())),
        );
        let tmp_f4497_20_limb_2 = eval.add_intermediate(
            (limb2b_0_col1.clone()
                + (M31_8.clone() * mod_words_to_12_bit_array_input_limb_3.clone())),
        );
        let tmp_f4497_20_limb_3 = eval.add_intermediate(
            (mod_words_to_12_bit_array_input_limb_4.clone()
                + (M31_512.clone() * limb5a_0_tmp_f4497_5.clone())),
        );
        let tmp_f4497_20_limb_4 = eval.add_intermediate(
            (limb5b_0_col2.clone() + (M31_64.clone() * limb6a_0_tmp_f4497_7.clone())),
        );
        let tmp_f4497_20_limb_5 = eval.add_intermediate(
            (limb6b_0_col3.clone()
                + (M31_8.clone() * mod_words_to_12_bit_array_input_limb_7.clone())),
        );
        let tmp_f4497_20_limb_6 = eval.add_intermediate(
            (mod_words_to_12_bit_array_input_limb_8.clone()
                + (M31_512.clone() * limb9a_0_tmp_f4497_9.clone())),
        );
        let tmp_f4497_20_limb_7 = eval.add_intermediate(
            (limb9b_0_col4.clone()
                + (M31_64.clone() * mod_words_to_12_bit_array_input_limb_10.clone())),
        );
        let tmp_f4497_20_limb_8 = eval.add_intermediate(
            (mod_words_to_12_bit_array_input_limb_28.clone()
                + (M31_512.clone() * limb1a_1_tmp_f4497_11.clone())),
        );
        let tmp_f4497_20_limb_9 = eval.add_intermediate(
            (limb1b_1_col5.clone() + (M31_64.clone() * limb2a_1_tmp_f4497_13.clone())),
        );
        let tmp_f4497_20_limb_10 = eval.add_intermediate(
            (limb2b_1_col6.clone()
                + (M31_8.clone() * mod_words_to_12_bit_array_input_limb_31.clone())),
        );
        let tmp_f4497_20_limb_11 = eval.add_intermediate(
            (mod_words_to_12_bit_array_input_limb_32.clone()
                + (M31_512.clone() * limb5a_1_tmp_f4497_15.clone())),
        );
        let tmp_f4497_20_limb_12 = eval.add_intermediate(
            (limb5b_1_col7.clone() + (M31_64.clone() * limb6a_1_tmp_f4497_17.clone())),
        );
        let tmp_f4497_20_limb_13 = eval.add_intermediate(
            (limb6b_1_col8.clone()
                + (M31_8.clone() * mod_words_to_12_bit_array_input_limb_35.clone())),
        );
        let tmp_f4497_20_limb_14 = eval.add_intermediate(
            (mod_words_to_12_bit_array_input_limb_36.clone()
                + (M31_512.clone() * limb9a_1_tmp_f4497_19.clone())),
        );
        let tmp_f4497_20_limb_15 = eval.add_intermediate(
            (limb9b_1_col9.clone()
                + (M31_64.clone() * mod_words_to_12_bit_array_input_limb_38.clone())),
        );
        [
            tmp_f4497_20_limb_0.clone(),
            tmp_f4497_20_limb_1.clone(),
            tmp_f4497_20_limb_2.clone(),
            tmp_f4497_20_limb_3.clone(),
            tmp_f4497_20_limb_4.clone(),
            tmp_f4497_20_limb_5.clone(),
            tmp_f4497_20_limb_6.clone(),
            tmp_f4497_20_limb_7.clone(),
            tmp_f4497_20_limb_8.clone(),
            tmp_f4497_20_limb_9.clone(),
            tmp_f4497_20_limb_10.clone(),
            tmp_f4497_20_limb_11.clone(),
            tmp_f4497_20_limb_12.clone(),
            tmp_f4497_20_limb_13.clone(),
            tmp_f4497_20_limb_14.clone(),
            tmp_f4497_20_limb_15.clone(),
        ]
    }
}
