...
fn write_trace_simd(
    ...
    trace
        ...
        .for_each(
            |(((row_index, mut row), add_opcode_imm_input), lookup_data)| {
                ...
                let offset0_tmp_7e965_3 =
                    ((PackedUInt16::from_m31(memory_id_to_big_value_tmp_7e965_2.get_m31(0)))
                        + (((PackedUInt16::from_m31(
                            memory_id_to_big_value_tmp_7e965_2.get_m31(1),
                        )) & (UInt16_127))
                            << (UInt16_9)));
                ...
                *row[3] = offset0_col3;
                let offset1_tmp_7e965_4 =
                    ((((PackedUInt16::from_m31(memory_id_to_big_value_tmp_7e965_2.get_m31(1)))
                        >> (UInt16_7))
                        + ((PackedUInt16::from_m31(
                            memory_id_to_big_value_tmp_7e965_2.get_m31(2),
                        )) << (UInt16_2)))
                        + (((PackedUInt16::from_m31(
                            memory_id_to_big_value_tmp_7e965_2.get_m31(3),
                        )) & (UInt16_31))
                            << (UInt16_11)));
                ...
                *row[4] = offset1_col4;
                let dst_base_fp_tmp_7e965_5 =
                    (((((PackedUInt16::from_m31(memory_id_to_big_value_tmp_7e965_2.get_m31(5)))
                        >> (UInt16_3))
                        + ((PackedUInt16::from_m31(
                            memory_id_to_big_value_tmp_7e965_2.get_m31(6),
                        )) << (UInt16_6)))
                        >> (UInt16_0))
                        & (UInt16_1));
                ...
                *row[98] = padding.packed_at(row_index);
