...
pub type InputType = Felt252Packed27;
pub type PackedInputType = PackedFelt252Packed27;
...
impl ClaimGenerator {
    pub fn new(inputs: Vec<InputType>, log_size: u32) -> Self {
        ...
        SimdBackend: BackendForChannel<MC>,
    {
        ...
        let log_size = (mults.len() * N_LANES).ilog2();
        assert!(log_size >= size.ilog2(), "More inputs than rows");
        if need_padding {
    ...
    pub fn add_input(&mut self, input: &InputType) {
        let index = self.inputs.iter().find_position(|&&x| x == *input);
        match index {
            Some((index, _)) => {
                self.mults.increase_at(index as u32);
            }
            None => {
                self.inputs.push(*input);
                self.mults.increase_at((self.inputs.len() - 1) as u32);
            }
        }
    }
...
fn write_trace_simd(
    ...
    assert_eq!(
        inputs.len(),
        mults.len(),
        "Inputs were not resized correctly"
    );
    ...
    trace
        ...
        .for_each(
            |(((row_index, row), range_check_felt_252_packed_27_input), lookup_data)| {
                let input_tmp_9287a_0 = range_check_felt_252_packed_27_input;
                let input_limb_0_col0 = input_tmp_9287a_0.get_m31(0);
                *row[0] = input_limb_0_col0;
                let input_limb_1_col1 = input_tmp_9287a_0.get_m31(1);
                *row[1] = input_limb_1_col1;
                let input_limb_2_col2 = input_tmp_9287a_0.get_m31(2);
                *row[2] = input_limb_2_col2;
                let input_limb_3_col3 = input_tmp_9287a_0.get_m31(3);
                *row[3] = input_limb_3_col3;
                let input_limb_4_col4 = input_tmp_9287a_0.get_m31(4);
                *row[4] = input_limb_4_col4;
                let input_limb_5_col5 = input_tmp_9287a_0.get_m31(5);
                *row[5] = input_limb_5_col5;
                let input_limb_6_col6 = input_tmp_9287a_0.get_m31(6);
                *row[6] = input_limb_6_col6;
                let input_limb_7_col7 = input_tmp_9287a_0.get_m31(7);
                *row[7] = input_limb_7_col7;
                let input_limb_8_col8 = input_tmp_9287a_0.get_m31(8);
                *row[8] = input_limb_8_col8;
                let input_limb_9_col9 = input_tmp_9287a_0.get_m31(9);
                *row[9] = input_limb_9_col9;
                let input_as_felt252_tmp_9287a_1 =
                    PackedFelt252::from_packed_felt252_packed27(input_tmp_9287a_0);
                let limb_0_high_part_col10 = input_as_felt252_tmp_9287a_1.get_m31(2);
                *row[10] = limb_0_high_part_col10;
                let limb_1_low_part_col11 = input_as_felt252_tmp_9287a_1.get_m31(3);
                ...
                *lookup_data.range_check_18_1 =
                ...
                let limb_2_high_part_col12 = input_as_felt252_tmp_9287a_1.get_m31(8);
                *row[12] = limb_2_high_part_col12;
                let limb_3_low_part_col13 = input_as_felt252_tmp_9287a_1.get_m31(9);
                ...
                *lookup_data.range_check_18_3 =
                ...
                let limb_4_high_part_col14 = input_as_felt252_tmp_9287a_1.get_m31(14);
                *row[14] = limb_4_high_part_col14;
                let limb_5_low_part_col15 = input_as_felt252_tmp_9287a_1.get_m31(15);
                ...
                *lookup_data.range_check_18_5 =
                ...
                let limb_6_high_part_col16 = input_as_felt252_tmp_9287a_1.get_m31(20);
                *row[16] = limb_6_high_part_col16;
                let limb_7_low_part_col17 = input_as_felt252_tmp_9287a_1.get_m31(21);
                ...
                *lookup_data.range_check_18_7 =
                ...
                let limb_8_high_part_col18 = input_as_felt252_tmp_9287a_1.get_m31(26);
                ...
                *lookup_data.range_check_felt_252_packed_27_0 = [
                    input_limb_0_col0,
                    input_limb_1_col1,
                    input_limb_2_col2,
                    input_limb_3_col3,
...
struct LookupData {
    mults: Vec<PackedM31>,
    range_check_felt_252_packed_27_0: Vec<[PackedM31; 10]>,
...
impl InteractionClaimGenerator {
    pub fn write_interaction_trace<MC: MerkleChannel>(
        self,
        tree_builder: &mut TreeBuilder<'_, '_, SimdBackend, MC>,
        range_check_felt_252_packed_27: &relations::RangeCheckFelt252Packed27,
        ...
        SimdBackend: BackendForChannel<MC>,
    {
        ...
        for (i, (values, mults)) in self
            .lookup_data
            .range_check_felt_252_packed_27_0
            .iter()
            .zip(self.lookup_data.mults)
            .enumerate()
        {
            let denom = range_check_felt_252_packed_27.combine(values);
