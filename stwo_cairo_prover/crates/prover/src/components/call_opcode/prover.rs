...
fn write_trace_simd(
    ...
    trace
        ...
        .for_each(
            |((((row_index, row), call_opcode_input), lookup_data), mut sub_components_inputs)| {
                ...
                let offset2_tmp_32b66_3 =
                    ((((PackedUInt16::from_m31(memory_id_to_big_value_tmp_32b66_2.get_m31(3)))
                        ...
                        + ((PackedUInt16::from_m31(
                            memory_id_to_big_value_tmp_32b66_2.get_m31(4),
                        )) << (UInt16_4)))
                        + (((PackedUInt16::from_m31(
                            memory_id_to_big_value_tmp_32b66_2.get_m31(5),
                        )) & (UInt16_7))
                            << (UInt16_13)));
