...
impl Claim {
    pub fn log_sizes(&self) -> TreeVec<Vec<u32>> {
        ...
        let trace_log_sizes = vec![log_size; 98];
...
impl FrameworkEval for Eval {
    ...
    fn evaluate<E: EvalAtRow>(&self, mut eval: E) -> E {
        ...
        let carry_tmp_f0ae3_15 = eval.add_intermediate(
        ...
        eval.add_constraint(
            (carry_tmp_f0ae3_15.clone()
                * ((carry_tmp_f0ae3_15.clone() * carry_tmp_f0ae3_15.clone()) - M31_1.clone())),
        );
        let carry_tmp_f0ae3_16 = eval.add_intermediate(
        ...
        eval.add_constraint(
            (carry_tmp_f0ae3_16.clone()
                * ((carry_tmp_f0ae3_16.clone() * carry_tmp_f0ae3_16.clone()) - M31_1.clone())),
        );
        let carry_tmp_f0ae3_17 = eval.add_intermediate(
        ...
        eval.add_constraint(
            (carry_tmp_f0ae3_17.clone()
                * ((carry_tmp_f0ae3_17.clone() * carry_tmp_f0ae3_17.clone()) - M31_1.clone())),
        );
        let carry_tmp_f0ae3_18 = eval.add_intermediate(
        ...
        eval.add_constraint(
            (carry_tmp_f0ae3_18.clone()
                * ((carry_tmp_f0ae3_18.clone() * carry_tmp_f0ae3_18.clone()) - M31_1.clone())),
        );
        let carry_tmp_f0ae3_19 = eval.add_intermediate(
        ...
        eval.add_constraint(
            (carry_tmp_f0ae3_19.clone()
                * ((carry_tmp_f0ae3_19.clone() * carry_tmp_f0ae3_19.clone()) - M31_1.clone())),
        );
        let carry_tmp_f0ae3_20 = eval.add_intermediate(
        ...
        eval.add_constraint(
            (carry_tmp_f0ae3_20.clone()
                * ((carry_tmp_f0ae3_20.clone() * carry_tmp_f0ae3_20.clone()) - M31_1.clone())),
        );
        let carry_tmp_f0ae3_21 = eval.add_intermediate(
        ...
        eval.add_constraint(
            (carry_tmp_f0ae3_21.clone()
                * ((carry_tmp_f0ae3_21.clone() * carry_tmp_f0ae3_21.clone()) - M31_1.clone())),
        );
        let carry_tmp_f0ae3_22 = eval.add_intermediate(
        ...
        eval.add_constraint(
            (carry_tmp_f0ae3_22.clone()
                * ((carry_tmp_f0ae3_22.clone() * carry_tmp_f0ae3_22.clone()) - M31_1.clone())),
        );
        let carry_tmp_f0ae3_23 = eval.add_intermediate(
        ...
        eval.add_constraint(
            (carry_tmp_f0ae3_23.clone()
                * ((carry_tmp_f0ae3_23.clone() * carry_tmp_f0ae3_23.clone()) - M31_1.clone())),
        );
        let carry_tmp_f0ae3_24 = eval.add_intermediate(
        ...
        eval.add_constraint(
            (carry_tmp_f0ae3_24.clone()
                * ((carry_tmp_f0ae3_24.clone() * carry_tmp_f0ae3_24.clone()) - M31_1.clone())),
        );
        let carry_tmp_f0ae3_25 = eval.add_intermediate(
        ...
        eval.add_constraint(
            (carry_tmp_f0ae3_25.clone()
                * ((carry_tmp_f0ae3_25.clone() * carry_tmp_f0ae3_25.clone()) - M31_1.clone())),
        );
        let carry_tmp_f0ae3_26 = eval.add_intermediate(
        ...
        eval.add_constraint(
            (carry_tmp_f0ae3_26.clone()
                * ((carry_tmp_f0ae3_26.clone() * carry_tmp_f0ae3_26.clone()) - M31_1.clone())),
        );
        let carry_tmp_f0ae3_27 = eval.add_intermediate(
        ...
        eval.add_constraint(
            (carry_tmp_f0ae3_27.clone()
                * ((carry_tmp_f0ae3_27.clone() * carry_tmp_f0ae3_27.clone()) - M31_1.clone())),
        );
        let carry_tmp_f0ae3_28 = eval.add_intermediate(
        ...
        eval.add_constraint(
            (carry_tmp_f0ae3_28.clone()
                * ((carry_tmp_f0ae3_28.clone() * carry_tmp_f0ae3_28.clone()) - M31_1.clone())),
        );
        let carry_tmp_f0ae3_29 = eval.add_intermediate(
        ...
        eval.add_constraint(
            (carry_tmp_f0ae3_29.clone()
                * ((carry_tmp_f0ae3_29.clone() * carry_tmp_f0ae3_29.clone()) - M31_1.clone())),
        );
        let carry_tmp_f0ae3_30 = eval.add_intermediate(
        ...
        eval.add_constraint(
            (carry_tmp_f0ae3_30.clone()
                * ((carry_tmp_f0ae3_30.clone() * carry_tmp_f0ae3_30.clone()) - M31_1.clone())),
        );
        let carry_tmp_f0ae3_31 = eval.add_intermediate(
        ...
        eval.add_constraint(
            (carry_tmp_f0ae3_31.clone()
                * ((carry_tmp_f0ae3_31.clone() * carry_tmp_f0ae3_31.clone()) - M31_1.clone())),
        );
        let carry_tmp_f0ae3_32 = eval.add_intermediate(
        ...
        eval.add_constraint(
            (carry_tmp_f0ae3_32.clone()
                * ((carry_tmp_f0ae3_32.clone() * carry_tmp_f0ae3_32.clone()) - M31_1.clone())),
        );
        let carry_tmp_f0ae3_33 = eval.add_intermediate(
        ...
        eval.add_constraint(
            (carry_tmp_f0ae3_33.clone()
                * ((carry_tmp_f0ae3_33.clone() * carry_tmp_f0ae3_33.clone()) - M31_1.clone())),
        );
        let carry_tmp_f0ae3_34 = eval.add_intermediate(
        ...
        eval.add_constraint(
            (carry_tmp_f0ae3_34.clone()
                * ((carry_tmp_f0ae3_34.clone() * carry_tmp_f0ae3_34.clone()) - M31_1.clone())),
        );
        let carry_tmp_f0ae3_35 = eval.add_intermediate(
        ...
        eval.add_constraint(
            (carry_tmp_f0ae3_35.clone()
                * ((carry_tmp_f0ae3_35.clone() * carry_tmp_f0ae3_35.clone()) - M31_1.clone())),
        );
        let carry_tmp_f0ae3_36 = eval.add_intermediate(
        ...
        eval.add_constraint(
            (carry_tmp_f0ae3_36.clone()
                * ((carry_tmp_f0ae3_36.clone() * carry_tmp_f0ae3_36.clone()) - M31_1.clone())),
        );
        let carry_tmp_f0ae3_37 = eval.add_intermediate(
        ...
        eval.add_constraint(
            (carry_tmp_f0ae3_37.clone()
                * ((carry_tmp_f0ae3_37.clone() * carry_tmp_f0ae3_37.clone()) - M31_1.clone())),
        );
        let carry_tmp_f0ae3_38 = eval.add_intermediate(
        ...
        eval.add_constraint(
            (carry_tmp_f0ae3_38.clone()
                * ((carry_tmp_f0ae3_38.clone() * carry_tmp_f0ae3_38.clone()) - M31_1.clone())),
        );
        let carry_tmp_f0ae3_39 = eval.add_intermediate(
        ...
        eval.add_constraint(
            (carry_tmp_f0ae3_39.clone()
                * ((carry_tmp_f0ae3_39.clone() * carry_tmp_f0ae3_39.clone()) - M31_1.clone())),
        );
        let carry_tmp_f0ae3_40 = eval.add_intermediate(
        ...
        eval.add_constraint(
            (carry_tmp_f0ae3_40.clone()
                * ((carry_tmp_f0ae3_40.clone() * carry_tmp_f0ae3_40.clone()) - M31_1.clone())),
        );
        let carry_tmp_f0ae3_41 = eval.add_intermediate(
        ...
        eval.add_constraint(
            (carry_tmp_f0ae3_41.clone()
                * ((carry_tmp_f0ae3_41.clone() * carry_tmp_f0ae3_41.clone()) - M31_1.clone())),
        );
        eval.add_constraint(
