...
pub fn write_trace_simd(
    ...
    inputs
        ...
        .for_each(|(row_index, add_opcode_is_small_f_is_imm_t_input)| {
            let input_tmp_1067 = add_opcode_is_small_f_is_imm_t_input;
            let input_pc_col0 = input_tmp_1067.pc;
            trace[0].data[row_index] = input_pc_col0;
            let input_ap_col1 = input_tmp_1067.ap;
            trace[1].data[row_index] = input_ap_col1;
            let input_fp_col2 = input_tmp_1067.fp;
            trace[2].data[row_index] = input_fp_col2;

            // decode_instruction_9aed6a790187299c.

            let memory_address_to_id_value_tmp_1068 =
                memory_address_to_id_state.deduce_output(input_pc_col0);
            let memory_id_to_big_value_tmp_1069 =
                memory_id_to_big_state.deduce_output(memory_address_to_id_value_tmp_1068);
            let offset0_tmp_1070 =
                ((PackedUInt16::from_m31(memory_id_to_big_value_tmp_1069.get_m31(0)))
                    + (((PackedUInt16::from_m31(memory_id_to_big_value_tmp_1069.get_m31(1)))
                        & (UInt16_127))
                        << (UInt16_9)));
            let offset0_col3 = offset0_tmp_1070.as_m31();
            trace[3].data[row_index] = offset0_col3;
            let offset1_tmp_1071 =
                ((((PackedUInt16::from_m31(memory_id_to_big_value_tmp_1069.get_m31(1)))
                    >> (UInt16_7))
                    + ((PackedUInt16::from_m31(memory_id_to_big_value_tmp_1069.get_m31(2)))
                        << (UInt16_2)))
                    + (((PackedUInt16::from_m31(memory_id_to_big_value_tmp_1069.get_m31(3)))
                        & (UInt16_31))
                        << (UInt16_11)));
            let offset1_col4 = offset1_tmp_1071.as_m31();
            trace[4].data[row_index] = offset1_col4;
            let dst_base_fp_tmp_1072 =
                (((((PackedUInt16::from_m31(memory_id_to_big_value_tmp_1069.get_m31(5)))
                    >> (UInt16_3))
                    + ((PackedUInt16::from_m31(memory_id_to_big_value_tmp_1069.get_m31(6)))
                        << (UInt16_6)))
                    >> (UInt16_0))
                    & (UInt16_1));
            let dst_base_fp_col5 = dst_base_fp_tmp_1072.as_m31();
            trace[5].data[row_index] = dst_base_fp_col5;
            let op0_base_fp_tmp_1073 =
                (((((PackedUInt16::from_m31(memory_id_to_big_value_tmp_1069.get_m31(5)))
                    >> (UInt16_3))
                    + ((PackedUInt16::from_m31(memory_id_to_big_value_tmp_1069.get_m31(6)))
                        << (UInt16_6)))
                    >> (UInt16_1))
                    & (UInt16_1));
            let op0_base_fp_col6 = op0_base_fp_tmp_1073.as_m31();
            trace[6].data[row_index] = op0_base_fp_col6;
            let ap_update_add_1_tmp_1074 =
                (((((PackedUInt16::from_m31(memory_id_to_big_value_tmp_1069.get_m31(5)))
                    >> (UInt16_3))
                    + ((PackedUInt16::from_m31(memory_id_to_big_value_tmp_1069.get_m31(6)))
                        << (UInt16_6)))
                    >> (UInt16_11))
                    & (UInt16_1));
            let ap_update_add_1_col7 = ap_update_add_1_tmp_1074.as_m31();
            ...
            let memory_address_to_id_value_tmp_1076 = memory_address_to_id_state.deduce_output(
                ((((dst_base_fp_col5) * (input_fp_col2))
                    + (((M31_1) - (dst_base_fp_col5)) * (input_ap_col1)))
                    + ((offset0_col3) - (M31_32768))),
            );
            let memory_id_to_big_value_tmp_1077 =
                memory_id_to_big_state.deduce_output(memory_address_to_id_value_tmp_1076);
            let dst_id_col8 = memory_address_to_id_value_tmp_1076;
            ...
            let dst_limb_0_col9 = memory_id_to_big_value_tmp_1077.get_m31(0);
            trace[9].data[row_index] = dst_limb_0_col9;
            let dst_limb_1_col10 = memory_id_to_big_value_tmp_1077.get_m31(1);
            trace[10].data[row_index] = dst_limb_1_col10;
            let dst_limb_2_col11 = memory_id_to_big_value_tmp_1077.get_m31(2);
            trace[11].data[row_index] = dst_limb_2_col11;
            let dst_limb_3_col12 = memory_id_to_big_value_tmp_1077.get_m31(3);
            trace[12].data[row_index] = dst_limb_3_col12;
            let dst_limb_4_col13 = memory_id_to_big_value_tmp_1077.get_m31(4);
            trace[13].data[row_index] = dst_limb_4_col13;
            let dst_limb_5_col14 = memory_id_to_big_value_tmp_1077.get_m31(5);
            trace[14].data[row_index] = dst_limb_5_col14;
            let dst_limb_6_col15 = memory_id_to_big_value_tmp_1077.get_m31(6);
            trace[15].data[row_index] = dst_limb_6_col15;
            let dst_limb_7_col16 = memory_id_to_big_value_tmp_1077.get_m31(7);
            trace[16].data[row_index] = dst_limb_7_col16;
            let dst_limb_8_col17 = memory_id_to_big_value_tmp_1077.get_m31(8);
            trace[17].data[row_index] = dst_limb_8_col17;
            let dst_limb_9_col18 = memory_id_to_big_value_tmp_1077.get_m31(9);
            trace[18].data[row_index] = dst_limb_9_col18;
            let dst_limb_10_col19 = memory_id_to_big_value_tmp_1077.get_m31(10);
            trace[19].data[row_index] = dst_limb_10_col19;
            let dst_limb_11_col20 = memory_id_to_big_value_tmp_1077.get_m31(11);
            trace[20].data[row_index] = dst_limb_11_col20;
            let dst_limb_12_col21 = memory_id_to_big_value_tmp_1077.get_m31(12);
            trace[21].data[row_index] = dst_limb_12_col21;
            let dst_limb_13_col22 = memory_id_to_big_value_tmp_1077.get_m31(13);
            trace[22].data[row_index] = dst_limb_13_col22;
            let dst_limb_14_col23 = memory_id_to_big_value_tmp_1077.get_m31(14);
            trace[23].data[row_index] = dst_limb_14_col23;
            let dst_limb_15_col24 = memory_id_to_big_value_tmp_1077.get_m31(15);
            trace[24].data[row_index] = dst_limb_15_col24;
            let dst_limb_16_col25 = memory_id_to_big_value_tmp_1077.get_m31(16);
            trace[25].data[row_index] = dst_limb_16_col25;
            let dst_limb_17_col26 = memory_id_to_big_value_tmp_1077.get_m31(17);
            trace[26].data[row_index] = dst_limb_17_col26;
            let dst_limb_18_col27 = memory_id_to_big_value_tmp_1077.get_m31(18);
            trace[27].data[row_index] = dst_limb_18_col27;
            let dst_limb_19_col28 = memory_id_to_big_value_tmp_1077.get_m31(19);
            trace[28].data[row_index] = dst_limb_19_col28;
            let dst_limb_20_col29 = memory_id_to_big_value_tmp_1077.get_m31(20);
            trace[29].data[row_index] = dst_limb_20_col29;
            let dst_limb_21_col30 = memory_id_to_big_value_tmp_1077.get_m31(21);
            trace[30].data[row_index] = dst_limb_21_col30;
            let dst_limb_22_col31 = memory_id_to_big_value_tmp_1077.get_m31(22);
            trace[31].data[row_index] = dst_limb_22_col31;
            let dst_limb_23_col32 = memory_id_to_big_value_tmp_1077.get_m31(23);
            trace[32].data[row_index] = dst_limb_23_col32;
            let dst_limb_24_col33 = memory_id_to_big_value_tmp_1077.get_m31(24);
            trace[33].data[row_index] = dst_limb_24_col33;
            let dst_limb_25_col34 = memory_id_to_big_value_tmp_1077.get_m31(25);
            trace[34].data[row_index] = dst_limb_25_col34;
            let dst_limb_26_col35 = memory_id_to_big_value_tmp_1077.get_m31(26);
            trace[35].data[row_index] = dst_limb_26_col35;
            let dst_limb_27_col36 = memory_id_to_big_value_tmp_1077.get_m31(27);
            ...
            let memory_address_to_id_value_tmp_1078 = memory_address_to_id_state.deduce_output(
                ((((op0_base_fp_col6) * (input_fp_col2))
                    + (((M31_1) - (op0_base_fp_col6)) * (input_ap_col1)))
                    + ((offset1_col4) - (M31_32768))),
            );
            let memory_id_to_big_value_tmp_1079 =
                memory_id_to_big_state.deduce_output(memory_address_to_id_value_tmp_1078);
            let op0_id_col37 = memory_address_to_id_value_tmp_1078;
            ...
            let op0_limb_0_col38 = memory_id_to_big_value_tmp_1079.get_m31(0);
            trace[38].data[row_index] = op0_limb_0_col38;
            let op0_limb_1_col39 = memory_id_to_big_value_tmp_1079.get_m31(1);
            trace[39].data[row_index] = op0_limb_1_col39;
            let op0_limb_2_col40 = memory_id_to_big_value_tmp_1079.get_m31(2);
            trace[40].data[row_index] = op0_limb_2_col40;
            let op0_limb_3_col41 = memory_id_to_big_value_tmp_1079.get_m31(3);
            trace[41].data[row_index] = op0_limb_3_col41;
            let op0_limb_4_col42 = memory_id_to_big_value_tmp_1079.get_m31(4);
            trace[42].data[row_index] = op0_limb_4_col42;
            let op0_limb_5_col43 = memory_id_to_big_value_tmp_1079.get_m31(5);
            trace[43].data[row_index] = op0_limb_5_col43;
            let op0_limb_6_col44 = memory_id_to_big_value_tmp_1079.get_m31(6);
            trace[44].data[row_index] = op0_limb_6_col44;
            let op0_limb_7_col45 = memory_id_to_big_value_tmp_1079.get_m31(7);
            trace[45].data[row_index] = op0_limb_7_col45;
            let op0_limb_8_col46 = memory_id_to_big_value_tmp_1079.get_m31(8);
            trace[46].data[row_index] = op0_limb_8_col46;
            let op0_limb_9_col47 = memory_id_to_big_value_tmp_1079.get_m31(9);
            trace[47].data[row_index] = op0_limb_9_col47;
            let op0_limb_10_col48 = memory_id_to_big_value_tmp_1079.get_m31(10);
            trace[48].data[row_index] = op0_limb_10_col48;
            let op0_limb_11_col49 = memory_id_to_big_value_tmp_1079.get_m31(11);
            trace[49].data[row_index] = op0_limb_11_col49;
            let op0_limb_12_col50 = memory_id_to_big_value_tmp_1079.get_m31(12);
            trace[50].data[row_index] = op0_limb_12_col50;
            let op0_limb_13_col51 = memory_id_to_big_value_tmp_1079.get_m31(13);
            trace[51].data[row_index] = op0_limb_13_col51;
            let op0_limb_14_col52 = memory_id_to_big_value_tmp_1079.get_m31(14);
            trace[52].data[row_index] = op0_limb_14_col52;
            let op0_limb_15_col53 = memory_id_to_big_value_tmp_1079.get_m31(15);
            trace[53].data[row_index] = op0_limb_15_col53;
            let op0_limb_16_col54 = memory_id_to_big_value_tmp_1079.get_m31(16);
            trace[54].data[row_index] = op0_limb_16_col54;
            let op0_limb_17_col55 = memory_id_to_big_value_tmp_1079.get_m31(17);
            trace[55].data[row_index] = op0_limb_17_col55;
            let op0_limb_18_col56 = memory_id_to_big_value_tmp_1079.get_m31(18);
            trace[56].data[row_index] = op0_limb_18_col56;
            let op0_limb_19_col57 = memory_id_to_big_value_tmp_1079.get_m31(19);
            trace[57].data[row_index] = op0_limb_19_col57;
            let op0_limb_20_col58 = memory_id_to_big_value_tmp_1079.get_m31(20);
            trace[58].data[row_index] = op0_limb_20_col58;
            let op0_limb_21_col59 = memory_id_to_big_value_tmp_1079.get_m31(21);
            trace[59].data[row_index] = op0_limb_21_col59;
            let op0_limb_22_col60 = memory_id_to_big_value_tmp_1079.get_m31(22);
            trace[60].data[row_index] = op0_limb_22_col60;
            let op0_limb_23_col61 = memory_id_to_big_value_tmp_1079.get_m31(23);
            trace[61].data[row_index] = op0_limb_23_col61;
            let op0_limb_24_col62 = memory_id_to_big_value_tmp_1079.get_m31(24);
            trace[62].data[row_index] = op0_limb_24_col62;
            let op0_limb_25_col63 = memory_id_to_big_value_tmp_1079.get_m31(25);
            trace[63].data[row_index] = op0_limb_25_col63;
            let op0_limb_26_col64 = memory_id_to_big_value_tmp_1079.get_m31(26);
            trace[64].data[row_index] = op0_limb_26_col64;
            let op0_limb_27_col65 = memory_id_to_big_value_tmp_1079.get_m31(27);
            ...
            let memory_address_to_id_value_tmp_1080 =
                memory_address_to_id_state.deduce_output(((input_pc_col0) + (M31_1)));
            let memory_id_to_big_value_tmp_1081 =
                memory_id_to_big_state.deduce_output(memory_address_to_id_value_tmp_1080);
            let op1_id_col66 = memory_address_to_id_value_tmp_1080;
            ...
            let op1_limb_0_col67 = memory_id_to_big_value_tmp_1081.get_m31(0);
            trace[67].data[row_index] = op1_limb_0_col67;
            let op1_limb_1_col68 = memory_id_to_big_value_tmp_1081.get_m31(1);
            trace[68].data[row_index] = op1_limb_1_col68;
            let op1_limb_2_col69 = memory_id_to_big_value_tmp_1081.get_m31(2);
            trace[69].data[row_index] = op1_limb_2_col69;
            let op1_limb_3_col70 = memory_id_to_big_value_tmp_1081.get_m31(3);
            trace[70].data[row_index] = op1_limb_3_col70;
            let op1_limb_4_col71 = memory_id_to_big_value_tmp_1081.get_m31(4);
            trace[71].data[row_index] = op1_limb_4_col71;
            let op1_limb_5_col72 = memory_id_to_big_value_tmp_1081.get_m31(5);
            trace[72].data[row_index] = op1_limb_5_col72;
            let op1_limb_6_col73 = memory_id_to_big_value_tmp_1081.get_m31(6);
            trace[73].data[row_index] = op1_limb_6_col73;
            let op1_limb_7_col74 = memory_id_to_big_value_tmp_1081.get_m31(7);
            trace[74].data[row_index] = op1_limb_7_col74;
            let op1_limb_8_col75 = memory_id_to_big_value_tmp_1081.get_m31(8);
            trace[75].data[row_index] = op1_limb_8_col75;
            let op1_limb_9_col76 = memory_id_to_big_value_tmp_1081.get_m31(9);
            trace[76].data[row_index] = op1_limb_9_col76;
            let op1_limb_10_col77 = memory_id_to_big_value_tmp_1081.get_m31(10);
            trace[77].data[row_index] = op1_limb_10_col77;
            let op1_limb_11_col78 = memory_id_to_big_value_tmp_1081.get_m31(11);
            trace[78].data[row_index] = op1_limb_11_col78;
            let op1_limb_12_col79 = memory_id_to_big_value_tmp_1081.get_m31(12);
            trace[79].data[row_index] = op1_limb_12_col79;
            let op1_limb_13_col80 = memory_id_to_big_value_tmp_1081.get_m31(13);
            trace[80].data[row_index] = op1_limb_13_col80;
            let op1_limb_14_col81 = memory_id_to_big_value_tmp_1081.get_m31(14);
            trace[81].data[row_index] = op1_limb_14_col81;
            let op1_limb_15_col82 = memory_id_to_big_value_tmp_1081.get_m31(15);
            trace[82].data[row_index] = op1_limb_15_col82;
            let op1_limb_16_col83 = memory_id_to_big_value_tmp_1081.get_m31(16);
            trace[83].data[row_index] = op1_limb_16_col83;
            let op1_limb_17_col84 = memory_id_to_big_value_tmp_1081.get_m31(17);
            trace[84].data[row_index] = op1_limb_17_col84;
            let op1_limb_18_col85 = memory_id_to_big_value_tmp_1081.get_m31(18);
            trace[85].data[row_index] = op1_limb_18_col85;
            let op1_limb_19_col86 = memory_id_to_big_value_tmp_1081.get_m31(19);
            trace[86].data[row_index] = op1_limb_19_col86;
            let op1_limb_20_col87 = memory_id_to_big_value_tmp_1081.get_m31(20);
            trace[87].data[row_index] = op1_limb_20_col87;
            let op1_limb_21_col88 = memory_id_to_big_value_tmp_1081.get_m31(21);
            trace[88].data[row_index] = op1_limb_21_col88;
            let op1_limb_22_col89 = memory_id_to_big_value_tmp_1081.get_m31(22);
            trace[89].data[row_index] = op1_limb_22_col89;
            let op1_limb_23_col90 = memory_id_to_big_value_tmp_1081.get_m31(23);
            trace[90].data[row_index] = op1_limb_23_col90;
            let op1_limb_24_col91 = memory_id_to_big_value_tmp_1081.get_m31(24);
            trace[91].data[row_index] = op1_limb_24_col91;
            let op1_limb_25_col92 = memory_id_to_big_value_tmp_1081.get_m31(25);
            trace[92].data[row_index] = op1_limb_25_col92;
            let op1_limb_26_col93 = memory_id_to_big_value_tmp_1081.get_m31(26);
            trace[93].data[row_index] = op1_limb_26_col93;
            let op1_limb_27_col94 = memory_id_to_big_value_tmp_1081.get_m31(27);
