...
impl Claim {
    pub fn log_sizes(&self) -> TreeVec<Vec<u32>> {
        ...
        let trace_log_sizes = vec![log_size; 31];
...
impl FrameworkEval for Eval {
    ...
    fn evaluate<E: EvalAtRow>(&self, mut eval: E) -> E {
        ...
        eval.add_constraint(
            ((M31_1.clone() * mid_limbs_set_col15.clone()) * (msb_col14.clone() - M31_1.clone())),
        );
        ...
        // Cannot have msb equals 0 and mid_limbs_set equals 1.
        eval.add_constraint(
            ((M31_1.clone() * mid_limbs_set_col21.clone()) * (msb_col20.clone() - M31_1.clone())),
        );
        ...
        // Cannot have msb equals 0 and mid_limbs_set equals 1.
        eval.add_constraint(
            ((M31_1.clone() * mid_limbs_set_col27.clone()) * (msb_col26.clone() - M31_1.clone())),
        );
