    ...
    inputs
        ...
        .for_each(|(row_index, add_opcode_is_small_t_is_imm_f_input)| {
            ...
            let offset1_tmp_6202e_4 =
                ((((PackedUInt16::from_m31(memory_id_to_big_value_tmp_6202e_2.get_m31(1)))
                    >> (UInt16_7))
                    + ((PackedUInt16::from_m31(memory_id_to_big_value_tmp_6202e_2.get_m31(2)))
                        << (UInt16_2)))
            ...
            let offset2_tmp_6202e_5 =
                ((((PackedUInt16::from_m31(memory_id_to_big_value_tmp_6202e_2.get_m31(3)))
                    >> (UInt16_5))
                    + ((PackedUInt16::from_m31(memory_id_to_big_value_tmp_6202e_2.get_m31(4)))
                        << (UInt16_4)))
            ...
            let dst_base_fp_tmp_6202e_6 =
                (((((PackedUInt16::from_m31(memory_id_to_big_value_tmp_6202e_2.get_m31(5)))
                    >> (UInt16_3))
                    + ((PackedUInt16::from_m31(memory_id_to_big_value_tmp_6202e_2.get_m31(6)))
                        << (UInt16_6)))
                    >> (UInt16_0))
                    & (UInt16_1));
