        ...
        |(row_index, assert_eq_opcode_is_double_deref_f_is_imm_f_input)| {
            ...
            let offset0_tmp_42997_3 =
                ((PackedUInt16::from_m31(memory_id_to_big_value_tmp_42997_2.get_m31(0)))
                    + (((PackedUInt16::from_m31(memory_id_to_big_value_tmp_42997_2.get_m31(1)))
                        & (UInt16_127))
                        << (UInt16_9)));
            ...
            let offset2_tmp_42997_4 =
                ((((PackedUInt16::from_m31(memory_id_to_big_value_tmp_42997_2.get_m31(3)))
                    >> (UInt16_5))
                    + ((PackedUInt16::from_m31(memory_id_to_big_value_tmp_42997_2.get_m31(4)))
                        << (UInt16_4)))
            ...
            let dst_base_fp_tmp_42997_5 =
                (((((PackedUInt16::from_m31(memory_id_to_big_value_tmp_42997_2.get_m31(5)))
                    >> (UInt16_3))
                    + ((PackedUInt16::from_m31(memory_id_to_big_value_tmp_42997_2.get_m31(6)))
                        << (UInt16_6)))
                    >> (UInt16_0))
                    & (UInt16_1));
            ...
            trace[10].data[row_index] = mem1_base_col10;
            ...
            sub_components_inputs.memory_address_to_id_inputs[1]
                .extend(((mem1_base_col10) + ((offset2_col4) - (M31_32768))).unpack());
