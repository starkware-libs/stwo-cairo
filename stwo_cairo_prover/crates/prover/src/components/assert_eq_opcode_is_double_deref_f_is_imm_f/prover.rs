...
pub fn write_trace_simd(
    ...
    inputs.into_iter().enumerate().for_each(
        |(row_index, assert_eq_opcode_is_double_deref_f_is_imm_f_input)| {
            let input_tmp_1110 = assert_eq_opcode_is_double_deref_f_is_imm_f_input;
            let input_pc_col0 = input_tmp_1110.pc;
            trace[0].data[row_index] = input_pc_col0;
            let input_ap_col1 = input_tmp_1110.ap;
            trace[1].data[row_index] = input_ap_col1;
            let input_fp_col2 = input_tmp_1110.fp;
            trace[2].data[row_index] = input_fp_col2;

            // decode_instruction_dc55adb272664963.

            let memory_address_to_id_value_tmp_1120 =
                memory_address_to_id_state.deduce_output(input_pc_col0);
            let memory_id_to_big_value_tmp_1121 =
                memory_id_to_big_state.deduce_output(memory_address_to_id_value_tmp_1120);
            let offset0_tmp_1122 =
                ((PackedUInt16::from_m31(memory_id_to_big_value_tmp_1121.get_m31(0)))
                    + (((PackedUInt16::from_m31(memory_id_to_big_value_tmp_1121.get_m31(1)))
                        & (UInt16_127))
                        << (UInt16_9)));
            let offset0_col3 = offset0_tmp_1122.as_m31();
            trace[3].data[row_index] = offset0_col3;
            let offset2_tmp_1123 =
                ((((PackedUInt16::from_m31(memory_id_to_big_value_tmp_1121.get_m31(3)))
                    >> (UInt16_5))
                    + ((PackedUInt16::from_m31(memory_id_to_big_value_tmp_1121.get_m31(4)))
                        << (UInt16_4)))
                    + (((PackedUInt16::from_m31(memory_id_to_big_value_tmp_1121.get_m31(5)))
                        & (UInt16_7))
                        << (UInt16_13)));
            let offset2_col4 = offset2_tmp_1123.as_m31();
            trace[4].data[row_index] = offset2_col4;
            let dst_base_fp_tmp_1124 =
                (((((PackedUInt16::from_m31(memory_id_to_big_value_tmp_1121.get_m31(5)))
                    >> (UInt16_3))
                    + ((PackedUInt16::from_m31(memory_id_to_big_value_tmp_1121.get_m31(6)))
                        << (UInt16_6)))
                    >> (UInt16_0))
                    & (UInt16_1));
            let dst_base_fp_col5 = dst_base_fp_tmp_1124.as_m31();
            trace[5].data[row_index] = dst_base_fp_col5;
            let op1_base_fp_tmp_1125 =
                (((((PackedUInt16::from_m31(memory_id_to_big_value_tmp_1121.get_m31(5)))
                    >> (UInt16_3))
                    + ((PackedUInt16::from_m31(memory_id_to_big_value_tmp_1121.get_m31(6)))
                        << (UInt16_6)))
                    >> (UInt16_3))
                    & (UInt16_1));
            let op1_base_fp_col6 = op1_base_fp_tmp_1125.as_m31();
            trace[6].data[row_index] = op1_base_fp_col6;
            let op1_base_ap_tmp_1126 =
                (((((PackedUInt16::from_m31(memory_id_to_big_value_tmp_1121.get_m31(5)))
                    >> (UInt16_3))
                    + ((PackedUInt16::from_m31(memory_id_to_big_value_tmp_1121.get_m31(6)))
                        << (UInt16_6)))
                    >> (UInt16_4))
                    & (UInt16_1));
            let op1_base_ap_col7 = op1_base_ap_tmp_1126.as_m31();
            trace[7].data[row_index] = op1_base_ap_col7;
            let ap_update_add_1_tmp_1127 =
                (((((PackedUInt16::from_m31(memory_id_to_big_value_tmp_1121.get_m31(5)))
                    >> (UInt16_3))
                    + ((PackedUInt16::from_m31(memory_id_to_big_value_tmp_1121.get_m31(6)))
                        << (UInt16_6)))
                    >> (UInt16_11))
                    & (UInt16_1));
            let ap_update_add_1_col8 = ap_update_add_1_tmp_1127.as_m31();
            ...
            let memory_address_to_id_value_tmp_1130 = memory_address_to_id_state.deduce_output(
                ((((dst_base_fp_col5) * (input_fp_col2))
                    + (((M31_1) - (dst_base_fp_col5)) * (input_ap_col1)))
                    + ((offset0_col3) - (M31_32768))),
            );
            let dst_id_col9 = memory_address_to_id_value_tmp_1130;
