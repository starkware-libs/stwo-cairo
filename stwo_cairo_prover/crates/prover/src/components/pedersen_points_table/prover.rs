...
use crate::cairo_air::pedersen::const_columns::{PedersenPoints, PEDERSEN_TABLE_N_COLUMNS};
...
impl ClaimGenerator {
    ...
    pub fn new() -> Self {
        Self {
            mults: AtomicMultiplicityColumn::new(PEDERSEN_TABLE_N_ROWS.next_power_of_two()),
        }
    }
