...
impl ClaimGenerator {
    ...
    pub fn write_trace(
        ...
        if need_padding {
            ...
            // permutes the natural ordered values to the native trace order. So as to make the
            // 'neighbor' function evaluate to the next natural index after permutation.
            // Used when padding is needed, to make the partial sum mechanism work.
