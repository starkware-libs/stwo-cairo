...
pub fn write_trace_simd(
    ...
    inputs.into_iter().enumerate().for_each(
        |(row_index, jump_opcode_is_rel_f_is_imm_f_is_double_deref_f_input)| {
            ...
            let memory_address_to_id_value_tmp_a5f5_1 =
                memory_address_to_id_state.deduce_output(input_pc_col0);
            let memory_id_to_big_value_tmp_a5f5_2 =
                memory_id_to_big_state.deduce_output(memory_address_to_id_value_tmp_a5f5_1);
            let offset2_tmp_a5f5_3 =
                ((((PackedUInt16::from_m31(memory_id_to_big_value_tmp_a5f5_2.get_m31(3)))
                    >> (UInt16_5))
                    + ((PackedUInt16::from_m31(memory_id_to_big_value_tmp_a5f5_2.get_m31(4)))
                        << (UInt16_4)))
                    + (((PackedUInt16::from_m31(memory_id_to_big_value_tmp_a5f5_2.get_m31(5)))
                        & (UInt16_7))
                        << (UInt16_13)));
            ...
            let op1_base_fp_tmp_a5f5_4 =
                (((((PackedUInt16::from_m31(memory_id_to_big_value_tmp_a5f5_2.get_m31(5)))
                    >> (UInt16_3))
                    + ((PackedUInt16::from_m31(memory_id_to_big_value_tmp_a5f5_2.get_m31(6)))
                        << (UInt16_6)))
                    >> (UInt16_3))
                    & (UInt16_1));
