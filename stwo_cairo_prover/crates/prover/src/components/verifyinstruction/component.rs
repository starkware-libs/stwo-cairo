...
pub struct Eval {
    pub claim: Claim,
    pub memoryaddresstoid_lookup_elements: AddrToIdRelation,
    pub memoryidtobig_lookup_elements: IdToValueRelation,
    pub rangecheck_4_3_lookup_elements: RangeCheck_4_3Relation,
    pub range_check_7_2_5_lookup_elements: RangeCheck_7_2_5Relation,
...
impl Eval {
    pub fn new(
        ...
        rangecheck_4_3_lookup_elements: RangeCheck_4_3Relation,
        range_check_7_2_5_lookup_elements: RangeCheck_7_2_5Relation,
