...
pub struct SubComponentInputs {
    pub memoryaddresstoid_inputs: Vec<memory::addr_to_id::CpuInputType>,
    pub rangecheck_4_3_inputs: Vec<range_check_4_3::CpuInputType>,
    pub range_check_7_2_5_inputs: Vec<range_check_7_2_5::CpuInputType>,
}
