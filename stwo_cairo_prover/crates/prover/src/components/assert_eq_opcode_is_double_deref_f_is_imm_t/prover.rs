    ...
    iter.for_each(
        |(row_index, assert_eq_opcode_is_double_deref_f_is_imm_t_input)| {
            unsafe {
                ...
                (*trace.data[4].get()).data[row_index] = dst_base_fp_col4;
                ...
                (*trace.data[5].get()).data[row_index] = ap_update_add_1_col5;
                ...
                (*trace.data[6].get()).data[row_index] = dst_id_col6;
                ...
                (*lookup_data.memoryaddresstoid[1].get())[row_index] =
                    [((input_pc_col0) + (M31_1)), dst_id_col6];
