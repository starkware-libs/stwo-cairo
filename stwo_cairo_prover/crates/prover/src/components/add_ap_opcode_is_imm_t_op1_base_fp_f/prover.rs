...
pub fn write_trace_simd(
    ...
    iter.for_each(|(row_index, add_ap_opcode_is_imm_t_op1_base_fp_f_input)| {
        unsafe {
            ...
            (*trace.data[3].get()).data[row_index] = op1_id_col3;
