...
pub struct BigEval {
    pub log_n_rows: u32,
    pub lookup_elements: IdToValueRelation,
    pub range9_9_lookup_elements: RangeCheck_9_9Relation,
}
impl BigEval {
...
pub struct SmallEval {
    pub log_n_rows: u32,
    pub lookup_elements: IdToValueRelation,
    pub range_check_9_9_relation: RangeCheck_9_9Relation,
}
impl SmallEval {
    pub const fn n_columns(&self) -> usize {
        SMALL_N_COLUMNS
    ...
    pub fn new(
        claim: Claim,
        lookup_elements: IdToValueRelation,
        range_check_9_9_relation: RangeCheck_9_9Relation,
    ) -> Self {
        Self {
