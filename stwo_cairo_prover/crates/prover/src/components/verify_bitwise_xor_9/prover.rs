...
use super::component::{Claim, InteractionClaim, N_BITS};
...
impl ClaimGenerator {
        ...
        SimdBackend: BackendForChannel<MC>,
    {
        ...
        let (trace, lookup_data) = write_trace_simd(log_size, self.mults.into_simd_vec());
    ...
    trace
        ...
        .for_each(|((row_index, row), lookup_data)| {
            ...
            *lookup_data.verify_bitwise_xor_9_0 = [
                ...
                BitwiseXor::new(9, 1).packed_at(row_index),
                BitwiseXor::new(9, 2).packed_at(row_index),
            ];
