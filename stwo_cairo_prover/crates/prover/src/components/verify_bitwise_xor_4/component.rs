...
impl FrameworkEval for Eval {
    ...
    fn evaluate<E: EvalAtRow>(&self, mut eval: E) -> E {
        let bitwisexor = eval.get_preprocessed_column((BitwiseXor::new(4, 0)).id());
        let bitwisexor = eval.get_preprocessed_column((BitwiseXor::new(4, 1)).id());
        let bitwisexor = eval.get_preprocessed_column((BitwiseXor::new(4, 2)).id());
