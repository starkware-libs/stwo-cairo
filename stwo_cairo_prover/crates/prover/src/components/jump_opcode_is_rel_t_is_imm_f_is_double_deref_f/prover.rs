    ...
    iter.for_each(
        |(row_index, jump_opcode_is_rel_t_is_imm_f_is_double_deref_f_input)| {
            unsafe {
                ...
                (*trace.data[8].get()).data[row_index] = msb_col8;
                let mid_limbs_set_tmp_1409_10 =
                    memoryidtobig_value_tmp_1409_8.get_m31(20).eq(M31_511);
                let mid_limbs_set_col9 = mid_limbs_set_tmp_1409_10.as_m31();
                (*trace.data[9].get()).data[row_index] = mid_limbs_set_col9;

                let next_pc_limb_0_col10 = memoryidtobig_value_tmp_1409_8.get_m31(0);
                (*trace.data[10].get()).data[row_index] = next_pc_limb_0_col10;
                let next_pc_limb_1_col11 = memoryidtobig_value_tmp_1409_8.get_m31(1);
                (*trace.data[11].get()).data[row_index] = next_pc_limb_1_col11;
                let next_pc_limb_2_col12 = memoryidtobig_value_tmp_1409_8.get_m31(2);
                (*trace.data[12].get()).data[row_index] = next_pc_limb_2_col12;
