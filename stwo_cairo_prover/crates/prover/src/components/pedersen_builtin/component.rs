...
impl Claim {
    pub fn log_sizes(&self) -> TreeVec<Vec<u32>> {
        let trace_log_sizes = vec![self.log_size; 359];
...
impl FrameworkEval for Eval {
    ...
    fn evaluate<E: EvalAtRow>(&self, mut eval: E) -> E {
        ...
        let limb_0_col0 = eval.next_trace_mask();
        let limb_1_col1 = eval.next_trace_mask();
        let limb_2_col2 = eval.next_trace_mask();
        let limb_3_col3 = eval.next_trace_mask();
        let limb_4_col4 = eval.next_trace_mask();
        let limb_5_col5 = eval.next_trace_mask();
        let limb_6_col6 = eval.next_trace_mask();
        let limb_7_col7 = eval.next_trace_mask();
        let limb_8_col8 = eval.next_trace_mask();
        let limb_9_col9 = eval.next_trace_mask();
        let limb_10_col10 = eval.next_trace_mask();
        let limb_11_col11 = eval.next_trace_mask();
        let limb_12_col12 = eval.next_trace_mask();
        let limb_13_col13 = eval.next_trace_mask();
        let limb_14_col14 = eval.next_trace_mask();
        let limb_15_col15 = eval.next_trace_mask();
        let limb_16_col16 = eval.next_trace_mask();
        let limb_17_col17 = eval.next_trace_mask();
        let limb_18_col18 = eval.next_trace_mask();
        let limb_19_col19 = eval.next_trace_mask();
        let limb_20_col20 = eval.next_trace_mask();
        let limb_21_col21 = eval.next_trace_mask();
        let limb_22_col22 = eval.next_trace_mask();
        let limb_23_col23 = eval.next_trace_mask();
        let limb_24_col24 = eval.next_trace_mask();
        let limb_25_col25 = eval.next_trace_mask();
        let limb_26_col26 = eval.next_trace_mask();
        ...
        let limb_0_col30 = eval.next_trace_mask();
        let limb_1_col31 = eval.next_trace_mask();
        let limb_2_col32 = eval.next_trace_mask();
        let limb_3_col33 = eval.next_trace_mask();
        let limb_4_col34 = eval.next_trace_mask();
        let limb_5_col35 = eval.next_trace_mask();
        let limb_6_col36 = eval.next_trace_mask();
        let limb_7_col37 = eval.next_trace_mask();
        let limb_8_col38 = eval.next_trace_mask();
        let limb_9_col39 = eval.next_trace_mask();
        let limb_10_col40 = eval.next_trace_mask();
        let limb_11_col41 = eval.next_trace_mask();
        let limb_12_col42 = eval.next_trace_mask();
        let limb_13_col43 = eval.next_trace_mask();
        let limb_14_col44 = eval.next_trace_mask();
        let limb_15_col45 = eval.next_trace_mask();
        let limb_16_col46 = eval.next_trace_mask();
        let limb_17_col47 = eval.next_trace_mask();
        let limb_18_col48 = eval.next_trace_mask();
        let limb_19_col49 = eval.next_trace_mask();
        let limb_20_col50 = eval.next_trace_mask();
        let limb_21_col51 = eval.next_trace_mask();
        let limb_22_col52 = eval.next_trace_mask();
        let limb_23_col53 = eval.next_trace_mask();
        let limb_24_col54 = eval.next_trace_mask();
        let limb_25_col55 = eval.next_trace_mask();
        let limb_26_col56 = eval.next_trace_mask();
        ...
        eval.add_constraint((ms_limb_is_max_col60.clone() * limb_22_col22.clone()));
        // If the MS limb is max, high limbs should be 0.
        eval.add_constraint((ms_limb_is_max_col60.clone() * limb_23_col23.clone()));
        // If the MS limb is max, high limbs should be 0.
        eval.add_constraint((ms_limb_is_max_col60.clone() * limb_24_col24.clone()));
        // If the MS limb is max, high limbs should be 0.
        eval.add_constraint((ms_limb_is_max_col60.clone() * limb_25_col25.clone()));
        // If the MS limb is max, high limbs should be 0.
        eval.add_constraint((ms_limb_is_max_col60.clone() * limb_26_col26.clone()));
        // rc_input.
        eval.add_constraint(
            (rc_input_col62.clone()
                - (ms_limb_is_max_col60.clone()
                    * ((M31_120.clone() + limb_21_col21.clone())
                        - ms_and_mid_limbs_are_max_col61.clone()))),
        );
        eval.add_to_relation(RelationEntry::new(
            &self.range_check_8_lookup_elements,
        ...
        eval.add_constraint((ms_and_mid_limbs_are_max_col61.clone() * limb_0_col0.clone()));
        // If the MS and mid limbs are max, low limbs should be 0.
        eval.add_constraint((ms_and_mid_limbs_are_max_col61.clone() * limb_1_col1.clone()));
        // If the MS and mid limbs are max, low limbs should be 0.
        eval.add_constraint((ms_and_mid_limbs_are_max_col61.clone() * limb_2_col2.clone()));
        // If the MS and mid limbs are max, low limbs should be 0.
        eval.add_constraint((ms_and_mid_limbs_are_max_col61.clone() * limb_3_col3.clone()));
        // If the MS and mid limbs are max, low limbs should be 0.
        eval.add_constraint((ms_and_mid_limbs_are_max_col61.clone() * limb_4_col4.clone()));
        // If the MS and mid limbs are max, low limbs should be 0.
        eval.add_constraint((ms_and_mid_limbs_are_max_col61.clone() * limb_5_col5.clone()));
        // If the MS and mid limbs are max, low limbs should be 0.
        eval.add_constraint((ms_and_mid_limbs_are_max_col61.clone() * limb_6_col6.clone()));
        // If the MS and mid limbs are max, low limbs should be 0.
        eval.add_constraint((ms_and_mid_limbs_are_max_col61.clone() * limb_7_col7.clone()));
        // If the MS and mid limbs are max, low limbs should be 0.
        eval.add_constraint((ms_and_mid_limbs_are_max_col61.clone() * limb_8_col8.clone()));
        // If the MS and mid limbs are max, low limbs should be 0.
        eval.add_constraint((ms_and_mid_limbs_are_max_col61.clone() * limb_9_col9.clone()));
        // If the MS and mid limbs are max, low limbs should be 0.
        eval.add_constraint((ms_and_mid_limbs_are_max_col61.clone() * limb_10_col10.clone()));
        // If the MS and mid limbs are max, low limbs should be 0.
        eval.add_constraint((ms_and_mid_limbs_are_max_col61.clone() * limb_11_col11.clone()));
        // If the MS and mid limbs are max, low limbs should be 0.
        eval.add_constraint((ms_and_mid_limbs_are_max_col61.clone() * limb_12_col12.clone()));
        // If the MS and mid limbs are max, low limbs should be 0.
        eval.add_constraint((ms_and_mid_limbs_are_max_col61.clone() * limb_13_col13.clone()));
        // If the MS and mid limbs are max, low limbs should be 0.
        eval.add_constraint((ms_and_mid_limbs_are_max_col61.clone() * limb_14_col14.clone()));
        // If the MS and mid limbs are max, low limbs should be 0.
        eval.add_constraint((ms_and_mid_limbs_are_max_col61.clone() * limb_15_col15.clone()));
        // If the MS and mid limbs are max, low limbs should be 0.
        eval.add_constraint((ms_and_mid_limbs_are_max_col61.clone() * limb_16_col16.clone()));
        // If the MS and mid limbs are max, low limbs should be 0.
        eval.add_constraint((ms_and_mid_limbs_are_max_col61.clone() * limb_17_col17.clone()));
        // If the MS and mid limbs are max, low limbs should be 0.
        eval.add_constraint((ms_and_mid_limbs_are_max_col61.clone() * limb_18_col18.clone()));
        // If the MS and mid limbs are max, low limbs should be 0.
        eval.add_constraint((ms_and_mid_limbs_are_max_col61.clone() * limb_19_col19.clone()));
        // If the MS and mid limbs are max, low limbs should be 0.
        eval.add_constraint((ms_and_mid_limbs_are_max_col61.clone() * limb_20_col20.clone()));
        ...
        // If the MS limb is max, high limbs should be 0.
        eval.add_constraint((ms_limb_is_max_col63.clone() * limb_22_col52.clone()));
        // If the MS limb is max, high limbs should be 0.
        eval.add_constraint((ms_limb_is_max_col63.clone() * limb_23_col53.clone()));
        // If the MS limb is max, high limbs should be 0.
        eval.add_constraint((ms_limb_is_max_col63.clone() * limb_24_col54.clone()));
        // If the MS limb is max, high limbs should be 0.
        eval.add_constraint((ms_limb_is_max_col63.clone() * limb_25_col55.clone()));
        // If the MS limb is max, high limbs should be 0.
        eval.add_constraint((ms_limb_is_max_col63.clone() * limb_26_col56.clone()));
        // rc_input.
        eval.add_constraint(
            (rc_input_col65.clone()
                - (ms_limb_is_max_col63.clone()
                    * ((M31_120.clone() + limb_21_col51.clone())
                        - ms_and_mid_limbs_are_max_col64.clone()))),
        );
        eval.add_to_relation(RelationEntry::new(
            &self.range_check_8_lookup_elements,
        ...
        // If the MS and mid limbs are max, low limbs should be 0.
        eval.add_constraint((ms_and_mid_limbs_are_max_col64.clone() * limb_0_col30.clone()));
        // If the MS and mid limbs are max, low limbs should be 0.
        eval.add_constraint((ms_and_mid_limbs_are_max_col64.clone() * limb_1_col31.clone()));
        // If the MS and mid limbs are max, low limbs should be 0.
        eval.add_constraint((ms_and_mid_limbs_are_max_col64.clone() * limb_2_col32.clone()));
        // If the MS and mid limbs are max, low limbs should be 0.
        eval.add_constraint((ms_and_mid_limbs_are_max_col64.clone() * limb_3_col33.clone()));
        // If the MS and mid limbs are max, low limbs should be 0.
        eval.add_constraint((ms_and_mid_limbs_are_max_col64.clone() * limb_4_col34.clone()));
        // If the MS and mid limbs are max, low limbs should be 0.
        eval.add_constraint((ms_and_mid_limbs_are_max_col64.clone() * limb_5_col35.clone()));
        // If the MS and mid limbs are max, low limbs should be 0.
        eval.add_constraint((ms_and_mid_limbs_are_max_col64.clone() * limb_6_col36.clone()));
        // If the MS and mid limbs are max, low limbs should be 0.
        eval.add_constraint((ms_and_mid_limbs_are_max_col64.clone() * limb_7_col37.clone()));
        // If the MS and mid limbs are max, low limbs should be 0.
        eval.add_constraint((ms_and_mid_limbs_are_max_col64.clone() * limb_8_col38.clone()));
        // If the MS and mid limbs are max, low limbs should be 0.
        eval.add_constraint((ms_and_mid_limbs_are_max_col64.clone() * limb_9_col39.clone()));
        // If the MS and mid limbs are max, low limbs should be 0.
        eval.add_constraint((ms_and_mid_limbs_are_max_col64.clone() * limb_10_col40.clone()));
        // If the MS and mid limbs are max, low limbs should be 0.
        eval.add_constraint((ms_and_mid_limbs_are_max_col64.clone() * limb_11_col41.clone()));
        // If the MS and mid limbs are max, low limbs should be 0.
        eval.add_constraint((ms_and_mid_limbs_are_max_col64.clone() * limb_12_col42.clone()));
        // If the MS and mid limbs are max, low limbs should be 0.
        eval.add_constraint((ms_and_mid_limbs_are_max_col64.clone() * limb_13_col43.clone()));
        // If the MS and mid limbs are max, low limbs should be 0.
        eval.add_constraint((ms_and_mid_limbs_are_max_col64.clone() * limb_14_col44.clone()));
        // If the MS and mid limbs are max, low limbs should be 0.
        eval.add_constraint((ms_and_mid_limbs_are_max_col64.clone() * limb_15_col45.clone()));
        // If the MS and mid limbs are max, low limbs should be 0.
        eval.add_constraint((ms_and_mid_limbs_are_max_col64.clone() * limb_16_col46.clone()));
        // If the MS and mid limbs are max, low limbs should be 0.
        eval.add_constraint((ms_and_mid_limbs_are_max_col64.clone() * limb_17_col47.clone()));
        // If the MS and mid limbs are max, low limbs should be 0.
        eval.add_constraint((ms_and_mid_limbs_are_max_col64.clone() * limb_18_col48.clone()));
        // If the MS and mid limbs are max, low limbs should be 0.
        eval.add_constraint((ms_and_mid_limbs_are_max_col64.clone() * limb_19_col49.clone()));
        // If the MS and mid limbs are max, low limbs should be 0.
        eval.add_constraint((ms_and_mid_limbs_are_max_col64.clone() * limb_20_col50.clone()));

        eval.add_to_relation(RelationEntry::new(
            &self.partial_ec_mul_lookup_elements,
            -E::EF::one(),
            &[
                ((seq.clone() * M31_4.clone()) + M31_0.clone()),
                M31_0.clone(),
                M31_0.clone(),
                (limb_0_col0.clone() + (limb_1_col1.clone() * M31_512.clone())),
                (limb_2_col2.clone() + (limb_3_col3.clone() * M31_512.clone())),
                (limb_4_col4.clone() + (limb_5_col5.clone() * M31_512.clone())),
                (limb_6_col6.clone() + (limb_7_col7.clone() * M31_512.clone())),
                (limb_8_col8.clone() + (limb_9_col9.clone() * M31_512.clone())),
                (limb_10_col10.clone() + (limb_11_col11.clone() * M31_512.clone())),
                (limb_12_col12.clone() + (limb_13_col13.clone() * M31_512.clone())),
                (limb_14_col14.clone() + (limb_15_col15.clone() * M31_512.clone())),
                (limb_16_col16.clone() + (limb_17_col17.clone() * M31_512.clone())),
                (limb_18_col18.clone() + (limb_19_col19.clone() * M31_512.clone())),
                (limb_20_col20.clone() + (limb_21_col21.clone() * M31_512.clone())),
                (limb_22_col22.clone() + (limb_23_col23.clone() * M31_512.clone())),
                (limb_24_col24.clone() + (limb_25_col25.clone() * M31_512.clone())),
                (limb_26_col26.clone() + (ms_limb_low_col27.clone() * M31_512.clone())),
                M31_435.clone(),
                M31_50.clone(),
                M31_508.clone(),
                M31_83.clone(),
        ...
        eval.add_to_relation(RelationEntry::new(
            ...
            &[
                ...
                M31_0.clone(),
                M31_3670016.clone(),
                (ms_limb_high_col28.clone() + M31_0.clone()),
                M31_0.clone(),
                M31_0.clone(),
                M31_0.clone(),
                M31_0.clone(),
        ...
        eval.add_to_relation(RelationEntry::new(
            ...
            &[
                ...
                M31_0.clone(),
                M31_3670032.clone(),
                (limb_0_col30.clone() + (limb_1_col31.clone() * M31_512.clone())),
                (limb_2_col32.clone() + (limb_3_col33.clone() * M31_512.clone())),
                (limb_4_col34.clone() + (limb_5_col35.clone() * M31_512.clone())),
                (limb_6_col36.clone() + (limb_7_col37.clone() * M31_512.clone())),
                (limb_8_col38.clone() + (limb_9_col39.clone() * M31_512.clone())),
                (limb_10_col40.clone() + (limb_11_col41.clone() * M31_512.clone())),
                (limb_12_col42.clone() + (limb_13_col43.clone() * M31_512.clone())),
                (limb_14_col44.clone() + (limb_15_col45.clone() * M31_512.clone())),
                (limb_16_col46.clone() + (limb_17_col47.clone() * M31_512.clone())),
                (limb_18_col48.clone() + (limb_19_col49.clone() * M31_512.clone())),
                (limb_20_col50.clone() + (limb_21_col51.clone() * M31_512.clone())),
                (limb_22_col52.clone() + (limb_23_col53.clone() * M31_512.clone())),
                (limb_24_col54.clone() + (limb_25_col55.clone() * M31_512.clone())),
                (limb_26_col56.clone() + (ms_limb_low_col57.clone() * M31_512.clone())),
                partial_ec_mul_output_limb_17_col156.clone(),
                partial_ec_mul_output_limb_18_col157.clone(),
                partial_ec_mul_output_limb_19_col158.clone(),
                partial_ec_mul_output_limb_20_col159.clone(),
        ...
        eval.add_to_relation(RelationEntry::new(
            ...
            &[
                ...
                M31_0.clone(),
                M31_7340048.clone(),
                (ms_limb_high_col58.clone() + M31_0.clone()),
                M31_0.clone(),
                M31_0.clone(),
                M31_0.clone(),
                M31_0.clone(),
