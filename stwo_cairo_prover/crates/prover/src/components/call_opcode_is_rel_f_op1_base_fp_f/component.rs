...
impl FrameworkEval for Eval {
    ...
    fn evaluate<E: EvalAtRow>(&self, mut eval: E) -> E {
        ...
        let ap_id_col4 = eval.next_trace_mask();
        let ap_plus_one_id_col5 = eval.next_trace_mask();
        let next_pc_id_col6 = eval.next_trace_mask();
        ...
        eval.add_to_relation(&[RelationEntry::new(
            ...
            E::EF::one(),
            &[input_ap_col1.clone(), ap_id_col4.clone()],
        )]);

        eval.add_to_relation(&[RelationEntry::new(
            &self.memoryidtobig_lookup_elements,
            E::EF::one(),
            &[ap_id_col4.clone(), input_fp_col2.clone()],
        )]);
