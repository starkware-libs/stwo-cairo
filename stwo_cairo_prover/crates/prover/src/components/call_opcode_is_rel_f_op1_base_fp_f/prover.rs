...
pub fn write_trace_simd(
    ...
    inputs.into_iter().enumerate().for_each(
        |(row_index, call_opcode_is_rel_f_op1_base_fp_f_input)| {
            ...
            let ap_id_col4 = memory_address_to_id_value_tmp_1178;
            ...
            let memory_address_to_id_value_tmp_1179 =
                memory_address_to_id_state.deduce_output(((input_ap_col1) + (M31_1)));
            let ap_plus_one_id_col5 = memory_address_to_id_value_tmp_1179;
            ...
            let memory_address_to_id_value_tmp_1180 = memory_address_to_id_state
            ...
            let next_pc_id_col6 = memory_address_to_id_value_tmp_1180;
            ...
            let next_pc_limb_0_col7 = memory_id_to_big_value_tmp_1181.get_m31(0);
            trace[7].data[row_index] = next_pc_limb_0_col7;
            let next_pc_limb_1_col8 = memory_id_to_big_value_tmp_1181.get_m31(1);
            trace[8].data[row_index] = next_pc_limb_1_col8;
            let next_pc_limb_2_col9 = memory_id_to_big_value_tmp_1181.get_m31(2);
