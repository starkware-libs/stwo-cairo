...
impl FrameworkEval for Eval {
    ...
    fn evaluate<E: EvalAtRow>(&self, mut eval: E) -> E {
        ...
        let dst_sum_tmp_57455_153 = eval.add_intermediate(
            ((((((((((((((((((((((((((((M31_0.clone()
                + dst_limb_0_col22.clone())
                + dst_limb_1_col23.clone())
                + dst_limb_2_col24.clone())
        ...
        eval.add_constraint(
            (op1_as_rel_imm_cond_col225.clone()
                - (pc_update_jnz_col15.clone() * dst_sum_tmp_57455_153.clone())),
        );
        ...
        eval.add_constraint(
            ((next_pc_jnz_col228.clone()
                ...
                * dst_sum_tmp_57455_153.clone()),
        );
        // Constraint2 for conditional jump.
        eval.add_constraint(
            ((next_pc_jnz_col228.clone()
                - (input_pc_col0.clone() + (M31_1.clone() + op1_imm_col8.clone())))
                * ((dst_sum_tmp_57455_153.clone() * dst_sum_inv_col224.clone()) - M31_1.clone())),
        );
