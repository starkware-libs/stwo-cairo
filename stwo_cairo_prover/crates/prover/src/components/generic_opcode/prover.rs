#![allow(unused_parens)]#![allow(unused_imports)]#![cfg_attr(rustfmt, rustfmt_skip)]
    ...
    .for_each(
        |(((row_index, mut row), generic_opcode_input), lookup_data)| {
            ...
            *row[225] = op1_as_rel_imm_cond_col225;
            ...
            let msb_tmp_57455_154 = op1_limb_27_col107.eq(M31_256);let msb_col226 = msb_tmp_57455_154.as_m31();
            *row[226] = msb_col226;let mid_limbs_set_tmp_57455_155 = op1_limb_20_col100.eq(M31_511);let mid_limbs_set_col227 = mid_limbs_set_tmp_57455_155.as_m31();
