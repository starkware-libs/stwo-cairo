...
use super::{
    exclusive_suffix_sum, generate_sparse_enumeration, packed_sparse_representation, simd_masks,
    RangeCheckVectorElements,
};
...
impl<const N: usize> RangeCheckClaimProver<N> {
    ...
    pub fn add_m31(&mut self, input: [M31; N]) {
        ...
        self.multiplicities[input_row as usize].simd[input_lane as usize] += 1;
    }
