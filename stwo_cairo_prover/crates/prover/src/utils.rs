...
pub fn cairo_provers(components: &CairoComponents) -> Vec<&dyn ComponentProver<SimdBackend>> {
    chain!(
        ...
        [&components.memory_id_to_value.0 as &dyn ComponentProver<SimdBackend>,],
        [
...
// ) -> Vec<&dyn ComponentProver<SimdBackend>> { if let Some(components) = components { return vec![
//   &components.blake_round as &dyn ComponentProver<SimdBackend>, &components.blake_g as &dyn
//   ComponentProver<SimdBackend>, &components.blake_sigma as &dyn ComponentProver<SimdBackend>,
...
//   &components.cube_252 as &dyn ComponentProver<SimdBackend>, &components.poseidon_round_keys as
//   &dyn ComponentProver<SimdBackend>, &components.range_check_252_width_27 as &dyn
//   ComponentProver<SimdBackend>, ]; }
//
//     vec![]
// }
