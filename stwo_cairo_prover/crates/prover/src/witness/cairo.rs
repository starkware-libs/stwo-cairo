...
impl CairoClaimGenerator {
    ...
    /// Generate pre-blake opcode traces that can run in parallel with preprocessed trace
    /// generation. Returns (PreBlakeOpcodeResult, self) where self has opcode generators
    /// removed.
