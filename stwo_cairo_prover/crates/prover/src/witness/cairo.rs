...
pub fn create_cairo_claim_generator(
    ...
    // }
    let _ = &builtin_segments; // Silence unused warning
...
impl CairoClaimGenerator {
    pub fn write_trace(
        ...
        let (
            ...
            .memory_id_to_big
            .unwrap()
            // NOTE: range_check_9_9 is a core dependency for memory_id_to_big
            // If you need to fully remove it, you'll need to modify memory_id_to_big module
            .write_trace(
                self.range_check_9_9.as_ref().unwrap(), // LOG_MAX_BIG_SIZE
            );
...
impl CairoInteractionClaimGenerator {
    pub fn write_interaction_trace(
        ...
        // ) = match self.blake_context_interaction_gen.gen { Some(gen) => (
        //   Some(gen.blake_round_interaction_gen), Some(gen.blake_g_interaction_gen),
        //   Some(gen.blake_sigma_interaction_gen), Some(gen.triple_xor_32_interaction_gen),
        //   Some(gen.verify_bitwise_xor_12_interaction_gen), ), None => (None, None, None, None,
        //   None),
        // };
        ...
        // ) = match self.poseidon_context_interaction_gen.gen { Some(gen) => (
        ...
        //   Some(gen.cube_252_interaction_gen), Some(gen.poseidon_round_keys_interaction_gen),
        //   Some(gen.range_check_felt_252_width_27_interaction_gen), ), None => (None, None, None,
        //   None, None, None),
        // };
        ...
        // {     claim: blake_round_interaction_claim.map(|blake_round|
        // BlakeInteractionClaim {         blake_round,
