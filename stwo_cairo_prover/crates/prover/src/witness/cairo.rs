...
impl CairoInteractionClaimGenerator {
    pub fn write_interaction_trace(
        ...
        CairoInteractionClaim {
            add_opcode: add_interaction_claims.into_iter().next(),
            add_opcode_small: add_small_interaction_claims.into_iter().next(),
            add_ap_opcode: add_ap_interaction_claims.into_iter().next(),
            assert_eq_opcode: assert_eq_interaction_claims.into_iter().next(),
            assert_eq_opcode_imm: assert_eq_imm_interaction_claims.into_iter().next(),
            assert_eq_opcode_double_deref: assert_eq_double_deref_interaction_claims
                .into_iter()
                .next(),
            blake_compress_opcode: blake_opcode_interaction_claims.into_iter().next(),
            call_opcode_abs: call_interaction_claims.into_iter().next(),
            call_opcode_rel_imm: call_rel_imm_interaction_claims.into_iter().next(),
            generic_opcode: generic_opcode_interaction_claims.into_iter().next(),
            jnz_opcode_non_taken: jnz_interaction_claims.into_iter().next(),
            jnz_opcode_taken: jnz_taken_interaction_claims.into_iter().next(),
            jump_opcode_abs: jump_interaction_claims.into_iter().next(),
            jump_opcode_double_deref: jump_double_deref_interaction_claims.into_iter().next(),
            jump_opcode_rel: jump_rel_interaction_claims.into_iter().next(),
            jump_opcode_rel_imm: jump_rel_imm_interaction_claims.into_iter().next(),
            mul_opcode: mul_interaction_claims.into_iter().next(),
            mul_opcode_small: mul_small_interaction_claims.into_iter().next(),
            qm_31_add_mul_opcode: qm31_interaction_claims.into_iter().next(),
            ret_opcode: ret_interaction_claims.into_iter().next(),
            ...
            blake_round_sigma: blake_sigma_interaction_claim,
            triple_xor_32: blake_triple_xor_32_interaction_claim,
            verify_bitwise_xor_12: blake_verify_bitwise_xor_12_interaction_claim,
            ...
            range_check96_builtin: range_check_96_builtin_interaction_claim,
            range_check_builtin: range_check_128_builtin_interaction_claim,
            ...
            range_check_6: Some(rc_6_interaction_claim),
            range_check_8: Some(rc_8_interaction_claim),
            range_check_11: Some(rc_11_interaction_claim),
            range_check_12: Some(rc_12_interaction_claim),
            range_check_18: Some(rc_18_interaction_claim),
            range_check_20: Some(rc_20_interaction_claim),
            range_check_4_3: Some(rc_4_3_interaction_claim),
            range_check_4_4: Some(rc_4_4_interaction_claim),
            range_check_9_9: Some(rc_9_9_interaction_claim),
            range_check_7_2_5: Some(rc_7_2_5_interaction_claim),
            range_check_3_6_6_3: Some(rc_3_6_6_3_interaction_claim),
            range_check_4_4_4_4: Some(rc_4_4_4_4_interaction_claim),
            range_check_3_3_3_3_3: Some(rc_3_3_3_3_3_interaction_claim),
