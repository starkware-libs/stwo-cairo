...
fn write_trace_simd(
    ...
    (
        ...
        .for_each(|(row_index, (row, lookup_data, sub_component_inputs))| {
            ...
            let memory_address_to_id_value_tmp_1580f_0 = memory_address_to_id_state.deduce_output(
                ((PackedM31::broadcast(M31::from(pedersen_builtin_segment_start)))
                    + ((seq) * (M31_3))),
            );
            let input_state_0_id_col0 = memory_address_to_id_value_tmp_1580f_0;
            ...
            *lookup_data.memory_address_to_id_0 = [
            ...
            let memory_address_to_id_value_tmp_1580f_2 = memory_address_to_id_state.deduce_output(
                (((PackedM31::broadcast(M31::from(pedersen_builtin_segment_start)))
                    + ((seq) * (M31_3)))
                    + (M31_1)),
            );
            let input_state_1_id_col1 = memory_address_to_id_value_tmp_1580f_2;
            ...
            *lookup_data.memory_address_to_id_1 = [
            ...
            let memory_address_to_id_value_tmp_1580f_4 = memory_address_to_id_state.deduce_output(
                (((PackedM31::broadcast(M31::from(pedersen_builtin_segment_start)))
                    + ((seq) * (M31_3)))
                    + (M31_2)),
            );
            let output_state_id_col2 = memory_address_to_id_value_tmp_1580f_4;
