...
pub struct PedersenContextClaimGenerator {
    ...
    pub partial_ec_mul_trace_generator: Option<partial_ec_mul_window_bits_9::ClaimGenerator>,
...
impl PedersenContextClaimGenerator {
    pub fn new(preprocessed_trace: Arc<PreProcessedTrace>) -> Self {
        ...
        let pedersen_aggregator_trace_generator =
            pedersen_aggregator_window_bits_9::ClaimGenerator::new();
        let partial_ec_mul_trace_generator = partial_ec_mul_window_bits_9::ClaimGenerator::new();
        let pedersen_points_table_trace_generator =
            pedersen_points_table_window_bits_9::ClaimGenerator::new(preprocessed_trace);
    ...
    pub fn write_interaction_trace(
        ...
        let pedersen_aggregator_interaction_claim = self
            ...
            .write_interaction_trace(
                ...
                &interaction_elements.partial_ec_mul_window_bits_9,
        ...
        let partial_ec_mul_interaction_claim =
            self.partial_ec_mul_interaction_gen.write_interaction_trace(
                tree_builder,
                &interaction_elements.pedersen_points_table_window_bits_9,
