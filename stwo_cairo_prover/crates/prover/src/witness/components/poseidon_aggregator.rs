    ...
    pub fn write_interaction_trace(
        ...
        (
            ...
            .for_each(|(i, (writer, values0, values1))| {
                ...
                writer.write_frac(denom1 - denom0 * enabler_col.packed_at(i), denom0 * denom1);
            });
        col_gen.finalize_col();
