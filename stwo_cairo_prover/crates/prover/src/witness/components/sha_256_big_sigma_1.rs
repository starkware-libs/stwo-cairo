...
impl ClaimGenerator {
    ...
    pub fn write_trace(
        ...
        println!("sha_256_big_sigma_1: log_size: {}", log_size);
        self.packed_inputs
        ...
        sub_component_inputs
            ...
            .iter()
            .for_each(|inputs| {
                sha_256_big_sigma_1_o_0_state.add_packed_inputs(inputs);
            });
        sub_component_inputs
...
fn write_trace_simd(
    ...
    let UInt32_26 = PackedUInt32::broadcast(UInt32::from(26));
    let UInt32_6 = PackedUInt32::broadcast(UInt32::from(6));
    ...
    (
        ...
        .for_each(
            |(
                row_index,
                (mut row, lookup_data, sub_component_inputs, sha_256_big_sigma_1_input),
            )| {
                let input_limb_0_col0 = sha_256_big_sigma_1_input.low().as_m31();
...
impl InteractionClaimGenerator {
    pub fn write_interaction_trace(
        ...
        (
            ...
            .into_par_iter()
            .for_each(|(writer, values0, values1)| {
                let denom0: PackedQM31 = sha_256_big_sigma_1_o_0.combine(values0);
                let denom1: PackedQM31 = sha_256_big_sigma_1_o_1.combine(values1);
                writer.write_frac(denom0 + denom1, denom0 * denom1);
            });
        col_gen.finalize_col();
        ...
        (
            ...
            .for_each(|(i, (writer, values))| {
                let denom = sha_256_big_sigma_1.combine(values);
