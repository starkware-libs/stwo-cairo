#![allow(unused_parens)]
use crate::components::call_opcode_op_1_base_fp::{Claim, InteractionClaim, N_TRACE_COLUMNS};
        ...
        .for_each(
            |(
                ...
                *lookup_data.verify_instruction_0 = [
                ...
                let memory_address_to_id_value_tmp_82665_3 =
                    memory_address_to_id_state.deduce_output(input_ap_col1);
                let memory_id_to_big_value_tmp_82665_4 =
                    memory_id_to_big_state.deduce_output(memory_address_to_id_value_tmp_82665_3);
                let stored_fp_id_col4 = memory_address_to_id_value_tmp_82665_3;
                ...
                *lookup_data.memory_address_to_id_0 = [input_ap_col1, stored_fp_id_col4];
                let stored_fp_limb_0_col5 = memory_id_to_big_value_tmp_82665_4.get_m31(0);
                *row[5] = stored_fp_limb_0_col5;
                let stored_fp_limb_1_col6 = memory_id_to_big_value_tmp_82665_4.get_m31(1);
                *row[6] = stored_fp_limb_1_col6;
                let stored_fp_limb_2_col7 = memory_id_to_big_value_tmp_82665_4.get_m31(2);
                ...
                *lookup_data.memory_id_to_big_0 = [
                ...
                let memory_address_to_id_value_tmp_82665_5 =
                    memory_address_to_id_state.deduce_output(((input_ap_col1) + (M31_1)));
                let memory_id_to_big_value_tmp_82665_6 =
                    memory_id_to_big_state.deduce_output(memory_address_to_id_value_tmp_82665_5);
                let stored_ret_pc_id_col8 = memory_address_to_id_value_tmp_82665_5;
                ...
                *lookup_data.memory_address_to_id_1 =
                ...
                let stored_ret_pc_limb_0_col9 = memory_id_to_big_value_tmp_82665_6.get_m31(0);
                *row[9] = stored_ret_pc_limb_0_col9;
                let stored_ret_pc_limb_1_col10 = memory_id_to_big_value_tmp_82665_6.get_m31(1);
                *row[10] = stored_ret_pc_limb_1_col10;
                let stored_ret_pc_limb_2_col11 = memory_id_to_big_value_tmp_82665_6.get_m31(2);
                ...
                *lookup_data.memory_id_to_big_1 = [
                ...
                let next_pc_id_col12 = memory_address_to_id_value_tmp_82665_7;
                ...
                *lookup_data.memory_address_to_id_2 = [
                ...
                let next_pc_limb_0_col13 = memory_id_to_big_value_tmp_82665_8.get_m31(0);
                *row[13] = next_pc_limb_0_col13;
                let next_pc_limb_1_col14 = memory_id_to_big_value_tmp_82665_8.get_m31(1);
                *row[14] = next_pc_limb_1_col14;
                let next_pc_limb_2_col15 = memory_id_to_big_value_tmp_82665_8.get_m31(2);
