...
range_check_11_state: &range_check_11::ClaimGenerator,
    ...
    ) -> (Claim, InteractionClaimGenerator)
    {
        ...
        sub_component_inputs.verify_instruction.iter().for_each(|inputs| {verify_instruction_state.add_packed_inputs(inputs, "VerifyInstruction");});sub_component_inputs.memory_address_to_id.iter().for_each(|inputs| {memory_address_to_id_state.add_packed_inputs(inputs, "MemoryAddressToId");});sub_component_inputs.memory_id_to_big.iter().for_each(|inputs| {memory_id_to_big_state.add_packed_inputs(inputs, "MemoryIdToBig");});sub_component_inputs.range_check_9_9.iter().for_each(|inputs| {range_check_9_9_state.add_packed_inputs(inputs, "RangeCheck_9_9");});sub_component_inputs.range_check_9_9_b.iter().for_each(|inputs| {range_check_9_9_state.add_packed_inputs(inputs, "RangeCheck_9_9_B");});sub_component_inputs.range_check_9_9_c.iter().for_each(|inputs| {range_check_9_9_state.add_packed_inputs(inputs, "RangeCheck_9_9_C");});sub_component_inputs.range_check_9_9_d.iter().for_each(|inputs| {range_check_9_9_state.add_packed_inputs(inputs, "RangeCheck_9_9_D");});sub_component_inputs.range_check_9_9_e.iter().for_each(|inputs| {range_check_9_9_state.add_packed_inputs(inputs, "RangeCheck_9_9_E");});sub_component_inputs.range_check_9_9_f.iter().for_each(|inputs| {range_check_9_9_state.add_packed_inputs(inputs, "RangeCheck_9_9_F");});sub_component_inputs.range_check_9_9_g.iter().for_each(|inputs| {range_check_9_9_state.add_packed_inputs(inputs, "RangeCheck_9_9_G");});sub_component_inputs.range_check_9_9_h.iter().for_each(|inputs| {range_check_9_9_state.add_packed_inputs(inputs, "RangeCheck_9_9_H");});sub_component_inputs.range_check_20.iter().for_each(|inputs| {range_check_20_state.add_packed_inputs(inputs, "RangeCheck_20");});sub_component_inputs.range_check_20_b.iter().for_each(|inputs| {range_check_20_state.add_packed_inputs(inputs, "RangeCheck_20_B");});sub_component_inputs.range_check_20_c.iter().for_each(|inputs| {range_check_20_state.add_packed_inputs(inputs, "RangeCheck_20_C");});sub_component_inputs.range_check_20_d.iter().for_each(|inputs| {range_check_20_state.add_packed_inputs(inputs, "RangeCheck_20_D");});sub_component_inputs.range_check_20_e.iter().for_each(|inputs| {range_check_20_state.add_packed_inputs(inputs, "RangeCheck_20_E");});sub_component_inputs.range_check_20_f.iter().for_each(|inputs| {range_check_20_state.add_packed_inputs(inputs, "RangeCheck_20_F");});sub_component_inputs.range_check_20_g.iter().for_each(|inputs| {range_check_20_state.add_packed_inputs(inputs, "RangeCheck_20_G");});sub_component_inputs.range_check_20_h.iter().for_each(|inputs| {range_check_20_state.add_packed_inputs(inputs, "RangeCheck_20_H");});sub_component_inputs.range_check_18.iter().for_each(|inputs| {range_check_18_state.add_packed_inputs(inputs, "RangeCheck_18");});sub_component_inputs.range_check_11.iter().for_each(|inputs| {range_check_11_state.add_packed_inputs(inputs, "RangeCheck_11");});
