...
range_check_11_state: &range_check_11::ClaimGenerator,
    ...
    .for_each(
        |(row_index,(row, lookup_data,sub_component_inputs,generic_opcode_input,))| {
            ...
            *lookup_data.range_check_18_0 = [M31_1109051422, ((((next_ap_col239) - (range_check_ap_bot11bits_col240))) * (M31_1048576))];*sub_component_inputs.range_check_11[0] =
                [range_check_ap_bot11bits_col240];
            *lookup_data.range_check_11_0 = [M31_991608089, range_check_ap_bot11bits_col240];
