...
impl InteractionClaimGenerator {
    pub fn write_interaction_trace(
        ...
        {
            let denom_partial_ec_mul_window_bits_18_0_ref =
                &mut denom_partial_ec_mul_window_bits_18_0;
            let denom_partial_ec_mul_window_bits_18_1_ref =
                &mut denom_partial_ec_mul_window_bits_18_1;
            let denom_pedersen_points_table_window_bits_18_0_ref =
                &mut denom_pedersen_points_table_window_bits_18_0;
            ...
            rayon::scope(|s| {
                s.spawn(|_| {
                    *denom_partial_ec_mul_window_bits_18_0_ref = Some(
                        self.lookup_data
                            .partial_ec_mul_window_bits_18_0
                            .par_iter()
                ...
                s.spawn(|_| {
                    *denom_partial_ec_mul_window_bits_18_1_ref = Some(
                        self.lookup_data
                            .partial_ec_mul_window_bits_18_1
                            .par_iter()
                            .map(|values| common_lookup_elements.combine(values))
                            .collect(),
                    );
                ...
                s.spawn(|_| {
                    *denom_pedersen_points_table_window_bits_18_0_ref = Some(
                        self.lookup_data
                            .pedersen_points_table_window_bits_18_0
                            .par_iter()
                            .map(|values| common_lookup_elements.combine(values))
                            .collect(),
                    );
        ...
        let denom_pedersen_points_table_window_bits_18_0 =
            denom_pedersen_points_table_window_bits_18_0.unwrap();
