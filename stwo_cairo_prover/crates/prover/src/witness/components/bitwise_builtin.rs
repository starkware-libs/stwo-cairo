...
use crate::witness::components::{
    memory_address_to_id, memory_id_to_big, range_check_8, verify_bitwise_xor_8,
            ...
            |(row_index, (mut row, lookup_data, sub_component_inputs))| {
                ...
                *lookup_data.verify_bitwise_xor_8_0 =
                ...
                let and_tmp_efb2a_89 = ((M31_1073741824)
                    * (((op0_limb_27_col28) + (op1_limb_27_col57)) - (xor_col85)));
                *sub_component_inputs.range_check_8[0] = [((and_tmp_efb2a_89) + (xor_col85))];
                *lookup_data.range_check_8_0 = [((and_tmp_efb2a_89) + (xor_col85))];
...
impl InteractionClaimGenerator {
    pub fn write_interaction_trace(
        ...
        // Sum last logup term.
        logup_gen.col_from_par_iter((&self.lookup_data.memory_id_to_big_4).into_par_iter().map(
            |(values)| {
