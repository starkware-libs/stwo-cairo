        ...
        .for_each(
            |(row_index, (row, lookup_data, sub_component_inputs, jnz_opcode_taken_input))| {
                ...
                *row[45] = partial_limb_msb_col45;
                ...
                let limb_4_to_20_value_tmp_f51a9_24 = decode_small_sign_output_tmp_f51a9_20[1];
                ...
                *lookup_data.memory_id_to_big_1 = [
                    ...
                    ((remainder_bits_col44) + (decode_small_sign_output_tmp_f51a9_20[0])),
                    limb_4_to_20_value_tmp_f51a9_24,
                    limb_4_to_20_value_tmp_f51a9_24,
                    limb_4_to_20_value_tmp_f51a9_24,
                    limb_4_to_20_value_tmp_f51a9_24,
                    limb_4_to_20_value_tmp_f51a9_24,
                    ...
                    limb_4_to_20_value_tmp_f51a9_24,
                    limb_4_to_20_value_tmp_f51a9_24,
                    decode_small_sign_output_tmp_f51a9_20[2],
                    M31_0,
                    M31_0,
                    M31_0,
                    M31_0,
                ...
                let read_small_output_tmp_f51a9_25 = (
                    ((((((next_pc_limb_0_col41) + ((next_pc_limb_1_col42) * (M31_512)))
                        + ((next_pc_limb_2_col43) * (M31_262144)))
                        + ((remainder_bits_col44) * (M31_134217728)))
                        - ((decode_small_sign_output_tmp_f51a9_20[3]) * (M31_8388608)))
                        - ((M31_536870912)
                            * ((decode_small_sign_output_tmp_f51a9_20[1]) * (M31_142885409)))),
                    next_pc_id_col38,
                );

                *lookup_data.opcodes_0 = [input_pc_col0, input_ap_col1, input_fp_col2];
                *lookup_data.opcodes_1 = [
                    ((input_pc_col0) + (read_small_output_tmp_f51a9_25.0)),
