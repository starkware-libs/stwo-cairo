        ...
        .for_each(
            |(row_index, (mut row, lookup_data, sub_component_inputs, jnz_opcode_taken_input))| {
                ...
                *lookup_data.memory_id_to_big_0 = [
                ...
                let dst_sum_p_non_zero_tmp_f51a9_11 = (((((((((((((((((((((((((dst_limb_1_col9)
                    + (dst_limb_2_col10))
                    + (dst_limb_3_col11))
                    + (dst_limb_4_col12))
                    + (dst_limb_5_col13))
                    ...
                    + (dst_limb_25_col33))
                    + (dst_limb_26_col34));
                let dst_0_minus_p_0_tmp_f51a9_12 = ((dst_limb_0_col8) - (M31_1));
                let dst_21_minus_p_21_tmp_f51a9_13 = ((dst_limb_21_col29) - (M31_136));
                let dst_27_minus_p_27_tmp_f51a9_14 = ((dst_limb_27_col35) - (M31_256));
                let res_col36 = ((dst_sum_p_non_zero_tmp_f51a9_11)
                    + (((dst_limb_0_col8) + (dst_limb_21_col29)) + (dst_limb_27_col35)))
                    .inverse();
                *row[36] = res_col36;
                let res_squares_col37 = ((dst_sum_p_non_zero_tmp_f51a9_11)
                    + ((((dst_0_minus_p_0_tmp_f51a9_12) * (dst_0_minus_p_0_tmp_f51a9_12))
                        + ((dst_21_minus_p_21_tmp_f51a9_13) * (dst_21_minus_p_21_tmp_f51a9_13)))
                        + ((dst_27_minus_p_27_tmp_f51a9_14) * (dst_27_minus_p_27_tmp_f51a9_14))))
                    .inverse();
