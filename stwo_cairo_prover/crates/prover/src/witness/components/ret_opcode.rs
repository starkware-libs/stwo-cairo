#![allow(unused_parens)]
use crate::cairo_air::components::ret_opcode::{Claim, InteractionClaim, N_TRACE_COLUMNS};
        ...
        .for_each(
            |(row_index, (mut row, lookup_data, sub_component_inputs, ret_opcode_input))| {
                ...
                *lookup_data.verify_instruction_0 = [
                ...
                let memory_address_to_id_value_tmp_e23a5_2 =
                    memory_address_to_id_state.deduce_output(((input_fp_col2) - (M31_1)));
                let memory_id_to_big_value_tmp_e23a5_3 =
                    memory_id_to_big_state.deduce_output(memory_address_to_id_value_tmp_e23a5_2);
                let next_pc_id_col3 = memory_address_to_id_value_tmp_e23a5_2;
                ...
                *lookup_data.memory_address_to_id_0 =
                ...
                let next_pc_limb_0_col4 = memory_id_to_big_value_tmp_e23a5_3.get_m31(0);
                *row[4] = next_pc_limb_0_col4;
                let next_pc_limb_1_col5 = memory_id_to_big_value_tmp_e23a5_3.get_m31(1);
                *row[5] = next_pc_limb_1_col5;
                let next_pc_limb_2_col6 = memory_id_to_big_value_tmp_e23a5_3.get_m31(2);
                ...
                *lookup_data.memory_id_to_big_0 = [
                ...
                let memory_address_to_id_value_tmp_e23a5_4 =
                    memory_address_to_id_state.deduce_output(((input_fp_col2) - (M31_2)));
                let memory_id_to_big_value_tmp_e23a5_5 =
                    memory_id_to_big_state.deduce_output(memory_address_to_id_value_tmp_e23a5_4);
                let next_fp_id_col7 = memory_address_to_id_value_tmp_e23a5_4;
                ...
                *lookup_data.memory_address_to_id_1 =
                ...
                let next_fp_limb_0_col8 = memory_id_to_big_value_tmp_e23a5_5.get_m31(0);
                *row[8] = next_fp_limb_0_col8;
                let next_fp_limb_1_col9 = memory_id_to_big_value_tmp_e23a5_5.get_m31(1);
                *row[9] = next_fp_limb_1_col9;
                let next_fp_limb_2_col10 = memory_id_to_big_value_tmp_e23a5_5.get_m31(2);
