...
fn write_trace_simd(mults: Vec<PackedM31>) -> (ComponentTrace<N_TRACE_COLUMNS>, LookupData) {
    ...
    let sha256k_0 = Sha256K::new(0);
    let sha256k_1 = Sha256K::new(1);
    ...
    (trace.par_iter_mut(), lookup_data.par_iter_mut())
        ...
        .for_each(|(row_index, (mut row, lookup_data))| {
            ...
            let sha256k_0 = sha256k_0.packed_at(row_index);
            let sha256k_1 = sha256k_1.packed_at(row_index);
            *lookup_data.sha_256_k_table_0 = [seq, sha256k_0, sha256k_1];
    ...
    pub fn write_interaction_trace(
        ...
        (
            ...
            .for_each(|(writer, values, mults)| {
                let denom = sha_256_k_table.combine(values);
