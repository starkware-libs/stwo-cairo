...
#![allow(unused_parens)]
use cairo_air::components::range_check_5_4::{Claim, InteractionClaim, LOG_SIZE, N_TRACE_COLUMNS};
    ...
    pub fn new(preprocessed_trace: Arc<PreProcessedTrace>) -> Self {
        let column_ids = [
            PreProcessedColumnId {
                id: "range_check_5_4_column_0".to_owned(),
            },
            PreProcessedColumnId {
                id: "range_check_5_4_column_1".to_owned(),
            },
        ];
        Self {
...
fn write_trace_simd(
    ...
    let range_check_5_4_column_0 = preprocessed_trace.get_column(&PreProcessedColumnId {
        id: "range_check_5_4_column_0".to_owned(),
    });
    let range_check_5_4_column_1 = preprocessed_trace.get_column(&PreProcessedColumnId {
        id: "range_check_5_4_column_1".to_owned(),
    });
    ...
    (trace.par_iter_mut(), lookup_data.par_iter_mut())
        ...
        .for_each(|(row_index, (row, lookup_data))| {
            let range_check_5_4_column_0 = range_check_5_4_column_0.packed_at(row_index);
            let range_check_5_4_column_1 = range_check_5_4_column_1.packed_at(row_index);
