        ...
        .for_each(
            |(row_index, (mut row, lookup_data, sub_component_inputs))| {
                ...
                *row[24] = p1_limb_10_col24;
                ...
                let memory_address_to_id_value_tmp_c1b19_14 = memory_address_to_id_state
                ...
                *row[84] = offsets_a_id_col84;
                ...
                lookup_data.memory_address_to_id_14 =
                    [offsets_ptr_tmp_c1b19_60, offsets_a_id_col84];
                ...
                *row[91] = partial_limb_msb_col91;
                ...
                let memory_address_to_id_value_tmp_c1b19_82 = memory_address_to_id_state
                    .deduce_output(((offsets_ptr_tmp_c1b19_60) + (M31_1)));
                ...
                *row[99] = partial_limb_msb_col99;
                ...
                let memory_address_to_id_value_tmp_c1b19_92 = memory_address_to_id_state
                    .deduce_output(((offsets_ptr_tmp_c1b19_60) + (M31_2)));
...
impl InteractionClaimGenerator {
    pub fn write_interaction_trace(
        ...
        (col_gen.par_iter_mut(), self.lookup_data.par_iter_mut())
            .into_par_iter()
            .for_each(|(writer, values)| {
                let denom = memory_id_to_big.combine(&values.memory_id_to_big_23);
