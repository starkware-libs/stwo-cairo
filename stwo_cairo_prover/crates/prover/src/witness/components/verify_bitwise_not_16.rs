...
#![allow(unused_parens)]
use cairo_air::components::verify_bitwise_not_16::{
...
fn write_trace_simd(mults: Vec<PackedM31>) -> (ComponentTrace<N_TRACE_COLUMNS>, LookupData) {
    ...
    let bitwisenot_16_0 = BitwiseNot::new(16, 0);
    let bitwisenot_16_1 = BitwiseNot::new(16, 1);

    (trace.par_iter_mut(), lookup_data.par_iter_mut())
        .into_par_iter()
        .enumerate()
        .for_each(|(row_index, (mut row, lookup_data))| {
            let bitwisenot_16_0 = bitwisenot_16_0.packed_at(row_index);
            let bitwisenot_16_1 = bitwisenot_16_1.packed_at(row_index);
            *lookup_data.verify_bitwise_not_16_0 = [bitwisenot_16_0, bitwisenot_16_1];
    ...
    pub fn write_interaction_trace(
        ...
        (
            ...
            .for_each(|(writer, values, mults)| {
                let denom = verify_bitwise_not_16.combine(values);
