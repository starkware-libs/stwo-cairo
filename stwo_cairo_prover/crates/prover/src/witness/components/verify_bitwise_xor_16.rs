...
#![allow(unused_parens)]
use cairo_air::components::verify_bitwise_xor_16::{
...
fn write_trace_simd(mults: Vec<PackedM31>) -> (ComponentTrace<N_TRACE_COLUMNS>, LookupData) {
    ...
    let bitwisexor_16_0 = BitwiseXor::new(16, 0);
    let bitwisexor_16_1 = BitwiseXor::new(16, 1);
    let bitwisexor_16_2 = BitwiseXor::new(16, 2);

    (trace.par_iter_mut(), lookup_data.par_iter_mut())
        .into_par_iter()
        .enumerate()
        .for_each(|(row_index, (mut row, lookup_data))| {
            let bitwisexor_16_0 = bitwisexor_16_0.packed_at(row_index);
            let bitwisexor_16_1 = bitwisexor_16_1.packed_at(row_index);
            let bitwisexor_16_2 = bitwisexor_16_2.packed_at(row_index);
            *lookup_data.verify_bitwise_xor_16_0 =
                [bitwisexor_16_0, bitwisexor_16_1, bitwisexor_16_2];
    ...
    pub fn write_interaction_trace(
        ...
        (
            ...
            .for_each(|(writer, values, mults)| {
                let denom = verify_bitwise_xor_16.combine(values);
