...
impl ClaimGenerator {
    ...
    pub fn write_trace(
        ...
        sub_component_inputs
            ...
            .iter()
            .for_each(|inputs| {
                range_check_5_4_state.add_packed_inputs(inputs, "RangeCheck_5_4");
            });
        sub_component_inputs
            .memory_id_to_big
            .iter()
        ...
        sub_component_inputs
            ...
            .iter()
            .for_each(|inputs| {
                range_check_8_state.add_packed_inputs(inputs, "RangeCheck_8");
            });
        sub_component_inputs
        ...
        sub_component_inputs
            ...
            .iter()
            .for_each(|inputs| {
                partial_ec_mul_state.add_packed_inputs(inputs, "PartialEcMul");
            });
