...
pub mod range_check_trace_generators {
    ...
    generate_range_check_witness!([20]);
    generate_range_check_witness!([20], b, B);
    generate_range_check_witness!([20], c, C);
    generate_range_check_witness!([20], d, D);
    generate_range_check_witness!([20], e, E);
    generate_range_check_witness!([20], f, F);
    generate_range_check_witness!([20], g, G);
    generate_range_check_witness!([20], h, H);
