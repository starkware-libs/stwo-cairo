...
use crate::witness::components::pedersen_aggregator;
...
impl PedersenContextClaimGenerator {
    ...
    pub fn write_trace(
        ...
        let (pedersen_aggregator_claim, pedersen_aggregator_interaction_gen) = self.pedersen_aggregator_trace_generator.write_trace(
            tree_builder,
...
impl InteractionClaimGenerator {
    pub fn write_interaction_trace(
        ...
        let pedersen_aggregator_interaction_claim = self
            .pedersen_aggregator_interaction_gen
            .write_interaction_trace(tree_builder, &interaction_elements.range_checks.rc_5_4,&interaction_elements.memory_id_to_value,
