...
#![allow(unused_parens)]
use cairo_air::components::read_positive_known_id_num_bits_27::{
        ...
        .for_each(
            |(
                ...
                (
                    ...
                    lookup_data,
                    sub_component_inputs,
                    read_positive_known_id_num_bits_27_input,
                ),
            )| {
                let memory_id_to_big_value_tmp_23073_0 =
                    memory_id_to_big_state.deduce_output(read_positive_known_id_num_bits_27_input);
                let value_limb_0_col0 = memory_id_to_big_value_tmp_23073_0.get_m31(0);
                *row[0] = value_limb_0_col0;
                let value_limb_1_col1 = memory_id_to_big_value_tmp_23073_0.get_m31(1);
                *row[1] = value_limb_1_col1;
                let value_limb_2_col2 = memory_id_to_big_value_tmp_23073_0.get_m31(2);
