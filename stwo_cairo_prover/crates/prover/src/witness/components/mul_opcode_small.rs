...
struct SubComponentInputsPerRow {
    ...
    range_check_11: [range_check_11::PackedInputType; 3],
}
...
struct LookupDataPerRow {
    ...
    range_check_11_1: [PackedM31; 1],
    range_check_11_2: [PackedM31; 1],
    ...
    pub fn write_interaction_trace(
        ...
        (col_gen.par_iter_mut(), self.lookup_data.par_iter_mut())
            ...
            .for_each(|(writer, values)| {
                ...
                let denom1: PackedQM31 = range_check_11.combine(&values.range_check_11_0);
                writer.write_frac(denom0 + denom1, denom0 * denom1);
            });
        col_gen.finalize_col();
        ...
        (col_gen.par_iter_mut(), self.lookup_data.par_iter_mut())
            .into_par_iter()
            .for_each(|(writer, values)| {
                let denom0: PackedQM31 = range_check_11.combine(&values.range_check_11_1);
                let denom1: PackedQM31 = range_check_11.combine(&values.range_check_11_2);
                writer.write_frac(denom0 + denom1, denom0 * denom1);
            });
        col_gen.finalize_col();
