        ...
        .for_each(
            |(row_index, (mut row, lookup_data, sub_component_inputs, mul_opcode_small_input))| {
                ...
                *row[7] = op0_base_fp_col7;
                let op1_imm_tmp_34662_7 =
                    (((((PackedUInt16::from_m31(memory_id_to_big_value_tmp_34662_1.get_m31(5)))
                        ...
                        >> (UInt16_2))
                        & (UInt16_1));
                let op1_imm_col8 = op1_imm_tmp_34662_7.as_m31();
                *row[8] = op1_imm_col8;
                let op1_base_fp_tmp_34662_8 =
                    (((((PackedUInt16::from_m31(memory_id_to_big_value_tmp_34662_1.get_m31(5)))
                        ...
                        >> (UInt16_3))
                        & (UInt16_1));
                let op1_base_fp_col9 = op1_base_fp_tmp_34662_8.as_m31();
                *row[9] = op1_base_fp_col9;
                let ap_update_add_1_tmp_34662_9 =
                    (((((PackedUInt16::from_m31(memory_id_to_big_value_tmp_34662_1.get_m31(5)))
                        >> (UInt16_3))
                        + ((PackedUInt16::from_m31(
                            memory_id_to_big_value_tmp_34662_1.get_m31(6),
                        ...
                        >> (UInt16_11))
                        & (UInt16_1));
                let ap_update_add_1_col10 = ap_update_add_1_tmp_34662_9.as_m31();
                ...
                *lookup_data.verify_instruction_0 = [
                ...
                let decode_instruction_5d587fc63f91aa1b_output_tmp_34662_10 = (
                    [
                ...
                *row[12] = mem0_base_col12;
                let mem1_base_col13 = ((((op1_imm_col8) * (input_pc_col0))
                    ...
                    + ((decode_instruction_5d587fc63f91aa1b_output_tmp_34662_10.1[4])
                        * (input_ap_col1)));
                *row[13] = mem1_base_col13;
                ...
                let memory_address_to_id_value_tmp_34662_11 = memory_address_to_id_state
                    .deduce_output(
                        PackedRelocatable::from_ap_m31(((mem_dst_base_col11)
                            + (decode_instruction_5d587fc63f91aa1b_output_tmp_34662_10.0[0]))),
                    );
                ...
                *row[14] = dst_id_col14;
                *sub_component_inputs.memory_address_to_id[0] = PackedRelocatable::from_ap_m31(((mem_dst_base_col11)
                    + (decode_instruction_5d587fc63f91aa1b_output_tmp_34662_10.0[0])));
                ...
                *lookup_data.memory_id_to_big_0 = [
                ...
                let read_positive_num_bits_72_output_tmp_34662_13 = (
                ...
                let memory_address_to_id_value_tmp_34662_14 = memory_address_to_id_state
                    .deduce_output(
                        PackedRelocatable::from_ap_m31(((mem0_base_col12)
                            + (decode_instruction_5d587fc63f91aa1b_output_tmp_34662_10.0[1]))),
                    );
                let memory_id_to_big_value_tmp_34662_15 =
                    memory_id_to_big_state.deduce_output(memory_address_to_id_value_tmp_34662_14);
                let op0_id_col23 = memory_address_to_id_value_tmp_34662_14;
                *row[23] = op0_id_col23;
                *sub_component_inputs.memory_address_to_id[1] = PackedRelocatable::from_ap_m31(((mem0_base_col12)
                    + (decode_instruction_5d587fc63f91aa1b_output_tmp_34662_10.0[1])));
                *lookup_data.memory_address_to_id_1 = [
                ...
                let op0_limb_0_col24 = memory_id_to_big_value_tmp_34662_15.get_m31(0);
                *row[24] = op0_limb_0_col24;
                let op0_limb_1_col25 = memory_id_to_big_value_tmp_34662_15.get_m31(1);
                *row[25] = op0_limb_1_col25;
                let op0_limb_2_col26 = memory_id_to_big_value_tmp_34662_15.get_m31(2);
                *row[26] = op0_limb_2_col26;
                let op0_limb_3_col27 = memory_id_to_big_value_tmp_34662_15.get_m31(3);
                ...
                *lookup_data.memory_id_to_big_1 = [
                ...
                let read_positive_num_bits_36_output_tmp_34662_16 = (
                    PackedFelt252::from_limbs([
                        op0_limb_0_col24,
                        op0_limb_1_col25,
                        op0_limb_2_col26,
                ...
                let memory_address_to_id_value_tmp_34662_17 = memory_address_to_id_state
                    .deduce_output(
                        PackedRelocatable{
                            segment_index: M31_1 * (M31_1 - op1_imm_col8),
                            offset:((mem1_base_col13)
                            + (decode_instruction_5d587fc63f91aa1b_output_tmp_34662_10.0[2]))}
                    );
                let memory_id_to_big_value_tmp_34662_18 =
                    memory_id_to_big_state.deduce_output(memory_address_to_id_value_tmp_34662_17);
                let op1_id_col28 = memory_address_to_id_value_tmp_34662_17;
                *row[28] = op1_id_col28;
                ...
                *lookup_data.memory_address_to_id_2 = [
                ...
                let op1_limb_0_col29 = memory_id_to_big_value_tmp_34662_18.get_m31(0);
                *row[29] = op1_limb_0_col29;
                let op1_limb_1_col30 = memory_id_to_big_value_tmp_34662_18.get_m31(1);
                *row[30] = op1_limb_1_col30;
                let op1_limb_2_col31 = memory_id_to_big_value_tmp_34662_18.get_m31(2);
                *row[31] = op1_limb_2_col31;
                let op1_limb_3_col32 = memory_id_to_big_value_tmp_34662_18.get_m31(3);
                ...
                *lookup_data.memory_id_to_big_2 = [
                ...
                let read_positive_num_bits_36_output_tmp_34662_19 = (
                    PackedFelt252::from_limbs([
                        op1_limb_0_col29,
                        op1_limb_1_col30,
                        op1_limb_2_col31,
