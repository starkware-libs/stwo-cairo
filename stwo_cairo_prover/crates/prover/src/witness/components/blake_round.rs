...
struct LookupDataPerRow {
    ...
    blake_g_1: [PackedM31; 20],
    blake_g_2: [PackedM31; 20],
    blake_g_3: [PackedM31; 20],
    blake_g_4: [PackedM31; 20],
    blake_g_5: [PackedM31; 20],
    blake_g_6: [PackedM31; 20],
    blake_g_7: [PackedM31; 20],
    blake_round_0: [PackedM31; 35],
    blake_round_1: [PackedM31; 35],
    blake_round_sigma_0: [PackedM31; 17],
    ...
    pub fn write_interaction_trace(
        ...
        (col_gen.par_iter_mut(), self.lookup_data.par_iter_mut())
            ...
            .for_each(|(writer, values)| {
                let denom0: PackedQM31 = blake_round_sigma.combine(&values.blake_round_sigma_0);
        ...
        (col_gen.par_iter_mut(), self.lookup_data.par_iter_mut())
            .into_par_iter()
            .for_each(|(writer, values)| {
                let denom0: PackedQM31 = memory_id_to_big.combine(&values.memory_id_to_big_5);
        ...
        (col_gen.par_iter_mut(), self.lookup_data.par_iter_mut())
            .into_par_iter()
            .for_each(|(writer, values)| {
                let denom0: PackedQM31 = memory_id_to_big.combine(&values.memory_id_to_big_7);
        ...
        (col_gen.par_iter_mut(), self.lookup_data.par_iter_mut())
            ...
            .for_each(|(writer, values)| {
                ...
                let denom1: PackedQM31 = memory_id_to_big.combine(&values.memory_id_to_big_10);
                writer.write_frac(denom0 + denom1, denom0 * denom1);
            });
        col_gen.finalize_col();
        ...
        (col_gen.par_iter_mut(), self.lookup_data.par_iter_mut())
            ...
            .for_each(|(writer, values)| {
                ...
                let denom1: PackedQM31 = memory_id_to_big.combine(&values.memory_id_to_big_12);
                writer.write_frac(denom0 + denom1, denom0 * denom1);
            });
        col_gen.finalize_col();
        ...
        (col_gen.par_iter_mut(), self.lookup_data.par_iter_mut())
            ...
            .for_each(|(writer, values)| {
                ...
                let denom1: PackedQM31 = memory_id_to_big.combine(&values.memory_id_to_big_14);
                writer.write_frac(denom0 + denom1, denom0 * denom1);
            });
        col_gen.finalize_col();
        ...
        (col_gen.par_iter_mut(), self.lookup_data.par_iter_mut())
            ...
            .for_each(|(writer, values)| {
                ...
                let denom1: PackedQM31 = blake_g.combine(&values.blake_g_0);
                writer.write_frac(denom0 + denom1, denom0 * denom1);
            });
        col_gen.finalize_col();
        ...
        (col_gen.par_iter_mut(), self.lookup_data.par_iter_mut())
            .into_par_iter()
            .for_each(|(writer, values)| {
                let denom0: PackedQM31 = blake_g.combine(&values.blake_g_1);
                let denom1: PackedQM31 = blake_g.combine(&values.blake_g_2);
                writer.write_frac(denom0 + denom1, denom0 * denom1);
            });
        col_gen.finalize_col();
        ...
        (col_gen.par_iter_mut(), self.lookup_data.par_iter_mut())
            .into_par_iter()
            .for_each(|(writer, values)| {
                let denom0: PackedQM31 = blake_g.combine(&values.blake_g_3);
                let denom1: PackedQM31 = blake_g.combine(&values.blake_g_4);
                writer.write_frac(denom0 + denom1, denom0 * denom1);
            });
        col_gen.finalize_col();
        ...
        (col_gen.par_iter_mut(), self.lookup_data.par_iter_mut())
            .into_par_iter()
            .for_each(|(writer, values)| {
                let denom0: PackedQM31 = blake_g.combine(&values.blake_g_5);
                let denom1: PackedQM31 = blake_g.combine(&values.blake_g_6);
                writer.write_frac(denom0 + denom1, denom0 * denom1);
            });
        col_gen.finalize_col();
        ...
        (col_gen.par_iter_mut(), self.lookup_data.par_iter_mut())
            ...
            .for_each(|(i, (writer, values))| {
                let denom0: PackedQM31 = blake_g.combine(&values.blake_g_7);
                let denom1: PackedQM31 = blake_round.combine(&values.blake_round_0);
        ...
        (col_gen.par_iter_mut(), self.lookup_data.par_iter_mut())
            ...
            .enumerate()
            .for_each(|(i, (writer, values))| {
                let denom = blake_round.combine(&values.blake_round_1);
