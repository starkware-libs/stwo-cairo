...
impl ClaimGenerator {
    ...
    pub fn write_trace(
        ...
        sub_component_inputs
            ...
            .iter()
            .for_each(|inputs| {
                verify_bitwise_xor_12_state.add_packed_inputs(inputs, "VerifyBitwiseXor_12");
            });
        sub_component_inputs
            .verify_bitwise_xor_4
            .iter()
            .for_each(|inputs| {
                verify_bitwise_xor_4_state.add_packed_inputs(inputs, "VerifyBitwiseXor_4");
            });
        sub_component_inputs
            .verify_bitwise_xor_7
            .iter()
            .for_each(|inputs| {
                verify_bitwise_xor_7_state.add_packed_inputs(inputs, "VerifyBitwiseXor_7");
            });
        sub_component_inputs
            .verify_bitwise_xor_9
            .iter()
