#![allow(unused_parens)]
use crate::cairo_air::components::assert_eq_opcode::{Claim, InteractionClaim, N_TRACE_COLUMNS};
        ...
        .for_each(
            |(row_index, (mut row, lookup_data, sub_component_inputs, assert_eq_opcode_input))| {
                ...
                *row[9] = mem1_base_col9;
                ...
                let memory_address_to_id_value_tmp_d6f03_7 = memory_address_to_id_state
                    .deduce_output(((mem_dst_base_col8) + ((offset0_col3) - (M31_32768))));
                let dst_id_col10 = memory_address_to_id_value_tmp_d6f03_7;
                *row[10] = dst_id_col10;
