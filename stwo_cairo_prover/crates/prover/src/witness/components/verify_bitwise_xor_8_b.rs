...
fn write_trace_simd(mults: Vec<PackedM31>) -> (ComponentTrace<N_TRACE_COLUMNS>, LookupData) {
    ...
    let bitwisexor_8_b_0 = BitwiseXor::new(8, 0);
    let bitwisexor_8_b_1 = BitwiseXor::new(8, 1);
    let bitwisexor_8_b_2 = BitwiseXor::new(8, 2);

    (trace.par_iter_mut(), lookup_data.par_iter_mut())
        .into_par_iter()
        .enumerate()
        .for_each(|(row_index, (mut row, lookup_data))| {
            let bitwisexor_8_b_0 = bitwisexor_8_b_0.packed_at(row_index);
            let bitwisexor_8_b_1 = bitwisexor_8_b_1.packed_at(row_index);
            let bitwisexor_8_b_2 = bitwisexor_8_b_2.packed_at(row_index);
            *lookup_data.verify_bitwise_xor_8_b_0 =
                [bitwisexor_8_b_0, bitwisexor_8_b_1, bitwisexor_8_b_2];
