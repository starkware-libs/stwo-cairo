use cairo_air::components::{
    ...
    jump_opcode_abs as jump_opcode_abs_air, jump_opcode_double_deref as jump_opcode_double_deref_air,
...
pub type TraceEval =
    Vec<CircleEvaluation<SimdBackend, M31, stwo::prover::poly::BitReversedOrder>>;
...
pub struct PreBlakeOpcodeResult {
    ...
    pub assert_eq_double_deref_result:
        Option<(TraceEval, assert_eq_opcode_double_deref::InteractionClaimGenerator)>,
    ...
    pub jump_double_deref_result:
        Option<(TraceEval, jump_opcode_double_deref::InteractionClaimGenerator)>,
