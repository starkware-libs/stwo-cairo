    ...
    SimdBackend: BackendForChannel<MC>,
{
    ...
    let preprocessed_log_size = commitment_scheme
        .trees
        .last()
        .unwrap()
        .commitment
        ...
        .len() as u32
        - 1;
    eprintln!("preprocessed_log_size: {}", preprocessed_log_size);
    ...
    let trace_log_size = commitment_scheme
        .trees
        .last()
        .unwrap()
        .commitment
        ...
        .len() as u32
        - 1;
    eprintln!("trace_log_size: {}", trace_log_size);
