...
pub mod tests {
    ...
    fn test_all_cairo_constraints() {
        ...
        let input = run_program_and_adapter(&compiled_program, false);
    ...
    pub mod slow_tests {
        ...
        fn test_prove_verify_all_opcode_components_from_file() {
            ...
            let input = read_and_adapt_prover_input_info_file(&prover_input_file_path, false)
        ...
        fn test_proof_stability(path: &str, n_proofs_to_compare: usize) {
            ...
            let input =
                read_and_adapt_prover_input_info_file(&prover_input_file_path, false).unwrap();
