...
pub mod tests {
    ...
    fn test_read_from_large_files() {
        ...
        assert_eq!(builtins_segments.bitwise, Some((5942840, 5942840).into()));
        assert_eq!(builtins_segments.add_mod, Some((21900856, 21900856).into()));
        assert_eq!(builtins_segments.ec_op, Some((16428600, 16428747).into()));
        assert_eq!(builtins_segments.ecdsa, Some((5910072, 5910072).into()));
        assert_eq!(builtins_segments.keccak, Some((16657976, 16657976).into()));
        assert_eq!(builtins_segments.mul_mod, Some((23735864, 23735864).into()));
    ...
    fn test_read_from_small_files() {
        ...
        assert_eq!(builtins_segments.add_mod, Some((84848, 84848).into()));
        ...
        assert_eq!(builtins_segments.mul_mod, Some((92016, 92016).into()));
