...
pub mod slow_tests {
    use crate::cairo_air::tests::create_prover_input_from_file;

    #[test]
    fn test_read_from_large_files() {
        let input = create_prover_input_from_file("test_read_from_large_files");
    ...
    fn test_read_from_small_files() {
        let input = create_prover_input_from_file("test_read_from_small_files");
