...
use super::casm_components_usage::CasmComponentsUsage;
...
pub fn import_from_vm_output(
    ...
    let components_usage = CasmComponentsUsage::from_iter(TraceIter(&mut trace_file), &mem);
...
pub mod tests {
    ...
    use super::*;
    use crate::input::casm_components_usage::CasmComponentCounts;
