...
mod mappings_tests {
    ...
    #[test]
    fn test_jmp_rel() {
        // flags: 000000100001011 (pc_update_jump_rel, op0_base_fp, dst_base_fp), offset2=
        // 1000000000000000 (0), offset1= 0111111111111111 (-1), offset0= 0111111111111111
        // (-1)
    ...
    fn test_jmp_abs_double_deref() {
        // flags: 000000010000001 (pc_update_jmp, op0_base_fp, dst_base_fp), offset2=
        // 1000000000000000 (0) (0), offset1= 1000000000000000 (0), offset0=
        // 0111111111111111 (-1)
