...
pub struct StateTransitions {
    ...
    pub vm_state_by_opcode: VmStateByOpcode,
}
...
impl StateTransitions {
    ...
    fn push_instr(&mut self, mem: &mut MemoryBuilder, state: CasmState, dev_mode: bool) {
        ...
        if dev_mode {
            ...
            {
                self.vm_state_by_opcode.ret_opcode.push(state);
            } else {
                self.vm_state_by_opcode.generic_opcode.push(state);
            }
