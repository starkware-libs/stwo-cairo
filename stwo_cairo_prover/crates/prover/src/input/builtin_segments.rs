...
impl BuiltinSegments {
    ...
    pub fn get_builtin_counts(&self) -> HashMap<BuiltinName, usize> {
        let builtin_names = &[
        ...
        builtin_names
            .iter()
            .filter_map(|&builtin_name| self.get_builtin_count(builtin_name))
            .collect()
    }

    fn get_builtin_count(&self, builtin_name: BuiltinName) -> Option<(BuiltinName, usize)> {
