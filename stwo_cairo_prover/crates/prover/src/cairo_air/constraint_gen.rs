mod tests {
    ...
    use crate::cairo_air::relations::{
        self, MemoryAddressToId, MemoryIdToBig, RangeCheck_6, RangeCheck_7_2_5,
    ...
    fn gen_code() {
        ...
        // gen_add_imm_constraint_code(path);
        // gen_add_small_constraint_code(path);
        // gen_add_small_imm_constraint_code(path);
        // gen_add_ap_constraint_code(path);
        // gen_add_ap_op_1_base_fp_constraint_code(path);
        // gen_add_ap_imm_constraint_code(path);
