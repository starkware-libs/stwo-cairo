...
// PackedM31. Pads all rows below R with the first row. Uses the <get_m31> function to get the value
// in a given row and column.
pub fn pack_and_pad<const R: usize, F>(get_m31: F, vec_row: usize, col: usize) -> PackedM31
where
