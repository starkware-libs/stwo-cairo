...
pub mod tests {
    ...
    pub mod slow_tests {
        ...
        /// Asserts that in the first instance of the bitwise builtin segment, the add result is not
        /// used, so there is a hole in the memory.
        ...
        /// instances of each builtin, and bitwise builtin has memory holes.
        #[test]
        ...
        /// This test's input was generated using `stwo_cairo_input.py` in Starkware repo with 50
        /// instances of bitwise builtin with memory holes (see `assert_bitwise_builtin_has_holes`).
        #[test]
        ...
        /// This test's input was generated using `stwo_cairo_input.py` in Starkware repo with 50
        /// instances of range check 96 builtin.
        #[test]
        ...
        /// This test's input was generated using `stwo_cairo_input.py` in Starkware repo with 50
        /// instances of range check 128 builtin.
        #[test]
