...
pub struct ProverConfig {
    ...
    /// Used for debugging the lookup argument, and should be removed. NOTE: Negatively affects
    /// performance.
...
impl ConfigBuilder {
    pub fn track_relations(mut self, flag: bool) -> Self {
        self.track_relations = flag;
        self
    }

    pub fn display_components(mut self, flag: bool) -> Self {
        self.display_components = flag;
        self
    }
