...
mod tests {
    ...
    pub mod slow_tests {
        ...
        fn generate_and_serialise_proof() {
            let cairo_proof = super::prove_cairo::<Poseidon252MerkleChannel>(
                super::test_input(),
                super::test_cfg(),
            )
            .unwrap();
            ...
            super::verify_cairo::<Poseidon252MerkleChannel>(cairo_proof).unwrap();
        }

        #[test]
        fn test_full_cairo_air() {
            let cairo_proof =
                super::prove_cairo::<Blake2sMerkleChannel>(small_cairo_input(), super::test_cfg())
                    .unwrap();
            super::verify_cairo::<Blake2sMerkleChannel>(cairo_proof).unwrap();
        }
    }
}
