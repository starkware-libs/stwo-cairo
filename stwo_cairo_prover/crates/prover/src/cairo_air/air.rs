...
impl CairoClaimGenerator {
    pub fn new(input: CairoInput) -> Self {
        let ret_trace_generator =
            ret_opcode::ClaimGenerator::new(input.state_transition.opcode_components.ret_opcode);
        ...
        let public_data = PublicData {
            public_memory,
            initial_state: input.state_transition.initial_state,
            final_state: input.state_transition.final_state,
        };
