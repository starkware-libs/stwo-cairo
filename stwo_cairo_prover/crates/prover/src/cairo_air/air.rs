...
impl PublicData {
    pub fn logup_sum(&self, lookup_elements: &CairoInteractionElements) -> QM31 {
        ...
        sum += self
            ...
            .iter()
            .map(|(addr, id, val)| {
                let addr_to_id = <AddrToIdRelation as Relation<M31, QM31>>::combine(
                    &lookup_elements.memory_addr_to_id,
                    &[M31::from_u32_unchecked(*addr), M31::from_u32_unchecked(*id)],
                )
                .inverse();
                let id_to_value = <IdToValueRelation as Relation<M31, QM31>>::combine(
        ...
        sum += <VmRelation as Relation<M31, QM31>>::combine(
...
pub struct CairoInteractionElements {
    pub opcodes: VmRelation,
    pub verify_instruction: VerifyInstructionRelation,
    pub memory_addr_to_id: AddrToIdRelation,
    pub memory_id_to_value: IdToValueRelation,
    pub range_check_19: RangeCheck_19Relation,
    pub range_check_9_9: RangeCheck_9_9Relation,
    pub range_check_7_2_5: RangeCheck_7_2_5Relation,
    pub range_check_4_3: RangeCheck_4_3Relation,
    // ...
}
impl CairoInteractionElements {
    pub fn draw(channel: &mut impl Channel) -> CairoInteractionElements {
        CairoInteractionElements {
            opcodes: VmRelation::draw(channel),
            verify_instruction: VerifyInstructionRelation::draw(channel),
            memory_addr_to_id: AddrToIdRelation::draw(channel),
            memory_id_to_value: IdToValueRelation::draw(channel),
            range_check_19: RangeCheck_19Relation::draw(channel),
            range_check_9_9: RangeCheck_9_9Relation::draw(channel),
            range_check_7_2_5: RangeCheck_7_2_5Relation::draw(channel),
            range_check_4_3: RangeCheck_4_3Relation::draw(channel),
        }
    }
}
