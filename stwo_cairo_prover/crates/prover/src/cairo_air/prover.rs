...
use stwo_prover::core::prover::{prove, ProvingError, VerificationError};
use thiserror::Error;
...
pub mod tests {
    ...
    use super::{default_prod_prover_parameters, CairoProver, CairoVerificationError};
    use crate::cairo_air::verifier::CairoVerifier;
    ...
    where
        SimdBackend: BackendForChannel<MC>,
    {
        let verifier = CairoVerifier::new(default_prod_prover_parameters().pcs_config);
        verifier.verify::<MC>(proof)
    }
