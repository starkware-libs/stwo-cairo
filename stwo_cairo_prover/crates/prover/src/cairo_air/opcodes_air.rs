...
pub struct OpcodeClaim {
    ...
    pub jump_f_f: Vec<jump_opcode_is_rel_f_is_imm_f_is_double_deref_f::Claim>,
    pub jump_f_t: Vec<jump_opcode_is_rel_f_is_imm_f_is_double_deref_t::Claim>,
    pub jump_t_f: Vec<jump_opcode_is_rel_t_is_imm_f_is_double_deref_f::Claim>,
    pub jump_t_t: Vec<jump_opcode_is_rel_t_is_imm_t_is_double_deref_f::Claim>,
