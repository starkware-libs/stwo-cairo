...
use crate::components::{
    ...
    mul_opcode_small, mul_opcode_small_imm, qm_31_add_mul_opcode, range_check_11, range_check_19,
    range_check_4_4_4_4, range_check_7_2_5, range_check_9_9, ret_opcode, verify_bitwise_xor_8,
    verify_instruction,
};
