...
pub mod relation_tracker {
    ...
    use crate::components::range_check_vector::{
        ...
        range_check_3_6, range_check_3_6_6_3, range_check_4_3, range_check_4_4,
        ...
        SimdBackend: BackendForChannel<MC>,
    {
                ...
                RelationTrackerComponent::new(
                    ...
                    poseidon_builtin::Eval {
                        ...
                        range_check_3_3_3_3_3_lookup_elements:
                            relations::RangeCheck_3_3_3_3_3::dummy(),
        ...
        if let Some(poseidon_3_partial_rounds_chain) =
            claim.builtins.poseidon_3_partial_rounds_chain
        {
            entries.extend(
                RelationTrackerComponent::new(
                    tree_span_provider,
