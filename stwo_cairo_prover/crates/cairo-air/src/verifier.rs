...
// };
use crate::air::{MemorySection, PublicData, PublicMemory, PublicSegmentRanges};
use crate::air_components::CairoComponents;
use crate::claims::{interaction_claim_mix_into, lookup_sum, CairoClaim};
...
fn verify_claim(claim: &CairoClaim) {
    ...
    // TODO(AnatG): Move to the builtins.
    // verify_builtins(
    ...
    // TODO(AnatG): Erase. Moved to memory_id_to_big.
...
// fn verify_builtins(
//     add_mod_builtin_claim: &Option<u32>,
//     bitwise_builtin_claim: &Option<u32>,
//     mul_mod_builtin_claim: &Option<u32>,
//     pedersen_builtin_claim: &Option<u32>,
//     poseidon_builtin_claim: &Option<u32>,
//     range_check_96_builtin_claim: &Option<u32>,
//     range_check_128_builtin_claim: &Option<u32>,
...
//     );
//     check_builtin_generic!(bitwise_builtin);
//     check_builtin_generic!(add_mod_builtin);
//     check_builtin_generic!(mul_mod_builtin);
//     check_builtin_generic!(pedersen_builtin);
//     check_builtin_generic!(poseidon_builtin);
// }
...
//     let Some(log_size) = builtin_claim.unwrap_or_else(|| {
...
pub fn verify_cairo<MC: MerkleChannel>(
    ...
    interaction_claim_mix_into(interaction_claim, channel);
