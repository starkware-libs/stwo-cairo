...
relation!(Opcodes, 3);
relation!(PedersenAggregatorWindowBits18, 3);
relation!(PartialEcMulWindowBits18, 72);
relation!(PedersenPointsTableWindowBits18, 57);
relation!(PedersenAggregatorWindowBits9, 3);
relation!(PartialEcMulWindowBits9, 87);
relation!(PedersenPointsTableWindowBits9, 57);
