...
relation!(Opcodes, 3);
relation!(PedersenAggregatorBitsPerWindow18, 3);
relation!(PartialEcMulBitsPerWindow18, 73);
relation!(PedersenPointsTableBitsPerWindow18, 57);
relation!(PedersenAggregatorBitsPerWindow9, 3);
relation!(PartialEcMulBitsPerWindow9, 87);
relation!(PedersenPointsTableBitsPerWindow9, 57);
