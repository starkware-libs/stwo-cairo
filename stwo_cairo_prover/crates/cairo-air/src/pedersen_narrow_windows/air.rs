...
#[derive(Serialize, Deserialize, CairoSerialize, CairoDeserialize)]
pub struct Claim {
    pub pedersen_aggregator: pedersen_aggregator_window_bits_9::Claim,
    pub partial_ec_mul: partial_ec_mul_window_bits_9::Claim,
    pub pedersen_points_table: pedersen_points_table_window_bits_9::Claim,
}
impl Claim {
    pub fn mix_into(&self, channel: &mut impl Channel) {
