...
mod tests {
    ...
    fn test_accumulate_relation_uses() {
        ...
        let comp_1_log_size = 1;
        let comp_1_rel_uses_per_row = [RelationUse {
            relation_id: "relation_1",
            uses: 1,
        }];
        let comp_2_log_size = 2;
        let comp_2_rel_uses_per_row = [
            RelationUse {
                relation_id: "relation_1",
                uses: 2,
            },
        ...
        accumulate_relation_uses(
            &mut relation_counts,
            comp_1_rel_uses_per_row,
            comp_1_log_size,
        );
        accumulate_relation_uses(
            &mut relation_counts,
            comp_2_rel_uses_per_row,
            comp_2_log_size,
        );
