...
/// `tree_idx`, in ascending order of query positions. In `VerifierFriendlyStarkProof`, the queried
/// values are organized in a TreeVec<Vec<M31>>: `verifier_friendly_queried_values[tree_idx]` is the
...
/// in sorted order is suitable for the verification of the Merkle decommitments. The downside is
/// that the queried values need to be sorted (once) for the computation of the fri quotients.
#[derive(Debug, Serialize, Deserialize)]
pub struct VerifierFriendlyStarkProof<H: MerkleHasherLifted> {
...
pub struct VerifierFriendlyCairoProof<H: MerkleHasherLifted> {
    pub claim: CairoClaim,
    pub interaction_pow: u64,
    pub interaction_claim: CairoInteractionClaim,
    pub stark_proof: VerifierFriendlyStarkProof<H>,
    pub channel_salt: Option<u64>,
}

impl<H: MerkleHasherLifted> CairoSerialize for VerifierFriendlyStarkProof<H>
where
    H::Hash: CairoSerialize,
{
    fn serialize(&self, output: &mut Vec<starknet_ff::FieldElement>) {
...
impl<H: MerkleHasherLifted> CairoDeserialize for VerifierFriendlyStarkProof<H>
where
    H::Hash: CairoDeserialize,
{
    fn deserialize<'a>(data: &mut impl Iterator<Item = &'a starknet_ff::FieldElement>) -> Self {
...
impl<H: MerkleHasherLifted> CairoSerialize for VerifierFriendlyCairoProof<H>
where
    H::Hash: CairoSerialize,
{
    fn serialize(&self, output: &mut Vec<starknet_ff::FieldElement>) {
        ...
        CairoSerialize::serialize(interaction_pow, output);
        CairoSerialize::serialize(interaction_claim, output);
        CairoSerialize::serialize(verifier_friendly_stark_proof, output);
        CairoSerialize::serialize(channel_salt, output);
    }
}

impl<H: MerkleHasherLifted> CairoDeserialize for VerifierFriendlyCairoProof<H>
where
    H::Hash: CairoDeserialize,
{
    fn deserialize<'a>(data: &mut impl Iterator<Item = &'a starknet_ff::FieldElement>) -> Self {
...
pub struct CairoInteractionElements {
    ...
    pub pedersen_aggregator_window_bits_18: relations::PedersenAggregatorWindowBits18,
    pub partial_ec_mul_window_bits_18: relations::PartialEcMulWindowBits18,
    pub pedersen_points_table_window_bits_18: relations::PedersenPointsTableWindowBits18,
    pub pedersen_aggregator_window_bits_9: relations::PedersenAggregatorWindowBits9,
    pub partial_ec_mul_window_bits_9: relations::PartialEcMulWindowBits9,
    pub pedersen_points_table_window_bits_9: relations::PedersenPointsTableWindowBits9,
...
impl CairoInteractionElements {
    pub fn draw(channel: &mut impl Channel) -> CairoInteractionElements {
        CairoInteractionElements {
            ...
            pedersen_aggregator_window_bits_18: relations::PedersenAggregatorWindowBits18::draw(
                channel,
            ),
            partial_ec_mul_window_bits_18: relations::PartialEcMulWindowBits18::draw(channel),
            pedersen_points_table_window_bits_18: relations::PedersenPointsTableWindowBits18::draw(
                channel,
            ),
            pedersen_aggregator_window_bits_9: relations::PedersenAggregatorWindowBits9::draw(
                channel,
            ),
            partial_ec_mul_window_bits_9: relations::PartialEcMulWindowBits9::draw(channel),
            pedersen_points_table_window_bits_9: relations::PedersenPointsTableWindowBits9::draw(
                channel,
            ),
