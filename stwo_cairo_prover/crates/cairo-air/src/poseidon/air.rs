...
impl Claim {
    ...
    pub fn accumulate_relation_uses(&self, relation_counts: &mut HashMap<&'static str, u32>) {
        ...
        accumulate_relation_uses(relation_counts, poseidon_3_partial_rounds_chain::RELATION_USES_PER_ROW, poseidon_3_partial_rounds_chain.log_size);
        accumulate_relation_uses(relation_counts, poseidon_full_round_chain::RELATION_USES_PER_ROW, poseidon_full_round_chain.log_size);
        accumulate_relation_uses(relation_counts, cube_252::RELATION_USES_PER_ROW, cube_252.log_size);
        accumulate_relation_uses(relation_counts, range_check_felt_252_width_27::RELATION_USES_PER_ROW, range_check_felt_252_width_27.log_size);
    }
}
