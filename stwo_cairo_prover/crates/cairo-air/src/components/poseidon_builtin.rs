...
impl FrameworkEval for Eval {
    ...
    fn evaluate<E: EvalAtRow>(&self, mut eval: E) -> E {
        ...
        let state_0_id_col0 = eval.next_trace_mask();
        let state_1_id_col1 = eval.next_trace_mask();
        let state_2_id_col2 = eval.next_trace_mask();
        let state_3_id_col3 = eval.next_trace_mask();
        let state_4_id_col4 = eval.next_trace_mask();
        let state_5_id_col5 = eval.next_trace_mask();
