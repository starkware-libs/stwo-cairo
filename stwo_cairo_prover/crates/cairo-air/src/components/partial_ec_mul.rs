...
impl FrameworkEval for Eval {
    ...
    fn evaluate<E: EvalAtRow>(&self, mut eval: E) -> E {
        ...
        let pedersen_points_table_output_limb_0_col86 = eval.next_trace_mask();
        let pedersen_points_table_output_limb_1_col87 = eval.next_trace_mask();
        let pedersen_points_table_output_limb_2_col88 = eval.next_trace_mask();
        let pedersen_points_table_output_limb_3_col89 = eval.next_trace_mask();
        let pedersen_points_table_output_limb_4_col90 = eval.next_trace_mask();
        let pedersen_points_table_output_limb_5_col91 = eval.next_trace_mask();
        let pedersen_points_table_output_limb_6_col92 = eval.next_trace_mask();
        let pedersen_points_table_output_limb_7_col93 = eval.next_trace_mask();
        let pedersen_points_table_output_limb_8_col94 = eval.next_trace_mask();
        let pedersen_points_table_output_limb_9_col95 = eval.next_trace_mask();
        let pedersen_points_table_output_limb_10_col96 = eval.next_trace_mask();
        let pedersen_points_table_output_limb_11_col97 = eval.next_trace_mask();
        let pedersen_points_table_output_limb_12_col98 = eval.next_trace_mask();
        let pedersen_points_table_output_limb_13_col99 = eval.next_trace_mask();
        let pedersen_points_table_output_limb_14_col100 = eval.next_trace_mask();
        let pedersen_points_table_output_limb_15_col101 = eval.next_trace_mask();
        let pedersen_points_table_output_limb_16_col102 = eval.next_trace_mask();
        let pedersen_points_table_output_limb_17_col103 = eval.next_trace_mask();
        let pedersen_points_table_output_limb_18_col104 = eval.next_trace_mask();
        let pedersen_points_table_output_limb_19_col105 = eval.next_trace_mask();
        let pedersen_points_table_output_limb_20_col106 = eval.next_trace_mask();
        let pedersen_points_table_output_limb_21_col107 = eval.next_trace_mask();
        let pedersen_points_table_output_limb_22_col108 = eval.next_trace_mask();
        let pedersen_points_table_output_limb_23_col109 = eval.next_trace_mask();
        let pedersen_points_table_output_limb_24_col110 = eval.next_trace_mask();
        let pedersen_points_table_output_limb_25_col111 = eval.next_trace_mask();
        let pedersen_points_table_output_limb_26_col112 = eval.next_trace_mask();
        let pedersen_points_table_output_limb_27_col113 = eval.next_trace_mask();
        let pedersen_points_table_output_limb_28_col114 = eval.next_trace_mask();
        let pedersen_points_table_output_limb_29_col115 = eval.next_trace_mask();
        let pedersen_points_table_output_limb_30_col116 = eval.next_trace_mask();
        let pedersen_points_table_output_limb_31_col117 = eval.next_trace_mask();
        let pedersen_points_table_output_limb_32_col118 = eval.next_trace_mask();
        let pedersen_points_table_output_limb_33_col119 = eval.next_trace_mask();
        let pedersen_points_table_output_limb_34_col120 = eval.next_trace_mask();
        let pedersen_points_table_output_limb_35_col121 = eval.next_trace_mask();
        let pedersen_points_table_output_limb_36_col122 = eval.next_trace_mask();
        let pedersen_points_table_output_limb_37_col123 = eval.next_trace_mask();
        let pedersen_points_table_output_limb_38_col124 = eval.next_trace_mask();
        let pedersen_points_table_output_limb_39_col125 = eval.next_trace_mask();
        let pedersen_points_table_output_limb_40_col126 = eval.next_trace_mask();
        let pedersen_points_table_output_limb_41_col127 = eval.next_trace_mask();
        let pedersen_points_table_output_limb_42_col128 = eval.next_trace_mask();
        let pedersen_points_table_output_limb_43_col129 = eval.next_trace_mask();
        let pedersen_points_table_output_limb_44_col130 = eval.next_trace_mask();
        let pedersen_points_table_output_limb_45_col131 = eval.next_trace_mask();
        let pedersen_points_table_output_limb_46_col132 = eval.next_trace_mask();
        let pedersen_points_table_output_limb_47_col133 = eval.next_trace_mask();
        let pedersen_points_table_output_limb_48_col134 = eval.next_trace_mask();
        let pedersen_points_table_output_limb_49_col135 = eval.next_trace_mask();
        let pedersen_points_table_output_limb_50_col136 = eval.next_trace_mask();
        let pedersen_points_table_output_limb_51_col137 = eval.next_trace_mask();
        let pedersen_points_table_output_limb_52_col138 = eval.next_trace_mask();
        let pedersen_points_table_output_limb_53_col139 = eval.next_trace_mask();
        let pedersen_points_table_output_limb_54_col140 = eval.next_trace_mask();
        let pedersen_points_table_output_limb_55_col141 = eval.next_trace_mask();
        ...
        eval.add_to_relation(RelationEntry::new(
            ...
            &[
                ...
                pedersen_points_table_output_limb_0_col86.clone(),
                pedersen_points_table_output_limb_1_col87.clone(),
                pedersen_points_table_output_limb_2_col88.clone(),
                pedersen_points_table_output_limb_3_col89.clone(),
                pedersen_points_table_output_limb_4_col90.clone(),
                pedersen_points_table_output_limb_5_col91.clone(),
                pedersen_points_table_output_limb_6_col92.clone(),
                pedersen_points_table_output_limb_7_col93.clone(),
                pedersen_points_table_output_limb_8_col94.clone(),
                pedersen_points_table_output_limb_9_col95.clone(),
                pedersen_points_table_output_limb_10_col96.clone(),
                pedersen_points_table_output_limb_11_col97.clone(),
                pedersen_points_table_output_limb_12_col98.clone(),
                pedersen_points_table_output_limb_13_col99.clone(),
                pedersen_points_table_output_limb_14_col100.clone(),
                pedersen_points_table_output_limb_15_col101.clone(),
                pedersen_points_table_output_limb_16_col102.clone(),
                pedersen_points_table_output_limb_17_col103.clone(),
                pedersen_points_table_output_limb_18_col104.clone(),
                pedersen_points_table_output_limb_19_col105.clone(),
                pedersen_points_table_output_limb_20_col106.clone(),
                pedersen_points_table_output_limb_21_col107.clone(),
                pedersen_points_table_output_limb_22_col108.clone(),
                pedersen_points_table_output_limb_23_col109.clone(),
                pedersen_points_table_output_limb_24_col110.clone(),
                pedersen_points_table_output_limb_25_col111.clone(),
                pedersen_points_table_output_limb_26_col112.clone(),
                pedersen_points_table_output_limb_27_col113.clone(),
                pedersen_points_table_output_limb_28_col114.clone(),
                pedersen_points_table_output_limb_29_col115.clone(),
                pedersen_points_table_output_limb_30_col116.clone(),
                pedersen_points_table_output_limb_31_col117.clone(),
                pedersen_points_table_output_limb_32_col118.clone(),
                pedersen_points_table_output_limb_33_col119.clone(),
                pedersen_points_table_output_limb_34_col120.clone(),
                pedersen_points_table_output_limb_35_col121.clone(),
                pedersen_points_table_output_limb_36_col122.clone(),
                pedersen_points_table_output_limb_37_col123.clone(),
                pedersen_points_table_output_limb_38_col124.clone(),
                pedersen_points_table_output_limb_39_col125.clone(),
                pedersen_points_table_output_limb_40_col126.clone(),
                pedersen_points_table_output_limb_41_col127.clone(),
                pedersen_points_table_output_limb_42_col128.clone(),
                pedersen_points_table_output_limb_43_col129.clone(),
                pedersen_points_table_output_limb_44_col130.clone(),
                pedersen_points_table_output_limb_45_col131.clone(),
                pedersen_points_table_output_limb_46_col132.clone(),
                pedersen_points_table_output_limb_47_col133.clone(),
                pedersen_points_table_output_limb_48_col134.clone(),
                pedersen_points_table_output_limb_49_col135.clone(),
                pedersen_points_table_output_limb_50_col136.clone(),
                pedersen_points_table_output_limb_51_col137.clone(),
                pedersen_points_table_output_limb_52_col138.clone(),
                pedersen_points_table_output_limb_53_col139.clone(),
                pedersen_points_table_output_limb_54_col140.clone(),
                pedersen_points_table_output_limb_55_col141.clone(),
            ],
        ));
