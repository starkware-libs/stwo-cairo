...
impl FrameworkEval for Eval {
    ...
    fn evaluate<E: EvalAtRow>(&self, mut eval: E) -> E {
        ...
        let dst_sum_p_non_zero_tmp_f51a9_11 = eval.add_intermediate(
            ((((((((((((((((((((((((dst_limb_1_col9.clone()
                + dst_limb_2_col10.clone())
                + dst_limb_3_col11.clone())
                + dst_limb_4_col12.clone())
        ...
        eval.add_constraint(
            (((dst_sum_p_non_zero_tmp_f51a9_11.clone()
                + (((dst_0_minus_p_0_tmp_f51a9_12.clone()
                    * dst_0_minus_p_0_tmp_f51a9_12.clone())
                    + (dst_21_minus_p_21_tmp_f51a9_13.clone()
                        * dst_21_minus_p_21_tmp_f51a9_13.clone()))
                    + (dst_27_minus_p_27_tmp_f51a9_14.clone()
                        * dst_27_minus_p_27_tmp_f51a9_14.clone())))
