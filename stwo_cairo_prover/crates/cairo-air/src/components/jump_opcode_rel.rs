...
use subroutines::decode_instruction_1af1f::DecodeInstruction1Af1F;
...
impl FrameworkEval for Eval {
    ...
    fn evaluate<E: EvalAtRow>(&self, mut eval: E) -> E {
        ...
        eval.add_to_relation(RelationEntry::new(
            ...
            &[
                M31_428564188.clone(),
                (input_pc_col1.clone() + read_small_output_tmp_6218d_15_limb_0.clone()),
...
mod tests {
    ...
    fn jump_opcode_rel_constraints_regression() {
        ...
        constraints_regression_test_values::JUMP_OPCODE_REL.assert_debug_eq(&sum);
    }
}
