...
mod tests {
    ...
    use super::*;
    use crate::components::constraints_regression_test_values::RANGE_CHECK_20_H;

    #[test]
    fn range_check_20_h_constraints_regression() {
        ...
        RANGE_CHECK_20_H.assert_debug_eq(&sum);
    }
}
