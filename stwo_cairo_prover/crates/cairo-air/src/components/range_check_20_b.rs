...
mod tests {
    ...
    use super::*;
    use crate::components::constraints_regression_test_values::RANGE_CHECK_20_B;

    #[test]
    fn range_check_20_b_constraints_regression() {
        ...
        RANGE_CHECK_20_B.assert_debug_eq(&sum);
    }
}
