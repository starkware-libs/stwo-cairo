...
mod tests {
    ...
    use super::*;
    use crate::components::constraints_regression_test_values::RANGE_CHECK_20_G;

    #[test]
    fn range_check_20_g_constraints_regression() {
        ...
        RANGE_CHECK_20_G.assert_debug_eq(&sum);
    }
}
