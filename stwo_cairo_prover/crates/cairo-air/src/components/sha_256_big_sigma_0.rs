...
impl FrameworkEval for Eval {
    ...
    fn evaluate<E: EvalAtRow>(&self, mut eval: E) -> E {
        ...
        let M31_3971 = E::F::from(M31::from(3971));
        let M31_61440 = E::F::from(M31::from(61440));
        ...
        BitwiseAndNumBits16::evaluate(
            [input_limb_0_col0.clone(), M31_3971.clone()],
            and_col2.clone(),
            &self.verify_bitwise_and_16_lookup_elements,
            &mut eval,
        );
        BitwiseAndNumBits16::evaluate(
            [input_limb_0_col0.clone(), M31_124.clone()],
            and_col3.clone(),
            &self.verify_bitwise_and_16_lookup_elements,
            &mut eval,
        );
        BitwiseAndNumBits16::evaluate(
            [input_limb_0_col0.clone(), M31_61440.clone()],
            and_col4.clone(),
            &self.verify_bitwise_and_16_lookup_elements,
            &mut eval,
        );
        BitwiseAndNumBits16::evaluate(
            [input_limb_1_col1.clone(), M31_124.clone()],
            and_col5.clone(),
            &self.verify_bitwise_and_16_lookup_elements,
            &mut eval,
        );
        BitwiseAndNumBits16::evaluate(
            [input_limb_1_col1.clone(), M31_61440.clone()],
            and_col6.clone(),
            &self.verify_bitwise_and_16_lookup_elements,
            &mut eval,
        );
        BitwiseAndNumBits16::evaluate(
            [input_limb_1_col1.clone(), M31_3971.clone()],
            and_col7.clone(),
            &self.verify_bitwise_and_16_lookup_elements,
            &mut eval,
        );
