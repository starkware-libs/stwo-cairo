...
mod tests {
    ...
    use super::*;
    use crate::components::constraints_regression_test_values::SHA_256_BIG_SIGMA_1;

    #[test]
    fn sha_256_big_sigma_1_constraints_regression() {
        ...
        assert_eq!(sum, SHA_256_BIG_SIGMA_1);
    }
}
