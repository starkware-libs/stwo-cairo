...
mod tests {
    ...
    use super::*;
    use crate::components::constraints_regression_test_values::RANGE_CHECK_20_F;

    #[test]
    fn range_check_20_f_constraints_regression() {
        ...
        RANGE_CHECK_20_F.assert_debug_eq(&sum);
    }
}
