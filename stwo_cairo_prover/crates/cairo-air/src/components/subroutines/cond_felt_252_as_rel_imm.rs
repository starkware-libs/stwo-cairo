...
impl CondFelt252AsRelImm {
    ...
    pub fn evaluate<E: EvalAtRow>(
        ...
        let [decode_small_sign_output_tmp_1e9bf_2_limb_0, decode_small_sign_output_tmp_1e9bf_2_limb_1, decode_small_sign_output_tmp_1e9bf_2_limb_2, decode_small_sign_output_tmp_1e9bf_2_limb_3] =
        ...
        let remainder_bits_tmp_1e9bf_3 = eval.add_intermediate(
            (cond_felt_252_as_rel_imm_input_limb_3.clone()
                - decode_small_sign_output_tmp_1e9bf_2_limb_0.clone()),
        );
        ...
        eval.add_constraint(
            (cond_felt_252_as_rel_imm_input_limb_28.clone()
                * (((((((((((((((((cond_felt_252_as_rel_imm_input_limb_4.clone()
                    ...
                    - (decode_small_sign_output_tmp_1e9bf_2_limb_1.clone() * M31_17.clone()))),
        );
        // When the condition holds, limb 21 must be 0x0, 0x88 or 0x87.
        eval.add_constraint(
            (cond_felt_252_as_rel_imm_input_limb_28.clone()
                * (cond_felt_252_as_rel_imm_input_limb_21.clone()
                    - decode_small_sign_output_tmp_1e9bf_2_limb_2.clone())),
        );
        ...
        eval.add_constraint(
            (cond_felt_252_as_rel_imm_input_limb_28.clone()
                * (cond_felt_252_as_rel_imm_input_limb_27.clone()
                    - decode_small_sign_output_tmp_1e9bf_2_limb_3.clone())),
        );
        [(((((cond_felt_252_as_rel_imm_input_limb_0.clone()
            ...
            - (decode_small_sign_output_tmp_1e9bf_2_limb_3.clone() * M31_8388608.clone()))
            - (M31_536870912.clone()
                * (decode_small_sign_output_tmp_1e9bf_2_limb_1.clone() * M31_142885409.clone())))]
    }
}
