        ...
        eval.add_to_relation(RelationEntry::new(
            ...
            &[
                ...
                (remainder_bits_col6.clone()
                    + decode_small_sign_output_tmp_c806d_5_limb3_7_high_bits.clone()),
                decode_small_sign_output_tmp_c806d_5_limbs4_to_20.clone(),
                decode_small_sign_output_tmp_c806d_5_limbs4_to_20.clone(),
                decode_small_sign_output_tmp_c806d_5_limbs4_to_20.clone(),
                decode_small_sign_output_tmp_c806d_5_limbs4_to_20.clone(),
                decode_small_sign_output_tmp_c806d_5_limbs4_to_20.clone(),
                ...
                decode_small_sign_output_tmp_c806d_5_limbs4_to_20.clone(),
                decode_small_sign_output_tmp_c806d_5_limbs4_to_20.clone(),
                decode_small_sign_output_tmp_c806d_5_limb21.clone(),
                M31_0.clone(),
                M31_0.clone(),
                M31_0.clone(),
                M31_0.clone(),
                M31_0.clone(),
                decode_small_sign_output_tmp_c806d_5_limb27.clone(),
            ],
        ));
