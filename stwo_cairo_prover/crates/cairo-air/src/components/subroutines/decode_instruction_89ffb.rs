...
pub struct DecodeInstruction89Ffb {}

impl DecodeInstruction89Ffb {
    #[allow(unused_parens)]
    ...
    pub fn evaluate<E: EvalAtRow>(
        [decode_instruction_89ffb_input_pc]: [E::F; 1],
        offset2_col0: E::F,
        op1_imm_col1: E::F,
        ...
        let op1_base_ap_tmp_89ffb_5 = eval
            .add_intermediate(((M31_1.clone() - op1_imm_col1.clone()) - op1_base_fp_col2.clone()));
        // Flag op1_base_ap is a bit.
        eval.add_constraint(
            (op1_base_ap_tmp_89ffb_5.clone() * (M31_1.clone() - op1_base_ap_tmp_89ffb_5.clone())),
        );
        eval.add_to_relation(RelationEntry::new(
            ...
            &[
                ...
                decode_instruction_89ffb_input_pc.clone(),
                M31_32767.clone(),
                M31_32767.clone(),
                offset2_col0.clone(),
                (((M31_24.clone() + (op1_imm_col1.clone() * M31_32.clone()))
                    + (op1_base_fp_col2.clone() * M31_64.clone()))
                    + (op1_base_ap_tmp_89ffb_5.clone() * M31_128.clone())),
                M31_16.clone(),
            ],
        ));
