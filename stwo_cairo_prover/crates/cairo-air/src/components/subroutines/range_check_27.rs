...
impl RangeCheck27 {
    ...
    pub fn evaluate<E: EvalAtRow>(
        [range_check_27_input]: [E::F; 1],
        rangecheck27_bot8bits_col0: E::F,
        ...
        eval.add_to_relation(RelationEntry::new(
            ...
            E::EF::one(),
            &[
                ((range_check_27_input.clone() - rangecheck27_bot8bits_col0.clone())
                    * M31_8388608.clone()),
            ],
        ));
        ...
        eval.add_to_relation(RelationEntry::new(
            ...
            E::EF::one(),
            &[rangecheck27_bot8bits_col0.clone()],
        ));
