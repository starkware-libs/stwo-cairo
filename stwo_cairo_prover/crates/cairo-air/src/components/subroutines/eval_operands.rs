    ...
    pub fn evaluate<E: EvalAtRow>(
        ...
        eval.add_constraint(
            ((((eval_operands_input_res_add.clone() * add_res_limb_0_col91.clone())
                ...
                - ((M31_1.clone() - eval_operands_input_pc_update_jnz.clone())
                    * res_limb_0_col176.clone())),
        );
