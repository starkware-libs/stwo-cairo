...
pub struct DecodeInstructionC630B {}

impl DecodeInstructionC630B {
    #[allow(unused_parens)]
    ...
    pub fn evaluate<E: EvalAtRow>(
        [decode_instruction_c630b_input_pc]: [E::F; 1],
        offset0_col0: E::F,
        offset1_col1: E::F,
        offset2_col2: E::F,
        ...
        let op1_base_ap_tmp_c630b_9 = eval
            .add_intermediate(((M31_1.clone() - op1_imm_col5.clone()) - op1_base_fp_col6.clone()));
        // Flag op1_base_ap is a bit.
        eval.add_constraint(
            (op1_base_ap_tmp_c630b_9.clone() * (M31_1.clone() - op1_base_ap_tmp_c630b_9.clone())),
        );
        ...
        eval.add_to_relation(RelationEntry::new(
            ...
            &[
                ...
                decode_instruction_c630b_input_pc.clone(),
                offset0_col0.clone(),
                offset1_col1.clone(),
                offset2_col2.clone(),
                (((((dst_base_fp_col3.clone() * M31_8.clone())
                    ...
                    + (op1_base_ap_tmp_c630b_9.clone() * M31_128.clone())),
