...
pub struct DecodeInstruction43E1C26Dca5A217 {}

impl DecodeInstruction43E1C26Dca5A217 {
    #[allow(unused_parens)]
    ...
    pub fn evaluate<E: EvalAtRow>(
        decode_instruction_43e1c26dca5a217_input: E::F,
        offset2_col0: E::F,
        ...
        eval.add_to_relation(RelationEntry::new(
            ...
            E::EF::one(),
            &[
                decode_instruction_43e1c26dca5a217_input.clone(),
                M31_32767.clone(),
                M31_32767.clone(),
                offset2_col0.clone(),
