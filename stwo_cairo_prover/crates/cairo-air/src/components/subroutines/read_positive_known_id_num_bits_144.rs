...
pub struct ReadPositiveKnownIdNumBits144 {}

impl ReadPositiveKnownIdNumBits144 {
    #[allow(unused_parens)]
    ...
    pub fn evaluate<E: EvalAtRow>(
        [read_positive_known_id_num_bits_144_input]: [E::F; 1],
        ...
        eval.add_to_relation(RelationEntry::new(
            ...
            E::EF::one(),
            &[
                read_positive_known_id_num_bits_144_input.clone(),
