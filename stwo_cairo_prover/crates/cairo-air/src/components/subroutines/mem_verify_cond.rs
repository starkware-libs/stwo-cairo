...
impl MemVerifyCond {
    ...
    pub fn evaluate<E: EvalAtRow>(
        ...
        eval.add_to_relation(RelationEntry::new(
            ...
            E::EF::from(mem_verify_cond_input_cond.clone()),
            &[
                M31_1444891767.clone(),
                mem_verify_cond_input_address.clone(),
                id_col0.clone(),
            ],
        ));
        ...
        eval.add_to_relation(RelationEntry::new(
            ...
            &[
                ...
                id_col0.clone(),
                mem_verify_cond_input_value_limb_0.clone(),
                mem_verify_cond_input_value_limb_1.clone(),
                mem_verify_cond_input_value_limb_2.clone(),
                mem_verify_cond_input_value_limb_3.clone(),
                mem_verify_cond_input_value_limb_4.clone(),
                mem_verify_cond_input_value_limb_5.clone(),
                mem_verify_cond_input_value_limb_6.clone(),
                mem_verify_cond_input_value_limb_7.clone(),
                mem_verify_cond_input_value_limb_8.clone(),
                mem_verify_cond_input_value_limb_9.clone(),
                mem_verify_cond_input_value_limb_10.clone(),
                mem_verify_cond_input_value_limb_11.clone(),
                mem_verify_cond_input_value_limb_12.clone(),
                mem_verify_cond_input_value_limb_13.clone(),
                mem_verify_cond_input_value_limb_14.clone(),
                mem_verify_cond_input_value_limb_15.clone(),
                mem_verify_cond_input_value_limb_16.clone(),
                mem_verify_cond_input_value_limb_17.clone(),
                mem_verify_cond_input_value_limb_18.clone(),
                mem_verify_cond_input_value_limb_19.clone(),
                mem_verify_cond_input_value_limb_20.clone(),
                mem_verify_cond_input_value_limb_21.clone(),
                mem_verify_cond_input_value_limb_22.clone(),
                mem_verify_cond_input_value_limb_23.clone(),
                mem_verify_cond_input_value_limb_24.clone(),
                mem_verify_cond_input_value_limb_25.clone(),
                mem_verify_cond_input_value_limb_26.clone(),
                mem_verify_cond_input_value_limb_27.clone(),
            ],
        ));
