...
mod tests {
    ...
    use super::*;
    use crate::components::constraints_regression_test_values::RANGE_CHECK_20_C;

    #[test]
    fn range_check_20_c_constraints_regression() {
        ...
        RANGE_CHECK_20_C.assert_debug_eq(&sum);
    }
}
