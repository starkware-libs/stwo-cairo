...
pub const RELATION_USES_PER_ROW: [RelationUse; 4] = [
    RelationUse {
        relation_id: "Sha256SmallSigma1O0",
        uses: 1,
    },
    RelationUse {
        relation_id: "Sha256SmallSigma1O1",
        uses: 1,
    },
    RelationUse {
...
pub struct Eval {
    ...
    pub sha_256_small_sigma_1_o_0_lookup_elements: relations::Sha256SmallSigma1O0,
...
impl FrameworkEval for Eval {
    ...
    fn evaluate<E: EvalAtRow>(&self, mut eval: E) -> E {
        ...
        let M31_122 = E::F::from(M31::from(122));
        let M31_133 = E::F::from(M31::from(133));
        let M31_165 = E::F::from(M31::from(165));
        let M31_180 = E::F::from(M31::from(180));
        let M31_189 = E::F::from(M31::from(189));
        let M31_256 = E::F::from(M31::from(256));
        let M31_66 = E::F::from(M31::from(66));
        let M31_74 = E::F::from(M31::from(74));
        let M31_90 = E::F::from(M31::from(90));
        ...
        let [split_16_low_part_size_8_output_tmp_2ae59_1_limb_0] = Split16LowPartSize8::evaluate(
        ...
        #[allow(clippy::unused_unit)]
        #[allow(unused_variables)]
        let [split_16_low_part_size_8_output_tmp_2ae59_3_limb_0] = Split16LowPartSize8::evaluate(
        ...
        BitwiseAndNumBits8::evaluate(
            [
                split_16_low_part_size_8_output_tmp_2ae59_1_limb_0.clone(),
                M31_133.clone(),
            ],
            and_col4.clone(),
        ...
        BitwiseAndNumBits8::evaluate(
            [ms_8_bits_col2.clone(), M31_66.clone()],
            and_col5.clone(),
            &self.verify_bitwise_and_8_lookup_elements,
            &mut eval,
        );
        ...
        BitwiseAndNumBits8::evaluate(
            [ms_8_bits_col2.clone(), M31_189.clone()],
            and_col11.clone(),
            &self.verify_bitwise_and_8_lookup_elements,
            &mut eval,
        );
        ...
        BitwiseAndNumBits8::evaluate(
            [
                split_16_low_part_size_8_output_tmp_2ae59_3_limb_0.clone(),
                M31_165.clone(),
            ],
            and_col13.clone(),
            &self.verify_bitwise_and_8_lookup_elements,
        ...
        BitwiseAndNumBits8::evaluate(
            [ms_8_bits_col3.clone(), M31_74.clone()],
            and_col14.clone(),
            &self.verify_bitwise_and_8_lookup_elements,
            &mut eval,
        );
        ...
        BitwiseAndNumBits8::evaluate(
            [ms_8_bits_col3.clone(), M31_1.clone()],
            and_col17.clone(),
            &self.verify_bitwise_and_8_lookup_elements,
            &mut eval,
        );
        ...
        BitwiseAndNumBits8::evaluate(
            [ms_8_bits_col3.clone(), M31_180.clone()],
            and_col20.clone(),
            &self.verify_bitwise_and_8_lookup_elements,
            &mut eval,
        );
        ...
        eval.add_to_relation(RelationEntry::new(
            &self.sha_256_small_sigma_1_o_0_lookup_elements,
            E::EF::one(),
            &[
                l0_col6.clone(),
                h0_col15.clone(),
        ...
        #[allow(clippy::unused_unit)]
        #[allow(unused_variables)]
        let [split_16_low_part_size_8_output_tmp_2ae59_39_limb_0] = Split16LowPartSize8::evaluate(
            [sigma_O2_prime_L_col28.clone()],
        ...
        #[allow(clippy::unused_unit)]
        #[allow(unused_variables)]
        let [split_16_low_part_size_8_output_tmp_2ae59_41_limb_0] = Split16LowPartSize8::evaluate(
            [sigma_O2_L_col26.clone()],
        ...
        BitwiseXorNumBits8::evaluate(
            [
                split_16_low_part_size_8_output_tmp_2ae59_39_limb_0.clone(),
                split_16_low_part_size_8_output_tmp_2ae59_41_limb_0.clone(),
            ],
            xor_col32.clone(),
        ...
        #[allow(clippy::unused_unit)]
        #[allow(unused_variables)]
        let [split_16_low_part_size_8_output_tmp_2ae59_47_limb_0] = Split16LowPartSize8::evaluate(
            [sigma_O2_prime_H_col29.clone()],
        ...
        #[allow(clippy::unused_unit)]
        #[allow(unused_variables)]
        let [split_16_low_part_size_8_output_tmp_2ae59_49_limb_0] = Split16LowPartSize8::evaluate(
            [sigma_O2_H_col27.clone()],
        ...
        BitwiseXorNumBits8::evaluate(
            [
                split_16_low_part_size_8_output_tmp_2ae59_47_limb_0.clone(),
                split_16_low_part_size_8_output_tmp_2ae59_49_limb_0.clone(),
            ],
            xor_col37.clone(),
            &self.verify_bitwise_xor_8_lookup_elements,
            &mut eval,
...
mod tests {
    ...
    use super::*;
    use crate::components::constraints_regression_test_values::SHA_256_SMALL_SIGMA_1;

    #[test]
    fn sha_256_small_sigma_1_constraints_regression() {
        let mut rng = SmallRng::seed_from_u64(0);
        let eval = Eval {
            claim: Claim { log_size: 4 },
            verify_bitwise_and_8_lookup_elements: relations::VerifyBitwiseAnd_8::dummy(),
            sha_256_small_sigma_1_o_0_lookup_elements: relations::Sha256SmallSigma1O0::dummy(),
        ...
        assert_eq!(sum, SHA_256_SMALL_SIGMA_1);
    }
}
