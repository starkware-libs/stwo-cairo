...
impl FrameworkEval for Eval {
    ...
    fn evaluate<E: EvalAtRow>(&self, mut eval: E) -> E {
        ...
        let M31_17029 = E::F::from(M31::from(17029));
        let M31_19109 = E::F::from(M31::from(19109));
        let M31_346 = E::F::from(M31::from(346));
        let M31_46080 = E::F::from(M31::from(46080));
        let M31_48384 = E::F::from(M31::from(48384));
        ...
        BitwiseAndNumBits16::evaluate(
            [input_limb_0_col0.clone(), M31_17029.clone()],
            and_col2.clone(),
            &self.verify_bitwise_and_16_lookup_elements,
            &mut eval,
        );
        BitwiseAndNumBits16::evaluate(
            [input_limb_0_col0.clone(), M31_122.clone()],
            and_col3.clone(),
            &self.verify_bitwise_and_16_lookup_elements,
            &mut eval,
        );
        BitwiseAndNumBits16::evaluate(
            [input_limb_0_col0.clone(), M31_48384.clone()],
            and_col4.clone(),
            &self.verify_bitwise_and_16_lookup_elements,
            &mut eval,
        );
        BitwiseAndNumBits16::evaluate(
            [input_limb_1_col1.clone(), M31_19109.clone()],
            and_col5.clone(),
            &self.verify_bitwise_and_16_lookup_elements,
            &mut eval,
        );
        BitwiseAndNumBits16::evaluate(
            [input_limb_1_col1.clone(), M31_346.clone()],
            and_col6.clone(),
            &self.verify_bitwise_and_16_lookup_elements,
            &mut eval,
        );
        BitwiseAndNumBits16::evaluate(
            [input_limb_1_col1.clone(), M31_46080.clone()],
            and_col7.clone(),
            &self.verify_bitwise_and_16_lookup_elements,
            &mut eval,
        );
