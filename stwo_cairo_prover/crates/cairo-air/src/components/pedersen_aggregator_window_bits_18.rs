...
impl FrameworkEval for Eval {
    ...
    fn evaluate<E: EvalAtRow>(&self, mut eval: E) -> E {
        ...
        let partial_ec_mul_window_bits_18_chain_tmp_tmp_48808_8 =
            eval.add_intermediate((seq.clone() * M31_2.clone()));
        eval.add_to_relation(RelationEntry::new(
            &self.partial_ec_mul_window_bits_18_lookup_elements,
            -E::EF::one(),
            &[
                partial_ec_mul_window_bits_18_chain_tmp_tmp_48808_8.clone(),
                M31_0.clone(),
        ...
        let partial_ec_mul_window_bits_18_chain_id_tmp_48808_23 = eval.add_intermediate(
            (partial_ec_mul_window_bits_18_chain_tmp_tmp_48808_8.clone() + M31_1.clone()),
        );
        eval.add_to_relation(RelationEntry::new(
            &self.partial_ec_mul_window_bits_18_lookup_elements,
            -E::EF::one(),
            &[
                partial_ec_mul_window_bits_18_chain_id_tmp_48808_23.clone(),
                M31_14.clone(),
