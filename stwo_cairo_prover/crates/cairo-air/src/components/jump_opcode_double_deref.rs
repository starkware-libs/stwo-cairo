...
impl FrameworkEval for Eval {
    ...
    fn evaluate<E: EvalAtRow>(&self, mut eval: E) -> E {
        ...
        let decode_instruction_f67489ac525d7245_output_tmp_2757b_6_limb_1 =
            eval.add_intermediate((offset1_col3.clone() - M31_32768.clone()));
        let decode_instruction_f67489ac525d7245_output_tmp_2757b_6_limb_2 =
        ...
        eval.add_to_relation(RelationEntry::new(
            ...
            &[
                (mem0_base_col7.clone()
                    + decode_instruction_f67489ac525d7245_output_tmp_2757b_6_limb_1.clone()),
        ...
        eval.add_to_relation(RelationEntry::new(
            ...
            &[
                (((mem1_base_limb_0_col9.clone()
                    ...
                    + decode_instruction_f67489ac525d7245_output_tmp_2757b_6_limb_2.clone()),
