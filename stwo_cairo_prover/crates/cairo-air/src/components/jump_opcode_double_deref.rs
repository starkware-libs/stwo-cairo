...
use subroutines::decode_instruction_11364::DecodeInstruction11364;
...
impl FrameworkEval for Eval {
    ...
    fn evaluate<E: EvalAtRow>(&self, mut eval: E) -> E {
        ...
        let mem0_base_col8 = eval.next_trace_mask();
        let mem1_base_id_col9 = eval.next_trace_mask();
        let mem1_base_limb_0_col10 = eval.next_trace_mask();
        let mem1_base_limb_1_col11 = eval.next_trace_mask();
        let mem1_base_limb_2_col12 = eval.next_trace_mask();
        let mem1_base_limb_3_col13 = eval.next_trace_mask();
        let partial_limb_msb_col14 = eval.next_trace_mask();
        let next_pc_id_col15 = eval.next_trace_mask();
        let next_pc_limb_0_col16 = eval.next_trace_mask();
        let next_pc_limb_1_col17 = eval.next_trace_mask();
        let next_pc_limb_2_col18 = eval.next_trace_mask();
        let next_pc_limb_3_col19 = eval.next_trace_mask();
        let partial_limb_msb_col20 = eval.next_trace_mask();
        ...
        eval.add_constraint(
            (mem0_base_col8.clone()
                - ((op0_base_fp_col6.clone() * input_fp_col3.clone())
                    + ((M31_1.clone() - op0_base_fp_col6.clone()) * input_ap_col2.clone()))),
        );
        ReadPositiveNumBits29::evaluate(
            ...
            mem1_base_limb_1_col11.clone(),
            mem1_base_limb_2_col12.clone(),
            mem1_base_limb_3_col13.clone(),
        ...
        ReadPositiveNumBits29::evaluate(
            [((((mem1_base_limb_0_col10.clone()
                + (mem1_base_limb_1_col11.clone() * M31_512.clone()))
                + (mem1_base_limb_2_col12.clone() * M31_262144.clone()))
                + (mem1_base_limb_3_col13.clone() * M31_134217728.clone()))
                + decode_instruction_11364_output_tmp_b5a8f_6_offset2.clone())],
            enabler_col0.clone(),
            next_pc_id_col15.clone(),
            next_pc_limb_0_col16.clone(),
            next_pc_limb_1_col17.clone(),
            next_pc_limb_2_col18.clone(),
            next_pc_limb_3_col19.clone(),
            partial_limb_msb_col20.clone(),
            &self.common_lookup_elements,
            &mut eval,
        );
        ...
        eval.add_to_relation(RelationEntry::new(
            ...
            &[
                M31_428564188.clone(),
                (((next_pc_limb_0_col16.clone()
                    + (next_pc_limb_1_col17.clone() * M31_512.clone()))
                    + (next_pc_limb_2_col18.clone() * M31_262144.clone()))
                    + (next_pc_limb_3_col19.clone() * M31_134217728.clone())),
                (input_ap_col2.clone() + ap_update_add_1_col7.clone()),
                input_fp_col3.clone(),
            ],
        ));
...
mod tests {
    ...
    fn jump_opcode_double_deref_constraints_regression() {
        ...
        constraints_regression_test_values::JUMP_OPCODE_DOUBLE_DEREF.assert_debug_eq(&sum);
    }
}
