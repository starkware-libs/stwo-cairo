...
impl FrameworkEval for Eval {
    ...
    fn evaluate<E: EvalAtRow>(&self, mut eval: E) -> E {
        ...
        let M31_170 = E::F::from(M31::from(170));
        ...
        let [split_16_low_part_size_8_output_tmp_4b93d_1_limb_0] = Split16LowPartSize8::evaluate(
        ...
        #[allow(clippy::unused_unit)]
        #[allow(unused_variables)]
        let [split_16_low_part_size_8_output_tmp_4b93d_3_limb_0] = Split16LowPartSize8::evaluate(
        ...
        BitwiseAndNumBits8::evaluate(
            [
                split_16_low_part_size_8_output_tmp_4b93d_1_limb_0.clone(),
                M31_170.clone(),
            ],
            and_col4.clone(),
        ...
        BitwiseAndNumBits8::evaluate(
            [ms_8_bits_col2.clone(), M31_74.clone()],
            and_col5.clone(),
            &self.verify_bitwise_and_8_lookup_elements,
            &mut eval,
        );
        ...
        BitwiseAndNumBits8::evaluate(
            [ms_8_bits_col2.clone(), M31_181.clone()],
            and_col11.clone(),
            &self.verify_bitwise_and_8_lookup_elements,
            &mut eval,
        );
        ...
        BitwiseAndNumBits8::evaluate(
            [
                split_16_low_part_size_8_output_tmp_4b93d_3_limb_0.clone(),
                M31_85.clone(),
            ],
            and_col13.clone(),
            &self.verify_bitwise_and_8_lookup_elements,
        ...
        BitwiseAndNumBits8::evaluate(
            [ms_8_bits_col3.clone(), M31_181.clone()],
            and_col17.clone(),
            &self.verify_bitwise_and_8_lookup_elements,
            &mut eval,
        );
        ...
        #[allow(clippy::unused_unit)]
        #[allow(unused_variables)]
        let [split_16_low_part_size_8_output_tmp_4b93d_39_limb_0] = Split16LowPartSize8::evaluate(
            [sigma_O2_prime_L_col28.clone()],
        ...
        #[allow(clippy::unused_unit)]
        #[allow(unused_variables)]
        let [split_16_low_part_size_8_output_tmp_4b93d_41_limb_0] = Split16LowPartSize8::evaluate(
            [sigma_O2_L_col26.clone()],
        ...
        BitwiseXorNumBits8::evaluate(
            [
                split_16_low_part_size_8_output_tmp_4b93d_39_limb_0.clone(),
                split_16_low_part_size_8_output_tmp_4b93d_41_limb_0.clone(),
            ],
            xor_col32.clone(),
        ...
        #[allow(clippy::unused_unit)]
        #[allow(unused_variables)]
        let [split_16_low_part_size_8_output_tmp_4b93d_47_limb_0] = Split16LowPartSize8::evaluate(
            [sigma_O2_prime_H_col29.clone()],
        ...
        #[allow(clippy::unused_unit)]
        #[allow(unused_variables)]
        let [split_16_low_part_size_8_output_tmp_4b93d_49_limb_0] = Split16LowPartSize8::evaluate(
            [sigma_O2_H_col27.clone()],
        ...
        BitwiseXorNumBits8::evaluate(
            [
                split_16_low_part_size_8_output_tmp_4b93d_47_limb_0.clone(),
                split_16_low_part_size_8_output_tmp_4b93d_49_limb_0.clone(),
            ],
            xor_col37.clone(),
            &self.verify_bitwise_xor_8_lookup_elements,
            &mut eval,
