...
mod tests {
    ...
    use super::*;
    use crate::components::constraints_regression_test_values::RANGE_CHECK_20_D;

    #[test]
    fn range_check_20_d_constraints_regression() {
        ...
        RANGE_CHECK_20_D.assert_debug_eq(&sum);
    }
}
