...
use crate::cairo_claim::prelude::SecureField;
...
impl CairoClaim {
    pub fn mix_into(&self, channel: &mut impl Channel) {
        ...
        self.blake_compress_opcode.inspect(|c| c.mix_into(channel));
        ...
        self.blake_round.inspect(|c| c.mix_into(channel));
        ...
        self.verify_bitwise_xor_7.inspect(|c| c.mix_into(channel));

        channel.mix_u64(self.verify_bitwise_xor_4.is_some() as u64);
        self.verify_bitwise_xor_4.inspect(|c| c.mix_into(channel));

        channel.mix_u64(self.verify_bitwise_xor_12.is_some() as u64);
        self.verify_bitwise_xor_12.inspect(|c| c.mix_into(channel));

        channel.mix_u64(self.blake_round_sigma.is_some() as u64);
        self.blake_round_sigma.inspect(|c| c.mix_into(channel));

        channel.mix_u64(self.qm_31_add_mul_opcode.is_some() as u64);
        self.qm_31_add_mul_opcode.inspect(|c| c.mix_into(channel));

        channel.mix_u64(self.ret_opcode.is_some() as u64);
        self.ret_opcode.inspect(|c| c.mix_into(channel));

        channel.mix_u64(self.mul_opcode.is_some() as u64);
        self.mul_opcode.inspect(|c| c.mix_into(channel));

        channel.mix_u64(self.mul_opcode_small.is_some() as u64);
        self.mul_opcode_small.inspect(|c| c.mix_into(channel));

        channel.mix_u64(self.jump_opcode_abs.is_some() as u64);
        self.jump_opcode_abs.inspect(|c| c.mix_into(channel));
        ...
        self.jump_opcode_rel.inspect(|c| c.mix_into(channel));

        channel.mix_u64(self.jump_opcode_rel_imm.is_some() as u64);
        self.jump_opcode_rel_imm.inspect(|c| c.mix_into(channel));

        channel.mix_u64(self.jnz_opcode_non_taken.is_some() as u64);
        self.jnz_opcode_non_taken.inspect(|c| c.mix_into(channel));

        channel.mix_u64(self.jnz_opcode_taken.is_some() as u64);
        self.jnz_opcode_taken.inspect(|c| c.mix_into(channel));

        channel.mix_u64(self.call_opcode_rel_imm.is_some() as u64);
        self.call_opcode_rel_imm.inspect(|c| c.mix_into(channel));

        channel.mix_u64(self.call_opcode_abs.is_some() as u64);
        self.call_opcode_abs.inspect(|c| c.mix_into(channel));

        channel.mix_u64(self.assert_eq_opcode_imm.is_some() as u64);
        self.assert_eq_opcode_imm.inspect(|c| c.mix_into(channel));
        ...
        self.assert_eq_opcode.inspect(|c| c.mix_into(channel));

        channel.mix_u64(self.add_opcode.is_some() as u64);
        self.add_opcode.inspect(|c| c.mix_into(channel));

        channel.mix_u64(self.add_opcode_small.is_some() as u64);
        self.add_opcode_small.inspect(|c| c.mix_into(channel));

        channel.mix_u64(self.add_ap_opcode.is_some() as u64);
        self.add_ap_opcode.inspect(|c| c.mix_into(channel));

        channel.mix_u64(self.generic_opcode.is_some() as u64);
        self.generic_opcode.inspect(|c| c.mix_into(channel));

        channel.mix_u64(self.range_check_11.is_some() as u64);
        self.range_check_11.inspect(|c| c.mix_into(channel));

        channel.mix_u64(self.verify_instruction.is_some() as u64);
        self.verify_instruction.inspect(|c| c.mix_into(channel));

        channel.mix_u64(self.range_check_4_3.is_some() as u64);
        self.range_check_4_3.inspect(|c| c.mix_into(channel));

        channel.mix_u64(self.range_check_7_2_5.is_some() as u64);
        self.range_check_7_2_5.inspect(|c| c.mix_into(channel));
        ...
        self.range_check_8.inspect(|c| c.mix_into(channel));
        ...
        self.poseidon_aggregator.inspect(|c| c.mix_into(channel));
        ...
        self.range_check_4_4.inspect(|c| c.mix_into(channel));

        channel.mix_u64(self.range_check_4_4_4_4.is_some() as u64);
        self.range_check_4_4_4_4.inspect(|c| c.mix_into(channel));
        ...
        self.range_check_3_3_3_3_3.inspect(|c| c.mix_into(channel));

        channel.mix_u64(self.poseidon_round_keys.is_some() as u64);
        self.poseidon_round_keys.inspect(|c| c.mix_into(channel));

        channel.mix_u64(self.cube_252.is_some() as u64);
        self.cube_252.inspect(|c| c.mix_into(channel));

        channel.mix_u64(self.range_check_20.is_some() as u64);
        self.range_check_20.inspect(|c| c.mix_into(channel));
        ...
        self.range_check_18.inspect(|c| c.mix_into(channel));

        channel.mix_u64(self.range_check_3_6_6_3.is_some() as u64);
        self.range_check_3_6_6_3.inspect(|c| c.mix_into(channel));

        channel.mix_u64(self.range_check_12.is_some() as u64);
        self.range_check_12.inspect(|c| c.mix_into(channel));
        ...
        self.range_check96_builtin.inspect(|c| c.mix_into(channel));

        channel.mix_u64(self.range_check_6.is_some() as u64);
        self.range_check_6.inspect(|c| c.mix_into(channel));

        channel.mix_u64(self.range_check_builtin.is_some() as u64);
        self.range_check_builtin.inspect(|c| c.mix_into(channel));
        ...
        self.verify_bitwise_xor_8.inspect(|c| c.mix_into(channel));

        channel.mix_u64(self.verify_bitwise_xor_9.is_some() as u64);
        self.verify_bitwise_xor_9.inspect(|c| c.mix_into(channel));
        ...
        self.range_check_9_9.inspect(|c| c.mix_into(channel));
    ...
    pub fn accumulate_relation_uses(&self, relation_uses: &mut RelationUsesDict) {
        self.blake_compress_opcode.inspect(|c| {
        ...
        self.jump_opcode_abs.inspect(|c| {
            accumulate_relation_uses(
                relation_uses,
        ...
        self.jump_opcode_double_deref.inspect(|c| {
            accumulate_relation_uses(
                relation_uses,
        ...
        self.jump_opcode_rel.inspect(|c| {
            accumulate_relation_uses(
                relation_uses,
        ...
        self.jump_opcode_rel_imm.inspect(|c| {
            accumulate_relation_uses(
                relation_uses,
        ...
        self.jnz_opcode_non_taken.inspect(|c| {
            accumulate_relation_uses(
                relation_uses,
        ...
        self.jnz_opcode_taken.inspect(|c| {
            accumulate_relation_uses(
                relation_uses,
        ...
        self.call_opcode_rel_imm.inspect(|c| {
            accumulate_relation_uses(
                relation_uses,
        ...
        self.call_opcode_abs.inspect(|c| {
            accumulate_relation_uses(
                relation_uses,
        ...
        self.assert_eq_opcode_imm.inspect(|c| {
            accumulate_relation_uses(
                relation_uses,
        ...
        self.assert_eq_opcode_double_deref.inspect(|c| {
            accumulate_relation_uses(
                relation_uses,
        ...
        self.assert_eq_opcode.inspect(|c| {
            accumulate_relation_uses(
                relation_uses,
        ...
        self.verify_instruction.inspect(|c| {
            accumulate_relation_uses(
                relation_uses,
        ...
        self.pedersen_builtin.inspect(|c| {
            accumulate_relation_uses(
                relation_uses,
        ...
        self.pedersen_aggregator_window_bits_18.inspect(|c| {
            accumulate_relation_uses(
                relation_uses,
        ...
        self.partial_ec_mul_window_bits_18.inspect(|c| {
            accumulate_relation_uses(
                relation_uses,
        ...
        self.poseidon_builtin.inspect(|c| {
            accumulate_relation_uses(
                relation_uses,
        ...
        self.poseidon_aggregator.inspect(|c| {
            accumulate_relation_uses(
                relation_uses,
        ...
        self.poseidon_3_partial_rounds_chain.inspect(|c| {
            accumulate_relation_uses(
                relation_uses,
        ...
        self.range_check_252_width_27.inspect(|c| {
            accumulate_relation_uses(
                relation_uses,
        ...
        self.poseidon_full_round_chain.inspect(|c| {
            accumulate_relation_uses(
                relation_uses,
        ...
        self.add_mod_builtin.inspect(|c| {
            accumulate_relation_uses(
                relation_uses,
        ...
        self.range_check96_builtin.inspect(|c| {
            accumulate_relation_uses(
                relation_uses,
        ...
        self.range_check_builtin.inspect(|c| {
            accumulate_relation_uses(
                relation_uses,
        ...
        self.bitwise_builtin.inspect(|c| {
            accumulate_relation_uses(
                relation_uses,
...
pub fn lookup_sum(
    ...
    interaction_claim.blake_compress_opcode.inspect(|ic| {
        sum += ic.claimed_sum;
    });
    ...
    interaction_claim.verify_bitwise_xor_7.inspect(|ic| {
        sum += ic.claimed_sum;
    });
    interaction_claim.verify_bitwise_xor_4.inspect(|ic| {
        sum += ic.claimed_sum;
    });
    interaction_claim.verify_bitwise_xor_12.inspect(|ic| {
        sum += ic.claimed_sum;
    });
    interaction_claim.blake_round_sigma.inspect(|ic| {
        sum += ic.claimed_sum;
    });
    interaction_claim.qm_31_add_mul_opcode.inspect(|ic| {
        sum += ic.claimed_sum;
    });
    interaction_claim.ret_opcode.inspect(|ic| {
        sum += ic.claimed_sum;
    });
    interaction_claim.mul_opcode.inspect(|ic| {
        sum += ic.claimed_sum;
    });
    interaction_claim.mul_opcode_small.inspect(|ic| {
        sum += ic.claimed_sum;
    });
    interaction_claim.jump_opcode_abs.inspect(|ic| {
        sum += ic.claimed_sum;
    });
    interaction_claim.jump_opcode_double_deref.inspect(|ic| {
        sum += ic.claimed_sum;
    });
    interaction_claim.jump_opcode_rel.inspect(|ic| {
        sum += ic.claimed_sum;
    });
    interaction_claim.jump_opcode_rel_imm.inspect(|ic| {
        sum += ic.claimed_sum;
    });
    interaction_claim.jnz_opcode_non_taken.inspect(|ic| {
        sum += ic.claimed_sum;
    });
    interaction_claim.jnz_opcode_taken.inspect(|ic| {
        sum += ic.claimed_sum;
    });
    interaction_claim.call_opcode_rel_imm.inspect(|ic| {
        sum += ic.claimed_sum;
    });
    interaction_claim.call_opcode_abs.inspect(|ic| {
        sum += ic.claimed_sum;
    });
    interaction_claim.assert_eq_opcode_imm.inspect(|ic| {
        sum += ic.claimed_sum;
    });
    interaction_claim
    ...
    interaction_claim.assert_eq_opcode.inspect(|ic| {
        sum += ic.claimed_sum;
    });
    interaction_claim.add_opcode.inspect(|ic| {
        sum += ic.claimed_sum;
    });
    interaction_claim.add_opcode_small.inspect(|ic| {
        sum += ic.claimed_sum;
    });
    interaction_claim.add_ap_opcode.inspect(|ic| {
        sum += ic.claimed_sum;
    });
    interaction_claim.generic_opcode.inspect(|ic| {
        sum += ic.claimed_sum;
    });
    interaction_claim.range_check_11.inspect(|ic| {
        sum += ic.claimed_sum;
    });
    interaction_claim.verify_instruction.inspect(|ic| {
        sum += ic.claimed_sum;
    });
    interaction_claim.range_check_4_3.inspect(|ic| {
        sum += ic.claimed_sum;
    });
    interaction_claim.range_check_7_2_5.inspect(|ic| {
        sum += ic.claimed_sum;
    });
    ...
    interaction_claim.range_check_8.inspect(|ic| {
        sum += ic.claimed_sum;
    });
    interaction_claim.poseidon_builtin.inspect(|ic| {
        sum += ic.claimed_sum;
    });
    interaction_claim.poseidon_aggregator.inspect(|ic| {
        sum += ic.claimed_sum;
    });
    interaction_claim
    ...
    interaction_claim.range_check_4_4.inspect(|ic| {
        sum += ic.claimed_sum;
    });
    interaction_claim.range_check_4_4_4_4.inspect(|ic| {
        sum += ic.claimed_sum;
    });
    interaction_claim.range_check_252_width_27.inspect(|ic| {
        sum += ic.claimed_sum;
    });
    interaction_claim.poseidon_full_round_chain.inspect(|ic| {
        sum += ic.claimed_sum;
    });
    interaction_claim.range_check_3_3_3_3_3.inspect(|ic| {
        sum += ic.claimed_sum;
    });
    interaction_claim.poseidon_round_keys.inspect(|ic| {
        sum += ic.claimed_sum;
    });
    interaction_claim.cube_252.inspect(|ic| {
        sum += ic.claimed_sum;
    });
    interaction_claim.range_check_20.inspect(|ic| {
        sum += ic.claimed_sum;
    });
    interaction_claim.mul_mod_builtin.inspect(|ic| {
        sum += ic.claimed_sum;
    });
    interaction_claim.range_check_18.inspect(|ic| {
        sum += ic.claimed_sum;
    });
    interaction_claim.range_check_3_6_6_3.inspect(|ic| {
        sum += ic.claimed_sum;
    });
    interaction_claim.range_check_12.inspect(|ic| {
        sum += ic.claimed_sum;
    });
    interaction_claim.add_mod_builtin.inspect(|ic| {
        sum += ic.claimed_sum;
    });
    interaction_claim.range_check96_builtin.inspect(|ic| {
        sum += ic.claimed_sum;
    });
    interaction_claim.range_check_6.inspect(|ic| {
        sum += ic.claimed_sum;
    });
    interaction_claim.range_check_builtin.inspect(|ic| {
        sum += ic.claimed_sum;
    });
    interaction_claim.bitwise_builtin.inspect(|ic| {
        sum += ic.claimed_sum;
    });
    interaction_claim.verify_bitwise_xor_8.inspect(|ic| {
        sum += ic.claimed_sum;
    });
    interaction_claim.verify_bitwise_xor_9.inspect(|ic| {
        sum += ic.claimed_sum;
    });
    interaction_claim.memory_id_to_big.as_ref().inspect(|ic| {
        sum += ic.claimed_sum;
    });
    interaction_claim.range_check_9_9.inspect(|ic| {
        sum += ic.claimed_sum;
    });
    interaction_claim.memory_address_to_id.inspect(|ic| {
        sum += ic.claimed_sum;
    });
    sum
}
