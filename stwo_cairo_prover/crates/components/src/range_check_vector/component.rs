...
macro_rules! range_check_eval{
    ($($log_range:expr),+) => {
        paste::paste! {
                ...
                use $crate::memory::memory_id_to_big::component::N_MULTIPLICITY_COLUMNS;
                use stwo_cairo_component_utils::preprocessed::RangeCheck;
                use stwo_cairo_component_utils::preprocessed::PreProcessedColumn;
