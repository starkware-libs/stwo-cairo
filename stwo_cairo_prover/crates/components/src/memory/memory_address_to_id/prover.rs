...
use crate::memory_address_to_id::component::{N_ID_AND_MULT_COLUMNS_PER_CHUNK, N_TRACE_COLUMNS};
use crate::utils::AtomicMultiplicityColumn;
...
mod tests {
    ...
    use crate::memory::memory_address_to_id;
