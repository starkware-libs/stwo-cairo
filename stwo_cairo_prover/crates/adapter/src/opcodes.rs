...
impl CasmStatesByOpcode {
    ...
    #[cfg(not(feature = "generic_opcode"))]
    fn push_instr(&mut self, memory: &MemoryBuilder, state: CasmState) {
        ...
        match instruction {
            ...
            Instruction {
                ...
                if opcode_utils::is_small_mul(op0, op_1) {
            ...
            Instruction {
                ...
                if opcode_utils::is_small_add(dst, op0, op_1) {
...
mod opcode_utils {
    ...
    use super::super::memory::MemoryValue;
...
mod mappings_tests {
    ...
    #[cfg(not(feature = "generic_opcode"))]
    use super::opcode_utils::is_small_add;
    ...
    fn test_generic_opcode_full_program() {
        ...
        let compiled_program = get_compiled_cairo_program_path(
            "test_prove_verify_all_opcode_components_generic_opcode",
        );
