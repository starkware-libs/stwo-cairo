...
const SMALL_ADD_NEGATIVE_UPPER_BOUND: U256 = U256::from_words([
    (P_MIN_1[1] as u64) << 32 | (P_MIN_1[0] as u64),
    (P_MIN_1[3] as u64) << 32 | (P_MIN_1[2] as u64),
    (P_MIN_1[5] as u64) << 32 | (P_MIN_1[4] as u64),
    (P_MIN_1[7] as u64) << 32 | (P_MIN_1[6] as u64),
]);
...
mod mappings_tests {
    ...
    /// Small ranges: [0 … 2^27 − 1] (positive) | [P − 2^27 … P − 1] (negative mod P).
    #[test]
