...
mod mappings_tests {
    ...
    use crate::relocator::relocator_tests::{create_test_relocator, get_relocatble_test_trace};
    ...
    fn test_jmp_rel() {
        ...
        let trace_entry = RelocatedTraceEntry {
            ap: 1,
            fp: 1,
            pc: 1,
        };
    ...
    fn test_casm_state_from_relocator() {
        ...
        let (state_transitions, _) = StateTransitions::from_iter(
            relocator
                .relocate_trace(get_relocatble_test_trace())
                .into_iter(),
            &mut memory_builder,
        );
        assert_eq!(
