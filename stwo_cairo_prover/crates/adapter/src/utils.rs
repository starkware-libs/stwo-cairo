...
fn run_program(program_path: &PathBuf, executable: bool, args: Option<&PathBuf>) -> CairoRunner {
...
fn get_program_and_hints_from_executable<'a>(
...
fn read_cairo_arguments_from_file(path: &PathBuf) -> Vec<Arg> {
