...
use stwo_cairo_component_utils::preprocessed::PreProcessedTrace;
use stwo_cairo_component_utils::relations;
use stwo_cairo_components::memory::{memory_address_to_id, memory_id_to_big};
...
impl CairoClaimGenerator {
    pub fn new(input: ProverInput) -> Self {
        ...
        let poseidon_context_trace_generator = PoseidonContextClaimGenerator::default();
