...
func main{
    ...
    // make program length even
    ap+=1;
    [ap]=1;
    ap+=[ap];

    // pad the program to length 4096, each ap+=1 adds 2 to length
    // should match the seq used in stwo_cairo_prover/crates/cairo-air/src/components/program_component.rs
    ap+=1;
    ap+=1;
    ap+=1;
    ap+=1;
