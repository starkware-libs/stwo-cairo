...
#[derive(Default)]
pub struct Memory {
    pub address_to_id: Vec<PackedMemoryValueId>,
...
impl Memory {
    ...
    pub fn set(&mut self, addr: u64, value: MemoryValue) {
        ...
        self.address_to_id[addr as usize] = PackedMemoryValueId::pack(match value {
...
impl PackedMemoryValueId {
    pub fn pack(value: MemoryValueId) -> PackedMemoryValueId {
        match value {
            MemoryValueId::I16(id) => PackedMemoryValueId((id + SMALL_VALUE_SHIFT) as u32),
            MemoryValueId::U64(id) => PackedMemoryValueId(id as u32 | 0x4000_0000),
            MemoryValueId::F252(id) => PackedMemoryValueId(id as u32 | 0x8000_0000),
        }
    }
    pub fn unpack(&self) -> MemoryValueId {
        let tag = self.0 >> 30;
