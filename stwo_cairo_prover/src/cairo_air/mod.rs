...
pub struct OpCodeComponentGenerator {
    ret: Vec<RetOpcodeComponent>,
    memory: MemoryComponent, //..
}
impl OpCodeComponentGenerator {
    pub fn new(
...
pub fn prove_cairo(input: CairoInput) -> CairoProof<Blake2sMerkleHasher> {
    ...
    // Component provers.
    let component_builder = OpCodeComponentGenerator::new(
        &cairo_claim,
...
pub fn verify_cairo(
    ...
    let component_generator =
        OpCodeComponentGenerator::new(&cairo_claim, &lookup_elements, &interaction_claim);
