...
use super::component::{
    LOG_MEMORY_ADDRESS_BOUND, MULTIPLICITY_COLUMN_OFFSET, N_M31_IN_FELT252, N_MEMORY_COLUMNS,
};
use crate::prover_types::{PackedUInt32, N_LANES};

const LOG_SIMD_MEMORY_ADDRESS_BOUND: u32 = LOG_MEMORY_ADDRESS_BOUND + LOG_N_LANES;
const SIMD_MEMORY_ADDRESS_BOUND: usize = 1 << LOG_SIMD_MEMORY_ADDRESS_BOUND;

pub struct MemorySimdTraceGenerator {
    pub values: Vec<[PackedM31; N_M31_IN_FELT252]>,
    pub multiplicities: Vec<PackedUInt32>,
}
impl MemorySimdTraceGenerator {
...
mod tests {
    ...
    fn test_deduct_output_simd() {
        let generator = super::MemorySimdTraceGenerator::new("".to_string());
