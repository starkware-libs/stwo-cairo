...
use stwo_prover::constraint_framework::logup::{LogupAtRow, LogupTraceGenerator, LookupElements};
...
use crate::prover_types::N_LANES;
...
pub struct RetOpcodeInteractionGenerator {}
impl RetOpcodeInteractionGenerator {
    pub fn write_interaction_trace(
        ...
        for col_index in 0..3 {
            ...
            for (i, (addr, output)) in zip_eq(
                &lookup_data.memory_inputs[col_index],
                &lookup_data.memory_outputs[col_index],
            )
            .enumerate()
            {
